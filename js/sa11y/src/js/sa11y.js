...
import findShadowComponents from './logic/find-shadow-components.js';

// Extras
import detectPageChanges from './features/detect-page-changes.js';
import { dismissLogic, dismissButtons, removeDismissListeners } from './features/dismiss-annotations.js';
import { addColourFilters, resetColourFilters } from './features/colour-filters.js';
import { exportResults, removeExportListeners } from './features/export-results.js';
import ConsoleErrors from './interface/console-error.js';

// Create UI/interface elements
import mainToggle from './logic/main-toggle-logic.js';
import ControlPanel from './interface/control-panel.js';
import settingsPanelToggles from './logic/settings-panel-logic.js';
import initializePanelToggles from './logic/control-panel-logic.js';
import generatePageOutline from './interface/page-outline.js';
import generateImageOutline from './interface/image-outline.js';
import { updatePanel, updateBadge, updateCount } from './logic/update-panel.js';
import { AnnotationTooltips, PanelTooltips } from './interface/tooltips.js';
import { Annotations, annotate } from './interface/annotations.js';
import { HeadingAnchor, HeadingLabel } from './interface/heading-labels.js';
import { skipToIssue, removeSkipBtnListeners } from './logic/skip-to-issue.js';

// Checks/rulesets
import checkImages from './rulesets/images.js';
import checkHeaders from './rulesets/headers.js';
import checkLinkText from './rulesets/link-text.js';
import checkContrast from './rulesets/contrast.js';
import checkLabels from './rulesets/labels.js';
import checkReadability from './rulesets/readability.js';
import checkEmbeddedContent from './rulesets/embedded-content.js';
import checkQA from './rulesets/quality-assurance.js';
import checkDeveloper from './rulesets/developer.js';
// import checkCustom from './sa11y-custom-checks.js';
