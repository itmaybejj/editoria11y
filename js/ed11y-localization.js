    ...
    linkTextIsGeneric : {
      ...
      tip: (text) =>
        ...
        <p>Readers skim for links. This is especially true of screen reader users, who navigate using a list of on-page links.</p>
                <p>Generic links like "click here," "read more" or "download" require the reader to stop, go back, and figure out each link's purpose from context. Few readers do this, so these links are often missed.</p>
