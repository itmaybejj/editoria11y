...
function generateEarl(outcomes, version) {
  ...
  graph.push({
    ...
    homepage: 'https://editoria11y.princeton.edu',
    release: {
      '@type': 'Version',
      revision: version,
    },
...
<head>
  <meta charset="utf-8">
  <title>Editoria11y ACT Conformance Report</title>
  <style>
...
<body>
  <h1>Editoria11y ACT Conformance Report</h1>
  <p>Generated: ${new Date().toISOString().slice(0, 10)} &middot; Editoria11y v${version}</p>
  ...
  <footer style="margin-top: 3rem; padding-top: 1rem; border-top: 1px solid #ddd; font-size: 0.8rem; color: #999;">
    ...
    Report generated by Editoria11y conformance testing suite.
  </footer>
</body>
</html>`;
}
