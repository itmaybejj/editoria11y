const ed11yLang={en:{toggleAccessibilityTools:"Toggle accessibility tools",toggleDisabled:"No content available for Editoria11y to check.",panelCount0:"No issues detected.",panelCountAllDismissed:"All issues hidden.",panelCount1:"One issue detected.",panelCountMultiple:" issues detected.",panelCountBase:"<span class='count'>No</span> <span class='content-type'>issues detected</span>.",panelControls:"Editorially",buttonToolsContent:"Check headings & alt text",buttonToolsActive:"Hide headings & alt text",buttonOutlineContent:"Headings",buttonAltsContent:"Alt Text",buttonFirstContent:"Go to first alert",buttonNextContent:"Go to next alert",buttonPrevContent:"Go to previous alert",buttonShowHiddenAlert:"Show hidden alert",buttonHideHiddenAlert:"Hide hidden alert",buttonShowHiddenAlerts:e=>`Show ${e} hidden alerts`,buttonHideHiddenAlerts:e=>`Hide ${e} hidden alerts`,buttonShowAlerts:"Show accessibility alerts",buttonShowNoAlert:"Show accessibility checker",buttonHideChecker:"Hide accessibility checker",buttonHideAlerts:"Hide accessibility alerts",panelCheckOutline:'<p class="ed11y-small">This shows the <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/" target="_blank" title="Opens in new tab">heading outline</a>. Check that it matches how the content is organized visually.</p>',panelCheckAltText:'<p class="ed11y-small">Check that each image <a href="https://www.w3.org/WAI/tutorials/images/informative/" target="_blank" title="Opens in new tab">describes what it means in context</a>, and that there are no images of text.</p>',noImagesFound:"No images found.",altLabelPrefix:"Alt text: ",errorAltMissing:"(missing!)",errorAltNull:"(none; image marked as decorative)",errorOutlinePrefixSkippedLevel:"(flagged for skipped level) ",errorOutlinePrefixHeadingEmpty:"(empty heading) ",errorOutlinePrefixHeadingIsLong:"(flagged for length) ",consoleNotSupported:"This browser can not run Editoria11y.",jumpedToInvisibleTip:"Note: this content may not be visible. Look for it inside the outlined container.",jumpedToAriaHiddenTip:"The item with this issue may be invisible or off screen.",suspiciousWords:["image of","graphic of","picture of","photo of","photograph of","placeholder","spacer","tbd","todo","copyright","courtesy of","photo by"],meaninglessAlt:["alt","chart","decorative","image","graphic","photo","placeholder","placeholder image","spacer","tbd","todo","to do","copyright","courtesy of","photo by"],linksUrls:["http:/","https:/",".asp",".htm",".php",".edu/",".com/"],linksMeaningless:/(learn|to|more|now|this|page|link|site|website|check|out|view|our|read|download|form|here|click|"|'|\?|\.|-|,|:|>|<|\s)+/g,linkStringsNewWindows:/window|\stab|download/g,toggleManualCheck:"manual check needed",toggleAlert:"alert",issue:"Issue",toggleAriaLabel:e=>`Accessibility ${e}`,transferFocus:"Edit this content",dismissOkButtonContent:"Mark as OK",dismissHideButtonContent:"Mark as ignored",dismissActions:e=>`${e} similar issues`,dismissHideAllButton:"Ignore all like this",dismissOkAllButton:"Mark all like this as OK",dismissOkTitle:"Hides this alert for all editors",dismissHideTitle:"Hides this alert for you",undismissOKButton:"Restore this alert marked as OK",undismissHideButton:"Restore this hidden alert",undismissNotePermissions:"This alert has been hidden by an administrator",reportsLink:"Open site reports in new tab",closeTip:"Close",panelHelpTitle:"About this tool",panelHelp:`
    ...
    `}connectedCallback(){if(!this.initialized&&typeof Ed11y!=="undefined"){this.style.setProperty("outline","0");this.classList.add("ed11y-element");const e=this.attachShadow({mode:"open"});const t=document.createElement("aside");t.setAttribute("id","ed11y-panel");t.classList.add("ed11y-wrapper","ed11y-panel-wrapper","ed11y-pass","ed11y-preload");t.innerHTML=this.template();e.appendChild(t);Ed11y.panel=t;Ed11y.panelElement=this;Ed11y.panelToggle=t.querySelector("#ed11y-toggle");Ed11y.panelToggleTitle=t.querySelector("#ed11y-toggle .ed11y-sr-only");Ed11y.panelCount=t.querySelector(".toggle-count");Ed11y.panelJumpNext=t.querySelector(".ed11y-jump.next");Ed11y.panelJumpNext.addEventListener("click",this.jumpTo);Ed11y.showDismissed=t.querySelector("#ed11y-show-hidden");Ed11y.message=t.querySelector("#ed11y-message");const s=t.querySelectorAll(".ed11y-buttonbar button");s.forEach(e=>{e.addEventListener("click",this.handleBarClick)});const i=Ed11y.panel.querySelector("#ed11y-alts-tab");const n=Ed11y.panel.querySelector("#ed11y-headings-tab");i.addEventListener("toggle",()=>{if(i.open&&n.open){n.removeAttribute("open")}});n.addEventListener("toggle",()=>{if(i.open&&n.open){i.removeAttribute("open")}});this.initialized=true}}jumpTo(e){e.preventDefault();Ed11y.toggledFrom=e.target.closest("button");if(!Ed11y.open){Ed11y.togglePanel();window.setTimeout(function(){Ed11y.jumpTo(1)},500)}else{Ed11y.jumpTo(1)}}handleBarClick(e){e.preventDefault();Ed11y.message.textContent="";let t=e.currentTarget.getAttribute("id");switch(t){case"ed11y-toggle":Ed11y.togglePanel();break;case"ed11y-show-hidden":Ed11y.toggleShowDismissals();break;case"ed11y-visualize":if(!Ed11y.open){Ed11y.togglePanel()}Ed11y.visualize();break;default:break}}}customElements.define("ed11y-element-panel",Ed11yElementPanel);class Ed11yElementHeadingLabel extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized){const o=this.attachShadow({mode:"open"});let e=document.createElement("div");e.classList.add("ed11y-wrapper","ed11y-heading-wrapper");let t=this.dataset.ed11yHeadingOutline;let s=Ed11y.headingOutline[t];e.innerHTML="H"+s[1];let i=!!s[2];e.classList.add("issue"+i);let n=Math.max(52-8*s[1],12);e.style.setProperty("font-size",n+"px");o.appendChild(e);this.initialized=true}}}customElements.define("ed11y-element-heading-label",Ed11yElementHeadingLabel);class Ed11yElementResult extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized){this.open=false;this.racing=false;this.style.setProperty("outline","0px solid transparent");const t=this.attachShadow({mode:"open"});this.resultID=this.dataset.ed11yResult;this.result=Ed11y.results[this.resultID];this.wrapper=document.createElement("div");this.dismissable=this.result.dismissalKey!==false;this.dismissed=!!this.result.dismissalStatus;this.wrapper.classList.add("ed11y-wrapper","ed11y-result-wrapper");this.wrapper.classList.add("ed11y-result");this.toggle=document.createElement("button");this.toggle.setAttribute("class","toggle");let e=this.dismissable?Ed11y.M.toggleManualCheck:Ed11y.M.toggleAlert;this.toggle.setAttribute("aria-label",Ed11y.M.toggleAriaLabel(e));this.toggle.setAttribute("aria-expanded","false");this.toggle.setAttribute("aria-haspopup","dialog");this.toggle.setAttribute("data-ed11y-result",this.dataset.ed11yResult);this.toggle.setAttribute("data-ed11y-ready","false");this.toggle.setAttribute("data-ed11y-race","false");if(!Ed11y.options.inlineAlerts){this.toggle.style.setProperty("font-size","16px")}if(this.dismissed){this.toggle.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 640 512">\x3c!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z"/></svg>';this.toggle.classList.add("dismissed");if(this.result.dismissalStatus!=="ok"){this.toggle.classList.add("notok")}else{this.toggle.classList.add("ok")}}else if(this.dismissable){this.toggle.classList.add("dismissable")}this.wrapper.appendChild(this.toggle);this.toggle.addEventListener("click",this.toggleClick);this.toggle.addEventListener("focus",this.handleFocus);this.toggle.addEventListener("mouseover",this.handleHover);this.tipNeedsBuild=true;Ed11y.attachCSS(this.wrapper);t.appendChild(this.wrapper);this.initialized=true}}handleHover(e){e.preventDefault();let t=this.getRootNode().host;if(!this.classList.contains("intersecting")&&this.open!==true&&t.racing===false){this.open=true;t.racing=true;t.toggleTip(true);Ed11y.toggledFrom=this;window.setTimeout(function(){t.racing=false},250,t)}}handleFocus(){let e=this.getRootNode().host;if(this.getRootNode().host.classList.contains("ed11y-offscreen")){e.result.element.scrollIntoView();Ed11y.alignButtons()}}toggleClick(e){e.preventDefault();let t=this.getRootNode().host;if(t.racing===false){t.racing=true;Ed11y.toggledFrom=this;let e=t.getAttribute("data-ed11y-open")==="false"?"open":"close";t.setAttribute("data-ed11y-action",e);if(e==="open"){window.setTimeout(function(){let e=document.querySelector('ed11y-element-tip[data-ed11y-open="true"]');e?.shadowRoot.querySelector(".title").focus()},500)}window.setTimeout(function(){t.racing=false},250,t)}}closeOtherTips(){if(Ed11y.openTip.button){Ed11y.openTip.button.setAttribute("data-ed11y-action","close")}}buildTip(){this.tipNeedsBuild=false;let e=document.createElement("ed11y-element-tip");e.result=this.result;e.setAttribute("data-ed11y-result",this.resultID);e.classList.add("ed11y-element");e.style.setProperty("opacity","0");let t=document.querySelector("body");t.insertAdjacentElement("beforeend",e);this.tip=e}toggleTip(e){if(this.tipNeedsBuild){this.buildTip()}this.toggle.setAttribute("aria-expanded",e);let t=this.dismissable?"ed11y-ring-yellow":"ed11y-ring-red";if(Ed11y.options.inlineAlerts){Ed11y.resetClass(["ed11y-hidden-highlight","ed11y-ring-red","ed11y-ring-yellow","ed11y-warning-block","ed11y-error-block","ed11y-warning-inline","ed11y-error-inline"])}else{Ed11y.editableHighlighter(this.resultID,e)}if(e===true){this.tip.style.setProperty("opacity","0");document.dispatchEvent(new CustomEvent("ed11yPop",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result"),result:this.result,tip:this.tip}}));this.closeOtherTips();this.tip.setAttribute("data-ed11y-action","open");if(Ed11y.options.inlineAlerts){this.result.element.classList.add(t)}requestAnimationFrame(()=>Ed11y.alignTip(this.toggle,this.tip,4,true));if(!Ed11y.jumpList){Ed11y.buildJumpList()}Ed11y.lastOpenTip=Number(this.getAttribute("data-ed11y-jump-position"));Ed11y.openTip={button:this,tip:this.tip};this.result.highlight?.style.setProperty("opacity","1")}else{document.dispatchEvent(new CustomEvent("ed11yShut",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result")}}));this.tip.setAttribute("data-ed11y-action","shut");this.result.highlight?.style.setProperty("opacity","0");Ed11y.openTip={button:false,tip:false}}this.setAttribute("data-ed11y-open",e);this.open=e}static get observedAttributes(){return["data-ed11y-action"]}attributeChangedCallback(e,t,s){if(this.initialized){switch(e){case"data-ed11y-action":if(s!=="false"){let e=s==="open"?true:false;this.setAttribute("data-ed11y-action","false");this.toggleTip(e)}break}}}}customElements.define("ed11y-element-result",Ed11yElementResult);class Ed11yElementTip extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized&&this.result){this.renderOnce()}}renderOnce(){this.initialized=true;this.open=true;this.style.setProperty("opacity","0");this.style.setProperty("outline","0px solid transparent");const e=this.attachShadow({mode:"open"});this.wrapper=document.createElement("div");this.wrapper.setAttribute("role","dialog");this.dismissable=this.result.dismissalKey!==false;this.dismissed=!!this.result.dismissalStatus;this.wrapper.classList.add("ed11y-tip-wrapper","ed11y-wrapper");this.wrapper.setAttribute("aria-label",`${Ed11y.M.issue}
        ${Number.parseInt(this.result.toggle.dataset.ed11yJumpPosition)+1}`);this.addEventListener("mouseover",this.handleHover);Ed11y.attachCSS(this.wrapper);this.tip=document.createElement("div");this.tip.classList.add("tip");let t=document.createElement("div");t.classList.add("content");this.heading=document.createElement("div");this.heading.setAttribute("id","tip-title-"+this.resultID);this.heading.classList.add("title");this.heading.setAttribute("tabindex","-1");this.heading.innerHTML=Ed11y.M[this.result.test].title;t.append(this.heading);const s=document.createElement("div");s.classList.add("ed11y-tip-alert");this.heading.insertAdjacentElement("afterbegin",s);let i=document.createElement("div");i.innerHTML=this.result.content;t.append(i);if(!Ed11y.options.inlineAlerts||Ed11y.options.editLinks){const c=document.createElement("div");if(!Ed11y.options.inlineAlerts){c.classList.add("ed11y-tip-dismissals");const y=document.createElement("button");const p=document.createElement("span");p.classList.add("ed11y-transfer-icon");p.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 256 512">\x3c!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M.1 29.3C-1.4 47 11.7 62.4 29.3 63.9l8 .7C70.5 67.3 96 95 96 128.3L96 224l-32 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l32 0 0 95.7c0 33.3-25.5 61-58.7 63.8l-8 .7C11.7 449.6-1.4 465 .1 482.7s16.9 30.7 34.5 29.2l8-.7c34.1-2.8 64.2-18.9 85.4-42.9c21.2 24 51.2 40 85.4 42.9l8 .7c17.6 1.5 33.1-11.6 34.5-29.2s-11.6-33.1-29.2-34.5l-8-.7C185.5 444.7 160 417 160 383.7l0-95.7 32 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-32 0 0-95.7c0-33.3 25.5-61 58.7-63.8l8-.7c17.6-1.5 30.7-16.9 29.2-34.5S239-1.4 221.3 .1l-8 .7C179.2 3.6 149.2 19.7 128 43.7c-21.2-24-51.2-40-85.4-42.9l-8-.7C17-1.4 1.6 11.7 .1 29.3z"/></svg>';y.textContent=Ed11y.M.transferFocus;y.prepend(p);y.classList.add("dismiss","ed11y-transfer-focus");c.append(y);y.addEventListener("click",function(){Ed11y.transferFocus()})}else{c.classList.add("ed11y-custom-edit-links");c.append(Ed11y.options.editLinks.cloneNode(true))}t.append(c)}if(this.dismissable){const u=document.createElement("div");u.classList.add("ed11y-tip-dismissals");const h=document.createElement("span");h.classList.add("ed11y-dismiss-icon");h.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 640 512">\x3c!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z"/></svg>';if(Ed11y.options.showDismissed&&this.dismissed){let e=Ed11y.dismissedAlerts[Ed11y.options.currentPage][this.result.test][this.result.dismissalKey]==="ok";if(e&&Ed11y.options.allowOK||!e){const m=document.createElement("button");const g=document.createElement("span");g.classList.add("ed11y-dismiss-icon");g.innerHTML='<svg aria-hidden="true" class="shown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">\x3c!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="Currentcolor" d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"/></svg>';m.classList.add("dismiss");m.textContent=e?Ed11y.M.undismissOKButton:Ed11y.M.undismissHideButton;m.prepend(g);u.append(m);m.addEventListener("click",function(){Ed11y.dismissThis("reset")})}else{const E=document.createElement("div");E.classList.add("dismissed-note");E.textContent=Ed11y.M.undismissNotePermissions;u.append(E)}}else{const f=document.createElement("details");const b=document.createElement("summary");const w=Ed11y.results.filter(e=>e.test===this.result.test).length;const v=w>3&&Ed11y.options.allowHide&&Ed11y.options.allowOK;if(v){f.classList.add("ed11y-bulk-actions","dismiss");b.textContent=Ed11y.M.dismissActions(w);f.appendChild(b);u.appendChild(f)}if(Ed11y.options.allowOK){const k=document.createElement("span");k.setAttribute("aria-hidden","true");k.textContent="✓";const x=document.createElement("button");x.classList.add("dismiss");if(Ed11y.options.syncedDismissals){x.setAttribute("title",Ed11y.M.dismissOkTitle)}x.textContent=Ed11y.M.dismissOkButtonContent;u.prepend(x);if(v){const C=x.cloneNode(true);C.textContent=Ed11y.M.dismissOkAllButton;C.prepend(k.cloneNode(true));f.append(C);C.addEventListener("click",function(){Ed11y.dismissThis("ok",true)})}x.prepend(k);x.addEventListener("click",function(){Ed11y.dismissThis("ok")})}if(Ed11y.options.allowHide){const T=document.createElement("button");T.classList.add("dismiss");if(Ed11y.options.syncedDismissals){T.setAttribute("title",Ed11y.M.dismissHideTitle)}T.textContent=Ed11y.M.dismissHideButtonContent;T.prepend(h.cloneNode(true));u.prepend(T);T.addEventListener("click",function(){Ed11y.dismissThis("hide")});if(v){const A=document.createElement("button");A.classList.add("dismiss");A.textContent=Ed11y.M.dismissHideAllButton;A.prepend(h.cloneNode(true));b.insertAdjacentElement("afterend",A);A.addEventListener("click",function(){Ed11y.dismissThis("hide",true)})}}}t.append(u)}this.tip.append(t);this.navBar=document.createElement("div");this.navBar.classList.add("ed11y-tip-header");this.count=document.createElement("div");this.count.classList.add("ed11y-tip-count");this.count.textContent=`${Ed11y.M.issue} ${Number.parseInt(this.result.toggle.dataset.ed11yJumpPosition)+1} / ${Ed11y.jumpList.length}`;this.navBar.append(this.count);if(Ed11y.jumpList.length>1){this.prev=document.createElement("button");this.prev.classList.add("ed11y-tip-prev");this.prev.setAttribute("aria-label",Ed11y.M.buttonPrevContent);this.prev.setAttribute("title",Ed11y.M.buttonPrevContent);this.prev.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">\x3c!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/></svg>';this.prev.addEventListener("click",e=>{e.preventDefault();Ed11y.jumpTo(-1)});this.navBar.append(this.prev);this.next=document.createElement("button");this.next.classList.add("ed11y-tip-next");this.next.setAttribute("aria-label",Ed11y.M.buttonNextContent);this.next.setAttribute("title",Ed11y.M.buttonNextContent);this.next.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">\x3c!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg>';this.next.addEventListener("click",e=>{e.preventDefault();Ed11y.jumpTo(1)});this.navBar.append(this.next)}this.help=document.createElement("details");this.help.classList.add("button");this.helpContent=document.createElement("div");this.helpContent.classList.add("ed11y-tip-help-content");this.helpContent.innerHTML=Ed11y.M.panelHelp;this.help.append(this.helpContent);this.helpToggle=document.createElement("summary");this.helpToggle.textContent="?";this.helpToggle.setAttribute("aria-label",Ed11y.M.panelHelpTitle);this.helpToggle.setAttribute("title",Ed11y.M.panelHelpTitle);this.help.insertAdjacentElement("afterbegin",this.helpToggle);this.navBar.append(this.help);let n=document.createElement("button");n.setAttribute("arial-label",Ed11y.M.closeTip);n.setAttribute("title",Ed11y.M.closeTip);n.classList.add("close");n.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 384 512">\x3c!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>';this.navBar.append(n);this.tip.append(this.navBar);let o=document.createElement("div");o.classList.add("arrow");n.addEventListener("click",e=>{e.preventDefault();if(this.open){let e=document.querySelector('ed11y-element-result[data-ed11y-open="true"]');if(Ed11y.toggledFrom){Ed11y.toggledFrom.focus()}e?.setAttribute("data-ed11y-action","shut");this.setAttribute("data-ed11y-action","shut")}});document.addEventListener("click",e=>{if(this.open&&!e.target.closest("ed11y-element-tip, ed11y-element-result, ed11y-element-panel")){let e=document.querySelector('ed11y-element-result[data-ed11y-open="true"]');e?.setAttribute("data-ed11y-action","shut");this.setAttribute("data-ed11y-action","shut")}});e.appendChild(this.wrapper);let l=document.createElement("div");l.setAttribute("tabIndex","0");let a=document.createElement("div");a.setAttribute("tabindex","0");this.wrapper.appendChild(l);this.wrapper.appendChild(o);this.wrapper.appendChild(this.tip);this.wrapper.appendChild(a);let d=this.wrapper.querySelectorAll('a, button, [tabindex="0"]');let r=d.length;d[0].addEventListener("focus",()=>{d[r-2].focus()});d[r-1].addEventListener("focus",()=>{d[1].focus()});this.initialized=true;this.rendering=false}toggleTip(e){if(e){this.wrapper.classList.add("open");Ed11y.alertOnInvisibleTip(this.result.toggle,this.result.element)}else{this.wrapper.classList.remove("open")}this.setAttribute("data-ed11y-open",e)}static get observedAttributes(){return["data-ed11y-action"]}attributeChangedCallback(e,t,s){if(!this.initialized&&this.result){this.renderOnce()}if(this.initialized){switch(e){case"data-ed11y-action":if(s!=="false"){let e=s==="open";this.open=e;this.setAttribute("data-ed11y-action","false");this.toggleTip(e)}break}}}}customElements.define("ed11y-element-tip",Ed11yElementTip);