    ...
    `,headingExample:`
        ...
        <p>Headings and subheadings create a <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/" title="Opens in new tab" target="_blank">navigable table of contents</a> for assistive devices. The heading's <strong><em>number</em></strong> indicates its <strong><em>depth</em></strong> in the page outline; e.g.:</p>
         ...
         <p>Consider using sentence case instead, and using bold text or font changes for visual emphasis, or structural formatting like headings for emphasis that will also be announced by screen readers.</p>`},embedVideo:{title:"Manual check: is this video accurately captioned?",tip:()=>`<p>If a recorded video contains speech or meaningful sounds, it must <a href="https://www.w3.org/WAI/media/av/captions/" title="Opens in new window" target="_blank">provide captions</a>.</p>
            ...
            <p>Check to make sure only a small number of items auto-load immediately or while scrolling. Having additional items load on request ("show more") is fine.</p>`},embedCustom:{title:"Manual check: is this embedded content accessible?",tip:()=>"<p>Please make sure images inside this embed have alt text, videos have captions, and interactive components can be <a href='https://webaim.org/techniques/keyboard/'>operated by a keyboard</a>.</p>"}}};class Ed11yTestEmbeds{check(){let e=Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.videoContent);e=e?e.concat(Array.from(Ed11y.elements.video)):Ed11y.elements.video;if(e.length>0){e.forEach(e=>{let t=Ed11y.dismissalKey(e?.getAttribute("src")!=="undefined"?e.getAttribute("src"):e.querySelector("[src]")?.getAttribute("src"));Ed11y.results.push({element:e,test:"embedVideo",content:Ed11y.M.embedVideo.tip(),position:"beforebegin",dismissalKey:t})})}let t=Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.audioContent);t=t?t.concat(Array.from(Ed11y.elements.audio)):Ed11y.elements.audio;if(t.length>0){t.forEach(e=>{let t=Ed11y.dismissalKey(e?.getAttribute("src")!=="undefined"?e.getAttribute("src"):e.querySelector("[src]")?.getAttribute("src"));Ed11y.results.push({element:e,test:"embedAudio",content:Ed11y.M.embedAudio.tip(),position:"beforebegin",dismissalKey:t})})}let i=Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.dataVizContent);if(i.length>0){i.forEach(e=>{let t=Ed11y.dismissalKey(e.getAttribute("src"));Ed11y.results.push({element:e,test:"embedVisualization",content:Ed11y.M.embedVisualization.tip(),position:"beforebegin",dismissalKey:t})})}let s=Ed11y.srcMatchesOptions(Ed11y.elements.frame,Ed11y.options.twitterContent);if(s.length>0){s.forEach(t=>{let e=t.querySelectorAll(".timeline-TweetList-tweet");if(!!e&&e>3){let e=Ed11y.dismissalKey(t.getAttribute("src"));Ed11y.results.push({element:t,test:"embedTwitter",content:Ed11y.M.embedTwitter.tip(),position:"beforebegin",dismissalKey:e})}})}if(Ed11y.options.embeddedContent){Ed11y.elements.embed?.forEach(e=>{let t=Ed11y.dismissalKey(e.getAttribute("src")+e.getAttribute("id")+e.getAttribute("class"));Ed11y.results.push({element:e,test:"embedCustom",content:Ed11y.M.embedCustom.tip(),position:"beforebegin",dismissalKey:t})})}}}class Ed11yTestHeadings{check(){Ed11y.panel?.querySelectorAll("#ed11y-outline-list li, .ed11y-headings-label")?.forEach(e=>e.remove());let d=0;let r=false;Ed11y.headingOutline=[];let c="afterbegin";Ed11y.elements.h?.filter(e=>Ed11y.elementNotHidden(e))?.forEach(i=>{if(!Ed11y.addedNodeReadyToCheck(i)){return}let e;let t=[];if(i.isContentEditable!==r){let t=i.closest("[contenteditable]");if(t){Ed11y.options.editorHeadingLevel.some(e=>{if(t.matches(e.selector)){if(e.previousHeading==="inherit"){return true}d=e.previousHeading;return true}})}r=i.isContentEditable}if(i.hasAttribute("aria-level")){e=+i.getAttribute("aria-level")}else{e=+i.tagName.slice(1)}e=parseInt(e);let s="";let n="";let o=Ed11y.computeText(i);let l=o.length;let a=false;if(l<1){let e=i.querySelector("img")?.getAttribute("alt");if(!e||e.length===0){n+=Ed11y.M.errorOutlinePrefixHeadingEmpty;s="headingEmpty";a=false;t.push({element:i,test:s,content:Ed11y.M.headingEmpty.tip(),position:c,dismissalKey:a})}}else if(l>160){n+=Ed11y.M.errorOutlinePrefixHeadingIsLong;a=Ed11y.dismissalKey(e+o);s="headingIsLong";t.push({element:i,test:s,content:Ed11y.M.headingIsLong.tip(),position:c,dismissalKey:a})}if(s!=="headingEmpty"&&d>0&&e-d>1){a=Ed11y.dismissalKey(e+o);n+=Ed11y.M.errorOutlinePrefixSkippedLevel;s="headingLevelSkipped";t.push({element:i,test:s,content:Ed11y.M.headingLevelSkipped.tip(d,e),position:c,dismissalKey:a})}d=e;if(s!==""){if(i.closest(Ed11y.options.checkRoots)!==null||Ed11y.options.shadowComponents&&i.getRootNode()?.host?.matches(Ed11y.options.shadowComponents)!==undefined){t.forEach(e=>{Ed11y.results.push(e)})}else{n=""}}Ed11y.headingOutline.push([i,e,n,a])});Ed11y.elements.blockquote?.forEach(s=>{if(!Ed11y.addedNodeReadyToCheck(s)){return}let n=Ed11y.getText(s);if(n&&n.length<25){let e=Ed11y.dismissalKey(n);let t="blockquoteIsShort";let i=Ed11y.M.blockquoteIsShort.tip();Ed11y.results.push({element:s,test:t,content:i,position:c,dismissalKey:e})}})}}class Ed11yTestImages{check(){Ed11y.imageAlts=[];Ed11y.elements.img.forEach(i=>{let s=i.getAttribute("alt");let e=Ed11y.M.altLabelPrefix;let n=i.getAttribute("src");let o=false;let l=true;let a=Ed11y.parentLink(i);if(typeof s!=="string"){o="altMissing";l=false;e+=Ed11y.M.errorAltMissing}else if(!!Ed11y.options.altPlaceholder&&s.indexOf(Ed11y.options.altPlaceholder)!==-1||s.length===0&&!a){o="altNull";e+=Ed11y.M.errorAltNull}else{e+=s;const r=s.toLowerCase();if(Ed11y.M.meaninglessAlt.includes(r.trim())){o="altMeaningless";l=false}else{let e=[".avi",".png",".jp",".webp",".gif",".tiff",".svg",".hei","://"];let t=Ed11y.M.suspiciousWords;let i=[null,null];e.forEach(e=>{if(r.indexOf(e)>=0){i[0]="URL"}});t.forEach(e=>{const t=r.indexOf(e);if(t>-1&&t<6){i[1]=e}});if(i[0]==="URL"){o="altURL";l=false}else if(i[1]!==null){o="altImageOf"}else if(!a&&s!==""&&s.replace(/"|'|\?|\.|-|\s+/g,"")===""){o="altDeadspace";l=false}else if(s.length>160){o="altLong"}}if(a!==null){i=a;if(!o&&s!==""){let e=Ed11y.computeText(i,0,!!Ed11y.options.linkIgnoreSelector);e=e.replace(s,"");if(Ed11y.options.linkStringsNewWindows&&Ed11y.options.linkStringsNewWindows!==Ed11y.M.linkStringsNewWindows){e=e.toLowerCase().replace(Ed11y.options.linkIgnoreStrings,"")}if(Ed11y.options.linkIgnoreStrings){e=Ed11y.options.linkIgnoreStrings?e.toLowerCase().replace(Ed11y.options.linkIgnoreStrings,""):e.toLowerCase()}e=e.replace(/"|'|\?|\.|-|\s+/g,"");if(e.length>0){o="altPartOfLinkWithText"}}else{o=o?o+"Linked":o}}}let d="pass";if(o){let e=Ed11y.options.langSanitizes?Ed11y.M[o].tip(s):Ed11y.M[o].tip(Ed11y.sanitizeForHTML(s));let t=n?n.split("?")[0]:"nosrc_";l=l?Ed11y.dismissalKey(t+s):false;Ed11y.results.push({element:i,test:o,content:e,position:"beforebegin",dismissalKey:l});d=l===false?"ed11y-error":"ed11y-warning"}Ed11y.imageAlts.push([i,n,e,d])})}}class Ed11yTestLinks{check(){Ed11y.elements.a?.forEach(s=>{let n=Ed11y.computeText(s,0,!!Ed11y.options.linkIgnoreSelector);let e=s.querySelectorAll("img");let o=e.length>0;let t=s.matches(Ed11y.options.documentLinks);if(s?.getAttribute("target")==="_blank"){if(!(Ed11y.options.linkIgnoreSelector&&s?.querySelector(Ed11y.options.linkIgnoreSelector)||n.toLowerCase().match(Ed11y.options.linkStringsNewWindows))){let e=Ed11y.dismissalKey(n);Ed11y.results.push({element:s,test:"linkNewWindow",content:Ed11y.M.linkNewWindow.tip(),position:"beforebegin",dismissalKey:e})}}if(n.replace(/"|'|\?|\.|-|\s+/g,"").length===0&&!(Ed11y.options.linkIgnoreSelector&&s.querySelector(Ed11y.options.linkIgnoreSelector))){if(o===false){Ed11y.results.push({element:s,test:"linkNoText",content:Ed11y.M.linkNoText.tip(),position:"beforebegin",dismissalKey:false})}else{Ed11y.results.push({element:s,test:"altEmptyLinked",content:Ed11y.M.altEmptyLinked.tip(),position:"beforebegin",dismissalKey:false})}}else{let e=function(t){let e=t;if(Ed11y.options.linkStringsNewWindows&&Ed11y.options.linkStringsNewWindows!==Ed11y.M.linkStringsNewWindows){e=e.toLowerCase().replace(Ed11y.options.linkIgnoreStrings,"")}if(Ed11y.options.linkIgnoreStrings){e=Ed11y.options.linkIgnoreStrings?e.toLowerCase().replace(Ed11y.options.linkIgnoreStrings,""):e.toLowerCase()}let i=Ed11y.options.linksUrls?Ed11y.options.linksUrls:Ed11y.M.linksUrls;let s=Ed11y.options.linksMeaningless?Ed11y.options.linksMeaningless:Ed11y.M.linksMeaningless;let n="none";if(e.replace(s,"").length===0){n="generic"}else{for(let e=0;e<i.length;e++){if(t.indexOf(i[e])>-1){n="url";break}}}return n};let i=e(n);if(i!=="none"){let e=false;let t=false;if(!o){t="linkTextIsURL";e=Ed11y.dismissalKey(n)}if(i==="generic"){t="linkTextIsGeneric";e=Ed11y.dismissalKey(n)}if(t){Ed11y.results.push({element:s,test:t,content:Ed11y.M[t].tip(Ed11y.sanitizeForHTML(n)),position:"beforebegin",dismissalKey:e})}}}if(t){let e=Ed11y.dismissalKey(s?.getAttribute("href"));Ed11y.results.push({element:s,test:"linkDocument",content:Ed11y.M.linkDocument.tip(),position:"beforebegin",dismissalKey:e})}})}}class Ed11yTestText{check(){const d=new RegExp(/(([023456789][\d\s])|(1\d))/,"");const r=new RegExp(/(^[aA1]|[^\p{Alphabetic}\s])[-\s.)]/,"u");const c=new RegExp(/\p{Extended_Pictographic}/,"u");const y=["a","A","1"];const t={b:"a",B:"A",2:"1"};const u=function(e){return e.replace(/^b|^B|^2/,function(e){return t[e]})};let p="";let h="";let m=false;Ed11y.elements.p?.forEach((s,e)=>{let i=false;let n=false;h=h?h:Ed11y.getText(s).replace("(","");let o=h.substring(0,2);const l=o.match(r);const t=o.match(d);const a=o.match(c);if(o.length>0&&o!==p&&!t&&(l||a)){let t=Ed11y.elements.p[e+1];e:if(t){i=Ed11y.getText(t).replace("(","").substring(0,2);if(y.includes(i?.toLowerCase().trim())){break e}let e=u(i);if(l){if(o!=="A "&&o===e){n=true}}else if(a&&!m){if(e.match(c)){n=true;m=true}}}if(!n){let e=s?.querySelector("br")?.nextSibling?.nodeValue;if(e){e=e.replace(/<\/?[^>]+(>|$)/g,"").replace("(","").trim().substring(0,2);if(o===u(e)||!l&&!m&&e.match(c)){n=true}}}if(n){let e=Ed11y.dismissalKey(h);Ed11y.results.push({element:s,test:"textPossibleList",content:Ed11y.options.langSanitizes?Ed11y.M.textPossibleList.tip(o):Ed11y.M.textPossibleList.tip(Ed11y.sanitizeForHTML(o)),position:"afterbegin",dismissalKey:e});p=o}else{p="";m=false}}else{let i=s.querySelector("strong:not(table strong), b:not(table b)");if(i&&!s.querySelector("a")){i=Ed11y.getText(i);let e=i.length;let t=i.match(/[.:;?!"']/)!==null;if(121>e&&e>5&&e===h.length&&t===false){let e=Ed11y.dismissalKey(i);Ed11y.results.push({element:s,test:"textPossibleHeading",content:Ed11y.M.textPossibleHeading.tip(),position:"afterbegin",dismissalKey:e})}}}h=i?"":i});let i=function(i){let s="";if(i.tagName==="LI"){i.childNodes.forEach(e=>{if(e.nodeType===3){s+=e.textContent}})}else{s=Ed11y.getText(i)}let e=/([A-Z]{2,}[ ])([A-Z]{2,}[ ])([A-Z]{2,}[ ])([A-Z]{2,})/g;let t=s.match(e);if(t&&t[0].length>10){let e=Ed11y.dismissalKey(s);let t=i.closest("a, button");if(t){Ed11y.results.push({element:t,test:"textUppercase",content:Ed11y.M.textUppercase.tip(),position:"beforebegin",dismissalKey:e})}else{Ed11y.results.push({element:i,test:"textUppercase",content:Ed11y.M.textUppercase.tip(),position:"afterbegin",dismissalKey:e})}}};Ed11y.elements.h?.forEach(e=>{i(e)});Ed11y.elements.p?.forEach(e=>{i(e)});Ed11y.elements.blockquote?.forEach(e=>{i(e)});Ed11y.elements.li?.forEach(e=>{i(e)});Ed11y.elements.table.forEach(e=>{if(!Ed11y.addedNodeReadyToCheck(e)){return}let t=e.querySelectorAll("th");let i=e.querySelectorAll("h1, h2, h3, h4, h5, h6");if(t.length===0){Ed11y.results.push({element:e,test:"tableNoHeaderCells",content:Ed11y.M.tableNoHeaderCells.tip(),position:"beforebegin",dismissalKey:false})}else{Array.from(t).some(e=>{if(Ed11y.computeText(e).length<1){Ed11y.results.push({element:e,test:"tableEmptyHeaderCell",content:Ed11y.M.tableEmptyHeaderCell.tip(),position:"afterbegin",dismissalKey:false});return true}})}if(i){i.forEach(e=>{Ed11y.results.push({element:e,test:"tableContainsContentHeading",content:Ed11y.M.tableContainsContentHeading.tip(),position:"beforebegin",dismissalKey:false})})}})}}class Ed11y{constructor(e){Ed11y.version="2.3.0-dev";let t={cssUrls:false,checkRoots:false,shadowComponents:false,ignoreElements:false,ignoreByKey:{p:"table p",img:"[aria-hidden], [aria-hidden] img",a:"[aria-hidden][tabindex]",table:'[role="presentation"]'},alertMode:"userPreference",inlineAlerts:true,editableContent:'[contenteditable="true"]:not(.gutenberg__editor [contenteditable]), .gutenberg__editor .interface-interface-skeleton__content',currentPage:false,allowHide:true,allowOK:true,syncedDismissals:false,reportsURL:false,showDismissed:false,ignoreAllIfAbsent:false,ignoreAllIfPresent:false,preventCheckingIfPresent:false,preventCheckingIfAbsent:false,linkIgnoreStrings:false,linkIgnoreSelector:false,checkVisible:true,hiddenHandlers:"",panelPinTo:"right",panelOffsetX:"25px",panelOffsetY:"25px",panelNoCover:"",lang:"en",langSanitizes:false,theme:"sleekTheme",sleekTheme:{bg:"#eff2ff",bgHighlight:"#7b1919",text:"#20160c",primary:"#276499",primaryText:"#fffdf7",button:"transparent",panelBar:"#1e517c",panelBarText:"#fffdf7",panelBarShadow:"0 0 0 1px #276499",activeTab:"#276499",activeTabText:"#fffffe",focusRing:"#007aff",outlineWidth:"0",borderRadius:"3px",ok:"#1f5381",warning:"rgb(250, 216, 89)",warningText:"#20160c",alert:"rgb(184, 5, 25)",alertText:"#f4f7ff"},darkTheme:{bg:"#0a2051",bgHighlight:"#7b1919",text:"#f4f7ff",primary:"#3052a0",primaryText:"#f4f7ff",button:"transparent",panelBar:"#3052a0",panelBarText:"#f4f7ff",panelBarShadow:"inset 0 0 1px, 0 0 0 1px #0a2051",activeTab:"#0a2051",activeTabText:"#fffffe",focusRing:"cyan",outlineWidth:"2px",borderRadius:"3px",ok:"#0a307a",warning:"rgb(250, 216, 89)",warningText:"#20160c",alert:"rgb(184, 5, 25)",alertText:"#f4f7ff"},lightTheme:{bg:"#fffffe",bgHighlight:"#7b1919",text:"#20160c",primary:"#0a307a",primaryText:"#fffdf7",panelBar:"#0a307a",panelBarText:"#f4f7ff",panelBarShadow:"0 0 0 1px #0a307a",button:"transparent",activeTab:"#b9c0cf",activeTabText:"#20160c",focusRing:"#007aff",outlineWidth:"0",borderRadius:"3px",ok:"#0a307a",warning:"rgb(250, 216, 89)",warningText:"#20160c",alert:"rgb(184, 5, 25)",alertText:"#f4f7ff"},buttonZIndex:1299,baseFontSize:"14px",baseFontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif',embeddedContent:false,embeddedContentTitle:"",embeddedContentMessage:"",videoContent:"youtube.com, vimeo.com, yuja.com, panopto.com",audioContent:"soundcloud.com, simplecast.com, podbean.com, buzzsprout.com, blubrry.com, transistor.fm, fusebox.fm, libsyn.com",dataVizContent:"datastudio.google.com, tableau",twitterContent:"twitter-timeline",documentLinks:"a[href$='.pdf'], a[href*='.pdf?']",linksUrls:false,linksMeaningless:false,altPlaceholder:false,editorHeadingLevel:[{selector:"*",previousHeading:0}],userPrefersShut:localStorage.getItem("editoria11yShow")==="0",customTests:0};Ed11y.options={...t,...e};Ed11y.M={...ed11yLang["en"],...ed11yLang[Ed11y.options.lang]};Ed11y.theme=Ed11y.options[Ed11y.options.theme];Ed11y.theme.baseFontSize=Ed11y.options.baseFontSize;Ed11y.theme.buttonZIndex=Ed11y.options.buttonZIndex;Ed11y.theme.baseFontFamily=Ed11y.options.baseFontFamily;if(Ed11y.options.currentPage===false){Ed11y.options.currentPage=window.location.pathname}if(!Ed11y.options.linkStringsNewWindows){Ed11y.options.linkStringsNewWindows=Ed11y.M.linkStringsNewWindows}if(!Ed11y.options.cssUrls){const b=document.querySelector('link[href*="editoria11y.css"], link[href*="editoria11y.min.css"]');if(b){Ed11y.options.cssUrls=[b.getAttribute("href")]}else{console.warn("Editoria11y CSS file parameter is missing; attempting to load from CDN.");Ed11y.options.cssUrls=["https://cdn.jsdelivr.net/gh/itmaybejj/editoria11y@2/dist/editoria11y.min.css"]}}const i=document.createElement("div");i.setAttribute("hidden","");Ed11y.options.cssUrls?.forEach(e=>{const t=document.createElement("link");t.setAttribute("rel","stylesheet");t.setAttribute("media","all");t.setAttribute("href",e+"?ver="+Ed11y.version);i.append(t)});Ed11y.attachCSS=function(e){e.appendChild(i.cloneNode(true))};Ed11y.elements=[];Ed11y.onLoad=true;Ed11y.showPanel=false;let T=window.innerWidth;Ed11y.disable=()=>{if(Ed11y.open&&!Ed11y.closedByDisable){Ed11y.closedByDisable=true}Ed11y.disabled=true;Ed11y.reset();document.documentElement.style.setProperty("--ed11y-activeBackground",Ed11y.theme.panelBar);document.documentElement.style.setProperty("--ed11y-activeColor",Ed11y.theme.panelBarText);document.documentElement.style.setProperty("--ed11y-activeBorder",Ed11y.theme.panelBarText+"44");document.documentElement.style.setProperty("--ed11y-activePanelBorder","transparent");if(Ed11y.panelToggle){Ed11y.panel?.classList.remove("ed11y-errors","ed11y-warnings");Ed11y.panelCount.textContent="i";Ed11y.panelJumpNext.setAttribute("hidden","");Ed11y.panelToggle.classList.add("disabled");Ed11y.panelToggle.querySelector(".ed11y-sr-only").textContent=Ed11y.M.toggleDisabled}};Ed11y.initialize=()=>{Ed11y.checkRunPrevent=()=>{let e=Ed11y.options.preventCheckingIfPresent?document.querySelector(Ed11y.options.preventCheckingIfPresent):false;if(e){console.warn(`Editoria11y is disabled because an element matched the "preventCheckingIfPresent" parameter:  "${Ed11y.options.preventCheckingIfPresent}"`)}else if(!e&&!!Ed11y.options.preventCheckingIfAbsent){e=document.querySelector(`:is(${Ed11y.options.preventCheckingIfAbsent})`)===null;if(e){console.warn(`Editoria11y is disabled because no elements matched the "preventCheckingIfAbsent" parameter: "${Ed11y.options.preventCheckingIfAbsent}"`)}}return e};const e=e=>{if(document.readyState==="complete"){e()}else{window.addEventListener("load",e)}};e(()=>{if(Ed11y.checkRunPrevent()){return false}Ed11y.running=true;let e=localStorage.getItem("editoria11yResultCount");Ed11y.seen=e?JSON.parse(e):{};if(Ed11y.options.syncedDismissals===false){Ed11y.dismissedAlerts=localStorage.getItem("ed11ydismissed");Ed11y.dismissedAlerts=Ed11y.dismissedAlerts?JSON.parse(Ed11y.dismissedAlerts):{}}else{Ed11y.dismissedAlerts={};Ed11y.dismissedAlerts[Ed11y.options.currentPage]=Ed11y.options.syncedDismissals}if(Ed11y.options.currentPage in Ed11y.dismissedAlerts){for(const[t]of Object.entries(Ed11y.dismissedAlerts[Ed11y.options.currentPage])){if(t in Ed11y.dismissedAlerts[Ed11y.options.currentPage]){for(const[i,s]of Object.entries(Ed11y.dismissedAlerts[Ed11y.options.currentPage][t])){let e=Ed11y.dismissalKey(i);if(e!==i){Ed11y.dismissedAlerts[Ed11y.options.currentPage][t][e]=s;delete Ed11y.dismissedAlerts[Ed11y.options.currentPage][t][i]}}}}}Ed11y.testEmbeds=new Ed11yTestEmbeds;Ed11y.testHeadings=new Ed11yTestHeadings;Ed11y.testImages=new Ed11yTestImages;Ed11y.testLinks=new Ed11yTestLinks;Ed11y.testText=new Ed11yTestText;Ed11y.ignore=Ed11y.options.ignoreElements?`:not(${Ed11y.options.ignoreElements})`:"";if(!Ed11y.options.checkRoots){Ed11y.options.checkRoots=document.querySelector("main")!==null?"main":"body"}Ed11y.checkAll();window.addEventListener("resize",function(){Ed11y.windowResize()})})};Ed11y.results=[];Ed11y.checkAll=()=>{Ed11y.disabled=false;if(!Ed11y.checkRunPrevent()){Ed11y.ignoreAll=Ed11y.options.ignoreAllIfAbsent&&document.querySelector(`:is(${Ed11y.options.ignoreAllIfAbsent})`)===null;if(!Ed11y.ignoreAll&&!!Ed11y.options.ignoreAllIfPresent){Ed11y.ignoreAll=document.querySelector(`:is(${Ed11y.options.ignoreAllIfPresent})`)!==null}if(Ed11y.incremental){Ed11y.oldResults=Ed11y.results}Ed11y.results=[];Ed11y.elements=[];Ed11y.mediaCount=0;Ed11y.customTestsRunning=false;let t=document.querySelectorAll(`:is(${Ed11y.options.checkRoots})`);if(t.length===0){if(Ed11y.onLoad){console.warn("Check Editoria11y configuration; specified root element not found")}Ed11y.disable();return}else{Ed11y.roots=[];t.forEach((e,t)=>{if(e.shadowRoot){Ed11y.roots[t]=e.shadowRoot}else{Ed11y.roots[t]=e}});Ed11y.buildElementList();let e=["testLinks","testImages","testHeadings","testText","testEmbeds"];e.forEach(e=>{window.setTimeout(function(e){Ed11y[e].check()},0,e)});if(Ed11y.options.customTests>0){Ed11y.customTestsRunning=true;Ed11y.customTestsFinished=0;document.addEventListener("ed11yResume",function(){Ed11y.customTestsFinished++;if(Ed11y.customTestsFinished===Ed11y.options.customTests){Ed11y.customTestsRunning=false;Ed11y.updatePanel()}});window.setTimeout(function(){if(Ed11y.customTestsRunning===true){Ed11y.customTestsRunning=false;if(Ed11y.panelToggle){Ed11y.panelToggle.querySelector(".ed11y-sr-only").textContent=Ed11y.M.toggleAccessibilityTools}Ed11y.updatePanel();console.error("Editoria11y was told to wait for custom tests, but no tests were returned.")}},1e3);window.setTimeout(function(){let e=new CustomEvent("ed11yRunCustomTests");document.dispatchEvent(e)},0)}}if(!Ed11y.customTestsRunning){window.setTimeout(function(){if(Ed11y.panelToggle){Ed11y.panelToggle.querySelector(".ed11y-sr-only").textContent=Ed11y.M.toggleAccessibilityTools}Ed11y.updatePanel()},0)}}else{Ed11y.disable()}};Ed11y.totalCount=0;Ed11y.countAlerts=function(){Ed11y.errorCount=0;Ed11y.warningCount=0;Ed11y.dismissedCount=0;if(Ed11y.ignoreAll){Ed11y.dismissedCount=Ed11y.results.length>0?1:0}else{Ed11y.dismissedCount=0;for(let i=Ed11y.results.length-1;i>=0;i--){let e=Ed11y.results[i].test;let t=Ed11y.dismissalKey(Ed11y.results[i].dismissalKey);if(t!==false&&Ed11y.options.currentPage in Ed11y.dismissedAlerts&&e in Ed11y.dismissedAlerts[Ed11y.options.currentPage]&&t in Ed11y.dismissedAlerts[Ed11y.options.currentPage][e]){Ed11y.dismissedCount++;Ed11y.results[i].dismissalStatus=Ed11y.dismissedAlerts[Ed11y.options.currentPage][e][t]}else if(Ed11y.results[i].dismissalKey){Ed11y.warningCount++;Ed11y.results[i].dismissalStatus=false}else{Ed11y.errorCount++;Ed11y.results[i].dismissalStatus=false}}}Ed11y.totalCount=Ed11y.errorCount+Ed11y.warningCount;if(!Ed11y.incremental){window.setTimeout(function(){let e=new CustomEvent("ed11yResults");document.dispatchEvent(e)},0)}};let s="";let o=false;const n=function(){if(o||Ed11y.results.length!==Ed11y.oldResults.length){o=false;return true}let t=`${Ed11y.errorCount} ${Ed11y.warningCount}`;Ed11y.results.forEach(e=>{t+=e.test+e.element.outerHTML});let e=t!==s;s=t;return e};Ed11y.updatePanel=function(){Ed11y.countAlerts();if(Ed11y.incremental){if(Ed11y.forceFullCheck||n()){Ed11y.forceFullCheck=false;Ed11y.resetResults()}else{Ed11y.results=Ed11y.oldResults;window.setTimeout(function(){if(!Ed11y.alignPending){Ed11y.alignButtons();Ed11y.alignPanel()}Ed11y.running=false},0);return}}else{if(Ed11y.totalCount>0){Ed11y.seen[encodeURI(Ed11y.options.currentPage)]=Ed11y.totalCount;localStorage.setItem("editoria11yResultCount",JSON.stringify(Ed11y.seen))}else{delete Ed11y.seen[encodeURI(Ed11y.options.currentPage)]}}if(Ed11y.options.alertMode!=="headless"){if(Ed11y.onLoad===true){Ed11y.onLoad=false;if(!Ed11y.options.inlineAlerts){s=`${Ed11y.errorCount} ${Ed11y.warningCount}`;Ed11y.results.forEach(e=>{s+=e.test+e.element.outerHTML})}let e=document.createElement("ed11y-element-panel");document.querySelector("body").appendChild(e);Ed11y.attachCSS(Ed11y.panel);Ed11y.panel.querySelector("#ed11y-visualize .ed11y-sr-only").textContent=Ed11y.M.buttonToolsContent;Ed11y.panel.querySelector("#ed11y-headings-tab .summary-title").textContent=Ed11y.M.buttonOutlineContent;Ed11y.panel.querySelector("#ed11y-headings-tab .details-title").innerHTML=Ed11y.M.panelCheckOutline;Ed11y.panel.querySelector("#ed11y-alts-tab .summary-title").textContent=Ed11y.M.buttonAltsContent;Ed11y.panel.querySelector("#ed11y-alts-tab .details-title").innerHTML=Ed11y.M.panelCheckAltText;Ed11y.panel.querySelector(".jump-next.ed11y-sr-only").textContent=Ed11y.M.buttonFirstContent;Ed11y.panel.setAttribute("aria-label",Ed11y.M.panelControls);if(Ed11y.options.reportsURL){let e=document.createElement("a");e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">\x3c!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--\x3e<path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32l384 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zm64 0l0 64 64 0 0-64L64 96zm384 0L192 96l0 64 256 0 0-64zM64 224l0 64 64 0 0-64-64 0zm384 0l-256 0 0 64 256 0 0-64zM64 352l0 64 64 0 0-64-64 0zm384 0l-256 0 0 64 256 0 0-64z"/></svg><span class="ed11y-sr-only"></span>';e.setAttribute("id","ed11y-reports-link");e.setAttribute("href",Ed11y.options.reportsURL);e.setAttribute("target","_blank");e.setAttribute("aria-label",Ed11y.M.reportsLink);e.querySelector(".ed11y-sr-only").textContent=Ed11y.M.reportsLink;Ed11y.showDismissed.insertAdjacentElement("beforebegin",e)}if(Ed11y.options.alertMode==="active"||!Ed11y.options.userPrefersShut||Ed11y.options.showDismissed){Ed11y.showPanel=true}else if(Ed11y.totalCount>0&&!Ed11y.ignoreAll&&(Ed11y.options.alertMode==="assertive"||Ed11y.options.alertMode==="polite"&&Ed11y.seen[encodeURI(Ed11y.options.currentPage)]!==Ed11y.totalCount)){Ed11y.showPanel=true}}if(!Ed11y.showPanel){Ed11y.reset()}else{Ed11y.open=true;Ed11y.panel.classList.remove("ed11y-shut");Ed11y.panel.classList.add("ed11y-active");Ed11y.panelToggle.setAttribute("aria-expanded","true");Ed11y.panelToggleTitle.textContent=Ed11y.totalCount>0?Ed11y.M.buttonHideAlerts:Ed11y.M.buttonHideChecker;if(Ed11y.dismissedCount===0){Ed11y.showDismissed.setAttribute("hidden","");Ed11y.showDismissed.setAttribute("data-ed11y-pressed","false");Ed11y.options.showDismissed=false}else if(Ed11y.dismissedCount===1){Ed11y.showDismissed.querySelector(".ed11y-sr-only").textContent=Ed11y.options.showDismissed?Ed11y.M.buttonHideHiddenAlert:Ed11y.M.buttonShowHiddenAlert;Ed11y.showDismissed.removeAttribute("hidden")}else{Ed11y.showDismissed.querySelector(".ed11y-sr-only").textContent=Ed11y.options.showDismissed?Ed11y.M.buttonHideHiddenAlerts(Ed11y.dismissedCount):Ed11y.M.buttonShowHiddenAlerts(Ed11y.dismissedCount);Ed11y.showDismissed.removeAttribute("hidden")}window.setTimeout(function(){document.dispatchEvent(new CustomEvent("ed11yPanelOpened"));if(!Ed11y.ignoreAll){Ed11y.showResults()}},0)}if(Ed11y.totalCount>0||Ed11y.options.showDismissed&&Ed11y.dismissedCount>0){Ed11y.panelToggleTitle.textContent=Ed11y.open?Ed11y.M.buttonHideAlerts:Ed11y.M.buttonShowAlerts;Ed11y.panelJumpNext.removeAttribute("hidden");if(Ed11y.errorCount>0){Ed11y.panel.classList.remove("ed11y-warnings","ed11y-pass");Ed11y.panel.classList.add("ed11y-errors");document.documentElement.style.setProperty("--ed11y-activeBackground",Ed11y.theme.alert);document.documentElement.style.setProperty("--ed11y-activeColor","#fff");document.documentElement.style.setProperty("--ed11y-activeBorder","#fff7");document.documentElement.style.setProperty("--ed11y-activePanelBorder","#def")}else if(Ed11y.warningCount>0){Ed11y.panel.classList.remove("ed11y-errors","ed11y-pass");Ed11y.panel.classList.add("ed11y-warnings");document.documentElement.style.setProperty("--ed11y-activeBackground",Ed11y.theme.warning);document.documentElement.style.setProperty("--ed11y-activeColor","#111");document.documentElement.style.setProperty("--ed11y-activeBorder","#947605");document.documentElement.style.setProperty("--ed11y-activePanelBorder","#947605")}else{Ed11y.panel.classList.remove("ed11y-errors","ed11y-warnings");Ed11y.panel.classList.add("ed11y-pass");document.documentElement.style.setProperty("--ed11y-activeBackground",Ed11y.theme.panelBar);document.documentElement.style.setProperty("--ed11y-activeColor",Ed11y.theme.panelBarText);document.documentElement.style.setProperty("--ed11y-activeBorder",Ed11y.theme.panelBarText+"44");document.documentElement.style.setProperty("--ed11y-activePanelBorder","transparent")}if(Ed11y.dismissedCount>0&&Ed11y.totalCount===0){Ed11y.panelCount.textContent=Ed11y.dismissedCount}else{Ed11y.panelCount.textContent=Ed11y.totalCount>99?"99+":Ed11y.totalCount}}else{Ed11y.panelJumpNext.setAttribute("hidden","");document.documentElement.style.setProperty("--ed11y-activeBackground",Ed11y.theme.panelBar);document.documentElement.style.setProperty("--ed11y-activeColor",Ed11y.theme.panelBarText);document.documentElement.style.setProperty("--ed11y-activeBorder",Ed11y.theme.panelBarText+"44");document.documentElement.style.setProperty("--ed11y-activePanelBorder","transparent");Ed11y.panelCount.style.display="display: none;";Ed11y.panel.classList.remove("ed11y-warnings","ed11y-errors");Ed11y.panel.classList.add("ed11y-pass");if(Ed11y.dismissedCount>0){Ed11y.panelCount.textContent="i";if(Ed11y.open){Ed11y.panelToggleTitle.textContent=Ed11y.M.buttonHideChecker}else{Ed11y.panelToggleTitle.textContent=Ed11y.dismissedCount>1?Ed11y.M.buttonShowHiddenAlerts(Ed11y.dismissedCount):Ed11y.M.buttonShowHiddenAlert}}else{Ed11y.panelCount.textContent="✓";Ed11y.panelToggleTitle.textContent=Ed11y.open?Ed11y.M.buttonHideChecker:Ed11y.M.buttonShowNoAlert}}Ed11y.panel.classList.remove("ed11y-preload");Ed11y.panelToggle.classList.remove("disabled");Ed11y.panelToggle.removeAttribute("aria-disabled");Ed11y.alignPanel();if(!Ed11y.bodyStyle){Ed11y.paintReady()}}Ed11y.running=false;if(Ed11y.elements["editable"]){Ed11y.elements["editable"].forEach(e=>{f(e)})}};Ed11y.result=function(t,e){let i=document.createElement("ed11y-element-result");i.classList.add("ed11y-preload");let s;let n="beforebegin";i.setAttribute("id","ed11y-result-"+e);i.setAttribute("data-ed11y-result",e);i.setAttribute("data-ed11y-open","false");if(!Ed11y.options.inlineAlerts){s=document.querySelector("body");n="beforeend";i.classList.add("ed11y-editable-result")}else{s=t.element.closest("a");if(!s){s=t.element;n=t.position}if(t.element.style.outline.indexOf("alert")===-1){const o=window.getComputedStyle(t.element).getPropertyValue("display");let e;if(o.indexOf("inline")===-1||t.element.tagName==="IMG"){e=t.dismissalKey?"ed11y-warning-block":"ed11y-error-block"}else{e=t.dismissalKey?"ed11y-warning-inline":"ed11y-error-inline"}t.element.classList.add(e)}}s.insertAdjacentElement(n,i);Ed11y.jumpList.unshift(i);Ed11y.results[e].toggle=i};Ed11y.resetResults=function(){Ed11y.jumpList=[];Ed11y.openTip={button:false,tip:false};Ed11y.lastOpenTip=-1;Ed11y.resetClass(["ed11y-ring-red","ed11y-ring-yellow","ed11y-hidden-highlight","ed11y-warning-inline","ed11y-warning-block","ed11y-error-block","ed11y-error-inline"]);Ed11y.findElements("reset","ed11y-element-heading-label, ed11y-element-alt, ed11y-element-highlight",false);Ed11y.elements.reset?.forEach(e=>e.remove());Ed11y.findElements("delayedReset","ed11y-element-result, ed11y-element-tip",false);const e=Ed11y.elements.delayedReset;window.setTimeout(()=>{e?.forEach(e=>e.remove())},10,e);if(Ed11y.panelJumpNext){Ed11y.panelJumpNext.querySelector(".ed11y-sr-only").textContent=Ed11y.M.buttonFirstContent}};Ed11y.resetPanel=function(){Ed11y.visualizing=true;Ed11y.visualize();if(Ed11y.totalCount===0&&Ed11y.dismissedCount>0){Ed11y.panelCount.textContent="i";Ed11y.panelToggleTitle.textContent=Ed11y.dismissedCount===1?Ed11y.M.buttonShowHiddenAlert:Ed11y.M.buttonShowHiddenAlerts(Ed11y.dismissedCount)}if(!Ed11y.options.showDismissed&&Ed11y.showDismissed){Ed11y.showDismissed.setAttribute("data-ed11y-pressed","false");Ed11y.showDismissed.querySelector(".ed11y-sr-only").textContent=Ed11y.dismissedCount===1?Ed11y.M.buttonShowHiddenAlert:Ed11y.M.buttonShowHiddenAlerts(Ed11y.dismissedCount)}Ed11y.panel?.classList.add("ed11y-shut");Ed11y.panel?.classList.remove("ed11y-active");Ed11y.panelToggle?.setAttribute("aria-expanded","false")};Ed11y.reset=function(){Ed11y.resetResults();Ed11y.resetPanel();Ed11y.incremental=false;Ed11y.running=false;Ed11y.showPanel=false;Ed11y.open=false};Ed11y.linkText=e=>{e=e.replace(Ed11y.options.linkIgnoreStrings,"");e=e.replace(/'|"|-|\.|\s+/g,"");return e};Ed11y.findElements=function(i,s,e=true){Ed11y.findElements.key=[];let t=Ed11y.options.shadowComponents?`, ${Ed11y.options.shadowComponents}`:"";let n="";if(Ed11y.options.ignoreElements){n=Ed11y.options.ignoreByKey[i]?`:not(${Ed11y.options.ignoreElements}, ${Ed11y.options.ignoreByKey[i]})`:`:not(${Ed11y.options.ignoreElements})`}else{n=Ed11y.options.ignoreByKey[i]?`:not(${Ed11y.options.ignoreByKey[i]})`:""}Ed11y.elements[i]=[];if(e&&Ed11y.roots){Ed11y.roots.forEach(e=>{Ed11y.elements[i]=Ed11y.elements[i].concat(Array.from(e.querySelectorAll(`:is(${s}${t})${n}`)))})}else{Ed11y.elements[i]=Ed11y.elements[i].concat(Array.from(document.querySelectorAll(`:is(${s}${t})${n}`)))}if(Ed11y.options.shadowComponents){for(let t=Ed11y.elements[i].length-1;t>=0;t--){if(Ed11y.elements[i][t].matches(Ed11y.options.shadowComponents)){let e=Ed11y.elements[i][t].shadowRoot?.querySelectorAll(`:is(${s})${n}`);if(typeof e==="object"&&e.length>0){Ed11y.elements[i].splice(t,1,...e)}else{console.warn("Editoria11y: A specified shadow host has no shadowRoot.");Ed11y.elements[i].splice(t,1)}}}}};Ed11y.buildElementList=function(){Ed11y.findElements("editable",Ed11y.options.editableContent,false);if(Ed11y.options.inlineAlerts&&Ed11y.elements.editable.length>0){Ed11y.options.inlineAlerts=false;console.log("Editable content detected; Editoria11y inline alerts disabled")}Ed11y.findElements("p","p");Ed11y.findElements("h",'h1, h2, h3, h4, h5, h6, [role="heading"][aria-level]',false);Ed11y.findElements("img","img");Ed11y.findElements("a","a[href]");Ed11y.findElements("li","li");Ed11y.findElements("blockquote","blockquote");Ed11y.findElements("iframe","iframe");Ed11y.findElements("audio","audio");Ed11y.findElements("video","video");Ed11y.findElements("table","table");if(Ed11y.options.embeddedContent){Ed11y.findElements("embed",Ed11y.options.embeddedContent)}if(Ed11y.options.panelNoCover){Ed11y.findElements("panelPin",Ed11y.options.panelNoCover,false)}};Ed11y.dismissalKey=function(e){return String(e).replace(/([^0-9a-zA-Z])/g,"").substring(0,512)};Ed11y.dismissThis=function(i){let e=Ed11y.openTip;let t=e.tip.dataset.ed11yResult;let s=Ed11y.results[t].test;let n=Ed11y.dismissalKey(Ed11y.results[t].dismissalKey);Ed11y.resetClass(["ed11y-hidden-highlight","ed11y-ring-red","ed11y-ring-yellow"]);e.tip?.parentNode.removeChild(e.tip);e.button?.parentNode.removeChild(e.button);if(i==="reset"){delete Ed11y.dismissedAlerts[Ed11y.options.currentPage][s][n];if(Object.keys(Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]).length===0){delete Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]}if(Object.keys(Ed11y.dismissedAlerts[Ed11y.options.currentPage]).length===0){delete Ed11y.dismissedAlerts[Ed11y.options.currentPage]}Ed11y.updatePanel()}else{let t={};t[n]=i;if(typeof Ed11y.dismissedAlerts[Ed11y.options.currentPage]=="undefined"){let e={};e[s]=t;Ed11y.dismissedAlerts[Ed11y.options.currentPage]=e}else if(typeof Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]==="undefined"){Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]=t}else{Ed11y.dismissedAlerts[Ed11y.options.currentPage][s][n]=i}Ed11y.showDismissed.removeAttribute("hidden")}if(Ed11y.options.syncedDismissals===false){localStorage.setItem("ed11ydismissed",JSON.stringify(Ed11y.dismissedAlerts))}else{let e={dismissPage:Ed11y.options.currentPage,dismissTest:s,dismissKey:n,dismissAction:i};let t=new CustomEvent("ed11yDismissalUpdate",{detail:e});document.dispatchEvent(t)}Ed11y.reset();Ed11y.showPanel=true;Ed11y.checkAll();let o=Ed11y.lastOpenTip;window.setTimeout(function(){if(Ed11y.jumpList.length>0){Ed11y.lastOpenTip=o-1;Ed11y.panelJumpNext?.focus()}else{window.setTimeout(function(){Ed11y.panelToggle?.focus()},100)}},500,o)};Ed11y.transferFocus=function(){if(!Ed11y.openTip.tip){return}const e=Ed11y.openTip.tip.dataset.ed11yResult;const t=Ed11y.results[e].element;const i=t.closest("[contenteditable]");if(!i&&!t.closest("textarea, input")){if(t.closest("a")){Ed11y.toggledFrom=t.closest("a")}else if(t.getAttribute("tabindex")!==null){Ed11y.toggledFrom=t}else{t.setAttribute("tabindex","0");Ed11y.toggledFrom=t}Ed11y.openTip.tip.shadowRoot.querySelector(".close").click()}else{Ed11y.toggledFrom=false;if(t.getAttribute("contenteditable")==="true"){Ed11y.toggledFrom=t}else if(t.closest('p[contenteditable="true"]')){Ed11y.toggledFrom=t.closest('p[contenteditable="true"]')}else{Ed11y.toggledFrom=false}Ed11y.openTip.tip.shadowRoot.querySelector(".close").click();if(!Ed11y.toggledFrom&&i){i.focus();const s=document.createRange();const n=window.getSelection();s.setStart(t,0);s.collapse(true);n.removeAllRanges();n.addRange(s)}}};Ed11y.toggleShowDismissals=function(){Ed11y.ignoreAll=false;Ed11y.options.showDismissed=!Ed11y.options.showDismissed;Ed11y.reset();Ed11y.showPanel=true;Ed11y.checkAll();Ed11y.showDismissed.setAttribute("data-ed11y-pressed",(!!Ed11y.options.showDismissed).toString());window.setTimeout(function(){Ed11y.showDismissed.focus()},0)};Ed11y.showResults=function(){Ed11y.buildJumpList();document.dispatchEvent(new CustomEvent("ed11yPanelOpened"));Ed11y.alignButtons();if(!Ed11y.options.inlineAlerts){Ed11y.checkEditableIntersects();Ed11y.intersectionObservers()}};Ed11y.editableHighlight=[];Ed11y.alignHighlights=function(){Ed11y.editableHighlight.forEach(e=>{let t=e.target.getBoundingClientRect();if(!Ed11y.visible(e.target)){const i=Ed11y.firstVisibleParent(e.target);t=i?i.getBoundingClientRect():t}e.highlight.style.setProperty("width",t.width+6+"px");e.highlight.style.setProperty("top",t.top+window.scrollY-3+"px");e.highlight.style.setProperty("left",t.left-3+"px");e.highlight.style.setProperty("height",t.height+6+"px")})};Ed11y.editableHighlighter=function(e,t,i){if(!t){Ed11y.editableHighlight[e]?.highlight.style.setProperty("opacity","0");return}const s=Ed11y.results[e];let n=Ed11y.editableHighlight[e]?.highlight;if(!n){n=document.createElement("ed11y-element-highlight");Ed11y.editableHighlight[e]={highlight:n};n.style.setProperty("position","absolute");n.style.setProperty("pointer-events","none");document.body.appendChild(n)}let o=i?i:s.element;Ed11y.editableHighlight[e].target=o;const l=s.dismissalKey?"calc(var(--ed11y-buttonZIndex, 9999) - 2)":"calc(var(--ed11y-buttonZIndex, 9999) - 1)";n.style.setProperty("z-index",l);const a=s.dismissalKey?"0 0 0 1px #fff, inset 0 0 0 2px var(--ed11y-warning, #fad859), 0 0 0 3px var(--ed11y-warning, #fad859), 0 0 0 4px var(--ed11y-primary)":"0 0 0 1px #fff, inset 0 0 0 2px var(--ed11y-alert, #b80519), 0 0 0 3px var(--ed11y-alert, #b80519), 0 0 1px 3px";n.style.setProperty("box-shadow",a);n.style.setProperty("border-radius","3px");n.style.setProperty("top","0");n.style.setProperty("left","0");Ed11y.alignHighlights();n.style.setProperty("opacity","1")};const d=function(t,i,s){if(t.style.transform){const n=window.getComputedStyle(t);let e=n.getPropertyValue("transform");e=e.split(",");t.style.transform=`translate(${parseFloat(e[4])+i}px, ${parseFloat(e[5])+s}px)`}else{t.style.transform=`translate(${i}px, ${s}px)`}};const l=function(e){let t=e.clientHeight&&e.clientHeight<e.scrollHeight;if(t){const i=window.getComputedStyle(e);t=i.overflowY!=="visible"}return t};const a=function(e){let t=e.parentElement;if(t&&t.tagName!=="BODY"){if(l(t)){return t}else{t=a(t);return t}}else{return false}};const r=function(e,t,i,s,n=55){return!(e+n<i||e>i+n||t+n<s||t>s+n)};Ed11y.alignPanel=function(){if(!Ed11y.panelElement){return false}let i=0;let s=0;if(Ed11y.elements.panelPin){Ed11y.elements.panelPin.forEach(e=>{let t=e.getBoundingClientRect();if(Ed11y.options.panelPinTo==="right"){i=T-t.left>i?T-t.left:i}else{i=t.right>i?t.right:i}s=t.height>s?t.height:s})}if(i>0&&i<T-240){Ed11y.panelElement.style.setProperty(Ed11y.options.panelPinTo,i+10+"px");Ed11y.panelElement.style.setProperty("bottom",Ed11y.options.panelOffsetY)}else if(i>0&&i>T-240&&s>0){Ed11y.panelElement.style.setProperty(Ed11y.options.panelPinTo,Ed11y.options.panelOffsetX);Ed11y.panelElement.style.setProperty("bottom",`calc(${Ed11y.options.panelOffsetY} + ${s}px)`)}else{Ed11y.panelElement.style.setProperty(Ed11y.options.panelPinTo,Ed11y.options.panelOffsetX);Ed11y.panelElement.style.setProperty("bottom",Ed11y.options.panelOffsetY)}};Ed11y.alignButtons=function(){if(Ed11y.jumpList.length===0){return}Ed11y.alignPending=true;let o=0;let l=0;const a=window.scrollY;if(!Ed11y.options.inlineAlerts){Ed11y.jumpList.forEach((e,t)=>{let i=e.result.element.getBoundingClientRect();let s=i.top+a;if(!Ed11y.visible(e.result.element)){const o=Ed11y.firstVisibleParent(e.result.element);i=o?o.getBoundingClientRect():i;s=i.top+a}let n=i.left;if(e.result.element.tagName==="IMG"){s=s+10;n=n+10}else{n=n-34}if(e.result.scrollableParent){Ed11y.jumpList[t].bounds=e.result.scrollableParent.getBoundingClientRect();if(n<Ed11y.jumpList[t].bounds.left){n=Ed11y.jumpList[t].bounds.left}else if(n+40>Ed11y.jumpList[t].bounds.right){n=Ed11y.jumpList[t].bounds.right-40}}Ed11y.jumpList[t].targetOffset=i;Ed11y.jumpList[t].markTop=s;Ed11y.jumpList[t].markLeft=n})}else{Ed11y.jumpList.forEach(t=>{t.style.setProperty("transform",null);t.style.setProperty("top","initial");t.style.setProperty("left","initial");if(t.style.transform){const i=window.getComputedStyle(t);let e=i.getPropertyValue("transform");e=e.split(",");t.xOffset=parseFloat(e[4]);t.yOffset=parseFloat(e[5])}else{t.xOffset=0;t.yOffset=0}});Ed11y.jumpList.forEach(e=>{e.markOffset=e.getBoundingClientRect();e.markLeft=e.markOffset.left;e.markTop=e.markOffset.top})}Ed11y.jumpList.forEach((e,t)=>{let i=0;let s=0;if(e.markTop+a<0){i=-1*(e.markTop+a)-6}if(t>0&&r(e.markLeft,e.markTop,Ed11y.jumpList[t-1].markLeft,Ed11y.jumpList[t-1].markTop)||t>1&&r(e.markLeft,e.markTop,Ed11y.jumpList[t-2].markLeft,Ed11y.jumpList[t-2].markTop)||t>2&&r(e.markLeft,e.markTop,Ed11y.jumpList[t-3].markLeft,Ed11y.jumpList[t-3].markTop)){i=i+21+o;s=21+l}let n=false;if(e.markLeft+s<44){s=44-e.markLeft+s;n=true}else if(e.markLeft+s+80>T){n=true;s=T-s-e.markLeft-80}else if(i!==0){n=true}if(!Ed11y.options.inlineAlerts){if(n){e.style.transform=`translate(${e.markLeft+s}px, ${e.markTop+i}px)`}else{e.style.transform=`translate(${e.markLeft}px, ${e.markTop}px)`}}else if(n){d(e,s,i)}o=i;l=s});if(!Ed11y.options.inlineAlerts){Ed11y.jumpList.forEach(e=>{if(e.result.scrollableParent){if(!!e.bounds&&(e.targetOffset.top-e.bounds.top<0||e.targetOffset.top-e.bounds.bottom>0)&&!e.matches(':focus, :focus-within, [data-ed11y-open="true"]')){e.classList.add("ed11y-offscreen");e.style.transform="translate(0px, -50px)";e.style.pointerEvents="none";if(e.getAttribute("data-ed11y-open")==="true"){e.setAttribute("data-ed11y-action","shut")}}else{e.classList.remove("ed11y-offscreen");e.style.pointerEvents="auto"}}else{e.classList.remove("ed11y-offscreen");e.style.pointerEvents="auto"}})}Ed11y.jumpList?.forEach(e=>{e.classList.remove("ed11y-preload")});if(!Ed11y.bodyStyle){Ed11y.paintReady()}};Ed11y.paintReady=function(){for(const[e,t]of Object.entries(Ed11y.theme)){document.documentElement.style.setProperty("--ed11y-"+e,t)}if(document.querySelector("body")){Ed11y.attachCSS(document.querySelector("body"))}Ed11y.roots.forEach(e=>{if(Ed11y.options.shadowComponents){e.querySelectorAll(Ed11y.options.shadowComponents)?.forEach(e=>{if(e.shadowRoot){Ed11y.attachCSS(e.shadowRoot)}})}});Ed11y.bodyStyle=true};Ed11y.alignTip=function(e,t,i=0){if(!t){return}let s=t.shadowRoot.querySelector(".arrow");let n=s.nextElementSibling;let o=i-1;if(i>0){window.setTimeout(function(){requestAnimationFrame(()=>Ed11y.alignTip(e,t,o))},50,o)}const l=e.getRootNode().host;const a=e.dataset.ed11yResult;const d=Ed11y.results[a];const r=window.scrollY;let c=e.getBoundingClientRect();let y=c.width;let u=0;let p=c.left+document.body.scrollLeft;let h=T;let m=window.innerHeight+r;let E=r;if(!Ed11y.options.inlineAlerts&&d.scrollableParent){let e=d.scrollableParent.getBoundingClientRect();if(e.width>0){p=c.left+d.scrollableParent.scrollLeft;u=e.left;h=e.width-30;m=e.bottom+r;E=e.top+r}n.style.setProperty("max-width",h+"px")}else if(!(Ed11y.visible(l)||c.top===0&&c.left===0)){n.style.setProperty("max-width","none");const x=Ed11y.firstVisibleParent(l);if(x){c=x.getBoundingClientRect()}else{n.style.setProperty("max-width","none")}y=parseInt(Ed11y.options.baseFontSize)*3}t.style.setProperty("top",c.top+r+"px");t.style.setProperty("left",l.markLeft+"px");const g=n.offsetWidth;const f=n.offsetHeight;let b="under";if(c.top+f+r+y+22>m){if(u+h>y+g+c.left+70&&!(c.top+r+125>m)){b="right"}else if(c.top-f-15>E){b="above"}else if(h>g*1.5&&p-g-50>u){b="left"}else if(c.top+f+r+y>m){b="above"}}let w;let k=0;const v=function(){w=Math.min(c.left-g,-25);if(c.left+w-25<u){w=10+u-c.left+(c.left-l.markLeft)}else if(c.left-w+g>u+h&&c.left+24-g>u){w=Math.min(Math.max(u+h-(c.left+g+y+20),24-g),0)}const e=Math.min(Math.max(7,7-w+c.left-l.markLeft),g-27);s.style.setProperty("left",`${e}px`)};if(b==="under"){k=y+14+parseInt(Ed11y.theme.outlineWidth);s.dataset.direction="under";s.style.setProperty("top",`${8-parseInt(Ed11y.theme.outlineWidth)}px`);v()}else if(b==="above"){k=-1*(9+f+parseInt(Ed11y.theme.outlineWidth));s.dataset.direction="above";s.style.setProperty("top",`${f+16-parseInt(Ed11y.theme.outlineWidth)}px`);v()}else{let e=c.top+r+f;let t=7;if(Ed11y.options.inlineAlerts){if(c.top+f>window.innerHeight){k=m-(e+45);t=k*-1+7}}else{if(c.top+f+r>m){k=m-(e+90);t=k*-1+7}}s.style.setProperty("top",`${t}px`);if(b==="left"){w=0-(g+17);s.style.setProperty("left",`${g-10}px`);s.dataset.direction="left"}else{w=14+y+c.left-l.markLeft;s.style.setProperty("left","-10px");s.dataset.direction="right"}}t.style.setProperty("transform",`translate(${w}px, ${k}px)`);Ed11y.alignHighlights()};Ed11y.togglePanel=function(){if(!Ed11y.doubleClickPrevent){if(Ed11y.running!==true){Ed11y.running=true;if(Ed11y.panel.classList.contains("ed11y-active")===false){Ed11y.onLoad=false;Ed11y.showPanel=true;if(Ed11y.dismissedCount>0&&Ed11y.warningCount===0&&Ed11y.errorCount===0){Ed11y.options.showDismissed=false;Ed11y.toggleShowDismissals()}else{Ed11y.checkAll()}Ed11y.options.userPrefersShut=false;localStorage.setItem("editoria11yShow","1")}else{Ed11y.panelToggleTitle.textContent=Ed11y.totalCount>0?Ed11y.M.buttonShowAlerts:Ed11y.M.buttonShowNoAlert;Ed11y.options.showDismissed=false;Ed11y.reset();Ed11y.options.userPrefersShut=true;localStorage.setItem("editoria11yShow","0")}}}Ed11y.doubleClickPrevent=true;window.setTimeout(function(){Ed11y.doubleClickPrevent=false},200);return false};const c=function(){let d=Ed11y.panel.querySelector("#ed11y-outline");if(Ed11y.headingOutline.length){d.innerHTML="";Ed11y.headingOutline.forEach((i,t)=>{if(Ed11y.options.inlineAlerts){let e=document.createElement("ed11y-element-heading-label");e.classList.add("ed11y-element","ed11y-element-heading");e.dataset.ed11yHeadingOutline=t.toString();e.setAttribute("id","ed11y-heading-"+t);e.setAttribute("tabindex","-1");i[0].insertAdjacentElement("afterbegin",e);Ed11y.attachCSS(e.shadowRoot)}let e=i[1];let s=10*e-10;let n=document.createElement("li");n.classList.add("level"+e);n.style.setProperty("margin-left",s+"px");let o=document.createElement("strong");o.textContent=`H${e}: `;let l=document.createElement("span");l.textContent=Ed11y.computeText(i[0]);let a=document.createElement("a");if(Ed11y.options.inlineAlerts){a.setAttribute("href","#ed11y-heading-"+t);n.append(a);a.append(o);a.append(l)}else{n.append(o);n.append(l)}if(i[2]){let e=!i[3]?"error":"warning";n.classList.add(e);let t=document.createElement("em");t.classList.add("ed11y-small");t.textContent=" "+i[2];if(Ed11y.options.inlineAlerts){a.append(t)}else{n.append(t)}}d.append(n)})}else{d.innerHTML="<p><em>No heading structure found.</em></p>"}};Ed11y.alignAlts=function(){Ed11y.findElements("altMark","ed11y-element-alt");Ed11y.elements.altMark?.forEach(e=>{let t=e.dataset.ed11yImg;e.style.setProperty("transform",null);e.style.setProperty("height",null);e.style.setProperty("width",null);let i=Ed11y.imageAlts[t][0];if(i.tagName!=="IMG"){i=i.querySelector("img")}let s=e.getBoundingClientRect();let n=i.getBoundingClientRect();let o=n.left-s.left;let l=getComputedStyle(i).height;l=l==="auto"?i.offsetHeight:Math.max(i.offsetHeight,parseInt(l));e.style.setProperty("transform",`translate(${o}px, 0px)`);e.style.setProperty("height",`${l}px`);e.style.setProperty("width",`${i.offsetWidth}px`)})};const y=function(){let o=Ed11y.panel.querySelector("#ed11y-alt-list");if(Ed11y.imageAlts.length){o.innerHTML="";Ed11y.imageAlts.forEach((t,i)=>{if(Ed11y.options.inlineAlerts){let e=document.createElement("ed11y-element-alt");e.classList.add("ed11y-element");e.dataset.ed11yImg=i.toString();t[0].insertAdjacentElement("beforebegin",e)}let e=document.createElement("span");e.textContent=t[2];let s=document.createElement("li");s.classList.add(t[3]);let n=document.createElement("img");n.setAttribute("src",t[1]);n.setAttribute("alt","");s.append(n);s.append(e);o.append(s)});Ed11y.alignAlts()}else{o.innerHTML="<p><em>No images found.</em></p>"}};Ed11y.visualizing=false;Ed11y.visualize=function(){if(Ed11y.visualizing){Ed11y.visualizing=false;Ed11y.panel?.querySelector("#ed11y-visualize").setAttribute("aria-pressed","false");Ed11y.panel?.querySelector("#ed11y-visualizers").setAttribute("hidden","true");Ed11y.findElements("reset","ed11y-element-heading-label, ed11y-element-alt");Ed11y.elements.reset?.forEach(e=>{e.remove()});return}Ed11y.visualizing=true;Ed11y.panel?.querySelector("#ed11y-visualize").setAttribute("aria-pressed","true");Ed11y.panel?.querySelector("#ed11y-visualizers").removeAttribute("hidden");y();c()};Ed11y.buildJumpList=function(){Ed11y.jumpList=[];Ed11y.results.forEach((e,t)=>{let i=e.element.getBoundingClientRect().top;if(!i){const s=Ed11y.firstVisibleParent(e.element);if(s){i=s.getBoundingClientRect().top}}i=i+window.scrollY;Ed11y.results[t].scrollableParent=a(e.element);if(Ed11y.results[t].scrollableParent){i=i*1e-6}Ed11y.results[t].sortPos=i});Ed11y.results.sort((e,t)=>t.sortPos-e.sortPos);Ed11y.results?.forEach(function(e,t){if(!Ed11y.results[t].dismissalStatus||Ed11y.options.showDismissed){Ed11y.result(e,t)}});Ed11y.jumpList.forEach((e,t)=>{e.dataset.ed11yJumpPosition=`${t}`})};let u=1;Ed11y.browserLag=0;const p=(t,i)=>{let s=null;return(...e)=>{window.clearTimeout(s);s=window.setTimeout(()=>{t.apply(null,e)},i+Ed11y.browserLag)}};const h=function(e,t,i=10){return e.left-i<=t.right&&t.left-i<=e.right&&e.top-i<=t.bottom&&t.top-i<=e.bottom};Ed11y.activeRange=false;const m=function(){let e=getSelection()?.anchorNode;const t=e&&e.parentNode&&typeof e.parentNode==="object"&&typeof e.parentNode.matches==="function";if(!e||t&&(e.parentNode.matches(Ed11y.options.checkRoots)||!e.parentNode.matches(Ed11y.options.checkRoots)&&e.parentNode.matches('div[contenteditable="true"]'))){Ed11y.activeRange=false;return false}if(t){const s=e.parentNode.closest("p, td, th, li, h2, h3, h4, h5, h6");if(s){e=s}}const i=document.createRange();if(typeof e==="object"){i.setStartBefore(e);i.setEndAfter(e)}if(typeof i!=="object"||typeof i.getBoundingClientRect!=="function"){if(Ed11y.activeRange){Ed11y.activeRange=false;return true}else{return false}}else{let e=Ed11y.activeRange&&i.startContainer===Ed11y.activeRange.startContainer&&i.startOffset===Ed11y.activeRange.startOffset;Ed11y.activeRange=i;return!e}};Ed11y.checkEditableIntersects=function(){if(!document.querySelector("[contenteditable]:focus, [contenteditable] :focus")){Ed11y.jumpList?.forEach(e=>{e.classList.remove("intersecting")});return}if(!Ed11y.activeRange){Ed11y.jumpList?.forEach(e=>{e.classList.remove("intersecting")});return}Ed11y.jumpList?.forEach(e=>{const t=e.shadowRoot.querySelector(".toggle");if(h(Ed11y.activeRange.getBoundingClientRect(),t.getBoundingClientRect(),0)){if(!t.classList.contains("was-intersecting")){e.classList.add("intersecting");t.classList.add("intersecting")}}else{e.classList.remove("intersecting","was-intersecting");t.classList.remove("intersecting","was-intersecting")}})};let E=false;Ed11y.scrollPending=0;Ed11y.updateTipLocations=()=>{if(!E&&Ed11y.scrollPending>0&&!Ed11y.running&&Ed11y.jumpList&&Ed11y.open){E=true;Ed11y.alignButtons();if(Ed11y.openTip.tip){Ed11y.alignTip(Ed11y.openTip.button.shadowRoot.querySelector("button"),Ed11y.openTip.tip)}Ed11y.scrollPending--}E=false;if(Ed11y.scrollPending>0){requestAnimationFrame(()=>Ed11y.updateTipLocations())}};Ed11y.intersectionObservers=function(){Ed11y.elements.editable?.forEach(e=>{e.addEventListener("scroll",function(){Ed11y.scrollPending=Ed11y.scrollPending<2?Ed11y.scrollPending+1:Ed11y.scrollPending;requestAnimationFrame(()=>Ed11y.updateTipLocations())})});Ed11y.selectionChanged=p(()=>{if(m()){Ed11y.updateTipLocations();Ed11y.checkEditableIntersects()}},100);document.addEventListener("selectionchange",function(){if(!Ed11y.running){Ed11y.selectionChanged()}})};Ed11y.recentlyAddedNodes=[];Ed11y.addedNodeReadyToCheck=function(e){if(Ed11y.recentlyAddedNodes.length===0){return true}const t=Ed11y.recentlyAddedNodes.indexOf(e);if(t>-1){if(e.textContent.trim().length===0||Ed11y.activeRange&&e.contains(Ed11y.activeRange.startContainer)){return false}else{Ed11y.recentlyAddedNodes.splice(t,1);return true}}else{return true}};Ed11y.incrementalAlign=p(()=>{if(!Ed11y.running){Ed11y.scrollPending++;Ed11y.updateTipLocations()}},10);let g=false;window.addEventListener("keyup",()=>{g=true});window.addEventListener("click",()=>{g=true});window.addEventListener("dragend",()=>{g=true;Ed11y.incrementalCheck()});Ed11y.incrementalCheck=p(()=>{if(!Ed11y.running){if(Ed11y.openTip.button||!g&&!Ed11y.forceFullCheck){return}g=false;Ed11y.running=true;let e=performance.now();Ed11y.incremental=true;if(Ed11y.disabled&&Ed11y.closedByDisable){Ed11y.showPanel=true;Ed11y.closedByDisable=false;Ed11y.disabled=false}Ed11y.checkAll();window.setTimeout(function(){if(Ed11y.visualizing){Ed11y.visualizing=false;Ed11y.visualize()}},500);e=performance.now()-e;u=e>10?10:(u+e)/2;Ed11y.browserLag=u<1?0:u*100+Ed11y.totalCount}else{window.setTimeout(Ed11y.incrementalCheck,250)}},250);const f=function(e){if(typeof e.closest!=="function"){if(e.host.matches(".editoria11y-observer")){return}else{e.host.classList.add("editoria11y-observer")}}else{if(e.closest(".editoria11y-observer")){return}else{e.classList.add("editoria11y-observer")}}const t={childList:true,subtree:true,characterData:true};const i=function(e){if(e.nodeType!==1){return}if(!e.matches("table, h1, h2, h3, h4, h5, h6, blockquote")){e=e.querySelector("table, h1, h2, h3, h4, h5, h6, blockquote")}if(e){Ed11y.recentlyAddedNodes.push(e);window.setTimeout(function(e){let t=Ed11y.recentlyAddedNodes.indexOf(e);if(t>-1){Ed11y.recentlyAddedNodes.splice(t,1);Ed11y.incrementalCheck()}},5e3,e)}};const s=e=>{for(const t of e){if(t.type==="childList"){o=true;if(t.addedNodes.length>0){t.addedNodes.forEach(e=>{i(e)})}}}Ed11y.incrementalAlign();Ed11y.alignPending=false;Ed11y.incrementalCheck()};const n=new MutationObserver(s);n.observe(e,t);document.addEventListener("readystatechange",()=>{window.setTimeout(function(){Ed11y.scrollPending++;Ed11y.updateTipLocations()},100)});window.setTimeout(function(){Ed11y.scrollPending++;Ed11y.updateTipLocations()},1e3)};Ed11y.openTip={button:false,tip:false};Ed11y.lastOpenTip=-1;Ed11y.viaJump=false;Ed11y.alertOnInvisibleTip=function(e,t){let i=100;if(Ed11y.options.hiddenHandlers.length>0&&!!t.closest(Ed11y.options.hiddenHandlers)){i=333;document.dispatchEvent(new CustomEvent("ed11yShowHidden",{detail:{result:e.getAttribute("data-ed11y-result")}}))}const s=t.closest("details");if(s&&!s.open){s.open=true;i=333}window.setTimeout((e,t)=>{Ed11y.message.textContent="";let i=false;let s;if(Ed11y.options.checkVisible&&!Ed11y.visible(t)){i=Ed11y.firstVisibleParent(t);s=Ed11y.M.jumpedToInvisibleTip}else if(t.closest('[aria-hidden="true"]')){i=t.closest('[aria-hidden="true"]');i=i.closest(':not([aria-hidden="true"])');s=Ed11y.M.jumpedToAriaHiddenTip}if(i){const l=Ed11y.openTip.tip?.shadowRoot.querySelector(".ed11y-tip-alert");l.textContent=s}let n=window.innerHeight>800&&window.innerWidth>800?"center":"start";if(!Ed11y.options.inlineAlerts){if(Ed11y.viaJump){t.scrollIntoView({block:n,behavior:"instant"})}Ed11y.editableHighlighter(e.dataset.ed11yResult,true,i)}else{if(Ed11y.viaJump){t.scrollIntoView({block:n,behavior:"instant"})}if(i){i.classList.add("ed11y-hidden-highlight")}}let o=document.querySelector('ed11y-element-tip[data-ed11y-open="true"]');if(!o){e.setAttribute("data-ed11y-action","open");if(Ed11y.viaJump){window.setTimeout(()=>{let e=document.querySelector('ed11y-element-tip[data-ed11y-open="true"]');if(Ed11y.viaJump){e?.shadowRoot.querySelector(".title").focus()}},100)}}else{if(Ed11y.viaJump){window.setTimeout(()=>{o?.shadowRoot.querySelector(".title").focus()},100,o)}}Ed11y.viaJump=false},i,e,t)};Ed11y.jumpTo=function(e=1){if(!Ed11y.open){return false}Ed11y.viaJump=true;let t=Ed11y.jumpList.length-1;let i=Ed11y.lastOpenTip+e;if(i<0){Ed11y.nextText=Ed11y.M.buttonFirstContent;i=t}else if(i>t){i=0;Ed11y.nextText=Ed11y.M.buttonNextContent}else{Ed11y.nextText=Ed11y.M.buttonNextContent}Ed11y.lastOpenTip=i;window.setTimeout(function(){Ed11y.panelJumpNext.querySelector(".ed11y-sr-only").textContent=Ed11y.nextText},250);Ed11y.resetClass(["ed11y-hidden-highlight"]);if(!Ed11y.jumpList){Ed11y.buildJumpList()}let s=Ed11y.jumpList[i];let n=s.getAttribute("data-ed11y-result");let o=Ed11y.results[n];const l=o.element;let a=window.innerHeight>800&&window.innerWidth>800?"center":"start";if(Ed11y.options.inlineAlerts){s.scrollIntoView({block:a,behavior:"instant"})}else{l.scrollIntoView({block:a,behavior:"instant"})}s.setAttribute("data-ed11y-action","open");Ed11y.scrollPending=2;Ed11y.updateTipLocations()};Ed11y.windowResize=function(){T=window.innerWidth;if(Ed11y.panel?.classList.contains("ed11y-active")===true){Ed11y.alignAlts();Ed11y.alignButtons()}if(Ed11y.openTip.button){Ed11y.alignTip(Ed11y.openTip.button.shadowRoot.querySelector("button"),Ed11y.openTip.tip)}Ed11y.alignPanel()};Ed11y.escapeWatch=function(e){if(e.keyCode===27){if(e.target.closest("ed11y-element-panel")&&Ed11y.panelToggle.getAttribute("aria-expanded")==="true"){Ed11y.panelToggle.focus();Ed11y.panelToggle.click()}else if(e.target.hasAttribute("data-ed11y-open")){if(Ed11y.openTip.button){Ed11y.toggledFrom.focus();Ed11y.openTip.button.shadowRoot.querySelector("button").click()}}}};document.addEventListener("keyup",function(e){Ed11y.escapeWatch(e)});Ed11y.getText=function(e){return e.textContent.replace(/[\n\r]+|\s{2,}/g," ").trim()};Ed11y.parents=function(e){let t=[];t.push(e);while(e&&!!e.parentElement&&e.parentElement.tagName!=="HTML"){t.push(e.parentElement);e=e.parentElement}return t};Ed11y.computeAriaLabel=function(e,t=0){const i=e.getAttribute("aria-labelledby");if(!t&&i){const s=i.split(/\s+/);if(s.length>0){let i="";s.forEach(e=>{const t=document.querySelector(`#${CSS.escape(e)}`);i+=!t?"":Ed11y.computeText(t,1)});return i}}if(e.getAttribute("aria-label")&&e.getAttribute("aria-label").trim().length>0){return e.getAttribute("aria-label")}return"noAria"};Ed11y.wrapPseudoContent=function(e,t){let i=[];i[0]=window.getComputedStyle(e,":before").getPropertyValue("content");i[1]=window.getComputedStyle(e,":after").getPropertyValue("content");i[0]=i[0]==="none"?"":i[0].replace(/^"(.*)"$/,"$1");i[1]=i[1]==="none"?"":i[1].replace(/^"(.*)"$/,"$1");return" "+i[0]+t+i[1]};Ed11y.nextTreeBranch=function(t){for(let e=0;e<1e3;e++){if(t.nextSibling()){return t.previousNode()}if(!t.parentNode()){return false}}return false};Ed11y.computeText=function(e,t=0,i=false){let s=Ed11y.computeAriaLabel(e,t);if(s!=="noAria"){return s}let n="";if(!e.children.length){n=Ed11y.wrapPseudoContent(e,e.textContent);if(!n.trim()&&e.hasAttribute("title")){return e.getAttribute("title")}return t?n:n.replace(/[\n\r]+|[\s]{2,}/g," ").trim()}let o=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_TEXT);let l=false;let a=false;let d=0;e:while(o.nextNode()){d++;if(o.currentNode.nodeType===Node.TEXT_NODE){n+=" "+o.currentNode.nodeValue;continue}if(i&&o.currentNode.matches(Ed11y.options.linkIgnoreSelector)){if(!Ed11y.nextTreeBranch(o)){break e}continue}if(l&&!o.currentNode.closest("a")){if(a===n){n+=l}l=false;a=false}if(o.currentNode.hasAttribute("aria-hidden")&&!(t&&d<3)){if(!Ed11y.nextTreeBranch(o)){break e}continue}let e=Ed11y.computeAriaLabel(o.currentNode,t);if(e!=="noAria"){n+=" "+e;if(!Ed11y.nextTreeBranch(o)){break e}continue}switch(o.currentNode.tagName){case"STYLE":case"NOSCRIPT":if(!Ed11y.nextTreeBranch(o)){break e}continue;case"IMG":if(o.currentNode.hasAttribute("alt")){n+=o.currentNode.getAttribute("alt")}continue;case"SVG":case"svg":if(o.currentNode.getAttribute("role")==="image"&&o.currentNode.hasAttribute("alt")){n+=Ed11y.wrapPseudoContent(o.currentNode,o.currentNode.getAttribute("alt"));if(!Ed11y.nextTreeBranch(o)){break e}}continue;case"A":if(o.currentNode.hasAttribute("title")){l=o.currentNode.getAttribute("title");a=n}else{l=false;a=false}n+=Ed11y.wrapPseudoContent(o.currentNode,"");break;default:n+=Ed11y.wrapPseudoContent(o.currentNode,"");break}}if(l&&!a){n+=" "+l}if(!n.trim()&&e.hasAttribute("title")){return e.getAttribute("title")}return t?n:n.replace(/[\n\r]+|[\s]{2,}/g," ").trim()};Ed11y.resetClass=function(e){e?.forEach(e=>{let t=e;Ed11y.findElements("reset",`.${t}`);Ed11y.elements.reset?.forEach(e=>{e.classList.remove(t)})})};Ed11y.keyboardClick=function(e){e.preventDefault();let t=e.keyCode;switch(t){case 13:case 32:e.target.click();break}};Ed11y.siblings=function(t){if(t.parentNode===null)return[];return Array.prototype.filter.call(t.parentNode.children,function(e){return e!==t})};Ed11y.nextUntil=function(e,t){let i=e.nextElementSibling;if(i){let e=i.matches(t);if(e){return i}else{i=Ed11y.nextUntil(i,t)}}return i};Ed11y.visibleElement=function(t){if(t){let e=window.getComputedStyle(t);if(t.classList.contains("ed11y-ring-red")||t.classList.contains("ed11y-ring-yellow")){return!(e.getPropertyValue("display")==="none"||e.getPropertyValue("visibility")==="hidden"||e.getPropertyValue("opacity")==="0"||t.hasAttribute("hidden"))}else return!(e.getPropertyValue("display")==="none"||e.getPropertyValue("visibility")==="hidden"||e.getPropertyValue("opacity")==="0"||t.hasAttribute("hidden")||e.getPropertyValue("overflow")==="hidden"&&(t.offsetWidth===0||t.offsetHeight===0))}};Ed11y.visible=function(i){if(!Ed11y.visibleElement(i)){return false}else{let e=Ed11y.parents(i);let t=e=>Ed11y.visibleElement(e);return e.every(t)}};Ed11y.firstVisibleParent=function(e){let t=e.parentElement;if(t){if(!Ed11y.visibleElement(t)){t=Ed11y.firstVisibleParent(t);return t}else{return t}}else{return false}};Ed11y.hiddenElementCheck=function(e){let t=window.getComputedStyle(e);return!(t.getPropertyValue("display")==="none"||t.getPropertyValue("visibility")==="hidden"||e.hasAttribute("aria-hidden")||e.hasAttribute("hidden"))};Ed11y.elementNotHidden=function(i){if(!Ed11y.hiddenElementCheck(i)){return false}else{let e=Ed11y.parents(i);let t=e=>Ed11y.hiddenElementCheck(e);return e.every(t)}};Ed11y.parentLink=function(e){return e.closest("a[href]")};Ed11y.srcMatchesOptions=function(s,n){if(n.length>0&&s?.length>0){let e=n.split(/\s*[\s,]\s*/).map(e=>{return"[src*='"+e+"']"});let t=e.join(", ");let i=Array.from(s);return i.filter(e=>e.matches(t))}else{return[]}};Ed11y.sanitizeForHTML=function(e){let t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;","`":"&#x60;","=":"&#x3D;"};return String(e).replace(/[&<>"'`=/]/g,function(e){return t[e]})};if(CSS.supports("selector(:is(body))")){Ed11y.initialize()}else{console.warn(Ed11y.M.consoleNotSupported)}}}class Ed11yElementAlt extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized){const s=this.attachShadow({mode:"open"});let e=document.createElement("div");e.classList.add("ed11y-wrapper","ed11y-alt-wrapper");let t=Ed11y.imageAlts[this.dataset.ed11yImg];let i=document.createElement("span");i.textContent=t[2];i.classList.add(t[3]);e.appendChild(i);Ed11y.attachCSS(e);s.appendChild(e);this.initialized=true}}}customElements.define("ed11y-element-alt",Ed11yElementAlt);class Ed11yElementPanel extends HTMLElement{constructor(){super()}template(){return`
