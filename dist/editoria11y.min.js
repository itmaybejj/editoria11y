const ed11yLang={en:{toggleAccessibilityTools:"Toggle accessibility tools",toggleDisabled:"Editorially is disabled.",panelCount0:"No issues detected.",panelCountAllDismissed:"All issues hidden.",panelCount1:"One issue detected.",panelCountMultiple:" issues detected.",panelCountBase:"<span class='count'>No</span> <span class='content-type'>issues detected</span>.",panelControls:"Editorially panel controls",buttonIssuesContent:"Issues",buttonOutlineContent:"Outline",buttonAltsContent:"Alt Text",buttonAboutTitle:"About this tool",buttonPrevContent:"Previous",buttonFirstContent:"First",buttonNextContent:"Next",buttonShowHiddenAlertsContent:"Show dismissed alerts",buttonHideHiddenAlertsContent:"Hide dismissed alerts",panelCheckOutline:"<p>Check that this forms <a href='https://accessibility.princeton.edu/how/content/headings'>a complete outline</a>:</p>",panelCheckAltText:"<p>Check <a href='https://accessibility.princeton.edu/how/content/alternative-text'>alt text</a>, <a href='https://accessibility.princeton.edu/how/content/images-text'>images of text</a>, &amp; <a href='https://webaim.org/techniques/captions/'>captions</a>.</p>",panelHelp:`
    ...
    `}connectedCallback(){var e,t,i;this.initialized||(this.setAttribute("style","outline: 0;"),e=this.attachShadow({mode:"open"}),(t=document.createElement("div")).setAttribute("class","wrapper"),t.innerHTML=this.template(),(i=document.createElement("style")).textContent=Ed11y.baseCSS+`
      ...
      `,e.appendChild(i),e.appendChild(t),Ed11y.panel=t,Ed11y.panelToggle=t.querySelector("#toggle"),Ed11y.panelMessage=t.querySelector(".content-text"),Ed11y.panelCount=t.querySelector(".count"),Ed11y.panelJumpNext=t.querySelector(".jump.next"),Ed11y.panelJumpPrev=t.querySelector(".jump.prev"),Ed11y.panelJumpNext.addEventListener("click",this.jumpTo),Ed11y.panelJumpPrev.addEventListener("click",this.jumpTo),Ed11y.showDismissed=t.querySelector("#show-hidden"),Ed11y.showDismissed.addEventListener("click",function(){Ed11y.toggleShowDismissals()}),Ed11y.announce=t.querySelector(".announce"),Ed11y.panelTabs=t.querySelectorAll(".buttonbar button"),Ed11y.panelTabs.forEach(e=>{e.addEventListener("click",this.handleBarClick)}),this.initialized=!0)}jumpTo(e){e.preventDefault(),Ed11y.toggledFrom=this,Ed11y.resetClass(["ed11y-hidden-highlight"]),Ed11y.elements.jumpList||Ed11y.buildJumpList();var e=parseInt(this.dataset.ed11yGoto),e=Ed11y.elements.jumpList[e],t=(Ed11y.scrollTo(e),e.setAttribute("data-ed11y-action","open"),Ed11y.results[e.getAttribute("data-ed11y-result")]),t=t[3];let i,n=("beforebegin"===t?i=Ed11y.nextUntil(e,":not(ed11y-element-result)"):"afterbegin"===t&&(i=e.parentElement),100);0<Ed11y.options.hiddenHandlers.length&&i.closest(Ed11y.options.hiddenHandlers)&&(n=333,document.dispatchEvent(new CustomEvent("ed11yShowHidden",{detail:{result:e.getAttribute("data-ed11y-result")}}))),window.setTimeout(function(e,t){let i=!1,n;Ed11y.visible(t)?t.closest('[aria-hidden="true"]')&&(i=(i=t.closest('[aria-hidden="true"]')).closest(':not([aria-hidden="true"])'),n=Ed11y.M.jumpedToAriaHiddenTip):(i=Ed11y.firstVisibleParent(t),n=Ed11y.M.jumpedToInvisibleTip),i&&(alert(n),i.classList.add("ed11y-hidden-highlight")),Ed11y.scrollTo(e),document.querySelector('ed11y-element-tip[data-ed11y-open="true"]').shadowRoot.querySelector(".close").focus()},n,e,i)}handleBarClick(e){e.preventDefault();var t=e.currentTarget.getAttribute("id");switch(t){case"toggle":Ed11y.togglePanel();break;case"minimize":Ed11y.minimize();break;default:Ed11y.switchPanel(t)}}static get observedAttributes(){return["style"]}attributeChangedCallback(e,t,i){"style"===e&&!0===this.initialized&&(this.shadowRoot?.querySelector("div")).setAttribute("style",i)}}customElements.define("ed11y-element-panel",Ed11yElementPanel);class Ed11yElementHeadingLabel extends HTMLElement{constructor(){super()}connectedCallback(){var e,t,i,n;this.initialized||(e=this.attachShadow({mode:"open"}),(t=document.createElement("div")).setAttribute("class","wrapper"),n=this.dataset.ed11yHeadingOutline,n=Ed11y.headingOutline[n],t.innerHTML="H"+n[1],i=!!n[2],t.classList.add("issue"+i),i=document.createElement("style"),n=Math.max(52-8*n[1],12),i.textContent=Ed11y.baseCSS+`
        :host {
          position: absolute;
          margin-top:-.5em;
        }
      ...
      `,e.appendChild(i),e.appendChild(t),this.initialized=!0)}}customElements.define("ed11y-element-heading-label",Ed11yElementHeadingLabel);class Ed11yElementResult extends HTMLElement{constructor(){super()}connectedCallback(){var e,t,i;this.initialized||(this.open=!1,this.racing=!1,this.setAttribute("style","outline: 0px solid transparent;"),e=this.attachShadow({mode:"open"}),this.resultID=this.dataset.ed11yResult,this.result=Ed11y.results[this.resultID],this.wrapper=document.createElement("aside"),this.dismissable=!1!==this.result[4],this.wrapper.classList.add("wrapper"),this.wrapper.classList.add("ed11y-result"),this.toggle=document.createElement("button"),this.toggle.setAttribute("class","toggle"),t=this.dismissable?Ed11y.M.toggleManualCheck:Ed11y.M.toggleAlert,this.toggle.setAttribute("aria-label",Ed11y.M.toggleAriaLabel(this.resultID,t)),this.toggle.setAttribute("aria-expanded","false"),this.toggle.setAttribute("aria-haspopup","dialog"),this.toggle.setAttribute("data-ed11y-result",this.dataset.ed11yResult),this.toggle.setAttribute("data-ed11y-ready","false"),this.toggle.setAttribute("data-ed11y-race","false"),this.wrapper.appendChild(this.toggle),this.toggle.addEventListener("click",this.toggleClick),this.toggle.addEventListener("mouseover",this.handleHover),this.tipNeedsBuild=!0,t=document.createElement("style"),i=this.toggleImage(),t.textContent=Ed11y.baseCSS+i+`
        :host {
          position: absolute;
          opacity: 0;
          transition: opacity .25s ease-in;
      ...
      `,e.appendChild(t),e.appendChild(this.wrapper),this.initialized=!0)}toggleImage(){var e=`
      .toggle {
      ...
      .toggle::before {
        content: "!";
      }`;return this.dismissable?e:t}handleHover(e){e.preventDefault();let t=this.getRootNode().host;"false"===t.getAttribute("data-ed11y-open")&&!1===t.racing&&(t.racing=!0,t.toggleTip(!0),Ed11y.toggledFrom=this,window.setTimeout(function(){t.racing=!1},250,t))}toggleClick(e){e.preventDefault();let t=this.getRootNode().host;!1===t.racing&&(t.racing=!0,Ed11y.toggledFrom=this,e="false"===t.getAttribute("data-ed11y-open")?"open":"close",t.setAttribute("data-ed11y-action",e),"open"==e&&window.setTimeout(function(){document.querySelector('ed11y-element-tip[data-ed11y-open="true"]')?.shadowRoot.querySelector(".close").focus()},500),window.setTimeout(function(){t.racing=!1},250,t))}closeOtherTips(){Ed11y.findElements("openTips",'[data-ed11y-open="true"]'),Ed11y.elements.openTips&&Array.from(Ed11y.elements.openTips).forEach(e=>{e.setAttribute("data-ed11y-action","close")})}tipDOM(e,t,i){return`>
      <div class="title" id="tip-title-${e}">${t}</div>
      <div class="message">${i}</div>
    `}buildTip(){this.tipNeedsBuild=!1;var e=document.createElement("ed11y-element-tip");e.setAttribute("data-ed11y-result",this.resultID),document.querySelector("body").insertAdjacentElement("beforeend",e),this.tip=e}toggleTip(e){this.tipNeedsBuild&&this.buildTip(),this.toggle.setAttribute("aria-expanded",e);var t=this.dismissable?"ed11y-ring-yellow":"ed11y-ring-red";this.result[0].classList.toggle(t),!0===e?(document.dispatchEvent(new CustomEvent("ed11yPop",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result")}})),this.closeOtherTips(),this.tip.setAttribute("data-ed11y-action","open"),window.setTimeout(Ed11y.alignTip(this.toggle,this.tip)),Ed11y.elements.jumpList||Ed11y.buildJumpList(),Ed11y.goto=this.getAttribute("data-ed11y-jump-position"),Ed11y.setCurrentJump()):(document.dispatchEvent(new CustomEvent("ed11yShut",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result")}})),this.tip.setAttribute("data-ed11y-action","shut")),this.setAttribute("data-ed11y-open",e),this.open=e}static get observedAttributes(){return["data-ed11y-action"]}attributeChangedCallback(e,t,i){this.initialized&&"data-ed11y-action"===e&&"false"!==i&&(e="open"===i,this.setAttribute("data-ed11y-action","false"),this.toggleTip(e))}}customElements.define("ed11y-element-result",Ed11yElementResult);class Ed11yElementTip extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized){this.open=!0,this.setAttribute("style","outline: 0px solid transparent;");var i=this.attachShadow({mode:"open"}),n=(this.resultID=this.dataset.ed11yResult,this.result=Ed11y.results[this.resultID],this.wrapper=document.createElement("div"),this.wrapper.setAttribute("role","dialog"),this.dismissable=!1!==this.result[4],this.wrapper.classList.add("wrapper"),this.wrapper.classList.add("ed11y-result"),this.addEventListener("mouseover",this.handleHover),document.createElement("style")),s=(n.textContent=Ed11y.baseCSS+`
        :host {
          position: absolute;
          top: 10vh;
          left: 2vw;
      ...
      `,this.tip=document.createElement("div"),this.tip.classList.add("tip"),this.tip.setAttribute("aria-labelledby","tip-title-"+[this.resultID]),this.heading=document.createElement("div"),this.heading.setAttribute("id","tip-"+this.resultID),this.heading.classList.add("title"),this.heading.setAttribute("tabindex","-1"),this.heading.innerHTML=Ed11y.M[this.result[1]].title,document.createElement("div"));if(s.classList.add("content"),s.innerHTML=this.result[2],this.dismissable){var o=document.createElement("div");let e=!1;Ed11y.options.showDismissed&&this.result[5]?(a="ok"===Ed11y.dismissedAlerts[Ed11y.options.currentPage][this.result[1]][this.result[5]])&&Ed11y.options.allowOK||!a?((a=document.createElement("button")).classList.add("dismiss"),a.textContent=Ed11y.M.undismissButtonContent,a.setAttribute("title",Ed11y.M.undismissButtonTitle),o.append(a),a.addEventListener("click",function(){Ed11y.dismissThis("reset")})):((a=document.createElement("div")).classList.add("dismissed-note"),a.textContent=Ed11y.M.undismissNotePermissions,o.append(a)):(Ed11y.options.allowOK&&((a=document.createElement("button")).classList.add("dismiss"),a.textContent=Ed11y.M.dismissOkButtonContent,a.setAttribute("title",Ed11y.M.dismissOkButtonTitle),o.append(a),a.addEventListener("click",function(){Ed11y.dismissThis("ok")}),e=!0),Ed11y.options.allowHide&&((a=document.createElement("button")).classList.add("dismiss"),a.textContent=Ed11y.M.dismissHideButtonContent,a.setAttribute("title",Ed11y.M.dismissHideButtonTitle),o.append(a),a.addEventListener("click",function(){Ed11y.dismissThis("hide")}),e=!0)),e&&((e=document.createElement("button")).classList.add("dismiss"),e.textContent="?",o.append(e),e.addEventListener("click",function(){Ed11y.dismissHelp(e)})),s.append(o)}var a=document.createElement("button"),o=(a.setAttribute("aria-label","close"),a.classList.add("close"),a.innerHTML="&times;",document.createElement("div")),s=(o.classList.add("arrow"),this.tip.append(this.heading),this.tip.append(a),this.tip.append(s),a.addEventListener("click",e=>{e.preventDefault,this.open&&(e=document.querySelector('ed11y-element-result[data-ed11y-open="true"]'),Ed11y.toggledFrom.focus(),e?.setAttribute("data-ed11y-action","shut"),this.setAttribute("data-ed11y-action","shut"))}),i.appendChild(n),i.appendChild(this.wrapper),document.createElement("div")),a=(s.setAttribute("tabIndex","0"),document.createElement("div"));a.setAttribute("tabindex","0"),this.wrapper.appendChild(s),this.wrapper.appendChild(o),this.wrapper.appendChild(this.tip),this.wrapper.appendChild(a);let e=this.wrapper.querySelectorAll('a, button, [tabindex="0"]'),t=e.length;e[0].addEventListener("focus",()=>{e[t-2].focus()}),e[t-1].addEventListener("focus",()=>{e[1].focus()}),this.initialized=!0}}toggleTip(e){e?this.wrapper.classList.add("open"):this.wrapper.classList.remove("open"),this.setAttribute("data-ed11y-open",e)}toggleImage(){var e=`
      .toggle {
        box-shadow: inset 0 0 0 2px ${Ed11y.color.warning}, inset 0 0 0 3px #444, inset 0 0 0 6px ${Ed11y.color.warning}, 1px 1px 5px 0 rgba(0,0,0,.5);
        background: ${Ed11y.color.warning};
        color: #333;
    ...
    `}static get observedAttributes(){return["data-ed11y-action"]}attributeChangedCallback(e,t,i){this.initialized&&"data-ed11y-action"===e&&"false"!==i&&(this.open=e="open"===i,this.setAttribute("data-ed11y-action","false"),this.toggleTip(e))}}customElements.define("ed11y-element-tip",Ed11yElementTip);class Ed11yTestEmbeds{check(){let e=Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.videoContent),t=(0<(e=e.concat(Array.from(Ed11y.elements.video))).length&&e.forEach(e=>{var t=Ed11y.dismissalKey("undefined"!==e?.getAttribute("src")?e.getAttribute("src"):e.querySelector("[src]")?.getAttribute("src"));Ed11y.results.push([e,"embedVideo",Ed11y.M.embedVideo.tip(),"beforebegin",t])}),Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.audioContent));0<(t=t.concat(Array.from(Ed11y.elements.audio))).length&&t.forEach(e=>{var t=Ed11y.dismissalKey("undefined"!==e?.getAttribute("src")?e.getAttribute("src"):e.querySelector("[src]")?.getAttribute("src"));Ed11y.results.push([e,"embedAudio",Ed11y.M.embedAudio.tip(),"beforebegin",t])});var i=Ed11y.srcMatchesOptions(Ed11y.elements.iframe,Ed11y.options.dataVizContent),i=(0<i.length&&i.forEach(e=>{var t=Ed11y.dismissalKey(e.getAttribute("src"));Ed11y.results.push([e,"embedVisualization",Ed11y.M.embedVisualization.tip(),"beforebegin",t])}),Ed11y.srcMatchesOptions(Ed11y.elements.frame,Ed11y.options.twitterContent));0<i.length&&i.forEach(e=>{var t=e.querySelectorAll(".timeline-TweetList-tweet");t&&3<t&&(t=Ed11y.dismissalKey(e.getAttribute("src")),Ed11y.results.push([e,"embedTwitter",Ed11y.M.embedTwitter.tip(),"beforebegin",t]))}),Ed11y.options.embeddedContent&&Ed11y.elements.embed?.forEach(e=>{var t=Ed11y.dismissalKey(e.getAttribute("src")+e.getAttribute("id")+e.getAttribute("class"));Ed11y.results.push([e,"embedCustom",Ed11y.M.embedCustom.tip(),"beforebegin",t])})}}class Ed11yTestHeadings{check(){Ed11y.panel?.querySelectorAll("#ed11y-outline-list li, .ed11y-headings-label")?.forEach(e=>e.remove());let p=0,c=(Ed11y.headingOutline=[],"beforebegin");Ed11y.elements.h?.forEach((e,t)=>{let i;var n=[];i=e.hasAttribute("aria-level")?+e.getAttribute("aria-level"):+e.tagName.slice(1),i=parseInt(i);let s="",o="";var a,d=Ed11y.getText(e),l=d.length;let r=!1;l<1?(a=e.querySelector("img")?.getAttribute("alt"))&&0!==a.length||(o+=Ed11y.M.errorOutlinePrefixHeadingEmpty,s="headingEmpty",r=!1,n.push([e,s,Ed11y.M.headingEmpty.tip(),c,r])):160<l&&(o+=Ed11y.M.errorOutlinePrefixHeadingIsLong,r=i+d,s="headingIsLong",n.push([e,s,Ed11y.M.headingIsLong.tip(),c,r])),1<i-p&&0!==t&&(r=i+d,o+=Ed11y.M.errorOutlinePrefixSkippedLevel,s="headingLevelSkipped",n.push([e,s,Ed11y.M.headingLevelSkipped.tip(p,i),c,r])),p=i,""!==s&&(o=null!==e.closest(Ed11y.options.checkRoots)||Ed11y.options.shadowComponents&&void 0!==e.getRootNode()?.host?.matches(Ed11y.options.shadowComponents)?(n.forEach(e=>{Ed11y.results.push(e)}),o&&"<span class='ed11y-small'><em>"+o+"</em></span>"):""),Ed11y.headingOutline.push([e,i,o])}),Ed11y.elements.blockquote?.forEach(e=>{var t,i=Ed11y.getText(e);i.length<25&&(i=Ed11y.dismissalKey(i),t=Ed11y.M.blockquoteIsShort.tip(),Ed11y.results.push([e,"blockquoteIsShort",t,c,i]))})}}class Ed11yTestImages{check(){Ed11y.imageAlts=[],Ed11y.elements.img.forEach(e=>{let i=e.getAttribute("alt"),n=Ed11y.M.altLabelPrefix;var t=e.getAttribute("src");let s=!1,o=!0;var a=Ed11y.parentLink(e);if("string"!=typeof i)s="altMissing",o=!1,n+=Ed11y.M.errorAltMissing;else if(0!==i.length||a){n+=i;var d=[".png",".jpg",".jpeg",".gif"],l=Ed11y.M.suspiciousWords;let t=[null,null];d.forEach(e=>{0<=i.toLowerCase().indexOf(e)&&(t[0]="URL")}),l.forEach(e=>{0<=i.toLowerCase().indexOf(e)&&(t[1]=e)}),"URL"===t[0]?(s="altURL",o=!1):null!==t[1]?s="altImageOf":""!==i&&""===i.replace(/"|'|\s+/g,"")?(s="altDeadspace",o=!1):160<i.length&&(s="altLong"),null!==a&&(e=a,s=!s&&1<Ed11y.linkText(a.textContent).length?"altPartOfLinkWithText":s&&s+"Linked")}else s="altNull",n+=Ed11y.M.errorAltNull;let r="pass";s&&(d=Ed11y.M[s].tip(Ed11y.sanitizeForHTML(i)),l=t?t.split("?")[0]:"nosrc_",o=!!o&&Ed11y.dismissalKey(l+i),Ed11y.results.push([e,s,d,"beforebegin",o]),r=!1===o?"error":"warning"),Ed11y.imageAlts.push([e,t,n,r])})}}class Ed11yTestLinks{check(){Ed11y.elements.a?.forEach(i=>{let n=Ed11y.computeAriaLabel(i);var s=i.querySelectorAll("img");let o=0<s.length;var e=i.querySelectorAll("[aria-label]:not(img)");let t=!1,a=(i.matches(Ed11y.options.documentLinks)&&(t=!0),"noAria"===n&&(n=Ed11y.getText(i),o&&(s.forEach(e=>{var t=Ed11y.computeAriaLabel(e);"noAria"!==t?n+=t:e.hasAttribute("alt")?n+=e.getAttribute("alt"):e.hasAttribute("src")&&(n+=e.getAttribute("src"))}),o=!0),0<e.length)&&e.forEach(e=>{n+=e.getAttribute("aria-label")}),n+=Ed11y.computeTitle(i)?Ed11y.computeTitle(i):"",Ed11y.options.linkIgnoreStrings?n.replace(Ed11y.options.linkIgnoreStrings,""):n);s=(a=a.toLowerCase()).replace(Ed11y.M.linkStringsNewWindows,"");if("_blank"===i?.getAttribute("target")&&n.length===s.length&&(e=Ed11y.dismissalKey(n),Ed11y.results.push([i,"linkNewWindow",Ed11y.M.linkNewWindow.tip(),"beforebegin",e])),0===(a=a.replace(/'|"|-|\.|\s+/g,"")).length)!1===o?Ed11y.results.push([i,"linkNoText",Ed11y.M.linkNoText.tip(),"beforebegin",!1]):Ed11y.results.push([i,"altEmptyLinked",Ed11y.M.altEmptyLinked.tip(),"beforebegin",!1]);else{s=function(t){var i=Ed11y.options.linksUrls||Ed11y.M.linksUrls,e=Ed11y.options.linksMeaningless||Ed11y.M.linksMeaningless;let n="none";if(0===t.replace(e,"").length)n="generic";else for(let e=0;e<i.length;e++)if(-1<t.indexOf(i[e])){n="url";break}return n}(a);if("none"!==s){let e=!1,t=!1;o||(t="linkTextIsURL",e=Ed11y.dismissalKey(n)),"generic"===s&&(t="linkTextIsGeneric",e=Ed11y.dismissalKey(n)),t&&Ed11y.results.push([i,t,Ed11y.M[t].tip(Ed11y.sanitizeForHTML(n)),"beforebegin",e])}}!o&&t&&(e=Ed11y.dismissalKey(i?.getAttribute("href")),Ed11y.results.push([i,"linkDocument",Ed11y.M.linkDocument.tip(),"beforebegin",e]))})}}class Ed11yTestText{check(){function d(e){return e.replace(/^b|^B|^2/,function(e){return i[e]})}function t(e){let t="";"LI"===e.tagName?e.childNodes.forEach(e=>{3===e.nodeType&&(t+=e.textContent)}):t=Ed11y.getText(e);var i,n=t.match(/([A-Z]{2,}[ ])([A-Z]{2,}[ ])([A-Z]{2,}[ ])([A-Z]{2,})/g);n&&10<n[0].length&&(n=Ed11y.dismissalKey(t),(i=e.closest("a, button"))?Ed11y.results.push([i,"textUppercase",Ed11y.M.textUppercase.tip(),"beforebegin",n]):Ed11y.results.push([e,"textUppercase",Ed11y.M.textUppercase.tip(),"afterbegin",n]))}let l="",r="",i={b:"a",B:"A",2:"1"},p=/a\.|a\)|A\.|A\)|1\.|1\)|\*\s|-\s|--|•\s|→\s|✓\s|✔\s|✗\s|✖\s|✘\s|❯\s|›\s|»\s/;Ed11y.elements.p?.forEach((t,e)=>{let i="",n=!1,s=!1;if(r||(r=Ed11y.getText(t),i=r.substring(0,2)),0<i.length&&i!==l&&i.match(p)){var e=Ed11y.elements.p[e+1];if(!(s=e&&(n=Ed11y.getText(e).substring(0,2),e=d(n),i===e)?!0:s)){let e=t?.querySelector("br")?.nextSibling?.nodeValue;e&&(e=e.replace(/<\/?[^>]+(>|$)/g,"").trim().substring(0,2),i===d(e))&&(s=!0)}l=s?(e=Ed11y.dismissalKey(r),Ed11y.results.push([t,"textPossibleList",Ed11y.M.textPossibleList.tip(i),"afterbegin",e]),i):""}else{var o,a,e=t.querySelector("strong:not(table strong), b:not(table b)");e&&(a=(e=Ed11y.getText(e)).length,o=null!==e.match(/[.:;?!"']/),a<121)&&5<a&&a===r.length&&!1==o&&(a=Ed11y.dismissalKey(e),Ed11y.results.push([t,"textPossibleHeading",Ed11y.M.textPossibleHeading.tip(),"afterbegin",a]))}r=n&&""});Ed11y.elements.h?.forEach(e=>{t(e)}),Ed11y.elements.p?.forEach(e=>{t(e)}),Ed11y.elements.blockquote?.forEach(e=>{t(e)}),Ed11y.elements.li?.forEach(e=>{t(e)}),Ed11y.elements.table.forEach(e=>{var t=e.querySelectorAll("th"),i=e.querySelectorAll("h1, h2, h3, h4, h5, h6");0===t.length?Ed11y.results.push([e,"tableNoHeaderCells",Ed11y.M.tableNoHeaderCells.tip(),"beforebegin",!1]):t.forEach(e=>{Ed11y.getText(e).length<1&&!Ed11y.computeTitle(e)&&Ed11y.results.push([e,"tableEmptyHeaderCell",Ed11y.M.tableEmptyHeaderCell.tip(),"afterbegin",!1])}),i&&i.forEach(e=>{Ed11y.results.push([e,"tableContainsContentHeading",Ed11y.M.tableContainsContentHeading.tip(),"beforebegin",!1])})})}}class Ed11y{constructor(e){Ed11y.options={checkRoots:!1,shadowComponents:!1,ignoreElements:!1,ignoreByKey:{img:"[aria-hidden], [aria-label], [aria-labelledby], [aria-hidden] img, [aria-label] img, [aria-labelledby] img",a:"[aria-hidden][tabindex]"},alertMode:"polite",currentPage:!1,allowHide:!0,allowOK:!0,syncedDismissals:!1,ignoreAllIfAbsent:!1,ignoreAllIfPresent:!1,preventCheckingIfPresent:!1,preventCheckingIfAbsent:!1,linkIgnoreStrings:!1,hiddenHandlers:"",lang:"en",theme:"lightTheme",darkTheme:{bg:"#0a2051",bgHighlight:"#7b1919",text:"#f4f7ff",primary:"#3052a0",primaryText:"#f4f7ff",secondary:"#20160c",warning:"#fad859",alert:"#b80519",button:"#dde8ff",focusRing:"cyan",activeTab:"#0a2051",tipHeader:"#3052a0"},lightTheme:{bg:"#fffffe",bgHighlight:"#7b1919",text:"#20160c",primary:"#0a307a",primaryText:"#fffdf7",secondary:"#20160c",warning:"#fad859",alert:"#b80519",button:"#0a307a",focusRing:"#007aff",activeTab:"#b9c0cf",tipHeader:"#0a307a"},buttonZIndex:9999,embeddedContent:!1,embeddedContentTitle:"",embeddedContentMessage:"",videoContent:"youtube.com, vimeo.com, yuja.com, panopto.com",audioContent:"soundcloud.com, simplecast.com, podbean.com, buzzsprout.com, blubrry.com, transistor.fm, fusebox.fm, libsyn.com",dataVizContent:"datastudio.google.com, tableau",twitterContent:"twitter-timeline",documentLinks:"a[href$='.pdf'], a[href*='.pdf?'], a[href$='.doc'], a[href$='.docx'], a[href*='.doc?'], a[href*='.docx?'], a[href$='.ppt'], a[href$='.pptx'], a[href*='.ppt?'], a[href*='.pptx?'], a[href^='https://docs.google']",linksUrls:!1,linksMeaningless:!1,...e},Ed11y.M={...ed11yLang.en,...ed11yLang[Ed11y.options.lang]},Ed11y.color=Ed11y.options[Ed11y.options.theme],!1===Ed11y.options.currentPage&&(Ed11y.options.currentPage=window.location.pathname),Ed11y.elements=[],Ed11y.initialize=()=>{Ed11y.checkRunPrevent=()=>{let e=!!Ed11y.options.preventCheckingIfPresent&&document.querySelector(Ed11y.options.preventCheckingIfPresent);return e=!e&&Ed11y.options.preventCheckingIfAbsent?null===document.querySelector(`:is(${Ed11y.options.preventCheckingIfAbsent})`):e};var e;e=()=>{Ed11y.checkRunPrevent()||(Ed11y.running=!0,Ed11y.localData=localStorage.getItem("Ed11y.localData"),Ed11y.localDataParsed=Ed11y.localData?JSON.parse(Ed11y.localData):{},!1===Ed11y.options.syncedDismissals?(Ed11y.dismissedAlerts=localStorage.getItem("ed11ydismissed"),Ed11y.dismissedAlerts=Ed11y.dismissedAlerts?JSON.parse(Ed11y.dismissedAlerts):{}):(Ed11y.dismissedAlerts={},Ed11y.dismissedAlerts[Ed11y.options.currentPage]=Ed11y.options.syncedDismissals),Ed11y.testEmbeds=new Ed11yTestEmbeds,Ed11y.testHeadings=new Ed11yTestHeadings,Ed11y.testImages=new Ed11yTestImages,Ed11y.testLinks=new Ed11yTestLinks,Ed11y.testText=new Ed11yTestText,Ed11y.ignore=Ed11y.options.ignoreElements?`:not(${Ed11y.options.ignoreElements})`:"",Ed11y.options.checkRoots||(Ed11y.options.checkRoots=null!==document.querySelector("main")?"main":"body"),Ed11y.ignoreAll=!(!Ed11y.options.ignoreAllIfAbsent||null!==document.querySelector(`:is(${Ed11y.options.ignoreAllIfAbsent})`)),!Ed11y.ignoreAll&&Ed11y.options.ignoreAllIfPresent&&(Ed11y.ignoreAll=null!==document.querySelector(`:is(${Ed11y.options.ignoreAllIfPresent})`)),Ed11y.checkAll(!0,"hide"),window.addEventListener("resize",function(){Ed11y.windowResize()}))},"complete"===document.readyState?e():window.addEventListener("load",e)},Ed11y.checkAll=(e,t)=>{var i;Ed11y.checkRunPrevent()?(Ed11y.reset(),Ed11y.panelToggle.classList.add("disabled"),Ed11y.panelToggle.setAttribute("aria-expanded","true"),Ed11y.panelToggle.setAttribute("title",Ed11y.M.toggleDisabled)):(Ed11y.results=[],Ed11y.elements=[],Ed11y.errorCount=0,Ed11y.warningCount=0,Ed11y.dismissedCount=0,(Ed11y.mediaCount=0)===(i=document.querySelectorAll(`:is(${Ed11y.options.checkRoots})`)).length?(Ed11y.roots=[document.querySelector("html, body")],0===i.length?console.warn("Check Editoria11y configuration; specified root element not found"):console.warn("No user editable content on this page"),Ed11y.reset()):(Ed11y.roots=[],i.forEach((e,t)=>{e.shadowRoot?Ed11y.roots[t]=e.shadowRoot:Ed11y.roots[t]=e}),Ed11y.buildElementList(),["testLinks","testImages","testHeadings","testText","testEmbeds"].forEach(e=>{window.setTimeout(function(){Ed11y[e].check()},0,e)})),window.setTimeout(function(){Ed11y.updatePanel(e,t),Ed11y.panelToggle.setAttribute("title",Ed11y.M.toggleAccessibilityTools)},0))},Ed11y.countAlerts=function(){if(Ed11y.ignoreAll)Ed11y.dismissedCount=0<Ed11y.results.length?1:0;else{Ed11y.dismissedCount=0;for(let e=Ed11y.results.length-1;0<=e;e--){var t=Ed11y.results[e][1],i=Ed11y.results[e][4];!1!==i&&Ed11y.options.currentPage in Ed11y.dismissedAlerts&&t in Ed11y.dismissedAlerts[Ed11y.options.currentPage]&&i in Ed11y.dismissedAlerts[Ed11y.options.currentPage][t]?(Ed11y.dismissedCount++,Ed11y.results[e][5]=Ed11y.dismissedAlerts[Ed11y.options.currentPage][t][i]):(Ed11y.results[e][4]?Ed11y.warningCount++:Ed11y.errorCount++,Ed11y.results[e][5]=!1)}}Ed11y.totalCount=Ed11y.errorCount+Ed11y.warningCount;var e=Ed11y.options.showDismissed?Ed11y.totalCount+Ed11y.dismissedCount:Ed11y.totalCount;0<e?(Ed11y.panelJumpNext.removeAttribute("hidden"),e<2?Ed11y.panelJumpPrev.setAttribute("hidden",""):Ed11y.panelJumpPrev.removeAttribute("hidden"),0<Ed11y.errorCount?(Ed11y.panel.classList.remove("warnings","pass"),Ed11y.panel.classList.add("errors")):0<Ed11y.warningCount&&(Ed11y.panel.classList.remove("errors","pass"),Ed11y.panel.classList.add("warnings")),Ed11y.panelCount.textCount=e,Ed11y.panelCount.style.display="inline-block",Ed11y.panelMessage.innerHTML=1===e?Ed11y.M.panelCount1:e+Ed11y.M.panelCountMultiple,Ed11y.panel.querySelector(".toggle-count").textContent=e):(Ed11y.panelJumpNext.setAttribute("hidden",""),Ed11y.panelJumpPrev.setAttribute("hidden",""),Ed11y.panelCount.style.display="display: none;",Ed11y.panel.classList.remove("warnings","errors"),Ed11y.panel.classList.add("pass"),0<Ed11y.dismissedCount?(Ed11y.panel.querySelector(".toggle-count").textContent="i",Ed11y.panelMessage.innerText=Ed11y.M.panelCountAllDismissed):(Ed11y.panel.querySelector(".toggle-count").textContent="✓",Ed11y.panelMessage.innerText=Ed11y.M.panelCount0)),(0<Ed11y.dismissedCount||Ed11y.ignoreAll)&&Ed11y.showDismissed.removeAttribute("hidden"),Ed11y.panel.classList.remove("ed11y-preload"),window.setTimeout(function(){var e=new CustomEvent("ed11yResults");document.dispatchEvent(e)},0)},Ed11y.updatePanel=function(e,t){var i;!0===e&&(i=document.createElement("ed11y-element-panel"),document.querySelector("body").appendChild(i)),Ed11y.countAlerts(),!0===e&&0<Ed11y.totalCount&&!Ed11y.ignoreAll?(Ed11y.localDataParsed[Ed11y.options.currentPage]===Ed11y.totalCount?t="seen":"assertive"===Ed11y.options.alertMode&&(t="show"),Ed11y.localDataParsed[Ed11y.options.currentPage]=Ed11y.totalCount,window.setTimeout(function(){Ed11y.announce.innerHTML=Ed11y.getText(Ed11y.panelMessage)},1500)):!0===e&&0===Ed11y.totalCount&&(t="pass"),"show"!==t?(Ed11y.reset(),Ed11y.bodyStyle||Ed11y.paintReady()):(Ed11y.panel.classList.remove("shut"),Ed11y.panel.classList.add("active"),Ed11y.panelToggle.setAttribute("aria-expanded","true"),window.setTimeout(function(){document.dispatchEvent(new CustomEvent("ed11yPanelOpened")),Ed11y.ignoreAll||Ed11y.showResults()},0),!1===e&&window.setTimeout(function(){Ed11y.panelMessage.focus()},500)),Ed11y.panelToggle.classList.remove("disabled"),Ed11y.panelToggle.removeAttribute("aria-disabled"),Ed11y.running=!1},Ed11y.result=function(e,t){var i=document.createElement("ed11y-element-result");let n=e[0].closest("a"),s="beforebegin";n||(n=e[0],s=e[3]),i.setAttribute("id","ed11y-result-"+t),i.setAttribute("data-ed11y-result",t),i.setAttribute("data-ed11y-open","false"),n.insertAdjacentElement(s,i)},Ed11y.reset=function(){Ed11y.resetClass(["ed11y-ring-red","ed11y-ring-yellow","ed11y-hidden-highlight"]),Ed11y.findElements("reset","ed11y-element-result, ed11y-element-tip, .ed11y-element-heading-label, .ed11y-element-alt, ed11y-element-heading-label, ed11y-element-alt",!1),Ed11y.elements.reset.forEach(e=>e.remove()),Ed11y.panelJumpNext?.setAttribute("data-ed11y-goto","0"),Ed11y.panelJumpPrev?.setAttribute("data-ed11y-goto","0"),Ed11y.panel?.classList.add("shut"),Ed11y.panel?.classList.remove("active"),Ed11y.panelToggle?.setAttribute("aria-expanded","false"),Ed11y.running=!1},Ed11y.linkText=e=>e=(e=e.replace(Ed11y.options.linkIgnoreStrings,"")).replace(/'|"|-|\.|\s+/g,""),Ed11y.computeAriaLabel=function(i,e=!1){var t=i.hasAttribute("aria-label"),n=i.hasAttribute("aria-labelledby");if(!e){if(n){let e=i.getAttribute("aria-labelledby"),t="";return 0<e.length&&(e=(e="#"+e).replace(/ /g,", #"),document.querySelectorAll(e)?.forEach(e=>{t+=Ed11y.computeAriaLabel(e,!0)+" "})),t}if(!t)return"noAria"}return t?i.getAttribute("aria-label"):e?Ed11y.getText(i):void 0},Ed11y.computeTitle=function(e){return e.hasAttribute("title")?e.getAttribute("title"):e.querySelector("[title]")?e.querySelector("[title]").getAttribute("title"):""},Ed11y.findElements=function(t,n,e=!0){let i=Ed11y.options.shadowComponents?", "+Ed11y.options.shadowComponents:"",s="";if(s=Ed11y.options.ignoreElements?Ed11y.options.ignoreByKey[t]?`:not(${Ed11y.options.ignoreElements}, ${Ed11y.options.ignoreByKey[t]})`:`:not(${Ed11y.options.ignoreElements})`:Ed11y.options.ignoreByKey[t]?`:not(${Ed11y.options.ignoreByKey[t]})`:"",Ed11y.elements[t]=[],e?Ed11y.roots.forEach(e=>{Ed11y.elements[t]=Ed11y.elements[t].concat(Array.from(e.querySelectorAll(`:is(${n}${i})`+s)))}):Ed11y.elements[t]=Ed11y.elements[t].concat(Array.from(document.querySelectorAll(`:is(${n}${i})`+s))),Ed11y.options.shadowComponents){let i=[];if(Ed11y.elements[t].forEach((e,t)=>{e.matches(Ed11y.options.shadowComponents)&&(i[t]=e.shadowRoot.querySelectorAll(`:is(${n})`+s))}),0<i.length)for(let e=i.length-1;0<=e;e--)i[e]&&Ed11y.elements[t].splice(e,1,...i[e])}},Ed11y.buildElementList=function(){Ed11y.findElements("p","p"),Ed11y.findElements("h",'h1, h2, h3, h4, h5, h6, [role="heading"][aria-level]',!1),Ed11y.findElements("img","img"),Ed11y.findElements("a","a[href]"),Ed11y.findElements("li","li"),Ed11y.findElements("blockquote","blockquote"),Ed11y.findElements("iframe","iframe"),Ed11y.findElements("audio","audio"),Ed11y.findElements("video","video"),Ed11y.findElements("table","table"),Ed11y.options.embeddedContent&&Ed11y.findElements("embed",Ed11y.options.embeddedContent)},Ed11y.dismissalKey=function(e){return String(e).substring(0,512)},Ed11y.dismissThis=function(e){var t,i=Ed11y.getOpenTip(),n=i.dataset.ed11yResult,s=Ed11y.results[n][1],n=Ed11y.dismissalKey(Ed11y.results[n][4]),i=(Ed11y.resetClass(["ed11y-hidden-highlight","ed11y-ring-red","ed11y-ring-yellow"]),i.parentNode.removeChild(i),Ed11y.elements.openButton[0]);i.parentNode.removeChild(i),"reset"===e?(delete Ed11y.dismissedAlerts[Ed11y.options.currentPage][s][n],0===Object.keys(Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]).length&&delete Ed11y.dismissedAlerts[Ed11y.options.currentPage][s],0===Object.keys(Ed11y.dismissedAlerts[Ed11y.options.currentPage]).length&&delete Ed11y.dismissedAlerts[Ed11y.options.currentPage]):((i={})[n]=e,void 0===Ed11y.dismissedAlerts[Ed11y.options.currentPage]?((t={})[s]=i,Ed11y.dismissedAlerts[Ed11y.options.currentPage]=t):void 0===Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]?Ed11y.dismissedAlerts[Ed11y.options.currentPage][s]=i:Ed11y.dismissedAlerts[Ed11y.options.currentPage][s][n]=e,Ed11y.options.showDismissed=!1,Ed11y.showDismissed.setAttribute("data-ed11y-showing-hidden",!!Ed11y.options.showDismissed),Ed11y.showDismissed.textContent=Ed11y.options.showDismissed?Ed11y.M.buttonHideHiddenAlertsContent:Ed11y.M.buttonShowHiddenAlertsContent),!1===Ed11y.options.syncedDismissals?localStorage.setItem("ed11ydismissed",JSON.stringify(Ed11y.dismissedAlerts)):(t={dismissPage:Ed11y.options.currentPage,dismissTest:s,dismissKey:n,dismissAction:e},i=new CustomEvent("ed11yDismissalUpdate",{detail:t}),document.dispatchEvent(i)),Ed11y.reset(),Ed11y.checkAll(!1,"show");let o=Ed11y.goto;window.setTimeout(function(){Ed11y.buildJumpList(),0<Ed11y.elements.jumpList.length?(Ed11y.goto=o-1,Ed11y.setCurrentJump(),Ed11y.panelJumpNext.focus()):window.setTimeout(function(){Ed11y.panel.querySelector("#issues-tab").focus()},100)},500,o)},Ed11y.toggleShowDismissals=function(){Ed11y.ignoreAll=!1,Ed11y.options.showDismissed=!Ed11y.options.showDismissed,Ed11y.reset(),Ed11y.checkAll(!1,"show"),Ed11y.showDismissed.setAttribute("data-ed11y-showing-hidden",!!Ed11y.options.showDismissed),Ed11y.showDismissed.textContent=Ed11y.options.showDismissed?Ed11y.M.buttonHideHiddenAlertsContent:Ed11y.M.buttonShowHiddenAlertsContent},Ed11y.dismissHelp=function(e){var t=document.createElement("ul"),i=(t.setAttribute("tabindex","-1"),t.classList.add("help"),Ed11y.options.allowHide&&((i=document.createElement("li")).textContent=Ed11y.M.elementDismissalHelpHide,t.append(i)),Ed11y.options.allowOK&&((i=document.createElement("li")).textContent=Ed11y.M.elementDismissalHelpOK,t.append(i)),document.createElement("li"));i.textContent=Ed11y.M.elementDismissalHelpAll,t.append(i),e.parentElement.append(t),t.focus(),e.remove()},Ed11y.showResults=function(){Ed11y.results?.forEach(function(e,t){Ed11y.results[t][5]&&!Ed11y.options.showDismissed||Ed11y.result(e,t)}),Ed11y.buildJumpList(),document.dispatchEvent(new CustomEvent("ed11yPanelOpened")),Ed11y.alignButtons()},Ed11y.alignButtons=function(){window.setTimeout(function(){let n=window.innerWidth,s=[],o=0,a=0,d=0;Ed11y.elements.jumpList.forEach(e=>{e.hasAttribute("style")&&e.removeAttribute("style");var t=e.getBoundingClientRect();let i=0;t.top>a-30&&t.top<a+30&&t.left>o-30&&t.left<a+30&&(i=30+d),t.left<8?s.push([e,8-t.left,i]):t.left+80>n?s.push([e,n-t.left-80,i]):0<i&&s.push([e,0,i]),o=t.left,a=t.top+i,d=i}),s.forEach(e=>{e[0].style.transform=`translate(${e[1]}px, ${e[2]}px)`}),Ed11y.bodyStyle||Ed11y.paintReady()},0)},Ed11y.paintReady=function(){let i=`ed11y-element-result, ed11y-element-panel {
            ...
            `;Ed11y.roots.forEach(e=>{var t=document.createElement("style");t.textContent=i,e.appendChild(t),Ed11y.options.shadowComponents&&e.querySelectorAll(Ed11y.options.shadowComponents).forEach(e=>{var t=document.createElement("style");t.textContent=i,e.shadowRoot.appendChild(t)})}),Ed11y.roots.forEach(e=>{var t=document.createElement("style");e.appendChild(t)}),Ed11y.bodyStyle=!0},Ed11y.scrollTo=function(e){e=e.getBoundingClientRect().top;e<.25*window.innerHeight?window.scrollBy(0,e-.25*window.innerHeight):e>.75*window.innerHeight&&window.scrollBy(0,e-window.innerHeight+160)},Ed11y.alignTip=function(e,t,i=0){var n=t.shadowRoot.querySelector(".arrow"),s=n.nextElementSibling;let o=i+1;i<3&&Ed11y.options.hiddenHandlers&&0<Ed11y.options.hiddenHandlers.length&&e.getRootNode().host.closest(Ed11y.options.hiddenHandlers)&&window.setTimeout(function(){Ed11y.alignTip(e,t,o)},150,o),s.setAttribute("style",""),n.setAttribute("style","");i=window.scrollY;let a=e.getBoundingClientRect();var d=(a=0===a.top&&0===a.left&&(d=Ed11y.firstVisibleParent(e.getRootNode().host))?d.getBoundingClientRect():a).left+document.body.scrollLeft,l=(t.style.setProperty("top",a.top+i+"px"),t.style.setProperty("left",a.left+"px"),s.offsetWidth),s=s.offsetHeight,r=window.innerWidth,p=i+window.innerHeight;let c="under",u=(a.top+s+i+50>p&&(1.5*l<r&&0<r-(d+l+90)&&a.top+130<window.innerHeight?c="right":a.top>s+15?c="above":1.5*l<r&&0<d-l-50?c="left":a.bottom+s>document.documentElement.clientHeight-50&&(c="above")),0),y=0;"under"===c?(l+a.left+20>r||a.left-20-l/5<0?l-15>a.left?(u=15-a.left,n.style.setProperty("left",Math.max(a.left,15)-9+"px")):(n.style.setProperty("left",l-26+"px"),u=31-l):(u=40-l/5,n.style.setProperty("left",l/5-34+"px")),n.dataset.direction="under",y=50):"above"===c?(y=-1*(s+18),n.style.setProperty("top",s),l+a.left+20>r||a.left-20-l/5<0?l-15>a.left?(u=15-a.left,n.style.setProperty("left",a.left-9+"px")):(n.style.setProperty("left",l-26+"px"),u=31-l):(u=40-l/5,n.style.setProperty("left",l/5-34+"px")),n.dataset.direction="above",n.style.setProperty("top",s+18+"px")):(p<(d=a.top+i+s)&&(r=-1*(y=p-(d+90))+7,r=Math.min(r,s-25),n.style.setProperty("top",r+"px")),"left"===c?(u=0-(l+17),n.style.setProperty("left",l-9+"px"),n.dataset.direction="left"):(u=50,n.dataset.direction="right")),t.style.setProperty("transform",`translate(${u}px, ${y}px)`)},Ed11y.baseCSS=`
      :host{all: initial;} 
      .hidden{display:none;}
