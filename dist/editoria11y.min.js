const ed11yLang={en:{toggleAccessibilityTools:"Toggle accessibility tools",toggleDisabled:"Editorially is disabled.",panelCount0:"No issues detected.",panelCountAllDismissed:"All issues hidden.",panelCount1:"One issue detected.",panelCountMultiple:" issues detected.",panelCountBase:"<span class='count'>No</span> <span class='content-type'>issues detected</span>.",panelControls:"Editorially panel controls",buttonIssuesContent:"Issues",buttonOutlineContent:"Outline",buttonAltsContent:"Alt Text",buttonAboutTitle:"About this tool",buttonPrevContent:"Previous",buttonFirstContent:"First",buttonNextContent:"Next",buttonShowHiddenAlert:"Show 1 hidden alert",buttonShowHiddenAlerts:e=>`Show ${e} hidden alerts`,panelCheckOutline:"<p>Check that this forms <a href='https://accessibility.princeton.edu/how/content/headings'>a complete outline</a>:</p>",panelCheckAltText:"<p>Check <a href='https://accessibility.princeton.edu/how/content/alternative-text'>alt text</a>, <a href='https://accessibility.princeton.edu/how/content/images-text'>images of text</a>, &amp; <a href='https://webaim.org/techniques/captions/'>captions</a>.</p>",panelHelp:`
    ...
    `,elementDismissalHelpAll:"Site-wide changes can be made in Editoria11y's settings.",headingExample:`
        ...
        labelling all content <strong>until the next heading</strong>. Table headers label specific columns or rows within a table.</p> 
         ...
         <p>Consider using sentence case instead, and using bold text or font changes for visual emphasis, or structural formatting like headings for emphasis that will also be announced by screen readers.</p>`},embedVideo:{title:"Manual check: is this video accurately captioned?",tip:()=>`<p>If a recorded video contains speech or meaningful sounds, it must provide captioning.</p>
            ...
            <p>Check to make sure only a small number of items auto-load immediately or while scrolling. Having additional items load on request ("show more") is fine.</p>`},embedCustom:{title:"Manual check: is this embedded content accessible?",tip:()=>"<p>Please make sure images inside this embed have alt text, videos have captions, and interactive components can be <a href='https://webaim.org/techniques/keyboard/'>operated by a keyboard</a>.</p>"}}};class Ed11yElementAlt extends HTMLElement{constructor(){super()}connectedCallback(){var e,t,i,n;this.initialized||(e=this.attachShadow({mode:"open"}),(t=document.createElement("div")).setAttribute("class","wrapper"),i=Ed11y.imageAlts[this.dataset.ed11yImg],(n=document.createElement("span")).textContent=i[2],n.classList.add(i[3]),t.appendChild(n),i=document.createElement("style"),n=`
        :host {
          position: absolute;
        }
        div {
      ...
      `,i.textContent=Ed11y.baseCSS+n+Ed11y.options.altCSS,e.appendChild(i),e.appendChild(t),this.initialized=!0)}}customElements.define("ed11y-element-alt",Ed11yElementAlt);class Ed11yElementPanel extends HTMLElement{constructor(){super()}template(){return`
    ...
    `}connectedCallback(){var e,t,i;this.initialized||(this.panelCSS=`
        :host {
          position: fixed;
          right: 1%;
          bottom: 1%;
      ...
      `,i.textContent=Ed11y.baseCSS+n+Ed11y.options.headingCSS,e.appendChild(i),e.appendChild(t),this.initialized=!0)}}customElements.define("ed11y-element-heading-label",Ed11yElementHeadingLabel);class Ed11yElementResult extends HTMLElement{constructor(){super()}connectedCallback(){var e,t,i,n;this.initialized||(this.open=!1,this.racing=!1,this.setAttribute("style","outline: 0px solid transparent;"),e=this.attachShadow({mode:"open"}),this.resultID=this.dataset.ed11yResult,this.result=Ed11y.results[this.resultID],this.wrapper=document.createElement("aside"),this.dismissable=!!this.result.dismissalKey,this.dismissed=!!this.result.dismissalStatus,this.wrapper.classList.add("wrapper"),this.wrapper.classList.add("ed11y-result"),this.toggle=document.createElement("button"),this.toggle.setAttribute("class","toggle"),t=this.dismissable?Ed11y.M.toggleManualCheck:Ed11y.M.toggleAlert,this.toggle.setAttribute("aria-label",Ed11y.M.toggleAriaLabel(this.resultID,t)),this.toggle.setAttribute("aria-expanded","false"),this.toggle.setAttribute("aria-haspopup","dialog"),this.toggle.setAttribute("data-ed11y-result",this.dataset.ed11yResult),this.toggle.setAttribute("data-ed11y-ready","false"),this.toggle.setAttribute("data-ed11y-race","false"),this.wrapper.appendChild(this.toggle),this.toggle.addEventListener("click",this.toggleClick),this.toggle.addEventListener("mouseover",this.handleHover),this.tipNeedsBuild=!0,t=document.createElement("style"),i=this.toggleImage(),n=`
        :host {
          position: absolute;
          opacity: 0;
          transition: opacity .25s ease-in;
      ...
      `,t.textContent=Ed11y.baseCSS+i+n+Ed11y.options.resultCSS,e.appendChild(t),e.appendChild(this.wrapper),this.initialized=!0)}toggleImage(){let e="";return this.dismissed?(e=`
        .toggle {
