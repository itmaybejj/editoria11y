const ed11yLang={en:{toggleAccessibilityTools:"Toggle accessibility tools",toggleDisabled:"Editorially is disabled.",panelCount0:"No issues detected.",panelCountAllDismissed:"All issues hidden.",panelCount1:"One issue detected.",panelCountMultiple:" issues detected.",panelCountBase:"<span class='count'>No</span> <span class='content-type'>issues detected</span>.",panelControls:"Editorially panel controls",buttonIssuesContent:"Issues",buttonOutlineContent:"Outline",buttonAltsContent:"Alt Text",buttonAboutTitle:"About this tool",buttonPrevContent:"Previous",buttonFirstContent:"First",buttonNextContent:"Next",buttonShowHiddenAlertsContent:"Restore hidden alerts",panelCheckOutline:"<p>Check that this forms <a href='https://accessibility.princeton.edu/how/content/headings'>a complete outline</a>:</p>",panelCheckAltText:"<p>Check <a href='https://accessibility.princeton.edu/how/content/alternative-text'>alt text</a>, <a href='https://accessibility.princeton.edu/how/content/images-text'>images of text</a>, &amp; <a href='https://webaim.org/techniques/captions/'>captions</a>.</p>",panelHelp:`
    ...
    `,elementDismissalHelpAll:"To dismiss an alert site-wide, have an administrator adjust the configuration options to ignore this element.",headingExample:`
        <ul>
            ...
            </ul>`,altAttributeProvided:e=>`<p><strong>This image's alt text is: "${e}"</strong></p>`,altMissing:{title:"Image has no alternative text attribute",tip:()=>`<p>When screen readers encounter an image with no alt attribute at all, they dictate the url of the image file instead, often one letter at a time.
        ...
        <p>To fix: set this image's alternative text to something that describes the link's destination, or add text to the link.</p>
            ...
            `},altLongLinked:{title:"Manual check: very long alternative text in linked image",tip:e=>Ed11y.M.altAttributeProvided(e)+`
        <p>The alt text on a linked image is used to describe the link destination. Links should be brief, clear and concise, as screen reader users often listen to the list of links on the page to find content of interest. Long alternative text inside a link often indicates that the image's text alternative is describing the image instead rather than the link.</p>`},altPartOfLinkWithText:{title:"Manual check: link contains both text and an image",tip:e=>`<p>When a link includes an image, screen readers speak the image's alt text as part of the link.
    ...
    `}buildTip(){this.tipNeedsBuild=!1;var e=document.createElement("ed11y-element-tip");e.setAttribute("data-ed11y-result",this.resultID),document.querySelector("body").insertAdjacentElement("beforeend",e),this.tip=e}toggleTip(e){this.tipNeedsBuild&&this.buildTip(),this.toggle.setAttribute("aria-expanded",e);var t=this.dismissable?"ed11y-ring-yellow":"ed11y-ring-red";this.result[0].classList.toggle(t),!0===e?(document.dispatchEvent(new CustomEvent("ed11yPop",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result")}})),this.closeOtherTips(),this.tip.setAttribute("data-ed11y-action","open"),window.setTimeout(Ed11y.alignTip(this.toggle,this.tip)),Ed11y.elements.jumpList||Ed11y.buildJumpList(),Ed11y.goto=this.getAttribute("data-ed11y-jump-position"),Ed11y.setCurrentJump()):(document.dispatchEvent(new CustomEvent("ed11yShut",{detail:{id:"ed11y-result-"+this.toggle.getAttribute("data-ed11y-result")}})),this.tip.setAttribute("data-ed11y-action","shut")),this.setAttribute("data-ed11y-open",e),this.open=e}static get observedAttributes(){return["data-ed11y-action"]}attributeChangedCallback(e,t,i){this.initialized&&"data-ed11y-action"===e&&"false"!==i&&(e="open"===i,this.setAttribute("data-ed11y-action","false"),this.toggleTip(e))}}customElements.define("ed11y-element-result",Ed11yElementResult);class Ed11yElementTip extends HTMLElement{constructor(){super()}connectedCallback(){if(!this.initialized){this.open=!0,this.setAttribute("style","outline: 0px solid transparent;");var i=this.attachShadow({mode:"open"}),n=(this.resultID=this.dataset.ed11yResult,this.result=Ed11y.results[this.resultID],this.wrapper=document.createElement("div"),this.wrapper.setAttribute("role","dialog"),this.dismissable=!1!==this.result[4],this.wrapper.classList.add("wrapper"),this.wrapper.classList.add("ed11y-result"),this.addEventListener("mouseover",this.handleHover),document.createElement("style")),s=(n.textContent=Ed11y.baseCSS+`
      ...
      `,this.tip=document.createElement("div"),this.tip.classList.add("tip"),this.tip.setAttribute("aria-labelledby","tip-title-"+[this.resultID]),this.heading=document.createElement("div"),this.heading.setAttribute("id","tip-"+this.resultID),this.heading.classList.add("title"),this.heading.setAttribute("tabindex","-1"),this.heading.innerHTML=Ed11y.M[this.result[1]].title,document.createElement("div"));if(s.classList.add("content"),s.innerHTML=this.result[2],this.dismissable&&(Ed11y.options.allowOK||Ed11y.options.allowHide)){var a=document.createElement("div");Ed11y.options.allowOK&&((o=document.createElement("button")).classList.add("dismiss"),o.textContent=Ed11y.M.dismissOkButtonContent,o.setAttribute("title",Ed11y.M.dismissOkButtonTitle),a.append(o),o.addEventListener("click",function(){Ed11y.dismissThis("ok")})),Ed11y.options.allowHide&&((o=document.createElement("button")).classList.add("dismiss"),o.textContent=Ed11y.M.dismissHideButtonContent,o.setAttribute("title",Ed11y.M.dismissHideButtonTitle),a.append(o),o.addEventListener("click",function(){Ed11y.dismissThis("hide")}));let e=document.createElement("button");e.classList.add("dismiss"),e.textContent="?",a.append(e),e.addEventListener("click",function(){Ed11y.dismissHelp(e)}),s.append(a)}var o=document.createElement("button"),a=(o.setAttribute("aria-label","close"),o.classList.add("close"),o.innerHTML="&times;",document.createElement("div")),s=(a.classList.add("arrow"),this.tip.append(this.heading),this.tip.append(o),this.tip.append(s),o.addEventListener("click",e=>{e.preventDefault,this.open&&(e=document.querySelector('ed11y-element-result[data-ed11y-open="true"]'),Ed11y.toggledFrom.focus(),e?.setAttribute("data-ed11y-action","shut"),this.setAttribute("data-ed11y-action","shut"))}),i.appendChild(n),i.appendChild(this.wrapper),document.createElement("div")),o=(s.setAttribute("tabIndex","0"),document.createElement("div"));o.setAttribute("tabindex","0"),this.wrapper.appendChild(s),this.wrapper.appendChild(a),this.wrapper.appendChild(this.tip),this.wrapper.appendChild(o);let e=this.wrapper.querySelectorAll('a, button, [tabindex="0"]'),t=e.length;e[0].addEventListener("focus",()=>{e[t-2].focus()}),e[t-1].addEventListener("focus",()=>{e[1].focus()}),this.initialized=!0}}toggleTip(e){e?this.wrapper.classList.add("open"):this.wrapper.classList.remove("open"),this.setAttribute("data-ed11y-open",e)}toggleImage(){var e=`
      .toggle {
        box-shadow: inset 0 0 0 2px ${Ed11y.color.warning}, inset 0 0 0 3px #444, inset 0 0 0 6px ${Ed11y.color.warning}, 1px 1px 5px 0 rgba(0,0,0,.5);
        background: ${Ed11y.color.warning};
        color: #333;
