const ed11yLang={en:{toggleAccessibilityTools:"Toggle accessibility tools",toggleDisabled:"Editorially is disabled.",panelCount0:"No issues detected.",panelCountAllDismissed:"All issues hidden.",panelCount1:"One issue detected.",panelCountMultiple:" issues detected.",panelCountBase:"<span class='count'>No</span> <span class='content-type'>issues detected</span>.",panelControls:"Editorially panel controls",buttonIssuesContent:"Issues",buttonOutlineContent:"Outline",buttonAltsContent:"Alt Text",buttonAboutTitle:"About this tool",buttonPrevContent:"Previous",buttonFirstContent:"First",buttonNextContent:"Next",buttonShowHiddenAlertsContent:"Show dismissed alerts",buttonHideHiddenAlertsContent:"Hide dismissed alerts",panelCheckOutline:"<p>Check that this forms <a href='https://accessibility.princeton.edu/how/content/headings'>a complete outline</a>:</p>",panelCheckAltText:"<p>Check <a href='https://accessibility.princeton.edu/how/content/alternative-text'>alt text</a>, <a href='https://accessibility.princeton.edu/how/content/images-text'>images of text</a>, &amp; <a href='https://webaim.org/techniques/captions/'>captions</a>.</p>",panelHelp:`
    ...
    `}connectedCallback(){var e,t,i;this.initialized||(this.setAttribute("style","outline: 0;"),e=this.attachShadow({mode:"open"}),(t=document.createElement("div")).setAttribute("class","wrapper"),t.innerHTML=this.template(),(i=document.createElement("style")).textContent=Ed11y.baseCSS+`
      ...
      `,e.appendChild(i),e.appendChild(t),Ed11y.panel=t,Ed11y.panelToggle=t.querySelector("#toggle"),Ed11y.panelMessage=t.querySelector(".content-text"),Ed11y.panelCount=t.querySelector(".count"),Ed11y.panelJumpNext=t.querySelector(".jump.next"),Ed11y.panelJumpPrev=t.querySelector(".jump.prev"),Ed11y.panelJumpNext.addEventListener("click",this.jumpTo),Ed11y.panelJumpPrev.addEventListener("click",this.jumpTo),Ed11y.showDismissed=t.querySelector("#show-hidden"),Ed11y.showDismissed.addEventListener("click",function(){Ed11y.toggleShowDismissals()}),Ed11y.announce=t.querySelector(".announce"),Ed11y.panelTabs=t.querySelectorAll(".buttonbar button"),Ed11y.panelTabs.forEach(e=>{e.addEventListener("click",this.handleBarClick)}),this.initialized=!0)}jumpTo(e){e.preventDefault(),Ed11y.toggledFrom=this,Ed11y.resetClass(["ed11y-hidden-highlight"]),Ed11y.elements.jumpList||Ed11y.buildJumpList();var e=parseInt(this.dataset.ed11yGoto),e=Ed11y.elements.jumpList[e],t=(Ed11y.scrollTo(e),e.setAttribute("data-ed11y-action","open"),Ed11y.results[e.getAttribute("data-ed11y-result")]),t=t[3];let i,n=("beforebegin"===t?i=Ed11y.nextUntil(e,":not(ed11y-element-result)"):"afterbegin"===t&&(i=e.parentElement),100);0<Ed11y.options.hiddenHandlers.length&&i.closest(Ed11y.options.hiddenHandlers)&&(n=333,document.dispatchEvent(new CustomEvent("ed11yShowHidden",{detail:{result:e.getAttribute("data-ed11y-result")}}))),window.setTimeout(function(e,t){let i=!1,n;Ed11y.options.checkVisible&&!Ed11y.visible(t)?(i=Ed11y.firstVisibleParent(t),n=Ed11y.M.jumpedToInvisibleTip):t.closest('[aria-hidden="true"]')&&(i=(i=t.closest('[aria-hidden="true"]')).closest(':not([aria-hidden="true"])'),n=Ed11y.M.jumpedToAriaHiddenTip),i&&(alert(n),i.classList.add("ed11y-hidden-highlight")),Ed11y.scrollTo(e),document.querySelector('ed11y-element-tip[data-ed11y-open="true"]').shadowRoot.querySelector(".close").focus()},n,e,i)}handleBarClick(e){e.preventDefault();var t=e.currentTarget.getAttribute("id");switch(t){case"toggle":Ed11y.togglePanel();break;case"minimize":Ed11y.minimize();break;default:Ed11y.switchPanel(t)}}static get observedAttributes(){return["style"]}attributeChangedCallback(e,t,i){"style"===e&&!0===this.initialized&&(this.shadowRoot?.querySelector("div")).setAttribute("style",i)}}customElements.define("ed11y-element-panel",Ed11yElementPanel);class Ed11yElementHeadingLabel extends HTMLElement{constructor(){super()}connectedCallback(){var e,t,i,n;this.initialized||(e=this.attachShadow({mode:"open"}),(t=document.createElement("div")).setAttribute("class","wrapper"),n=this.dataset.ed11yHeadingOutline,n=Ed11y.headingOutline[n],t.innerHTML="H"+n[1],i=!!n[2],t.classList.add("issue"+i),i=document.createElement("style"),n=Math.max(52-8*n[1],12),i.textContent=Ed11y.baseCSS+`
        :host {
          position: absolute;
          margin-top:-.5em;
        }
      ...
      `,e.appendChild(t),e.appendChild(this.wrapper),this.initialized=!0)}toggleImage(){let e="";return e=this.dismissed?`
        .toggle {
      ...
      .toggle::before {
        content: "!";
      }`}handleHover(e){e.preventDefault();let t=this.getRootNode().host;"false"===t.getAttribute("data-ed11y-open")&&!1===t.racing&&(t.racing=!0,t.toggleTip(!0),Ed11y.toggledFrom=this,window.setTimeout(function(){t.racing=!1},250,t))}toggleClick(e){e.preventDefault();let t=this.getRootNode().host;!1===t.racing&&(t.racing=!0,Ed11y.toggledFrom=this,e="false"===t.getAttribute("data-ed11y-open")?"open":"close",t.setAttribute("data-ed11y-action",e),"open"==e&&window.setTimeout(function(){document.querySelector('ed11y-element-tip[data-ed11y-open="true"]')?.shadowRoot.querySelector(".close").focus()},500),window.setTimeout(function(){t.racing=!1},250,t))}closeOtherTips(){Ed11y.findElements("openTips",'[data-ed11y-open="true"]'),Ed11y.elements.openTips&&Array.from(Ed11y.elements.openTips).forEach(e=>{e.setAttribute("data-ed11y-action","close")})}tipDOM(e,t,i){return`>
