...
(function (global, factory) {
  ...
  var lt = {
    ...
    strings: {
      ...
      OUTLINE: 'Struktūra',
      READABILITY_DESC:
        'Skirtuke <strong>Struktūra</strong> rodomas skaitomumo balas, padedantis įvertinti skaitymo sudėtingumą.',
      TITLE: 'Pavadinimas',
      ALT: 'ALT',
      IMAGES: 'Vaizdai',
      EDIT: 'Redaguoti',
      ...
      DEVELOPER_DESC:
        'Tikrina problemas, kurioms išspręsti gali prireikti kodavimo žinių, pavyzdžiui, HTML atributus, formas ir kt.',
      ...
      NOT_VISIBLE:
        'Elementas, kurį bandote peržiūrėti, nėra matomas; jis gali būti paslėptas arba būti akordeono ar skirtuko komponento viduje.',
      MISSING_ROOT:
        'Buvo patikrintas viso puslapio prieinamumas, nes tikslinė sritis <code>%(root)</code> neegzistuoja.',
      MISSING_READABILITY_ROOT:
        'Skaitymo įvertinimas pagrįstas turinio sritimi <code>%(fallback)</code>, nes tikslinė sritis <code>%(root)</code> neegzistuoja.',
      SKIP_TO_PAGE_ISSUES: 'Pereiti prie puslapio klausimų',
      CONSOLE_ERROR:
        'Atsiprašome, bet šiame puslapyje yra problema su prieinamumo tikrintuvu. Ar galite apie tai <a href="%(link)">pranešti per šią formą</a> arba <a href="%(link)">GitHub</a>?',
      APPEARANCE: 'Išvaizda',
      ...
      DISMISSED: 'Atmestas',
      DISMISS_REMINDER:
        'Atkreipkite dėmesį, kad įspėjimai yra tik <strong>laikinai</strong> atmesti. Ištrynus naršymo istoriją ir slapukus, bus atkurtas visas anksčiau atmestas įspėjimas visose puslapiuose.',
      ...
      COLOUR_FILTER_MESSAGE:
        'Patikrinkite, ar nėra elementų, kuriuos sunku pastebėti arba atskirti nuo kitų spalvų.',
      ...
      HEADING_SKIPPED_LEVEL:
        'Antraštės neturėtų praleisti lygių arba peršokti nuo <strong>Antraštės %(PREV_LEVEL)</strong> prie <strong {C}>Antraštės %(LEVEL)</strong>, nes tai sutrikdo turinio tvarką ir hierarchiją, todėl sunkiau sekti. <hr> Jei <strong {C}>%(HEADING)</strong> patenka į <strong>%(PREV_HEADING)</strong> skyrių, apsvarstykite galimybę formatuoti ją kaip <strong>Antraštė %(LEVEL)</strong>.',
      HEADING_EMPTY:
        'Rasta tuščia antraštė! Norėdami ištaisyti, ištrinkite šią eilutę arba pakeiskite jos formatą iš <strong {C}>Heading %(level)</strong> į <strong>Normal</strong> arba <strong>Paragraph</strong>.',
      HEADING_LONG:
        'Antraštė ilga! Antraštės turėtų būti naudojamos turiniui tvarkyti ir struktūrai perteikti. Jos turėtų būti trumpos, informatyvios ir unikalios. Prašome, kad antraštės būtų trumpesnės nei %(MAX_LENGTH) ženklų (ne ilgesnės nei sakinys). <hr> <strong {B}>%(HEADING_LENGTH) Ženklai</strong>',
      HEADING_FIRST:
        'Pirmoji puslapio antraštė paprastai turėtų būti 1 arba 2 antraštė. 1 antraštė turėtų būti pagrindinio turinio skyriaus pradžia ir yra pagrindinė antraštė, apibūdinanti bendrą puslapio tikslą. Sužinokite daugiau apie <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">Galvutės struktūrą.</a>',
      HEADING_MISSING_ONE:
      ...
      LINK_EMPTY_LABELLEDBY:
        'Nuoroda turi <code>aria-labelledby</code> reikšmę, kuri yra tuščia arba neatitinka kito puslapio elemento atributo <code>id</code> reikšmės.',
      LINK_EMPTY_NO_LABEL:
        'Nuorodoje nėra įskaitomo teksto, kuris būtų matomas ekrano skaitytuvams ir kitoms pagalbinėms technologijoms. Ištaisyti: <ul><li>Pridėkite glaustą tekstą, kuriame būtų aprašyta, kur nuoroda veda.</li><li>Jeigu tai yra <a href="https://a11y-101.com/development/icons-and-links">paveiksliuko arba SVG nuoroda,</a> greičiausiai trūksta aprašomosios etiketės.</li><li>Jeigu manote, kad ši nuoroda yra klaida dėl kopijavimo ir įkėlimo klaidos, apsvarstykite galimybę ją ištrinti.</li></ul>',
      LINK_STOPWORD:
        'Nuorodos tekstas gali būti nepakankamai aiškus be konteksto: <strong {C}>%(ERROR)</strong>',
      LINK_STOPWORD_ARIA:
        'Nors buvo pateiktas prieinamas pavadinimas, apsvarstykite galimybę peržiūrėti matomą nuorodos tekstą. Tokios frazės kaip &quot;<strong {C}>%(ERROR)</strong>&quot; nėra prasmingos.',
      LINK_TIP:
        '<hr> <strong>Patarimas!</strong> Naudokite aiškų ir unikalų nuorodos tekstą, kuris apibūdintų nuorodos tikslą, paprastai – puslapio ar dokumento pavadinimą.',
      LINK_CLICK_HERE:
        'Frazė "spustelėkite" arba "spustelėkite čia" sutelkia dėmesį į pelės mechaniką, nors daugelis žmonių nenaudoja pelės arba gali žiūrėti šią svetainę mobiliuoju įrenginiu. Apsvarstykite kito, su užduotimi susijusio veiksmažodžio naudojimą.',
      DUPLICATE_TITLE:
        'Nuorodų ir paveikslėlių atributas <code>title</code> yra skirtas pateikti papildomą informaciją ir turėtų būti <strong>skirtingas</strong> nei tekstas ar alt tekstas. Pavadinimo tekstas rodomas, kai pelės žymeklis užvedamas ant elemento, bet nepasiekiamas klaviatūra ar lietimui jautriu įvestimi. Apsvarstykite <a href="https://www.a11yproject.com/posts/title-attributes/">visai atsisakyti title atributo.</a>',
      LINK_SYMBOLS:
        'Venkite naudoti simbolius kaip kvietimą veikti nuorodos tekste, nebent jie yra paslėpti nuo pagalbinių technologijų. Ekrano skaitytuvai gali garsiai perskaityti simbolius, o tai gali būti klaidinantis. Apsvarstykite jų pašalinimą: <strong {C}>%(ERROR)</strong>',
      LINK_URL:
        'Ilgesni, mažiau suprantami URL adresai, naudojami kaip nuorodos tekstas, gali būti sunkiai suprantami naudojantis pagalbinėmis technologijomis. Daugeliu atvejų vietoj URL adreso geriau naudoti žmogui suprantamą tekstą. Trumpi URL adresai (pavyzdžiui, svetainės pagrindinis puslapis) yra tinkami.',
      LINK_DOI:
        'Interneto puslapiuose arba tik internete esančiuose ištekliuose <a href="https://apastyle.apa.org/style-grammar-guidelines/paper-format/accessibility/urls#:~:text=descriptive%20links">APA stiliaus vadove</a> rekomenduojama naudoti aprašomąsias nuorodas, aplink kūrinio pavadinimą nurodant jo URL arba DOI. Ilgesni, mažiau suprantami URL adresai, naudojami kaip nuorodos tekstas, gali būti sunkiai suprantami naudojantis pagalbinėmis technologijomis.',
      LINK_NEW_TAB:
      ...
      // Images
      ALT_UNPRONOUNCEABLE:
        'Alternatyvus tekstas turi tik neištariamus simbolius ir/arba tarpus. Ekrano skaitytuvai praneš apie vaizdą ir tada sustos. Jei vaizdas dekoratyvinis, užtikrinkite, kad alternatyviame tekste nebūtų tarpų. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_ALT_UNPRONOUNCEABLE:
        'Šio susieto vaizdo alternatyvus tekstas turi tik neištariamus simbolius ir/arba tarpus. Ekrano skaitytuvai praneš apie vaizdą ir tada sustos. Įsitikinkite, kad alternatyvus tekstas aprašo nuorodos paskirtį. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      MISSING_ALT_LINK_HAS_TEXT:
        'Paveikslas naudojamas kaip nuoroda su aplinkiniu tekstu, nors atributas alt turėtų būti pažymėtas kaip dekoratyvinis arba nulinis.',
      MISSING_ALT_LINK:
        'Paveiksliukas naudojamas kaip nuoroda, bet nėra teksto alt! Užtikrinkite, kad alt tekste būtų aprašyta, kur nukreipia nuoroda.',
      MISSING_ALT:
        'Trūksta alt teksto! Jei paveikslėlis perteikia istoriją, nuotaiką ar svarbią informaciją, būtinai jį aprašykite.',
      LINK_ALT_FILE_EXT:
        'Alternatyvus tekstas neturėtų apimti failų plėtinių ar atvaizdų matmenų. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. Pašalinti: <strong {C}>%(ERROR)</strong>.<hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_PLACEHOLDER_ALT:
        'Rastas ne aprašomasis arba pakaitinis alt tekstas susietame paveikslėlyje. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. Pakeiskite šį alt tekstą. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_SUS_ALT:
        'Pagalbinėse technologijose jau nurodoma, kad tai yra paveikslėlis, todėl &quot;<strong {C}>%(ERROR)</strong>&quot; gali būti nereikalingas. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_FILE_EXT:
        'Alternatyvus tekstas neturėtų apimti failų plėtinių ar atvaizdų matmenų. Jei vaizdas perteikia istoriją, nuotaiką ar svarbią informaciją, būtinai aprašykite vaizdą. Pašalinti: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_PLACEHOLDER:
        'Rastas neaprašytas arba pakaitinis alt tekstas. Pakeiskite šį alt tekstą į prasmingesnį. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      SUS_ALT:
        'Pagalbinėse technologijose jau nurodoma, kad tai yra paveikslėlis, todėl &quot;<strong {C}>%(ERROR)</strong>&quot; gali būti nereikalingas. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_NO_ALT_TEXT:
        'Nuorodoje esantis paveikslėlis pažymėtas kaip dekoratyvinis, o nuorodos teksto nėra. Prie paveikslėlio pridėkite alt tekstą, kuriame būtų aprašyta nuorodos paskirtis.',
      LINK_IMAGE_TEXT:
        'Paveikslas pažymėtas kaip dekoratyvinis, nors nuorodoje aplinkinis tekstas naudojamas kaip aprašomoji etiketė.',
      LINK_IMAGE_LONG_ALT:
        'Susieto paveikslėlio Alt teksto aprašymas yra <strong>per ilgas</strong>. Susietų paveikslėlių alt tekstas turėtų apibūdinti, kur nukreipia nuoroda, o ne pažodinis paveikslėlio aprašymas. <strong>Svarstykite galimybę kaip alt tekstą naudoti puslapio, į kurį nukreipia nuoroda, pavadinimą.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Ženklai</strong> <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT:
        'Paveikslėlio nuorodoje yra teksto alt. <strong>Ar alt tekste aprašoma, kur nukreipia nuoroda?</strong> Apsvarstykite galimybę kaip alt tekstą naudoti puslapio, į kurį nukreipia nuoroda, pavadinimą. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT_AND_TEXT:
        'Paveikslėlio nuorodoje yra <strong>ir alt tekstas, ir aplink esantis nuorodos tekstas.</strong> Jei šis paveikslėlis yra dekoratyvinis ir naudojamas kaip funkcinė nuoroda į kitą puslapį, apsvarstykite galimybę pažymėti paveikslėlį kaip dekoratyvinį arba nulinį - aplink esančio nuorodos teksto turėtų pakakti. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Prieinamas pavadinimas</strong> {L} <strong {C}>%(TEXT)</strong>',
      IMAGE_FIGURE_DECORATIVE:
        'Vaizdas pažymėtas kaip <strong>dekoratyvinis</strong>, todėl pagalbinės technologijos jį ignoruos. <hr> Nors buvo pateikta <strong>antrašė</strong>, daugeliu atvejų paveikslėlis taip pat turėtų turėti alt tekstą. <ul><li>Alt tekste turėtų būti glaustai aprašyta, kas yra paveikslėlyje.</li><li>Paprastai antraštėje turėtų būti pateiktas kontekstas, kad paveikslėlis būtų susietas su aplinkiniu turiniu, arba atkreiptas dėmesys į tam tikrą informaciją.</li></ul>Sužinokite daugiau: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a>',
      IMAGE_FIGURE_DUPLICATE_ALT:
        'Nenaudokite tų pačių žodžių ir alt, ir antraštės tekstui. Ekrano skaitytuvai informaciją skelbs du kartus. <ul><li>Alt tekste turėtų būti glaustai aprašyta, kas yra paveikslėlyje.</li><li>Tapatybėje paprastai turėtų būti pateiktas kontekstas, kad paveikslėlis būtų susietas su aplinkiniu turiniu arba atkreiptas dėmesys į tam tikrą informaciją.</li></ul> Sužinokite daugiau: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      IMAGE_DECORATIVE:
        'Vaizdas pažymėtas kaip <strong>dekoratyvinis</strong>, todėl pagalbinės technologijos jį ignoruos. Jei vaizdas perteikia istoriją, nuotaiką ar svarbią informaciją - būtinai pridėkite alt tekstą.',
      ...
      ALT_MAYBE_BAD:
        'Alt tekstas gali nesuteikti naudingos informacijos arba būti neaprašomasis. Patobulinkite šį alt tekstą: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

      // Form labels
      LABELS_MISSING_IMAGE_INPUT:
        'Nėra paveikslėlio mygtuko alt teksto. Pridėkite alt tekstą ir pateikite prieinamą pavadinimą. Pavyzdžiui: <em>Ieškoti</em> arba <em>Pateikti</em>.',
      LABELS_INPUT_RESET:
        'Atstatymo mygtukai turėtų būti <strong>nenaudojami, nebent jų specialiai reikia, nes juos lengva įjungti per klaidą. <hr> <strong>Tipas!</strong> Sužinokite, kodėl <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">Mygtukai "Reset" ir "Cancel" kelia patogumo problemų.</a>',
      LABELS_ARIA_LABEL_INPUT:
        'Įvestis turi prieinamą pavadinimą, tačiau užtikrinkite, kad būtų matoma ir etiketė. <hr> <strong {B}>Prieinamas pavadinimas</strong> <strong {C}>%(TEXT)</strong>',
      LABELS_NO_FOR_ATTRIBUTE:
        'Su šia įvestimi nėra susieta jokia etiketė. Pridėkite <code>for</code> atributą prie etiketės, atitinkančios šios įvesties <code>id</code>. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      ...
      EMBED_UNFOCUSABLE:
        '<code>&lt;iframe&gt;</code> su elementais, į kuriuos negalima sutelkti dėmesio, neturėtų turėti <code>tabindex="-1"</code>. Įterptasis turinys nebus pasiekiamas naudojant klaviatūrą.',
      ...
      QA_UNDERLINE:
        'Pabrauktą tekstą galima supainioti su nuorodomis. Apsvarstykite galimybę naudoti kitą stilių, pavyzdžiui, <code>&lt;strong&gt;</code><strong>strong svarba</strong><code>&lt;/strong&gt;</code> arba <code>&lt;em&gt;</code><em>pabrėžimas</em><code>&lt;/em&gt;</code>.',
      QA_SUBSCRIPT:
        'Subskripcijos ir superskripcijos formatavimo parinktys turėtų būti naudojamos tik teksto padėčiai pakeisti dėl tipografinių susitarimų ar standartų. Jos neturėtų būti <strong>nenaudojamos</strong> tik pateikimo ar išvaizdos tikslais. Formatuojant ištisus sakinius kyla skaitomumo problemų. Tinkami naudojimo atvejai būtų eksponentų, eilės numerių, pavyzdžiui, 4<sup>th</sup> vietoj fourth, ir cheminių formulių (pvz., H<sub>2</sub>O) rodymas.',
      QA_NESTED_COMPONENTS:
        'Venkite interaktyvių išdėstymo komponentų įdėjimo į vieną kitą, pavyzdžiui, akordeonų įdėjimo į skirtukus arba skirtukų įdėjimo į akordeonus. Tai gali sudėtinginti navigaciją, padidinti kognityvinę apkrovą ir sukelti turinio ignoravimą.',
      QA_JUSTIFY:
        'Venkite naudoti lygiuotą tekstą, kuris sulygiuotas tiek prie kairiojo, tiek prie dešiniojo krašto. Tai gali būti sunkiai skaitoma dėl nevienodų tarpų tarp žodžių. Naudokite kairiuoju kraštu sulygiuotą tekstą, kad užtikrintumėte geresnį skaitomumą.',
      QA_SMALL_TEXT:
      ...
      // Developer
      DUPLICATE_ID:
        'Rastas <strong>dvigubas ID</strong>. Yra žinoma, kad pasikartojančio ID klaidos sukelia problemų pagalbinėms technologijoms, kai jos bando sąveikauti su turiniu. Prašome pašalinti arba pakeisti šį ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      UNCONTAINED_LI:
        'Visi <code>&lt;li&gt;</code> sąrašo elementai turi būti įdėti į <code>&lt;ul&gt;</code> nesurūšiuotus arba <code>&lt;ol&gt;</code> surūšiuotus elementus. Ši struktūra padeda ekranų skaitytuvams tiksliai paskelbti sąrašą ir jo elementus.',
      TABINDEX_ATTR: 'Elementas neturėtų turėti <code>tabindex</code> atributo, didesnio nei 0.',

      // Meta checks
      META_LANG:
        'Puslapio kalba nedeklaruota! Prašome <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklaruoti kalbą HTML žymėje.</a>',
      META_TITLE:
        'Trūksta puslapio pavadinimo! Pateikite <a href="https://developer.mozilla.org/lt/docs/Web/HTML/Element/title">puslapio pavadinimą.</a>',
      META_SCALABLE:
        'Pašalinkite <code>user-scalable="no"</code> parametrą iš <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">meta žymos vaizde</a>, kad būtų galima priartinti.',
      META_MAX:
      ...
      BTN: 'mygtukas',
      BTN_TIP:
        'Sužinokite, kaip sukurti <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">prieinamą mygtuką.</a>',
      BTN_ROLE_IN_NAME:
      ...
      CONTRAST_WARNING:
        'Šio teksto kontrastas nežinomas ir turi būti patikrintas rankiniu būdu. Įsitikinkite, kad tekstas ir fonas turi stiprų kontrastą.',
      CONTRAST_ERROR_GRAPHIC:
        'Grafika neturi pakankamo kontrasto su fono spalva, todėl ją sunku matyti.',
      CONTRAST_WARNING_GRAPHIC:
        'Šios grafikos kontrastas nežinomas ir turi būti patikrintas rankiniu būdu.',
      CONTRAST_TIP_GRAPHIC:
        'Grafikose ir naudotojo sąsajos elementuose turi būti bent 3:1 kontrasto santykis.',
      CONTRAST_OPACITY: 'Padidinkite nepralaidumą, kad geriau matytumėte.',
      CONTRAST_APCA:
        'Tai nėra pakankamai kontrastinga jokių tekstų dydžiams. Apsvarstykite galimybę naudoti šią spalvų ir teksto dydžio kombinaciją?',
      ...
      CONTRAST_PLACEHOLDER:
        'Šio įvesties laukelio užpildymo tekstas neturi pakankamo kontrasto su fonu, todėl jį sunku skaityti.',
      CONTRAST_PLACEHOLDER_UNSUPPORTED:
        'Šio vietos rezervavimo teksto kontrastas nežinomas ir turi būti peržiūrėtas rankiniu būdu. Įsitikinkite, kad tekstas ir fonas turi stipriai kontrastuojančias spalvas.',
      CONTRAST_INPUT:
        'Šio įvesties laukelio tekstas neturi pakankamo kontrasto su fonu, todėl jį sunku skaityti.',
      CONTRAST: 'Kontrastas',
      UNKNOWN: 'Nežinomas',
      FG: 'Priekinis planas',
      BG: 'Fonas',
      NO_SUGGESTION:
        'Nėra prieinamos kombinacijos, keičiant tik teksto spalvą. Pabandykite pakeisti fono spalvą.',
    },
  };
