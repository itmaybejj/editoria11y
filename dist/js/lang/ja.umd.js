(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_IMAGE_ALT_AND_TEXT: `<p><span style="</span>Alt を含むリンク：<br>"<strong>%(LINK)</strong>"</p><p><strong class="badge">修正方法</strong> alt が不要または冗長な場合は修正または削除してください。</p>${why.imageLinks}`,
