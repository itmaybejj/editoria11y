...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Sa11yLangRo = factory());
  ...
  var ro = {
    ...
    strings: {
      ...
      OUTLINE: 'Schiță',
      READABILITY_DESC:
        'Afișează scorul de lizibilitate în fila <strong>Schiță</strong> pentru a ajuta la evaluarea dificultății de citire.',
      TITLE: 'Titlu',
      ALT: 'ALT',
      IMAGES: 'Imagini',
      EDIT: 'Editare',
      ...
      DEVELOPER_DESC:
        'Verifică problemele care pot necesita cunoștințe de programare pentru a fi remediate, cum ar fi atributele HTML, formularele și altele.',
      ...
      NOT_VISIBLE:
        'Elementul pe care încercați să îl vizualizați nu este vizibil; este posibil să fie ascuns sau să se afle în interiorul unui acordeon sau al unei componente de tablă.',
      MISSING_ROOT:
        'Pagina completă a fost verificată din punct de vedere al accesibilității deoarece zona țintă <code>%(root)</code> nu există.',
      ...
      DISMISSED: 'Respins',
      DISMISS_REMINDER:
        'Vă rugăm să rețineți că alertele sunt doar <strong>temporar</strong> respinse. Ștergerea istoricului browserului și a cookie-urilor va restabili toate alertele respinse anterior pe toate paginile.',
      ...
      COLOUR_FILTER_MESSAGE:
        'Verificați dacă există elemente care sunt greu de perceput sau de distins în raport cu alte culori.',
      RED_EYE: 'Roșu orb.',
      GREEN_EYE: 'Orb verde.',
      BLUE_EYE: 'Orb albastru.',
      MONO_EYE: 'Orbitor roșu, albastru și verde.',
      COLOUR_FILTER_HIGH_CONTRAST:
        'Filtrele de culoare nu funcționează în modul de contrast ridicat.',

      // Alternative text stop words
      SUS_ALT_STOPWORDS: ['imagine', 'grafic', 'imagine', 'fotografie'],
      ...
      HEADING_SKIPPED_LEVEL:
        'Titlurile nu ar trebui să sară peste niveluri sau să treacă de la <strong>Titlu %(PREV_LEVEL)</strong> la <strong {C}>Titlu %(LEVEL)</strong>, deoarece acest lucru perturbă ordinea și ierarhia conținutului, îngreunând urmărirea. <hr> Dacă <strong {C}>%(HEADING)</strong> se încadrează în secțiunea <strong>%(PREV_HEADING)</strong>, luați în considerare formatarea acestuia ca <strong>Titlu %(LEVEL)</strong> în schimb.',
      HEADING_EMPTY:
        'Rubrica goală găsită! Pentru a remedia problema, ștergeți această linie sau schimbați formatul acesteia din <strong {C}>Antet %(level)</strong> în <strong>Normal</strong> sau <strong>Paragraf</strong>.',
      HEADING_LONG:
      ...
      LINK_EMPTY_LABELLEDBY:
        'Linkul are o valoare pentru <code>aria-labelledby</code> care este goală sau nu se potrivește cu valoarea atributului <code>id</code> al altui element de pe pagină.',
      LINK_EMPTY_NO_LABEL:
        'Linkul nu are un text vizibil pentru cititorii de ecran și alte tehnologii de asistență. Pentru a remedia problema: <ul><li>Adaugați un text concis care să descrie unde vă duce linkul.</li><li>Dacă este un <a href="https://a11y-101.com/development/icons-and-links">link cu pictograme sau SVG,</a> este probabil să lipsească o etichetă descriptivă.</li><li>Dacă credeți că acest link este o eroare datorată unui bug de copy/paste, luați în considerare ștergerea lui.</li></ul>',
      LINK_STOPWORD:
        'Textul linkului poate să nu fie suficient de descriptiv în afara contextului: <strong {C}>%(ERROR)</strong>',
      LINK_STOPWORD_ARIA:
        'Deși a fost furnizat un nume accesibil, luați în considerare revizuirea textului vizibil al linkului. Expresii precum &quot;<strong {C}>%(ERROR)</strong>&quot; nu sunt semnificative.',
      LINK_TIP:
        '<hr> <strong>Sfat!</strong> Utilizați un text de link clar și unic care descrie destinația linkului, de obicei titlul paginii sau al documentului.',
      LINK_CLICK_HERE:
        'Expresia "click" sau "faceți clic aici" pune accent pe utilizarea mouse-ului, deși multe persoane nu folosesc mouse-ul sau pot vizualiza acest site pe un dispozitiv mobil. Luați în considerare utilizarea unui alt verb care se referă la sarcină.',
      DUPLICATE_TITLE:
        'Atributul <code>title</code> pentru linkuri și imagini este destinat să ofere informații suplimentare și ar trebui să fie <strong>diferențiat</strong> de textul sau textul alternativ. Textul titlului apare când treceți cu mouse-ul peste un element, dar nu este accesibil cu tastatura sau prin atingere. Luați în considerare <a href="https://www.a11yproject.com/posts/title-attributes/">evitarea completă a atributului title.</a>',
      LINK_SYMBOLS:
        'Evitați utilizarea simbolurilor ca apeluri la acțiune în textul linkurilor, cu excepția cazului în care sunt ascunse de tehnologiile asistive. Cititoarele de ecran pot citi simbolurile cu voce tare, ceea ce poate fi derutant. Luați în considerare eliminarea lor: <strong {C}>%(ERROR)</strong>',
      LINK_URL:
        'URL-urile mai lungi și mai puțin inteligibile folosite ca text de link ar putea fi dificil de înțeles atunci când sunt accesate cu ajutorul tehnologiei de asistență. În cele mai multe cazuri, este mai bine să folosiți un text lizibil pentru oameni în locul URL-ului. URL-urile scurte (cum ar fi pagina de pornire a unui site) sunt în regulă.',
      LINK_DOI:
      ...
      // Images
      ALT_UNPRONOUNCEABLE:
        'Textul alternativ conține doar simboluri impronunțabile și/sau spații. Cititoarele de ecran vor anunța imaginea și apoi se vor opri. Dacă imaginea este decorativă, asigurați-vă că nu există spații în textul alternativ. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_ALT_UNPRONOUNCEABLE:
        'Textul alternativ din această imagine legată conține doar simboluri impronunțabile și/sau spații. Cititoarele de ecran vor anunța imaginea și apoi se vor opri. Asigurați-vă că textul alternativ descrie destinația linkului. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      MISSING_ALT_LINK_HAS_TEXT:
        'Imaginea este utilizată ca link cu text în jur, deși atributul alt ar trebui să fie marcat ca fiind decorativ sau nul.',
      MISSING_ALT_LINK:
        'Imaginea este folosită ca link, dar lipsește textul alt! Vă rugăm să vă asigurați că textul alternativ descrie unde vă duce link-ul.',
      MISSING_ALT:
        'Lipsește alt text! Dacă imaginea transmite o poveste, o stare de spirit sau o informație importantă, nu uitați să descrieți imaginea.',
      LINK_ALT_FILE_EXT:
        'Textul alternativ nu trebuie să includă extensii de fișiere sau dimensiuni ale imaginii. Asigurați-vă că textul alternativ descrie destinația linkului și nu o descriere literală a imaginii. Eliminați: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_PLACEHOLDER_ALT:
        'Text alt necorespunzător sau cu caracter de locțiitor într-o imagine legată găsit. Asigurați-vă că textul alternativ descrie destinația linkului și nu o descriere literală a imaginii. Înlocuiți următorul text alt. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>.',
      LINK_SUS_ALT:
        'Tehnologiile asistive indică deja că aceasta este o imagine, astfel încât &quot;<strong {C}>%(ERROR)</strong>&quot; poate fi redundant. Asigurați-vă că textul alt descrie destinația linkului, nu o descriere literală a imaginii. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_FILE_EXT:
        'Textul alternativ nu trebuie să includă extensii de fișiere sau dimensiuni ale imaginii. Dacă imaginea transmite o poveste, o stare de spirit sau o informație importantă, nu uitați să descrieți imaginea. Eliminați: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_PLACEHOLDER:
        'A fost găsit un text alt nedescriptat sau un text alt de tip placeholder. Înlocuiți următorul text alt cu ceva mai semnificativ. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>.',
      SUS_ALT:
        'Tehnologiile asistive indică deja că aceasta este o imagine, astfel încât &quot;<strong {C}>%(ERROR)</strong>&quot; poate fi redundant. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_NO_ALT_TEXT:
        'Imaginea din cadrul linkului este marcată ca fiind decorativă și nu există text de link. Vă rugăm să adăugați la imagine un text alt care să descrie destinația linkului.',
      LINK_IMAGE_TEXT:
        'Imaginea este marcată ca fiind decorativă, deși link-ul folosește textul din jur ca etichetă descriptivă.',
      LINK_IMAGE_LONG_ALT:
        'Descrierea textului Alt de pe o imagine legată este <strong>prea lungă</strong>. Textul alt de pe imaginile cu link ar trebui să descrie unde duce link-ul, nu o descriere literală a imaginii. <strong>Considerați să folosiți titlul paginii către care se face legătura ca text alt.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Caractere</strong> <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT:
        'Legătura imaginii conține text alternativ. <strong>Textul alt descrie unde vă duce link-ul?</strong> Luați în considerare utilizarea titlului paginii către care se face legătura ca text alternativ. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT_AND_TEXT:
        'Legătura de imagine conține <strong>atât textul alt cât și textul de legătură din jur.</strong> Dacă această imagine este decorativă și este folosită ca o legătură funcțională către o altă pagină, luați în considerare marcarea imaginii ca fiind decorativă sau nulă - textul de legătură din jur ar trebui să fie suficient. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Numele accesibil</strong> {L} <strong {C}>%(TEXT)</strong>',
      IMAGE_FIGURE_DECORATIVE:
        'Imaginea este marcată ca fiind <strong>decorativă</strong> și va fi ignorată de tehnologia de asistență. <hr> Deși a fost furnizat un <strong>caption</strong>, imaginea ar trebui să aibă, de asemenea, un text alt în majoritatea cazurilor. <ul><li>Textul alt ar trebui să ofere o descriere concisă a ceea ce se află în imagine.</li><li>De obicei, legenda ar trebui să ofere un context pentru a relaționa imaginea cu conținutul din jur sau să atragă atenția asupra unei anumite informații.</li></ul> Aflați mai multe: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a>',
      IMAGE_FIGURE_DUPLICATE_ALT:
        'Nu folosiți exact aceleași cuvinte atât pentru textul alt, cât și pentru legendă. Cititoarele de ecran vor anunța informațiile de două ori. <ul><li>Textul alt ar trebui să ofere o descriere concisă a ceea ce se află în imagine.</li><li>Legenda ar trebui, de obicei, să ofere un context pentru a relaționa imaginea cu conținutul din jur sau să atragă atenția asupra unei anumite informații.</li></ul> Aflați mai multe: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      IMAGE_DECORATIVE:
        'Imaginea este marcată ca fiind <strong>decorativă</strong> și va fi ignorată de tehnologia de asistență. Dacă imaginea transmite o poveste, o stare de spirit sau informații importante - asigurați-vă că adăugați text alternativ.',
      ...
      ALT_MAYBE_BAD:
        'Textul alternativ poate să nu ofere informații utile sau să nu fie descriptiv. Îmbunătățește următorul text alt: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

      // Form labels
      LABELS_MISSING_IMAGE_INPUT:
        'Butonul de imagine nu are text alternativ. Vă rugăm să adăugați un alt text pentru a oferi un nume accesibil. De exemplu: <em>Cercetare</em> sau <em>Submitere</em>.',
      LABELS_INPUT_RESET:
        'Butoanele de resetare nu ar trebui <strong>nu</strong> utilizate decât dacă sunt necesare în mod specific, deoarece sunt ușor de activat din greșeală. <hr> <strong>Tip!</strong> Aflați de ce <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">Butoanele Reset și Cancel ridică probleme de utilizare.</a>',
      LABELS_ARIA_LABEL_INPUT:
        'Intrarea are un nume accesibil, deși vă rugăm să vă asigurați că există și o etichetă vizibilă. <hr> <strong {B}>Numele accesibil</strong> <strong {C}>%(TEXT)</strong>',
      LABELS_NO_FOR_ATTRIBUTE:
        'Nu există nicio etichetă asociată cu această intrare. Adăugați un atribut <code>for</code> la eticheta care se potrivește cu <code>id</code> al acestei intrări. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      ...
      // Embedded content
      EMBED_VIDEO:
        'Vă rugăm să vă asigurați că <strong>toate videoclipurile au subtitrare.</strong> Furnizarea de subtitrări pentru tot conținutul audio și video este o cerință obligatorie de nivel A. Subtitrările vin în sprijinul persoanelor care sunt D/surde sau cu deficiențe de auz.',
      EMBED_AUDIO:
      ...
      QA_BLOCKQUOTE:
        'E un titlu? <strong {C}>%(TEXT)</strong> <hr> Blocurile de ghilimele trebuie folosite numai pentru citate. Dacă se intenționează ca acesta să fie un titlu, schimbați acest blockquote într-un titlu semantic (de exemplu, titlul 2 sau titlul 3).',
      QA_FAKE_HEADING:
        'E un titlu? <strong {C}>%(TEXT)</strong> <hr> Un rând de text bold sau mare poate părea un titlu, dar o persoană care folosește un cititor de ecran nu poate spune că este important sau nu poate sări la conținutul său. Textul bold sau mare nu ar trebui să înlocuiască niciodată titlurile semantice (de la titlul 2 la titlul 6).',
      QA_FAKE_LIST:
        'Încercați să creați o listă? Posibil element de listă găsit: <strong {C}>%(firstPrefix)</strong> <hr> Asigurați-vă că folosiți liste semantice, utilizând în schimb butoanele de formatare a punctelor sau a numerelor. Atunci când se utilizează o listă semantică, tehnologiile asistive sunt capabile să transmită informații precum numărul total de elemente și poziția relativă a fiecărui element din listă. Aflați mai multe despre <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">liste semantice.</a>',
      QA_UPPERCASE:
        'Am găsit toate majusculele. Unele cititoare de ecran pot interpreta textul cu majuscule ca fiind un acronim și vor citi fiecare literă în parte. În plus, unele persoane consideră că toate majusculele sunt mai greu de citit și pot da impresia că strigă.',
      QA_UNDERLINE:
        'Textul subliniat poate fi confundat cu linkurile. Luați în considerare utilizarea unui stil diferit, cum ar fi <code>&lt;strong&gt;</code><strong>importanță</strong><code>&lt;/strong&gt;</code> sau <code>&lt;em&gt;</code><em>accentuare</em><code>&lt;/em&gt;</code>.',
      QA_SUBSCRIPT:
        'Opțiunile de formatare subscript și superscript ar trebui utilizate numai pentru a modifica poziția textului pentru convenții sau standarde tipografice. Nu ar trebui <strong>nu</strong> să fie utilizate exclusiv în scopuri de prezentare sau de aspect. Formatarea unor propoziții întregi ridică probleme de lizibilitate. Cazurile de utilizare adecvate ar include afișarea exponenților, a numerelor ordinale, cum ar fi 4<sup>th</sup> în loc de fourth, și a formulelor chimice (de exemplu, H<sub>2</sub>O).',
      QA_NESTED_COMPONENTS:
        'Evitați să înnodați componentele interactive de layout, cum ar fi plasarea acordioanelor în tab-uri sau tab-urilor în acordeoane. Acest lucru poate complica navigarea, crește încărcătura cognitivă și duce la trecerea cu vederea a conținutului.',
      QA_JUSTIFY:
        'Evitați utilizarea textului justificat, care se aliniază atât la marginea stângă, cât și la cea dreaptă. Acest lucru poate fi dificil de citit pentru unele persoane din cauza spațiilor inegale dintre cuvinte. Utilizați text aliniat la stânga pentru o lizibilitate mai bună.',
      QA_SMALL_TEXT:
      ...
      // Developer
      DUPLICATE_ID:
        'S-a găsit <strong>un ID duplicat</strong>. Se știe că erorile de ID duplicat cauzează probleme pentru tehnologiile asistive atunci când acestea încearcă să interacționeze cu conținutul. Vă rugăm să eliminați sau să modificați următorul ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      UNCONTAINED_LI:
        'Toate elementele de listă <code>&lt;li&gt;</code> trebuie să fie plasate în interiorul elementelor <code>&lt;ul&gt;</code> neordonate sau <code>&lt;ol&gt;</code> ordonate. Această structură ajută cititoarele de ecran să anunțe lista și elementele sale cu precizie.',
      TABINDEX_ATTR: 'Elementul nu ar trebui să aibă un atribut <code>tabindex</code> mai mare de 0.',

      // Meta
      META_LANG:
        'Limba paginii nu este declarată! Vă rugăm <a href="https://www.w3.org/International/questions/qa-html-language-declarations">declarați limba în tag-ul HTML.</a>',
      META_TITLE:
        'Lipsește titlul paginii! Vă rugăm să furnizați un <a href="https://developer.mozilla.org/ro/docs/Web/HTML/Element/title">titlu pagină.</a>',
      META_SCALABLE:
        'Eliminați parametrul <code>user-scalable="no"</code> din <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">meta tag-ul viewport</a> pentru a permite mărirea.',
      META_MAX:
      ...
      BTN: 'buton',
      BTN_TIP:
        'Învățați cum să creați un <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">buton accesibil.</a>',
      BTN_ROLE_IN_NAME:
      ...
      // Contrast
      CONTRAST_NORMAL:
        'Textul de dimensiune normală trebuie să aibă un raport de contrast de cel puțin %(RATIO).',
      CONTRAST_LARGE:
        'Textul de dimensiune mare trebuie să aibă un raport de contrast de cel puțin %(RATIO).',
      CONTRAST_ERROR: 'Textul nu are un contrast suficient cu fundalul, făcându-l mai greu de citit.',
      CONTRAST_WARNING:
        'Contrastul acestui text este necunoscut și trebuie revizuit manual. Asigurați-vă că textul și fundalul au un contrast puternic.',
      CONTRAST_ERROR_GRAPHIC:
        'Graficul nu are un contrast suficient cu fundalul, făcându-l mai greu de perceput.',
      CONTRAST_WARNING_GRAPHIC:
        'Contrastul acestui grafic este necunoscut și trebuie revizuit manual.',
      CONTRAST_TIP_GRAPHIC:
        'Graficile și elementele interfeței utilizatorului trebuie să aibă un raport de contrast de cel puțin 3:1.',
      CONTRAST_OPACITY: 'Creșteți opacitatea pentru o vizibilitate mai bună.',
      CONTRAST_APCA:
        'Acesta nu este un contrast suficient pentru orice dimensiune de text. Luați în considerare utilizarea acestei combinații de culoare și dimensiune a textului?',
      CONTRAST_COLOR: 'Luați în considerare utilizarea acestei culori în locul celei?',
      CONTRAST_SIZE:
        'Luați în considerare mărirea dimensiunii textului pentru această combinație de culori?',
      CONTRAST_PLACEHOLDER:
        'Textul de substituție din acest câmp de introducere nu are un contrast suficient cu fundalul, făcându-l mai greu de citit.',
      CONTRAST_PLACEHOLDER_UNSUPPORTED:
        'Contrastul acestui text substituent este necunoscut și trebuie revizuit manual. Asigurați-vă că textul și fundalul au culori puternic contrastante.',
      CONTRAST_INPUT:
        'Textul din acest câmp de introducere nu are un contrast suficient cu fundalul, făcându-l mai greu de citit.',
      CONTRAST: 'Contrast',
      UNKNOWN: 'Necunoscut',
      FG: 'Prim-plan',
      BG: 'Fundal',
      NO_SUGGESTION:
        'Nu există nicio combinație accesibilă ce poate fi găsită schimbând doar culoarea textului. Încercați să schimbați culoarea fundalului.',
    },
  };
