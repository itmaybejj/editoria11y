...
var lv = {
  ...
  strings: {
    ...
    OUTLINE: 'Struktūra',
    READABILITY_DESC:
      'Cilnē <strong>Struktūra</strong> rāda lasāmības rādītāju, lai palīdzētu novērtēt lasīšanas grūtības.',
    TITLE: 'Nosaukums',
    ALT: 'ALT',
    IMAGES: 'Attēli',
    EDIT: 'Rediģēt',
    ...
    DEVELOPER_DESC:
      'Pārbauda problēmas, kuru novēršanai var būt nepieciešamas programmēšanas zināšanas, piemēram, HTML atribūtus, veidlapas un citus.',
    ...
    NOT_VISIBLE:
      'Mēģinātais apskatīt vienums nav redzams; iespējams, tas ir paslēpts vai atrodas akordeona vai cilnes komponenta iekšpusē.',
    MISSING_ROOT:
      'Tika pārbaudīta visas lapas pieejamība, jo mērķa apgabals <code>%(root)</code> nepastāv.',
    ...
    DISMISSED: 'Noraidīts',
    DISMISS_REMINDER:
      'Lūdzu, ņemiet vērā, ka brīdinājumi ir tikai <strong>pagaidu</strong> noraidīti. Dzēšot pārlūkprogrammas vēsturi un sīkdatnes, visi iepriekš noraidītie brīdinājumi tiks atjaunoti visās lapās.',
    ...
    COLOUR_FILTER_MESSAGE:
      'Pārbaudiet, vai nav grūti pamanāmi vai no citām krāsām atšķirami elementi.',
    ...
    LINK_EMPTY_LABELLEDBY:
      'Saitei ir <code>aria-labelledby</code> ir tās vērtībai jābūt tukšai, vai nu tā nesakrīt ar citu elementu lapā, kam ir atribūts <code>id</code>.',
    LINK_EMPTY_NO_LABEL:
      'Saitei nav atpazīstama teksta, kas būtu redzams ekrānlasītājiem un citām palīgtehnoloģijām. Lai labotu: <ul><li>Pievienojiet īsu tekstu, kas apraksta, kur saite ved.</li><li>Ja tā ir <a href="https://a11y-101.com/development/icons-and-links">ikonas saite vai SVG,</a>, tai, visticamāk, trūkst aprakstoša marķējuma.</li><li>Ja domājat, ka šī saite ir kļūda, kas radusies kopēšanas/ielīmēšanas kļūdas dēļ, apsveriet tās dzēšanu.</li></ul>',
    LINK_STOPWORD:
      'Saite teksts, iespējams, nav pietiekami aprakstošs ārpus konteksta: <strong {C}>%(ERROR)</strong>',
    LINK_STOPWORD_ARIA:
      'Lai arī tika norādīts pieejams nosaukums, apsveriet iespēju pārskatīt redzamo saites tekstu. Tādas frāzes kā &quot;<strong {C}>%(ERROR)</strong>&quot; nav nozīmīgas.',
    LINK_TIP:
      '<hr> <strong>Padoms!</strong> Izmantojiet skaidru un unikālu saites tekstu, kas apraksta saites galamērķi, parasti lapas vai dokumenta nosaukumu.',
    LINK_CLICK_HERE:
      'Frāze "klikšķiniet" vai "klikšķiniet šeit" uzsver peles mehānismu, lai gan daudzi cilvēki neizmanto peli vai var skatīt šo tīmekļa vietni mobilajā ierīcē. Apsveriet iespēju izmantot citu darbības vārdu, kas attiecas uz uzdevumu.',
    DUPLICATE_TITLE:
      'Atribūts <code>title</code> saitēm un attēliem ir paredzēts papildu informācijas sniegšanai, un tam vajadzētu būt <strong>atšķirīgam</strong> no teksta vai alt teksta. Nosaukuma teksts tiek parādīts, novietojot peli virs elementa, bet tas nav pieejams ar tastatūru vai pieskārienu ievadi. Apsveriet <a href="https://www.a11yproject.com/posts/title-attributes/">pilnībā izvairīties no title atribūta.</a>',
    LINK_SYMBOLS:
      'Izvairieties izmantot simbolus kā aicinājumu rīkoties saites tekstā, ja vien tie nav paslēpti no palīgtehnoloģijām. Ekrāna lasītāji var nolasīt simbolus skaļi, kas var būt mulsinoši. Apsveriet to noņemšanu: <strong {C}>%(ERROR)</strong>',
    LINK_URL:
      'Garākus, mazāk saprotamus URL, kas tiek izmantoti kā saites teksts, var būt grūti saprast, kad tiem piekļūst ar palīgtehnoloģiju palīdzību. Vairumā gadījumu URL vietā ir labāk izmantot cilvēkam saprotamu tekstu. Īsi URL (piemēram, vietnes sākumlapa) ir piemēroti.',
    LINK_DOI:
    ...
    // Images
    ALT_UNPRONOUNCEABLE:
      'Alternatīvais teksts satur tikai neizrunājamus simbolus un/vai atstarpes. Ekrānlasītāji paziņos attēlu un tad apstāsies. Ja attēls ir dekoratīvs, pārliecinieties, ka alternatīvajā tekstā nav atstarpju. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_ALT_UNPRONOUNCEABLE:
      'Šajā saistītajā attēlā alternatīvais teksts satur tikai neizrunājamus simbolus un/vai atstarpes. Ekrānlasītāji paziņos attēlu un tad apstāsies. Pārliecinieties, ka alternatīvais teksts apraksta saites galamērķi. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    MISSING_ALT_LINK_HAS_TEXT:
      'Attēls tiek izmantots kā saite ar apkārtējo tekstu, lai gan atribūtam alt jābūt atzīmētam kā dekoratīvam vai nulles atribūtam.',
    MISSING_ALT_LINK:
      'Attēls tiek izmantots kā saite, bet tam trūkst teksta! Lūdzu, pārliecinieties, ka alt tekstā ir aprakstīts, uz kurieni jūs aizved saite.',
    MISSING_ALT:
      'Trūkst alt teksta! Ja attēls ir stāsts, noskaņa vai svarīga informācija, noteikti aprakstiet attēlu.',
    LINK_ALT_FILE_EXT:
      'Alternatīvais teksts nedrīkst ietvert failu paplašinājumus vai attēlu izmērus. Pārliecinieties, ka alt teksts apraksta saites galamērķi, nevis burtisku attēla aprakstu. Noņemt: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_PLACEHOLDER_ALT:
      'Atrasts nenoteikts vai aizvietotājs alt teksts saistītajā attēlā. Pārliecinieties, ka alt teksts apraksta saites galamērķi, nevis burtisku attēla aprakstu. Aizstājiet šādu alt tekstu. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_SUS_ALT:
      'Palīgtehnoloģijas jau norāda, ka tas ir attēls, tāpēc &quot;<strong {C}>%(ERROR)</strong>&quot; var būt lieks. Pārliecinieties, ka alt teksts apraksta saites galamērķi, nevis burtisku attēla aprakstu. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_FILE_EXT:
      'Alternatīvais teksts nedrīkst ietvert failu paplašinājumus vai attēlu izmērus. Ja attēls ir stāsts, noskaņa vai svarīga informācija, noteikti aprakstiet attēlu. Noņemt: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER:
      'Atrasts nenoteikts vai aizvietotājs alt teksts. Aizstājiet šādu alt tekstu ar jēgpilnāku. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    SUS_ALT:
      'Palīgtehnoloģijas jau norāda, ka tas ir attēls, tāpēc &quot;<strong {C}>%(ERROR)</strong>&quot; var būt lieks. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_NO_ALT_TEXT:
      'Attēls saitē ir atzīmēts kā dekoratīvs, un saites teksta nav. Lūdzu, pievienojiet attēlam alt tekstu, kas apraksta saites galamērķi.',
    LINK_IMAGE_TEXT:
      'Attēls ir atzīmēts kā dekoratīvs, lai gan saite izmanto apkārtējo tekstu kā aprakstošu etiķeti.',
    LINK_IMAGE_LONG_ALT:
      'Alt teksta apraksts saistītajam attēlam ir <strong>pārāk garš</strong>. Saistīto attēlu alt tekstam ir jāapraksta, uz kurieni ved saite, nevis burtisks attēla apraksts. <strong>Vēlams kā alttekstu izmantot tās lapas virsrakstu, uz kuru ir saite.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Rakstzīmes</strong> <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT:
      'Attēla saitē ir ietverts alt teksts. <strong>Vai alt tekstā ir aprakstīts, uz kurieni jūs aizved saite?</strong> Apsveriet iespēju kā alt tekstu izmantot tās lapas nosaukumu, uz kuru ir saite. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ...
    IMAGE_DECORATIVE:
      'Attēls ir atzīmēts kā <strong>dekoratīvs</strong>, un palīgtehnoloģijas to ignorēs. Ja attēls atspoguļo stāstu, noskaņu vai svarīgu informāciju, noteikti pievienojiet alt tekstu.',
    ...
    ALT_MAYBE_BAD:
      'Alt teksts var nesniegt noderīgu informāciju vai nebūt aprakstošs. Uzlabojiet šo alt tekstu: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ...
    LABELS_NO_FOR_ATTRIBUTE:
      'Šim ievadam nav piesaistīta etiķete. Pievienojiet <code>for</code> atribūtu etiķetei, kas atbilst šīs ievades <code>id</code>. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    LABELS_MISSING_LABEL:
      'Šim ievadam nav piesaistīta etiķete. Lūdzu, pievienojiet šim ievadam <code>id</code> un pievienojiet etiķetei atbilstošu atribūtu <code>for</code>.',
    LABELS_PLACEHOLDER:
      'Izšķirošais vietturis teksts apgrūtina cilvēkiem atcerēties, kāda informācija pieder laukam, un noteikt un labot validācijas problēmas. Tā vietā apsveriet iespēju izmantot pastāvīgi redzamu norādi pirms veidlapas lauka. <hr> Uzziniet vairāk: <a href="https://www.nngroup.com/articles/form-design-placeholders/">Vietturis veidlapu laukos ir kaitīgs.</a>',

    // Embedded content
    EMBED_VIDEO:
      'Lūdzu, pārliecinieties, ka <strong>visiem videoklipiem ir slēptie titri.</strong> Visu audio un video materiālu titru nodrošināšana ir obligāta A līmeņa prasība. Titri palīdz cilvēkiem, kuri ir nedzirdīgi vai vājdzirdīgi.',
    EMBED_AUDIO:
    ...
    QA_FAKE_LIST:
      'Vai mēģināt izveidot sarakstu? Atrasts iespējamais saraksta vienums: <strong {C}>%(firstPrefix)</strong> <hr> Pārliecinieties, ka izmantojat semantiskos sarakstus, to vietā izmantojot lodītes vai skaitļu formatēšanas pogas. Izmantojot semantisko sarakstu, palīgtehnoloģijas spēj nodot tādu informāciju kā kopējais elementu skaits un katra elementa relatīvā pozīcija sarakstā. Uzziniet vairāk par <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">semantiskajiem sarakstiem.</a>',
    QA_UPPERCASE:
      'Atrasti visi vāciņi. Daži ekrāna lasītāji var interpretēt tekstu ar lielajiem burtiem kā akronīmu un lasīt katru burtu atsevišķi. Turklāt dažiem cilvēkiem ir grūtāk lasīt tekstu ar lielajiem burtiem, un tas var radīt iespaidu, ka teksts ir RAKSTS.',
    QA_UNDERLINE:
      'Pasvītroto tekstu var sajaukt ar saitēm. Apsveriet iespēju izmantot citu stilu, piemēram, <code>&lt;strong&gt;</code><strong>strong importance</strong><code>&lt;/strong&gt;</code> vai <code>&lt;em&gt;</code><em>emphasis</em><code>&lt;/em&gt;</code>.',
    QA_SUBSCRIPT:
      'Apakšindiksu un augšindiksu formatēšanas opcijas jāizmanto tikai, lai mainītu teksta pozīciju tipogrāfisko konvenciju vai standartu vajadzībām. Tās nevajadzētu <strong>nevajadzētu</strong> izmantot tikai noformējuma vai izskata nolūkos. Veselu teikumu formatēšana rada lasāmības problēmas. Piemēroti lietošanas gadījumi būtu eksponentu, kārtas skaitļu, piemēram, 4<sup>tā</sup> vietā ceturtā, un ķīmisko formulu (piemēram, H<sub>2</sub>O) attēlošana.',
    QA_NESTED_COMPONENTS:
      'Izvairieties no interaktīvo izkārtojuma komponentu ieliktajiem, piemēram, akordeonu ievietošanas cilnēs vai cilņu ievietošanas akordeonos. Tas var sarežģīt navigāciju, palielināt kognitīvo slodzi un izraisīt satura ignorēšanu.',
    QA_JUSTIFY:
      'Izvairieties no izmantošanas izlīdzinātam tekstam, kas izlīdzināts gan pie kreisās, gan pie labās malas. Tas var būt grūti lasāms dažiem cilvēkiem, jo vārdu starpā ir nevienmērīgas atstarpes. Labākai lasāmībai izmantojiet tekstu, kas izlīdzināts pa kreisi.',
    QA_SMALL_TEXT:
    ...
    // Developer
    DUPLICATE_ID:
      'Atrasts <strong>duplicate ID</strong>. Ir zināms, ka dubultā ID kļūdas rada problēmas palīgtehnoloģijām, kad tās mēģina mijiedarboties ar saturu. Lūdzu, noņemiet vai mainiet šādu ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    UNCONTAINED_LI:
      'Visiem <code>&lt;li&gt;</code> saraksta elementiem jābūt ievietotiem <code>&lt;ul&gt;</code> nesakārtotas vai <code>&lt;ol&gt;</code> sakārtotas elementus. Šī struktūra palīdz ekrāna lasītājiem precīzi paziņot sarakstu un tā elementus.',
    TABINDEX_ATTR:
      'Elementam nevajadzētu būt ar <code>tabindex</code> atribūtu, kas ir lielāks par 0.',

    // Meta
    META_LANG:
      'Lapas valoda nav deklarēta! Lūdzu, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklarējiet valodu HTML tagā.</a>',
    META_TITLE:
      'Trūkst lapas virsraksta! Lūdzu, norādiet <a href="https://developer.mozilla.org/lv/docs/Web/HTML/Element/title">lapas virsrakstu.</a>',
    META_SCALABLE:
      'Noņemiet parametru <code>user-scalable="no"</code> <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">meta atzīmē</a>, lai atļautu mērogošanu.',
    META_MAX:
    ...
    BTN: 'poga',
    BTN_TIP:
      'Uzziniet, kā izveidot <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">pieejamu pogu.</a>',
    BTN_ROLE_IN_NAME:
    ...
    CONTRAST_WARNING:
      'Šī teksta kontrasts nav zināms un tam jābūt pārbaudītam manuāli. Pārliecinieties, ka tekstam un fonam ir spēcīgs kontrasts.',
    CONTRAST_ERROR_GRAPHIC:
      'Grafikai nav pietiekama kontrasta ar fona krāsu, tāpēc to ir grūti redzēt.',
    CONTRAST_WARNING_GRAPHIC: 'Šīs grafikas kontrasts nav zināms un tam jābūt pārbaudītam manuāli.',
    CONTRAST_TIP_GRAPHIC:
      'Grafikām un lietotāja interfeisa elementiem jābūt ar kontrasta attiecību vismaz 3:1.',
    CONTRAST_OPACITY: 'Palieliniet necaurspīdīgumu, lai uzlabotu redzamību.',
    CONTRAST_APCA:
      'Šis kontrasts nav pietiekams jebkuram teksta izmēram. Apsveriet iespēju izmantot šo krāsu un teksta lieluma kombināciju?',
    ...
    CONTRAST_PLACEHOLDER:
      'Šī ievades lauka aizvietotājteksts nav pietiekami kontrastējošs ar fonu, tāpēc to ir grūti lasīt.',
    CONTRAST_PLACEHOLDER_UNSUPPORTED:
      'Šī vietturētāja teksta kontrasts nav zināms un tas jāizvērtē manuāli. Pārliecinieties, ka tekstam un fonam ir spēcīgi kontrastējošas krāsas.',
    CONTRAST_INPUT:
      'Šī ievades lauka teksts nav pietiekami kontrastējošs ar fonu, tāpēc to ir grūti lasīt.',
    CONTRAST: 'Kontrasts',
    UNKNOWN: 'Nezināms',
    FG: 'Priekšplāns',
    BG: 'Fons',
    NO_SUGGESTION:
      'Nekādas pieejamās kombinācijas nevar atrast, mainot tikai teksta krāsu. Pamēģiniet mainīt fona krāsu.',
  },
};
