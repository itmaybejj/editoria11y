...
var sk = {
  ...
  strings: {
    ...
    CONSOLE_ERROR:
      'Je nám ľúto, ale na tejto stránke je problém s kontrolou prístupnosti. Môžete to prosím <a href="%(link)">nahlásiť prostredníctvom tohto formulára</a> alebo na <a href="%(link)">GitHub</a>?',
    APPEARANCE: 'Vzhľad',
    ...
    COLOUR_FILTER_MESSAGE:
      'Skontrolujte, či nie sú prítomné prvky, ktoré je ťažké vnímať alebo rozlíšiť na pozadí iných farieb.',
    ...
    SUS_ALT_STOPWORDS: ['obrázok', 'grafika', 'obrázok', 'foto'],
    ...
    HEADING_SKIPPED_LEVEL:
      'Nadpisy by nemali preskakovať úrovne alebo preskočiť z <strong>Nadpisu %(PREV_LEVEL)</strong> na <strong {C}>Nadpis %(LEVEL)</strong>, pretože to narúša poriadok a hierarchiu obsahu, čo sťažuje jeho sledovanie. <hr> Ak <strong {C}>%(HEADING)</strong> patrí pod sekciu <strong>%(PREV_HEADING)</strong>, zvážte jeho formátovanie ako <strong>Nadpis %(LEVEL)</strong> namiesto toho.',
    HEADING_EMPTY:
      'Nájdená prázdna položka! Ak to chcete opraviť, odstráňte tento riadok alebo zmeňte jeho formát z <strong {C}>Head %(level)</strong> na <strong>Normal</strong> alebo <strong>Paragraph</strong>.',
    HEADING_LONG:
      'Smerovanie je dlhé! Nadpisy by sa mali používať na usporiadanie obsahu a vyjadrenie štruktúry. Mali by byť stručné, informatívne a jedinečné. Prosím, aby nadpisy mali menej ako %(MAX_LENGTH) znakov (nie viac ako jednu vetu). <hr> <strong {B}>%(HEADING_LENGTH) Znakov</strong>',
    HEADING_FIRST:
      'Prvý nadpis na stránke by mal byť zvyčajne nadpis 1 alebo 2. Nadpis 1 by mal byť začiatkom hlavnej časti obsahu a je to hlavný nadpis, ktorý opisuje celkový účel stránky. Viac informácií o <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">štruktúre nadpisov.</a>',
    HEADING_MISSING_ONE:
    ...
    LINK_EMPTY_LABELLEDBY:
      'Odkaz má hodnotu <code>aria-labelledby</code>, ktorá je prázdna alebo nezodpovedá hodnote atribútu <code>id</code> iného prvku na stránke.',
    LINK_EMPTY_NO_LABEL:
      'Odkaz nemá rozoznateľný text, ktorý je viditeľný pre čítačky obrazovky a iné asistenčné technológie. Oprava: <ul><li>Pridajte stručný text, ktorý popisuje, kam vás odkaz zavedie.</li><li>Ak ide o <a href="https://a11y-101.com/development/icons-and-links">odkaz na ikonu alebo SVG,</a> pravdepodobne chýba popisný štítok.</li><li>Ak si myslíte, že tento odkaz je chybou spôsobenou chybou kopírovania/vkladania, zvážte jeho odstránenie.</li></ul>',
    LINK_STOPWORD:
      'Text odkazu nemusí byť dostatočne popisný mimo kontextu: <strong {C}>%(ERROR)</strong>',
    LINK_STOPWORD_ARIA:
      'Aj keď bolo poskytnuté prístupné meno, zvážte revíziu viditeľného textu odkazu. Výrazy ako &quot;<strong {C}>%(ERROR)</strong>&quot; nemajú zmysel.',
    LINK_TIP:
    ...
    LINK_CLICK_HERE:
      'Výraz "kliknite" alebo "kliknite sem" kladie dôraz na mechaniku myši, hoci mnoho ľudí nepoužíva myš alebo si môže tento web prezerať na mobilnom zariadení. Zvážte použitie iného slovesa, ktoré súvisí s úlohou.',
    DUPLICATE_TITLE:
      'Atribút <code>title</code> na odkazoch a obrázkoch je určený na poskytovanie ďalších informácií a mal by byť <strong>odlišný</strong> od textu alebo alternatívneho textu. Text titulu sa zobrazí, keď sa nad elementom podrží myš, ale nie je prístupný klávesnicou alebo dotykovým vstupom. Zvážte <a href="https://www.a11yproject.com/posts/title-attributes/">úplné vyhnutie sa atribútu title.</a>',
    LINK_SYMBOLS:
      'Vyhnite sa používaniu symbolov ako výzvy na akciu v texte odkazu, pokiaľ nie sú skryté pred asistívnymi technológiami. Čítačky obrazovky môžu symboly nahlas prečítať, čo môže byť mätúce. Zvážte ich odstránenie: <strong {C}>%(ERROR)</strong>',
    LINK_URL:
      'Dlhšie a menej zrozumiteľné adresy URL použité ako text odkazu by mohli byť ťažko zrozumiteľné pre asistenčné technológie. Vo väčšine prípadov je lepšie namiesto adresy URL použiť text čitateľný pre človeka. Krátke adresy URL (napríklad domovská stránka webu) sú v poriadku.',
    LINK_DOI:
      'V prípade webových stránok alebo len online zdrojov odporúča <a href="https://apastyle.apa.org/style-grammar-guidelines/paper-format/accessibility/urls#:~:text=descriptive%20links">príručka štýlu APA</a> používať popisné odkazy tak, že okolo názvu diela uvediete jeho URL alebo DOI. Dlhšie, menej zrozumiteľné adresy URL použité ako text odkazu by mohli byť ťažko zrozumiteľné pomocou asistenčných technológií.',
    LINK_NEW_TAB:
    ...
    // Images
    ALT_UNPRONOUNCEABLE:
      'Alternatívny text obsahuje iba nevysloviteľné symboly a/alebo medzery. Čítačky obrazovky oznámia obrázok a potom sa zastavia. Ak je obrázok dekoratívny, uistite sa, že alternatívny text neobsahuje medzery. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_ALT_UNPRONOUNCEABLE:
      'Alternatívny text v tomto prepojenom obrázku obsahuje iba nevysloviteľné symboly a/alebo medzery. Čítačky obrazovky oznámia obrázok a potom sa zastavia. Uistite sa, že alternatívny text popisuje cieľ odkazu. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    MISSING_ALT_LINK_HAS_TEXT:
      'Obrázok sa používa ako odkaz s okolitým textom, hoci atribút alt by mal byť označený ako dekoratívny alebo nulový.',
    MISSING_ALT_LINK:
      'Obrázok sa používa ako odkaz, ale chýba text alt! Uistite sa, že text alt opisuje, kam vás odkaz zavedie.',
    MISSING_ALT:
      'Chýbajúci text alt! Ak obrázok vyjadruje príbeh, náladu alebo dôležitú informáciu, nezabudnite ho opísať.',
    LINK_ALT_FILE_EXT:
      'Alternatívny text by nemal obsahovať prípony súborov alebo rozmery obrázkov. Uistite sa, že text alt opisuje cieľ odkazu, nie doslovný opis obrázka. Odstráňte: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_PLACEHOLDER_ALT:
      'Nájdený text alt bez popisu alebo zástupný text v rámci prepojeného obrázka. Uistite sa, že text alt opisuje cieľ odkazu, nie doslovný opis obrázka. Nahraďte nasledujúci text alt. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_SUS_ALT:
      'Asistenčné technológie už indikujú, že ide o obrázok, takže &quot;<strong {C}>%(ERROR)</strong>&quot; môže byť zbytočné. Uistite sa, že alt text opisuje cieľ odkazu, nie doslovný opis obrázka. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_FILE_EXT:
      'Alternatívny text by nemal obsahovať prípony súborov alebo rozmery obrázkov. Ak obrázok vyjadruje príbeh, náladu alebo dôležitú informáciu, nezabudnite ho opísať. Odstráňte: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER:
      'Nájdený text alt bez popisu alebo zástupného textu. Nahraďte nasledujúci alt text niečím zmysluplnejším. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    SUS_ALT:
      'Asistenčné technológie už indikujú, že ide o obrázok, takže &quot;<strong {C}>%(ERROR)</strong>&quot; môže byť zbytočné. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_NO_ALT_TEXT:
      'Obrázok v rámci odkazu je označený ako dekoratívny a nie je v ňom žiadny text odkazu. K obrázku pridajte text alt, ktorý opisuje cieľ odkazu.',
    LINK_IMAGE_TEXT:
      'Obrázok je označený ako dekoratívny, hoci odkaz používa okolitý text ako popisné označenie.',
    LINK_IMAGE_LONG_ALT:
      'Popis Alt textu na prepojenom obrázku je <strong>predlžený</strong>. Text alt na prepojených obrázkoch by mal popisovať, kam vás odkaz zavedie, nie doslovný opis obrázka. <strong>Zvážte použitie názvu stránky, na ktorú odkazuje, ako alt textu.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Znakov</strong> <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT:
      'Odkaz na obrázok obsahuje text alt. Opisuje text alt, kam vás odkaz zavedie? <strong>Zvážte použitie názvu stránky, na ktorú odkazuje, ako alt textu.</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_AND_TEXT:
      'Odkaz na obrázok obsahuje <strong>obidva texty alt a okolitý text odkazu.</strong> Ak je tento obrázok dekoratívny a používa sa ako funkčný odkaz na inú stránku, zvážte označenie obrázka ako dekoratívneho alebo nulového - okolitý text odkazu by mal stačiť. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Prístupné meno</strong> {L} <strong {C}>%(TEXT)</strong>',
    ...
    ALT_MAYBE_BAD:
      'Alt text nemusí poskytovať užitočné informácie alebo nie je popisný. Vylepšite nasledujúci alt text: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

    // Form labels
    LABELS_MISSING_IMAGE_INPUT:
      'V tlačidle obrázka chýba text alt. Pridajte text alt a uveďte prístupný názov. Napríklad: <em>Vyhľadať</em> alebo <em>Odoslať</em>.',
    LABELS_INPUT_RESET:
      'Tlačidlá resetovania by sa nemali používať, ak to nie je výslovne potrebné, pretože sa ľahko aktivujú omylom. <hr> <strong>Tip!</strong> Prečítajte si, prečo <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">tlačidlá Reset a Cancel predstavujú problémy s použiteľnosťou.</a>',
    LABELS_ARIA_LABEL_INPUT:
      'Vstup má prístupný názov, ale dbajte na to, aby bol viditeľný aj štítok. <hr> <strong {B}>Prístupné meno</strong> <strong {C}>%(TEXT)</strong>',
    LABELS_NO_FOR_ATTRIBUTE:
      'K tomuto vstupu nie je priradený žiadny štítok. Pridajte atribút <code>for</code> k štítku, ktorý sa zhoduje s <code>id</code> tohto vstupu. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    ...
    // Embedded content
    EMBED_VIDEO:
      'Uistite sa, že <strong>všetky videá majú skryté titulky.</strong> Poskytovanie titulkov pre všetok zvukový a obrazový obsah je povinnou požiadavkou úrovne A. Titulky podporujú osoby s poruchou sluchu alebo nepočujúce osoby.',
    EMBED_AUDIO:
      'Zabezpečte <strong>prepis všetkých podcastov.</strong> Poskytovanie prepisov zvukového obsahu je povinnou požiadavkou úrovne A. Prepisy podporujú ľudí s poruchou sluchu alebo nepočujúcich, ale môžu byť prínosom pre všetkých. Zvážte umiestnenie prepisu pod alebo v rámci akordeónového panelu.',
    EMBED_DATA_VIZ:
      'Takéto widgety na vizualizáciu údajov sú často problematické pre ľudí, ktorí na navigáciu používajú klávesnicu alebo čítačku obrazovky, a môžu predstavovať značné ťažkosti pre ľudí so slabým zrakom alebo farbosleposťou. Odporúča sa poskytnúť rovnaké informácie v alternatívnom (textovom alebo tabuľkovom) formáte pod widgetom. <hr> Ďalšie informácie o <a href="https://www.w3.org/WAI/tutorials/images/complex">komplexných obrázkoch.</a>',
    EMBED_MISSING_TITLE:
      'Vložený obsah vyžaduje prístupný názov, ktorý opisuje jeho obsah. Uveďte jedinečný atribút <code>title</code> alebo <code>aria-label</code> na prvku <code>iframe</code>. Ďalšie informácie o <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrame.</a>',
    EMBED_GENERAL:
      'Nie je možné skontrolovať vložený obsah. Uistite sa, že obrázky majú alt text, videá majú titulky, text má dostatočný kontrast a interaktívne komponenty sú <a href="https://webaim.org/techniques/keyboard/">prístupné z klávesnice.</a>',
    EMBED_UNFOCUSABLE:
      '<code>&lt;iframe&gt;</code> s nezamerateľnými prvkami by nemalo mať <code>tabindex="-1"</code>. Vložený obsah nebude dostupný pomocou klávesnice.',
    ...
    QA_BLOCKQUOTE:
      'Je to nadpis? <strong {C}>%(TEXT)</strong> <hr> Blokové úvodzovky by sa mali používať len pre citácie. Ak to má byť nadpis, zmeňte tento blokový citát na sémantický nadpis (napr. Nadpis 2 alebo Nadpis 3).',
    QA_FAKE_HEADING:
      'Je to nadpis? <strong {C}>%(TEXT)</strong> <hr> Riadok tučného alebo veľkého textu môže vyzerať ako nadpis, ale osoba používajúca čítačku obrazovky nedokáže určiť, že je dôležitý, ani prejsť na jeho obsah. Tučný alebo veľký text by nikdy nemal nahrádzať sémantické nadpisy (nadpisy 2 až 6).',
    QA_FAKE_LIST:
      'Snažíte sa vytvoriť zoznam? Nájdená možná položka zoznamu: <strong {C}>%(firstPrefix)</strong> <hr> Uistite sa, že používate sémantické zoznamy tak, že namiesto nich použijete tlačidlá na formátovanie odrážok alebo čísel. Pri použití sémantického zoznamu dokážu asistenčné technológie sprostredkovať informácie, ako je celkový počet položiek a relatívna pozícia každej položky v zozname. Viac informácií o <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">sémantických zoznamoch.</a>',
    QA_UPPERCASE:
      'Nájdené všetky čiapky. Niektoré čítačky obrazovky môžu interpretovať text písaný veľkými písmenami ako skratku a budú čítať každé písmeno samostatne. Okrem toho sa niektorým ľuďom všetky veľké písmená čítajú ťažšie a môže to pôsobiť dojmom, akoby sa kričalo.',
    QA_UNDERLINE:
      'Podčiarknutý text sa môže zameniť s odkazmi. Zvážte použitie iného štýlu, napríklad <code>&lt;strong&gt;</code><strong>strong importance</strong><code>&lt;/strong&gt;</code> alebo <code>&lt;em&gt;</code><em>emphasis</em><code>&lt;/em&gt;</code>.',
    QA_SUBSCRIPT:
    ...
    QA_NESTED_COMPONENTS:
      'Vyhnite sa vnoreniu interaktívnych komponentov rozloženia, ako je umiestnenie akordeónov do kariet alebo kariet do akordeónov. To môže skomplikovať navigáciu, zvýšiť kognitívne zaťaženie a viesť k prehliadaniu obsahu.',
    QA_JUSTIFY:
      'Vyhnite sa používaniu zarovnaného textu, ktorý je zarovnaný ako k ľavému, tak aj k pravému okraju. To môže byť pre niektorých ľudí ťažké čítať kvôli nerovnomerným medzerám medzi slovami. Použite text zarovnaný na ľavo pre lepšiu čitateľnosť.',
    QA_SMALL_TEXT:
    ...
    // Developer
    DUPLICATE_ID:
      'Nájdené <strong>duplicitné ID</strong>. Je známe, že chyby duplicitného ID spôsobujú problémy asistenčným technológiám pri pokusoch o interakciu s obsahom. Odstráňte alebo zmeňte nasledujúce ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    UNCONTAINED_LI:
      'Všetky položky zoznamu <code>&lt;li&gt;</code> musia byť umiestnené vo vnútri <code>&lt;ul&gt;</code> neusporiadaných alebo <code>&lt;ol&gt;</code> usporiadaných prvkov. Táto štruktúra pomáha čítačkám obrazovky presne oznamovať zoznam a jeho položky.',
    ...
    META_SCALABLE:
      'Odstráňte parameter <code>user-scalable="no"</code> v <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">meta značke zobrazenia</a>, aby ste umožnili priblíženie.',
    META_MAX:
    ...
    CONTRAST_WARNING:
      'Kontrast tohto textu je neznámy a musí byť manuálne skontrolovaný. Uistite sa, že text a pozadie majú dostatočný kontrast.',
    CONTRAST_ERROR_GRAPHIC:
      'Grafika nemá dostatočný kontrast s pozadím, čo sťažuje jej viditeľnosť.',
    ...
    CONTRAST_APCA:
      'Tento kontrast nie je dostatočný pre žiadnu veľkosť textu. Zvážte použitie tejto kombinácie farieb a veľkostí textu?',
    ...
    CONTRAST_PLACEHOLDER:
      'Zástupný text v tomto vstupnom poli nemá dostatočný kontrast s pozadím, čo sťažuje jeho čitateľnosť.',
    CONTRAST_PLACEHOLDER_UNSUPPORTED:
      'Kontrast tohto zástupného textu nie je známy a je potrebné ho manuálne skontrolovať. Uistite sa, že text a pozadie majú silne kontrastné farby.',
    CONTRAST_INPUT:
      'Text v tomto vstupnom poli nemá dostatočný kontrast s pozadím, čo sťažuje jeho čitateľnosť.',
    CONTRAST: 'Kontrast',
    UNKNOWN: 'Neznáme',
    FG: 'Popredie',
    BG: 'Pozadie',
