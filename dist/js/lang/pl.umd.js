(function(global, factory) {
  ...
  const tooltip = {
    ...
    EMBED_MISSING_TITLE: 'Osadzona zawartość wymaga dostępnej nazwy, która opisuje jej treść. Dodaj unikalny <code>title</code> lub atrybutu <code>aria-label</code> do elementu <code>&lt;%(ELEMENT)&gt;</code>. Dowiedz się więcej o <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrame.</a>',
  ...
  const testNames = {
    ALT_PLACEHOLDER: "Ten tekst alternatywny może być tekstem zastępczym",
    ...
    BTN_UNPRONOUNCEABLE: "Ten przycisk jest niewymawialny",
    ...
    HEADING_UNPRONOUNCEABLE: "Ten nagłówek jest niewymawialny",
    ...
    IMAGE_FIGURE_DECORATIVE: "Ten obraz z podpisem nie ma tekstu alternatywnego",
    ...
    LINK_CLICK_HERE: "Ten link zawiera „kliknij tutaj”",
    ...
    LINK_UNPRONOUNCEABLE: "Ten link jest niewymawialny",
    LINK_FILE_EXT: "Link prowadzi do pliku bez ostrzeżenia",
    LINK_IMAGE_ALT: "Czy ten tekst alternatywny opisuje link, czy obraz?",
    ...
    LINK_IMAGE_TEXT: "Czy ten obraz‑link wymaga opisu?",
    ...
    LINK_SYMBOLS: "Czy symbole/emoji w linku są znaczące?",
    ...
    QA_BAD_LINK: "Cel tego linku może być nieprawidłowy",
  ...
  const tips = {
    ...
    BTN_TIP: `${why.buttons}`,
    BTN_UNPRONOUNCEABLE: `<p><strong>Tekst przycisku:</strong> <i>%(TEXT)</i></p><p>${why.fix}Dodaj tekst, tytuł lub atrybut aria-label opisujący jego przeznaczenie.</p><div class="why"><p>Porada: czytniki ekranu nie mogą opisać przycisków zawierających tylko spacje lub symbole. Albo milczą ("Przycisk, [...niezręczna pauza, gdzie powinna być etykieta przycisku...]"), albo odczytują nazwę symbolu.</p></div>`,
    ...
    EMBED_GENERAL: 'Automatyczne testy nie analizują zawartości wewnątrz osadzeń. Upewnij się, że obrazy mają alt, filmy — napisy, tekst — odpowiedni kontrast, a linki/przyciski są <a href="https://webaim.org/techniques/keyboard/">dostępne z klawiatury</a>. Potem możesz zignorować alert.',
    ...
    HEADING_UNPRONOUNCEABLE: `<p>Puste nagłówki powodują luki w strukturze.</p><p>${why.fix}Dodaj do tego nagłówka tekst zrozumiały dla człowieka albo zmień go w akapit.</p>${why.headings}`,
    ...
    LINK_FILE_EXT: `<p><strong>Tekst linku:</strong> <i>%(TEXT)</i></p><p>Link prowadzi do pliku (PDF/MP3/ZIP/Word) bez uprzedzenia.</p><p>${why.fix}Wskaż typ pliku w tekście/ikonie: <a href="https://itmaybejj.github.io/linkpurpose/"></a>.</p><p class="why">Przy dużych plikach podaj rozmiar, np. „Raport (PDF, 3 MB)”.</p>`,
    LINK_IDENTICAL_NAME: `<p><strong>Tekst linku:</strong> <i>%(TEXT)</i></p><p><strong class="badge">Aby naprawić</strong> Zmień treść linków prowadzących do różnych miejsc tak, aby ich teksty były unikalne.</p>${why.links}`,
    ...
    LINK_IMAGE_NO_ALT_TEXT: `<p>Gdy link zawiera obraz, jego alt staje się <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">nazwą linku</a> dla czytnika.</p><p>${why.fix}Jako tekstu alternatywnego obrazów‑linków używaj tytułu celu linku.</p>${why.imageLinks}`,
    ...
    LINK_NEW_TAB: `<p><strong>Tekst linku:</strong> <i>%(TEXT)</i></p><p>${why.fix}Otwieraj w tej samej karcie lub <a href="https://itmaybejj.github.io/linkpurpose/">poinformuj z wyprzedzeniem</a> o nowej karcie.</p><div class="why"><p>Wymuszanie nowej karty bywa dezorientujące (np. „Cofnij” działa inaczej). Wyjątek: linki w formularzach często otwierają się w nowej karcie, aby nie utracić danych.</p></div>`,
    ...
    META_LANG: `<p>${why.fix}Dodaj <a href="https://www.w3.org/International/questions/qa-html-language-declarations">atrybut języka</a> do elementu HTML.</p><div class="why"><p>Czytniki dobierają wymowę na podstawie języka; błędny język utrudnia zrozumienie.</p></div>`,
    ...
    META_TITLE: `<p>${why.fix}Dodaj <code>&lt;title&gt;</code> w sekcji <code>head</code>.</p><div class="why"><p><a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/title">Krótki, unikalny tytuł</a> jest kluczowy (wyniki wyszukiwarki, karty przeglądarki, czytniki podczas przełączania kart).</p><p>Bez tytułu użytkownik widzi tylko URL.</p></div>`,
    ...
    QA_IN_PAGE_LINK: `<p><strong>URL:</strong> <i>#%(ID)</i></p><p><strong>Link:</strong> <code>%(TEXT)</code></p><p>Cel linku wewnętrznego nie istnieje na stronie.</p><div class="why"><p>Dla programistów: jeśli to handler JS — zweryfikuj obsługę klawiaturą, zanim wyłączysz kontrolę.</p></div>`,
  ...
  const interfaceStrings = {
    ...
    buttonHideHiddenAlerts_few: `Ukryj %(count) ukryte alerty`,
    ...
    main_toggle_few: ` ostrzeżenia dotyczące dostępności`,
