(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p><strong class="badge">Aby naprawić</strong> Dodaj tekst opisujący cel linku albo usuń link, jeśli to błąd (np. linkowany znak spacji).</p><div class="why"><p>Wskazówka: czytniki ekranu nie potrafią odczytać pustych linków. Mogą zamilknąć ("Link, [...pauza...]") lub odczytać URL znak po znaku.</p><p>Linkowane spacje bywają trudne do usunięcia; czasem trzeba usunąć i ponownie wpisać tekst po obu stronach spacji.</p></div>`,
