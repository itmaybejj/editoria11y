(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Tekst alternatywny:</strong> <i>%(ALT_TEXT)</i></p><p>Czytniki ekranu spróbują wymówić ten adres URL, często litera po literze. Prawdopodobnie nie odda to znaczenia obrazu.</p><p>${why.fix}Krótko opisz, co ten obraz oznacza w danym kontekście.</p>${why.images}`,
