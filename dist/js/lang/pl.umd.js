(function(global, factory) {
  ...
  const tips = {
    ...
    EMBED_AUDIO: `<p>To narzędzie nie jest w stanie stwierdzić, czy odtwarzacz audio ma transkrypcję, ani czy transkrypcja jest dokładna.</p><p>${why.fix}Upewnij się, że dostępna jest <a href="https://www.w3.org/WAI/media/av/transcribing/">transkrypcja lub tekstowa alternatywa</a>, a mówcy i znaczące efekty dźwiękowe są prawidłowo oznaczeni.</p>`,
    ...
    EMBED_UNFOCUSABLE: `<p>Ten atrybut nakazuje klawiaturze i technologiom wspomagającym pominięcie elementu. Jeśli zawartość tego iframe zawiera linki, przyciski lub pola formularza albo można ją przewijać, atrybut należy usunąć.</p>`,
    EMBED_VIDEO: `<p>To narzędzie nie jest w stanie „zobaczyć", czy filmy mają napisy, ani stwierdzić, czy ktoś je sprawdził — konieczna jest ręczna weryfikacja.</p><p>${why.fix}Upewnij się, że dostępne są <a href="https://www.w3.org/WAI/media/av/captions/">dokładne napisy („CC") lub podpisy</a>, a mówcy i znaczące efekty dźwiękowe są prawidłowo oznaczeni.</p>`,
