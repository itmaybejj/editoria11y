(function(global, factory) {
  ...
  const tooltip = {
    ...
    EMBED_MISSING_TITLE: 'Inbäddat innehåll kräver ett tillgängligt namn som beskriver det inbäddade innehåll. Sätt ett unikt <code>title</code>- eller <code>aria-label</code>-attribut på <code>&lt;%(ELEMENT)&gt;</code>-elementet. Läs mer om <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
  ...
  const testNames = {
    ...
    BTN_UNPRONOUNCEABLE: "Den här knappen går inte att uttala",
    ...
    HEADING_UNPRONOUNCEABLE: "Den här rubriken går inte att uttala",
    ...
    IMAGE_FIGURE_DECORATIVE: "Denna bild med bildtext saknar alt-text",
    ...
    LINK_CLICK_HERE: "Denna länk innehåller ”klicka här”",
    ...
    LINK_IMAGE_ALT: "Beskriver denna alt-text länken eller bilden?",
    ...
    LINK_IMAGE_TEXT: "Behöver denna länkade bild en beskrivning?",
    ...
    LINK_SYMBOLS: "Är symbolerna eller emojin i denna länk meningsfulla?",
    ...
    QA_BAD_LINK: "Detta länkmål kan vara ogiltigt",
  ...
  const tips = {
    ...
    BTN_EMPTY: `<p>${why.fix}Använd valfri metod för att tala om för skärmläsare vad knappen gör — t.ex. synlig text, alt-text på en ikon eller ett title-attribut.</p>`,
    ...
    BTN_UNPRONOUNCEABLE: `<p><strong>Knapptext:</strong> <i>%(TEXT)</i></p><p>${why.fix}Lägg till text, en titel eller en aria-label som beskriver dess destination.</p><div class="why"><p>Tips: Skärmläsare kan inte beskriva knappar som bara innehåller mellanslag eller symboler. De blir antingen tysta (”Knapp, [...obekväm paus där knappens etikett borde vara...]”), eller läser upp symbolens namn.</p></div>`,
    ...
    DUPLICATE_TITLE: `<p>${why.fix}Ta bort länkens text eller <code>title</code>-attribut.</p><div class="why"><p>Tips: <code>title</code>-verktygstips visas endast vid muspekar-hovring. De syns inte på mobil eller med tangentbord, så många användare kommer aldrig att se dem. Lägg inte viktig information där.</p></div>`,
    ...
    EMBED_GENERAL: 'Automatisk kontroll ser inte innehållet i inbäddade element. Säkerställ alt-texter, undertexter, tillräcklig kontrast och <a href="https://webaim.org/techniques/keyboard/">tangentbordsåtkomlighet</a> för länkar/knappar innan varningen ignoreras.',
    ...
    HEADING_UNPRONOUNCEABLE: `<p>Tomma rubriker skapar luckor i strukturen.</p><p>${why.fix}Lägg till läsbar text i denna rubrik, eller omvandla den till ett stycke.</p>${why.headings}`,
    ...
    HIDDEN_FOCUSABLE: `<p>Detta interaktiva element har <code>aria-hidden="true"</code> men kan fortfarande fokuseras.</p><p>${why.fix}Om det ska döljas för skärmläsare, lägg till <code>tabindex="-1"</code>; annars ta bort <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LABELS_MISSING_LABEL: `<p>${why.fix}Lägg till ett <code>id</code> på detta fält och ett matchande <code>for</code>-attribut på etiketten.</p>`,
    ...
    LINK_FILE_EXT: `<p><strong>Länktext:</strong> <i>%(TEXT)</i></p><p>Länken leder till en fil (PDF/MP3/ZIP/Word) utan att informera användaren.</p><p>${why.fix}Ange filtyp i länktext/ikon: <a href="https://itmaybejj.github.io/linkpurpose/"></a>.</p><p class="why">För stora filer, ange gärna storlek (t.ex. ”Årsrapport (PDF, 3 MB)”).</p>`,
    LINK_IDENTICAL_NAME: `<p><strong>Länktext:</strong> <i>%(TEXT)</i></p><p>${why.fix}Skriv om länkar som går till olika mål så att texten återspeglar deras unika destinationer.</p>${why.links}`,
    ...
    LINK_IMAGE_NO_ALT_TEXT: `<p>När en länk innehåller en bild används dess alt som <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">länkens namn</a>.</p><p>${why.fix}Använd titeln på länkens mål som alt-text för länkade bilder.</p>${why.imageLinks}`,
    ...
    LINK_NEW_TAB: `<p><strong>Länktext:</strong> <i>%(TEXT)</i></p><p>${why.fix}Öppna i samma flik eller <a href="https://itmaybejj.github.io/linkpurpose/">informera i förväg</a> om ny flik används.</p><div class="why"><p>Tvång till ny flik kan förvirra (tillbaka-knappen fungerar annorlunda). I formulär kan ny flik ibland skydda ifyllda uppgifter.</p></div>`,
    ...
    META_LANG: `<p>${why.fix}Lägg till <a href="https://www.w3.org/International/questions/qa-html-language-declarations">språkattribut</a> på <code>html</code>-elementet.</p><div class="why"><p>Korrekt språk ger korrekt uttal och begriplighet.</p></div>`,
    ...
    META_TITLE: `<p>${why.fix}Lägg till <code>&lt;title&gt;</code> i <code>head</code>.</p><div class="why"><p>En <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/title">kort och unik titel</a> är central för sökresultat, fliknamn och uppläsning vid flikbyte.</p><p>Utan titel återstår bara URL:en.</p></div>`,
    ...
    QA_IN_PAGE_LINK: `<p><strong>URL:</strong> <i>#%(ID)</i></p><p><strong>Länk:</strong> <code>%(TEXT)</code></p><p>Länkmålet för denna interna länk saknas på sidan.</p><div class="why"><p>För utvecklare: om JS hanterar länken, säkerställ tangentbordsstöd innan varningen ignoreras.</p></div>`,
