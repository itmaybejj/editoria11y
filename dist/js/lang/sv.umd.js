(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt‑text:</strong> <i>%(ALT_TEXT)</i></p><p>Skärmläsare försöker uttala denna URL, ofta tecken för tecken. Det ger sällan samma mening som att se bilden.</p><p>${why.fix}Beskriv kortfattat vad bilden betyder i detta sammanhang.</p>${why.images}`,
