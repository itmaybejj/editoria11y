(function(global, factory) {
  ...
  const Sa11yStrings = {
    ...
    strings: {
      ...
      TABLES_INVALID_HEADERS_REF: 'Attributet <code>headers</code> innehåller en ogiltig referens: <strong {C}>%(VALUE)</strong>. Det måste referera till ID för en giltig rubrikcell i samma tabell. <hr> Läs mer om att <a href="https://www.w3.org/WAI/WCAG22/Techniques/html/H43">använda attributen id och headers för att associera dataceller med rubrikceller i datatabeller.</a>',
      // Contrast
