...
var de = {
  ...
  strings: {
    ...
    OUTLINE: 'Gliederung',
    READABILITY_DESC:
      'Zeigt den Lesbarkeitswert im Tab <strong>Gliederung</strong> an, um die Leseschwierigkeit einzuschätzen.',
    TITLE: 'Titel',
    ALT: 'ALT',
    IMAGES: 'Bilder',
    EDIT: 'Bearbeiten',
    ...
    DEVELOPER_DESC:
      'Überprüft Probleme, deren Behebung Programmierkenntnisse erfordern kann, wie HTML-Attribute, Formulare und mehr.',
    DARK_MODE: 'Dark mode',
    ...
    NOT_VISIBLE:
      'Das Element, das Sie anzeigen möchten, ist nicht sichtbar; es ist möglicherweise ausgeblendet oder befindet sich in einer Akkordeon- oder Registerkartenkomponente.',
    MISSING_ROOT:
      'Die gesamte Seite wurde auf Barrierefreiheit geprüft, da der Zielbereich <code>%(root)</code> nicht existiert.',
    MISSING_READABILITY_ROOT:
      'Die Lesbarkeitsbewertung basiert auf dem Inhaltsbereich <code>%(fallback)</code>, da der Zielbereich <code>%(root)</code> nicht existiert.',
    SKIP_TO_PAGE_ISSUES: 'Zu Seitenproblemen springen',
    CONSOLE_ERROR:
      'Leider liegt ein Problem mit der Barrierefreiheitsprüfung auf dieser Seite vor. Können Sie es bitte <a href="%(link)">über dieses Formular</a> oder auf <a href="%(link)">GitHub</a> melden?',
    ...
    DISMISSED: 'Abgelehnt',
    DISMISS_REMINDER:
      'Bitte beachten Sie, dass Warnungen nur <strong>vorübergehend</strong> abgelehnt werden. Das Löschen Ihres Browserverlaufs und Ihrer Cookies stellt alle zuvor abgelehnten Warnungen auf allen Seiten wieder her.',
    ...
    COLOUR_FILTER_MESSAGE:
      'Suchen Sie nach Elementen, die schwer wahrnehmbar oder von anderen Farben zu unterscheiden sind.',
    ...
    HEADING_SKIPPED_LEVEL:
      'Überschriften sollten keine Ebenen überspringen oder von <strong>Überschrift %(PREV_LEVEL)</strong> zu <strong {C}>Überschrift %(LEVEL)</strong> springen, da dies die Ordnung und Hierarchie des Inhalts stört und das Folgen erschwert. <hr> Wenn <strong {C}>%(HEADING)</strong> unter den Abschnitt <strong>%(PREV_HEADING)</strong> fällt, sollten Sie in Betracht ziehen, es stattdessen als <strong>Überschrift %(LEVEL)</strong> zu formatieren.',
    HEADING_EMPTY:
      'Leere Überschrift gefunden! Um dies zu beheben, löschen Sie diese Zeile oder ändern Sie ihr Format von <strong {C}>Überschrift %(level)</strong> zu <strong>Normal</strong> oder <strong>Absatz (p)</strong>.',
    HEADING_LONG:
      'Die Überschrift ist lang! Überschriften sollten dazu dienen, den Inhalt zu gliedern und eine Struktur zu vermitteln. Sie sollten kurz, informativ und eindeutig sein. Überschriften sollten nicht länger als %(MAX_LENGTH) Zeichen sein (nicht länger als ein Satz). <hr> <strong {B}>%(HEADING_LENGTH) Zeichen</strong>',
    HEADING_FIRST:
    ...
    HEADING_MISSING_ONE:
      'Fehlende Überschrift 1: Überschrift 1 sollte am Anfang des Hauptinhaltsbereichs stehen und ist die Hauptüberschrift, die den allgemeinen Zweck der Seite beschreibt. Erfahre mehr über <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">Überschriften-Struktur.</a>',
    HEADING_EMPTY_WITH_IMAGE:
      'Die Überschrift hat keinen Text, enthält aber ein Bild. Wenn es sich nicht um eine Überschrift handelt, ändere das Format von <strong {C}>Überschrift %(level)</strong> zu <strong>Normal</strong> oder <strong>Absatz (p)</strong>. Andernfalls füge bitte einen Alt-Text zum Bild hinzu, wenn es nicht dekorativ ist.',
    ...
    LINK_EMPTY_LABELLEDBY:
      'Der Link hat einen Wert für <code>aria-labelledby</code>, der leer ist oder nicht mit dem Wert des <code>id</code>-Attributs eines anderen Elements auf der Seite übereinstimmt.',
    LINK_EMPTY_NO_LABEL:
      'Der Link hat keinen erkennbaren Text, der für Bildschirmleser und andere unterstützenden Technologien sichtbar ist. Zu beheben: <ul><li>Füge einen kurzen Text hinzu, der beschreibt, wohin der Link führt.</li><li>Wenn es ein <a href="https://a11y-101.com/development/icons-and-links">Icon Link oder ein SVG ist,</a> ist es sehr wahrscheinlich, dass ein beschreibendes Label fehlt.</li><li>Wenn Du glaubst, dass dieser Link aufgrund eines Kopier-/Einfügefehlers fehlerhaft ist, solltest Du ihn löschen.</li></ul>',
    LINK_STOPWORD:
      'Linktext ist möglicherweise außerhalb des Kontexts nicht aussagekräftig genug: <strong {C}>%(ERROR)</strong>',
    LINK_STOPWORD_ARIA:
      'Obwohl ein zugänglicher Name bereitgestellt wurde, sollten Sie den sichtbaren Linktext überarbeiten. Ausdrücke wie &quot;<strong {C}>%(ERROR)</strong>&quot; sind nicht aussagekräftig.',
    LINK_TIP:
      '<hr> <strong>Tipp!</strong> Verwenden Sie klaren und einzigartigen Linktext, der das Ziel des Links beschreibt, in der Regel der Titel der Seite oder des Dokuments.',
    LINK_CLICK_HERE:
      'Die Phrase "klicken" oder "hier klicken" konzentriert sich auf Mausmechanik, obwohl viele Personen keine Maus benutzen oder diese Webseite auf einem mobilen Gerät anzeigen. Verwenden Sie stattdessen ein anderes Verb, das zur Aufgabe passt.',
    DUPLICATE_TITLE:
      'Das Attribut <code>title</code> bei Links und Bildern soll zusätzliche Informationen bereitstellen und sollte <strong>anders</strong> als der Text oder der Alternativtext sein. Der Titeltext erscheint, wenn Sie mit der Maus über ein Element fahren, ist jedoch mit Tastatur oder Touch-Eingabe nicht zugänglich. Erwägen Sie <a href="https://www.a11yproject.com/posts/title-attributes/">das Attribut title vollständig zu vermeiden.</a>',
    LINK_SYMBOLS:
      'Vermeiden Sie die Verwendung von Symbolen als Handlungsaufforderungen im Linktext, es sei denn, sie sind für assistive Technologien verborgen. Bildschirmlesegeräte können die Symbole laut vorlesen, was verwirrend sein kann. Ziehen Sie in Betracht, sie zu entfernen: <strong {C}>%(ERROR)</strong>',
    LINK_URL:
      'Längere, weniger verständliche URLs, die als Linktext verwendet werden, könnten beim Zugriff mit Hilfe von Hilfsmitteln schwer zu verstehen sein. In den meisten Fällen ist es besser, anstelle der URL einen von Menschen lesbaren Text zu verwenden. Kurze URLs (z. B. die Homepage einer Website) sind in Ordnung.',
    LINK_DOI:
    ...
    // Images
    ALT_UNPRONOUNCEABLE:
      'Der Alternativtext enthält nur unaussprechbare Symbole und/oder Leerzeichen. Screenreader geben das Bild aus und machen dann eine Pause. Wenn das Bild dekorativ ist, stellen Sie sicher, dass der Alternativtext keine Leerzeichen enthält. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_ALT_UNPRONOUNCEABLE:
      'Der Alternativtext in diesem verlinkten Bild enthält nur unaussprechbare Symbole und/oder Leerzeichen. Screenreader geben das Bild aus und machen dann eine Pause. Stellen Sie sicher, dass der Alternativtext das Ziel des Links beschreibt. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    MISSING_ALT_LINK_HAS_TEXT:
      'Das Bild wird als Link mit umliegendem Text verwendet, obwohl das alt-Attribut als dekorativ oder null markiert sein sollte.',
    MISSING_ALT_LINK:
      'Das Bild wird als Link verwendet, aber es fehlt der Alt-Text! Bitte stellen Sie sicher, dass der Alt-Text beschreibt, wohin der Link Dich führt.',
    MISSING_ALT:
      'Fehlender Alt text! Wenn das Bild eine Geschichte, eine Stimmung oder eine wichtige Information vermittelt - beschreibe das Bild unbedingt.',
    LINK_ALT_FILE_EXT:
      'Alternativtext sollte keine Dateierweiterungen oder Bildmaße enthalten. Achte darauf, dass der Alt-Text das Ziel des Links beschreibt und nicht eine wörtliche Beschreibung des Bildes ist. Entferne: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_PLACEHOLDER_ALT:
      'Nicht beschreibender oder Platzhalter-Alt-Text innerhalb eines verlinkten Bildes gefunden. Achte darauf, dass der Alt-Text das Ziel des Links beschreibt und nicht eine wörtliche Beschreibung des Bildes ist. Ersetzen Sie den folgenden Alt-Text. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_SUS_ALT:
      'Assistive Technologien zeigen bereits an, dass es sich um ein Bild handelt, so dass &quot;<strong {C}>%(ERROR)</strong>&quot; möglicherweise überflüssig ist. Achte darauf, dass der Alt-Text das Ziel des Links beschreibt und nicht eine wörtliche Beschreibung des Bildes ist. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_FILE_EXT:
      'Alternativtext sollte keine Dateierweiterungen oder Bildmaße enthalten. Wenn das Bild eine Geschichte, eine Stimmung oder eine wichtige Information vermittelt - beschreibe das Bild unbedingt. Entferne: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER:
      'Nicht-beschreibender oder Platzhalter-Alt-Text gefunden. Ersetze den folgenden Alt-Text durch einen aussagekräftigeren Text. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    SUS_ALT:
      'Assistive Technologien zeigen bereits an, dass es sich um ein Bild handelt, so dass &quot;<strong {C}>%(ERROR)</strong>&quot; möglicherweise überflüssig ist. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_NO_ALT_TEXT:
      'Das Bild innerhalb des Links ist als dekorativ gekennzeichnet und es gibt keinen Linktext. Bitte füge dem Bild einen Alt-Text hinzu, der das Ziel des Links beschreibt.',
    LINK_IMAGE_TEXT:
      'Das Bild ist als dekorativ gekennzeichnet, obwohl der Link den umgebenden Text als beschreibende Bezeichnung verwendet.',
    LINK_IMAGE_LONG_ALT:
      'Alt-Text-Beschreibung auf einem verlinkten Bild ist <strong>zu lang</strong>. Der Alt-Text von verlinkten Bildern sollte beschreiben, wohin der Link führt, und nicht eine wörtliche Beschreibung des Bildes enthalten. <strong>Erwäge, den Titel der Seite, auf die verlinkt wird, als Alt-Text zu verwenden.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Zeichen</strong> <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT:
      'Der Bildlink enthält einen Alt-Text. <strong>Beschreibt der Alt-Text, wohin der Link Sie führt?</strong> Erwägen Sie, den Titel der Seite, zu der der Link führt, als Alt-Text zu verwenden. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_AND_TEXT:
      'Der Bildlink enthält <strong>beide Alt-Texte und den umgebenden Linktext.</strong> Wenn dieses Bild dekorativ ist und als funktionaler Link zu einer anderen Seite verwendet wird, sollte das Bild als dekorativ oder nichtig gekennzeichnet werden - der umgebende Linktext sollte ausreichen. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Zugänglicher Name</strong> {L} <strong {C}>%(TEXT)</strong>',
    IMAGE_FIGURE_DECORATIVE:
      'Das Bild ist als <strong>dekorativ</strong> gekennzeichnet und wird von Hilfsmitteln ignoriert. <hr> Obwohl eine <strong>Beschriftung</strong> angegeben wurde, sollte das Bild in den meisten Fällen auch einen Alt-Text haben. <ul><li>Der Alt-Text sollte eine prägnante Beschreibung des Bildes enthalten.</li><li>Die Bildunterschrift sollte in der Regel einen Zusammenhang zwischen dem Bild und dem umgebenden Inhalt herstellen oder auf eine bestimmte Information hinweisen.</li></ul>Erfahre mehr: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a>',
    ...
    IMAGE_DECORATIVE:
      'Das Bild ist als <strong>dekorativ</strong> gekennzeichnet und wird von Hilfsmitteln ignoriert. Wenn das Bild eine Geschichte, eine Stimmung oder wichtige Informationen vermittelt - füge unbedingt einen Alt-Text hinzu.',
    IMAGE_ALT_TOO_LONG:
      'Die Beschreibung des Alt-Textes ist <strong>zu lang</strong>. Der Alt-Text sollte prägnant, aber aussagekräftig wie ein <em>Tweet</em> sein (etwa 100 Zeichen). Wenn es sich um ein komplexes Bild oder eine Grafik handelt, sollten Sie erwägen, die lange Beschreibung des Bildes in den Text darunter oder in eine Akkordeonkomponente zu integrieren. <hr> {ALT} <strong {B}>%(altLength) Zeichen</strong> <strong {C}>%(ALT_TEXT)</strong>',
    IMAGE_DECORATIVE_CAROUSEL:
      'Das Bild ist als dekorativ gekennzeichnet, aber alle Bilder in einem Karussell oder einer Galerie sollten beschreibenden Alt-Text enthalten, um ein gleichwertiges Erlebnis für alle zu gewährleisten.',
    IMAGE_PASS: '{ALT} %(ALT_TEXT)',
    LINK_ALT_MAYBE_BAD:
      'Bildlink hat möglicherweise Alt-Text, der keine nützlichen Informationen liefert oder nicht beschreibend ist. Stellen Sie sicher, dass der Alt-Text das Ziel des Links beschreibt. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_MAYBE_BAD:
      'Alt-Text liefert möglicherweise keine nützlichen Informationen oder ist nicht beschreibend. Verbessern Sie den folgenden Alt-Text: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

    // Labels
    LABELS_MISSING_IMAGE_INPUT:
      'Bildschaltfläche fehlt Alt-Text. Bitte füge alternativen Text hinzu, um einen barrierefreien Namen bereitzustellen. Zum Beispiel: <em>Suchen</em> oder <em>Senden</em>.',
    LABELS_INPUT_RESET:
    ...
    LABELS_ARIA_LABEL_INPUT:
      'Die Eingabe hat einen zugänglichen Namen, stelle bitte trotzdem sicher, dass es auch ein sichtbares Label gibt. <hr> <strong {B}>Zugänglicher Name</strong> <strong {C}>%(TEXT)</strong>',
    LABELS_NO_FOR_ATTRIBUTE:
      'Dieser Eingabe ist kein Label zugeordnet. Füge dem Label ein <code>for</code>-Attribut hinzu, das der <code>id</code> dieser Eingabe entspricht. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    ...
    // Embedded content
    EMBED_VIDEO:
      'Bitte stelle sicher, dass <strong>alle Videos Untertitel haben.</strong> Das Bereitstellen von Untertiteln für alle Audio- und Videoinhalte ist eine obligatorische Anforderung der Stufe-A. Bildunterschriften unterstützen Menschen, die Taub oder schwerhörig sind.',
    EMBED_AUDIO:
      'Bitte stelle sicher, dass Du ein <strong>Transkript für alle Podcasts bereitstellst.</strong> Das Bereitstellen von Transkripten für Audioinhalte ist eine obligatorische Anforderung der Stufe-A. Transkripte unterstützen Menschen, die gehörlos oder schwerhörig sind, können aber allen zugute kommen. Erwäge, das Transkript unter- oder innerhalb eines Akkordeonfelds zu platzieren.',
    EMBED_DATA_VIZ:
    ...
    EMBED_UNFOCUSABLE:
      '<code>&lt;iframe&gt;</code> mit nicht fokussierbaren Elementen sollte kein <code>tabindex="-1"</code> haben. Der eingebettete Inhalt wird nicht mit der Tastatur erreichbar sein.',
    ...
    QA_PDF:
      'PDFs können nicht auf Barrierefreiheit geprüft werden. PDFs gelten als Webinhalte und müssen ebenfalls zugänglich gemacht werden. PDFs enthalten oft Probleme für Personen, die Screenreader verwenden (fehlende Struktur-Tags oder fehlende Beschriftungen von Formularfeldern) und Personen mit Sehbehinderung (Text umfließt beim Vergrößern nicht ). <ul><li>Wenn es sich um ein Formular handelt, solltest Du alternativ ein barrierefreies HTML-Formular verwenden.</li><li>Wenn es sich um ein Dokument handelt, solltest Du es in eine Webseite umwandeln.</li></ul> Andernfalls überprüfe bitte <a href="https://helpx.adobe.com/acrobat/using/create-verify-pdf-accessibility.html">PDF für Barrierefreiheit in Acrobat DC.</a>',
    QA_DOCUMENT:
      'Das Dokument kann nicht auf Zugänglichkeit geprüft werden. Verknüpfte Dokumente gelten als Webinhalte und müssen ebenfalls zugänglich gemacht werden. Bitte überprüfen Sie dieses Dokument manuell. <ul><li>Machen Sie Ihr <a href="https://support.google.com/docs/answer/6199477?hl=de">Google Workspace-Dokument oder Ihre Präsentation besser zugänglich.</a></li><li>Machen Sie Ihre <a href="https://support.microsoft.com/de-de/office/create-accessible-office-documents-868ecfcd-4f00-4224-b881-a65537a7c155">Office-Dokumente besser zugänglich.</a></li></ul>',
    QA_BLOCKQUOTE:
      'Ist das eine Überschrift? <strong {C}>%(TEXT)</strong> <hr> Blockquotes sollten nur für Zitate verwendet werden. Wenn dies eine Überschrift sein soll, ändere dieses Blockquote in eine semantische Überschrift (z. B. Überschrift 2 oder Überschrift 3).',
    QA_FAKE_HEADING:
      'Ist das eine Überschrift? <strong {C}>%(TEXT)</strong> <hr> Eine Zeile mit fettem Text mag wie eine Überschrift aussehen, aber jemand, der einen Bildschirmleser verwendet, kann nicht erkennen, dass sie wichtig ist, oder zu ihrem Inhalt springen. Fettgedruckter Text sollte niemals semantische Überschriften ersetzen (Überschrift 2 bis Überschrift 6).',
    QA_FAKE_LIST:
      'Versuchst Du, eine Liste zu erstellen? Mögliches gefundenes Listenelement: <strong {C}>%(firstPrefix)</strong> <hr> Stelle sicher, dass Du semantische Listen verwendest, indem Du stattdessen eine Aufzählungsliste formatierst (Zahlen oder Bullet-Points). Bei der Verwendung einer semantischen Liste sind Hilfstechnologien in der Lage, Informationen wie die Gesamtzahl der Elemente und die relative Position jedes Elements in der Liste zu übermitteln. Erfahre mehr über <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">semantische Listen.</a>',
    QA_UPPERCASE:
      'Text in Großbuchstaben gefunden. Einige Screenreader interpretieren Text in Großbuchstaben möglicherweise als Akronym und lesen jeden Buchstaben einzeln. Außerdem finden manche Leute, dass Großbuchstaben schwieriger zu lesen sind, und es kann den Anschein erwecken, als würden man SCHREIEN.',
    QA_UNDERLINE:
      'Unterstrichener Text kann mit Links verwechselt werden. Erwäge die Verwendung eines anderen Stils wie <code>&lt;strong&gt;</code><strong>starke Wichtigkeit</strong><code>&lt;/strong&gt;</code> oder <code>&lt;em&gt;</code><em>Hervorhebung</em><code>&lt;/em&gt;</code>.',
    QA_SUBSCRIPT:
      'Die Formatierungsoptionen für tiefgestellten und hochgestellten Text sollten nur verwendet werden, um die Textposition für typografische Konventionen oder Standards zu ändern. Es sollte <strong>nicht</strong> ausschließlich zu Präsentations- oder Erscheinungszwecken verwendet werden. Das Formatieren ganzer Sätze wirft Lesbarkeitsprobleme auf. Geeignete Anwendungsfälle wären die Anzeige von Exponenten, Ordnungszahlen wie 4<sup>th</sup> anstelle von 4 und chemischen Formeln (z. B. H<sub>2</sub>O).',
    QA_NESTED_COMPONENTS:
      'Vermeiden Sie das Verschachteln interaktiver Layoutkomponenten, wie das Platzieren von Akkordeons in Tabs oder Tabs in Akkordeons. Dies kann die Navigation komplizieren, die kognitive Belastung erhöhen und dazu führen, dass Inhalte übersehen werden.',
    QA_JUSTIFY:
      'Vermeiden Sie die Verwendung von Blocksatz, der sowohl am linken als auch am rechten Rand ausgerichtet ist. Dies kann für einige Menschen aufgrund der ungleichmäßigen Abstände zwischen den Wörtern schwer lesbar sein. Verwenden Sie linksbündigen Text für eine bessere Lesbarkeit.',
    QA_SMALL_TEXT:
    ...
    // Developer
    DUPLICATE_ID:
      '<strong>Doppelte ID</strong> gefunden. Doppelte ID-Fehler verursachen bekanntermaßen Probleme für Hilfstechnologien, wenn man versucht, mit Inhalten zu interagieren. Bitte entferne oder ändere die folgende ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    UNCONTAINED_LI:
      'Alle <code>&lt;li&gt;</code> Listenelemente müssen innerhalb von <code>&lt;ul&gt;</code> ungeordneten oder <code>&lt;ol&gt;</code> geordneten Elementen platziert werden. Diese Struktur hilft Bildschirmlesern, die Liste und ihre Elemente genau anzukündigen.',
    ...
    META_SCALABLE:
      'Entfernen Sie den Parameter <code>user-scalable="no"</code> im <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">Viewport-Meta-Tag</a>, um das Zoomen zu ermöglichen.',
    META_MAX:
    ...
    BTN: 'Schaltfläche',
    BTN_TIP:
      'Erfahren Sie, wie Sie eine <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">zugängliche Schaltfläche</a> erstellen.',
    BTN_ROLE_IN_NAME:
    ...
    CONTRAST_WARNING:
      'Der Kontrast dieses Textes ist unbekannt und muss manuell überprüft werden. Stellen Sie sicher, dass Text und Hintergrund starke Kontrastfarben haben.',
    CONTRAST_ERROR_GRAPHIC:
      'Diese Grafik hat nicht genug Kontrast zum Hintergrund, was sie schwer erkennbar macht.',
    CONTRAST_WARNING_GRAPHIC:
      'Der Kontrast dieser Grafik ist unbekannt und muss manuell überprüft werden.',
    CONTRAST_TIP_GRAPHIC:
      'Grafiken und Benutzeroberflächenelemente sollten ein Kontrastverhältnis von mindestens 3:1 haben.',
    CONTRAST_OPACITY: 'Erhöhen Sie die Deckkraft für bessere Sichtbarkeit.',
    CONTRAST_APCA:
      'Dies ist nicht genug Kontrast für beliebige Textgrößen. Erwägen Sie, diese Farbkombination und Textgröße zu verwenden?',
    ...
    CONTRAST_PLACEHOLDER:
      'Platzhaltertext in diesem Eingabefeld hat nicht genug Kontrast zum Hintergrund, was das Lesen erschwert.',
    CONTRAST_PLACEHOLDER_UNSUPPORTED:
      'Der Kontrast dieses Platzhaltertexts ist unbekannt und muss manuell überprüft werden. Stellen Sie sicher, dass der Text und der Hintergrund starke Kontrastfarben haben.',
    CONTRAST_INPUT:
      'Text in diesem Eingabefeld hat nicht genug Kontrast zum Hintergrund, was das Lesen erschwert.',
    CONTRAST: 'Kontrast',
    UNKNOWN: 'Unbekannt',
    FG: 'Vordergrund',
    BG: 'Hintergrund',
