...
<li>Ha segnato il gol della vittoria dalla fascia sinistra!</li></ul></div>`,
  ...
  const tips = {
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Testo alternativo:</strong> <i>%(ALT_TEXT)</i></p><p>I lettori di schermo proveranno a pronunciare questo URL; difficilmente trasmette lo stesso significato dell’immagine.</p><p>${why.fix}Descrivi in modo conciso cosa significa questa immagine, in questo contesto.</p>${why.images}`,
