...
<li>Ha segnato il gol della vittoria dalla fascia sinistra!</li></ul></div>`,
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p>${why.fix}Aggiungi testo descrittivo o elimina il link se è un errore (p.es. spazio linkato).</p><div class="why"><p>Suggerimento: i link vuoti producono silenzi o fanno leggere l’URL.</p><p>Gli spazi linkati a volte richiedono di riscrivere il testo intorno per essere rimossi.</p></div>`,
