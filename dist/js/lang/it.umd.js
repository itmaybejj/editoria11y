(function(global, factory) {
  ...
  const testNames = {
    ...
    META_LANG_VALID: "Il codice lingua per questo elemento non è valido",
...
<li>Ha segnato il gol della vittoria dalla fascia sinistra!</li></ul></div>`,
  ...
  const tips = {
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span>Testo alternativo: <i>%(ALT_TEXT)</i></p><p>I lettori di schermo possono leggere questo URL lettera per lettera; difficilmente trasmette lo stesso significato dell’immagine.</p><p>${why.fix}Aggiungi alt vuoto (alt="") se è decorativa, oppure un testo alternativo descrittivo.</p>${why.images}`,
    ALT_MAYBE_BAD: `<p>Testo alternativo: <i>%(alt)</i></p><p>${why.fix}Imposta un testo alternativo conciso che esprima cosa significa l’immagine in questo contesto.</p>${why.images}`,
    ALT_MAYBE_BAD_WARNING: `<p>Testo alternativo: <i>%(alt)</i></p><p>${why.fix}Imposta un testo alternativo conciso che esprima cosa significa l’immagine in questo contesto.</p>${why.images}`,
    ALT_PLACEHOLDER: `<p>Testo alternativo: <i>%(alt)</i></p><p>${why.fix}Imposta un testo alternativo conciso che esprima cosa significa l’immagine in questo contesto.</p>${why.images}`,
    ALT_UNPRONOUNCEABLE: `<p>Testo alternativo: <i>%(alt)</i></p><p>Questo testo alternativo contiene solo simboli o spazi non pronunciabili. Un lettore di schermo annuncerà “immagine”, poi farà una pausa o produrrà un risultato incomprensibile.</p><p>${why.fix}Aggiungi un alt descrittivo oppure alt=”” se è solo un’icona o uno spazio funzionale.</p>${why.images}`,
    ...
    LINK_ALT_MAYBE_BAD: `<p>Testo alternativo: <i>%(alt)</i></p><p>${why.fix}Imposta l’alt sulla destinazione del link.</p>${why.imageLinks}`,
    LINK_ALT_MAYBE_BAD_WARNING: `<p>Testo alternativo: <i>%(alt)</i></p><p>${why.fix}Imposta l’alt sulla destinazione del link.</p>${why.imageLinks}`,
    LINK_ALT_UNPRONOUNCEABLE: `<p>L’alt per l’immagine linkata contiene solo simboli/spazi: <i>%(ALT_TEXT)</i></p><p>${why.fix}Usa un alt che descriva destinazione o scopo del link.</p>${why.imageLinks}`,
    ...
    LINK_IMAGE_ALT: `<p><strong>Testo alternativo:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Assicurati che questo alt descriva la destinazione del link, non solo il contenuto visivo dell’immagine:</p>${why.imageLinks}`,
    ...
    LINK_IMAGE_LONG_ALT: `<p>Testo alternativo di %(altLength) caratteri: <i class="ed11y-small">%(ALT_TEXT)</i></p><p>${why.fix}Imposta l’alt sul titolo della destinazione.</p><div class="why"><p>I lettori di schermo leggono le liste di link fuori contesto; l’alt deve descrivere la destinazione, non l’immagine.</p></div>`,
    LINK_IMAGE_NO_ALT_TEXT: `<p>Se un link contiene un'immagine, il suo alt <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">funge da etichetta del link</a>.</p><p>${why.fix}Imposta l'alt su destinazione o scopo del link.</p>${why.imageLinks}`,
    ...
    LINK_PLACEHOLDER_ALT: `<p>L’alt dell’immagine linkata è un segnaposto: <i>%(alt)</i>.</p><p>${why.fix}Imposta l’alt sulla destinazione.</p>${why.imageLinks}`,
    ...
    LINK_SUS_ALT: `<p>Questo alt contiene la parola <i>%(alt)</i>, il che spesso indica che non descrive la destinazione.</p><p>Alt: <i>%(ALT_TEXT)</i></p><p>Correzione: assicurati che descriva la destinazione o lo scopo.</p>${why.imageLinks}`,
