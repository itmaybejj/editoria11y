(function(global, factory) {
  ...
  const tooltip = {
    ...
    EMBED_MISSING_TITLE: 'Il contenuto incorporato richiede un nome accessibile che ne descriva il contenuto. Si prega di fornire un attributo unico <code>title</code> o <code>aria-label</code> sull’elemento <code>&lt;%(ELEMENT)&gt;</code>. Per saperne di più su <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
  ...
  const testNames = {
    ...
    BTN_UNPRONOUNCEABLE: "Questo pulsante non è pronunciabile",
    ...
    HEADING_UNPRONOUNCEABLE: "Questa intestazione non è pronunciabile",
    ...
    IMAGE_FIGURE_DECORATIVE: "Questa immagine con didascalia non ha testo alternativo",
    ...
    LINK_CLICK_HERE: "Questo link contiene “clicca qui”",
    ...
    LINK_IMAGE_ALT: "Questo testo alternativo descrive il link o l’immagine?",
    ...
    LINK_IMAGE_TEXT: "Questa immagine linkata necessita di una descrizione?",
    ...
    LINK_SYMBOLS: "I simboli o le emoji in questo link sono significativi?",
    ...
    QA_BAD_LINK: "La destinazione di questo link potrebbe non essere valida",
...
<li>Ha segnato il gol della vittoria dalla fascia sinistra!</li></ul></div>`,
  ...
  const tips = {
    ...
    BTN_UNPRONOUNCEABLE: `<p><strong>Testo del pulsante:</strong> <i>%(TEXT)</i></p><p>${why.fix}Aggiungi testo, un titolo o un aria-label che descriva la sua destinazione.</p><div class="why"><p>Consiglio: gli screen reader non possono descrivere i pulsanti che contengono solo spazi o simboli. Rimangono silenziosi (“Pulsante, [...pausa imbarazzante dove dovrebbe essere l’etichetta del pulsante...]”), oppure leggono il nome del simbolo.</p></div>`,
    ...
    EMBED_GENERAL: 'I controlli automatici non esaminano il contenuto interno di embed. Assicurati che le immagini abbiano alt, i video sottotitoli, il testo contrasto sufficiente e che link/pulsanti siano <a href="https://webaim.org/techniques/keyboard/">accessibili da tastiera</a>, quindi chiudi l’avviso.',
    ...
    HEADING_UNPRONOUNCEABLE: `<p>Intestazioni vuote creano buchi nella struttura.</p><p>${why.fix}Aggiungi testo leggibile a questa intestazione, oppure convertila in un paragrafo.</p>${why.headings}`,
    ...
    HIDDEN_FOCUSABLE: `<p>Questo elemento ha <code>aria-hidden="true"</code>, ma è ancora focalizzabile da tastiera.</p><p>${why.fix}Se va nascosto agli screen reader, aggiungi <code>tabindex="-1"</code>; altrimenti rimuovi <code>aria-hidden</code>.</p><p><strong>Elemento:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LINK_FILE_EXT: `<p><strong>Testo del link:</strong> <i>%(TEXT)</i></p><p>Il link punta a un file (PDF, MP3, ZIP, Word, …) senza avviso.</p><p>${why.fix}Indica nel link il tipo di file (testo/icone; vedi <a href="https://itmaybejj.github.io/linkpurpose/">)</a>.</p><p class="why">Per file grandi, indica la dimensione, es. “Rapporto (PDF, 3 MB)”.</p>`,
    LINK_IDENTICAL_NAME: `<p><strong>Testo del link:</strong> <i>%(TEXT)</i></p><p>${why.fix}Rendi unici i testi dei link in base alla destinazione.</p>${why.links}`,
    ...
    META_LANG: `<p>${why.fix}Aggiungi l’<a href="https://www.w3.org/International/questions/qa-html-language-declarations">attributo di lingua</a> al tag HTML.</p><div class="why"><p>I lettori di schermo impostano la pronuncia dalla lingua; una lingua errata produce pronuncia confusa.</p></div>`,
    ...
    META_TITLE: `<p>${why.fix}Aggiungi <code>&lt;title&gt;</code> in <code>head</code>.</p><div class="why"><p>Un <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/title">titolo breve e unico</a> è fondamentale:</p><ul><li>Nei risultati di ricerca</li><li>Nelle schede del browser</li><li>Annunciato dai lettori di schermo al cambio scheda</li></ul><p>Senza titolo, si vede/sente un URL grezzo.</p></div>`,
    ...
    QA_IN_PAGE_LINK: `<p><strong>URL:</strong> <i>#%(ID)</i></p><p><strong>Link:</strong> <code>%(TEXT)</code></p><p>La destinazione del link non corrisponde a nessun elemento in pagina.</p><div class="why"><p>Nota dev: se è un handler JS, verifica anche l’uso da tastiera prima di escludere il controllo.</p></div>`,
