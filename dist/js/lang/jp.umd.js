(function(global, factory) {
  ...
  const tips = {
    ...
    QA_IN_PAGE_LINK: `<p><strong>リンク：</strong> <i>%(TEXT)</i></p><p><strong>URL：</strong> <code>#%(ID)</code></p><p>このページ内リンクのターゲットが存在しません。</p><div class="why"><p>開発者向け：JavaScript で処理している場合は、キーボード操作でも動作することを確認してください。</p></div>`,
