(function(global, factory) {
  ...
  const tips = {
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt szöveg:</strong> <i>%(ALT_TEXT)</i></p><p>A képernyőolvasók megpróbálják kiejteni ezt az URL-t. Ez nem adja vissza a kép látványának jelentését.</p><p>${why.fix}Tömören írja le, mit jelent ez a kép ebben a kontextusban.</p>${why.images}`,
    ...
    LINK_IDENTICAL_NAME: `<p>Link szöveg: <i>%(TEXT)</i></p><p><strong class="badge">Megoldás</strong> Fogalmazza át azokat a linkeket, amelyek különböző célokra mutatnak, és adjon mindegyiknek egyedi, célhoz illő szöveget.</p>${why.links}`,
    ...
    QA_IN_PAGE_LINK: `<p><strong>Link:</strong> <i>%(TEXT)</i></p><p><strong>URL:</strong> <code>#%(ID)</code></p><p>A hivatkozás célja nem található a lapon.</p><div class="why"><p>Megjegyzés fejlesztőknek: ha ez JavaScript‑es horgony, ellenőrizze, hogy billentyűzettel is működik, mielőtt a kivételek közé veszi.</p></div>`,
