(function(global, factory) {
  ...
  const tips = {
    ...
    HIDDEN_FOCUSABLE: `<p>Ez az interaktív elem <code>aria-hidden="true"</code> beállítással rendelkezik, mégis fókuszálható. Ha el akarja rejteni a képernyőolvasók elől, adjon hozzá <code>tabindex="-1"</code>. Ha nem, távolítsa el az <code>aria-hidden</code> attribútumot.</p><p><strong>Elem:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LINK_IDENTICAL_NAME: `<p><strong>Link szöveg:</strong> <i>%(TEXT)</i></p><p><strong class="badge">Megoldás</strong> Fogalmazza át azokat a linkeket, amelyek különböző célokra mutatnak, és adjon mindegyiknek egyedi, célhoz illő szöveget.</p>${why.links}`,
    ...
    LINK_STOPWORD: `<p>Link szöveg: <i>%(ERROR)</i></p><p><strong class="badge">Megoldás</strong> Használjon olyan linkszöveget, amely leírja a link célját.</p>${why.links}`,
    ...
    LINK_SYMBOLS: `<p>Talált szimbólum: <i>%(ERROR)</i></p><p><strong class="badge">Megoldás</strong> Ne használjon szimbólumokat felhívásként a link szövegében, hacsak azok nincsenek elrejtve az akadálymentes technológiák elől. A képernyőolvasók felolvashatják őket, ami félrevezető lehet.</p>`,
