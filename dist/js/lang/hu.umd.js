(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_FILE_EXT: `<p><strong>Link szövege:</strong> <i>%(TEXT)</i></p><p>A link fájlra mutat (PDF, MP3, ZIP, Word stb.) előzetes tájékoztatás nélkül.</p><p>${why.fix}Jelezze a fájltípust a linkben (szöveggel vagy ikonnal): https://itmaybejj.github.io/linkpurpose/</a>.</p><p class="why">Nagy fájloknál érdemes a méretet is feltüntetni: „Éves jelentés (PDF, 3 MB)”.</p>`,
    ...
    LINK_IMAGE_NO_ALT_TEXT: `<p>Ha egy link képben jelenik meg, az alt szöveg https://webaim.org/techniques/hypertext/link_text#alt_linka link neveként hangzik el</a>.</p><p>${why.fix}Képlinkeknél használja a link céloldalának címét alt szövegként.</p>${why.imageLinks}`,
