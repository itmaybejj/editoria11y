(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p><strong class="badge">Megoldás</strong> Adjon hozzá szöveget, amely leírja a link célját, vagy törölje, ha ez csak elgépelés vagy egy linkelt szóköz.</p><div class="why"><p>Tipp: a képernyőolvasók nem tudják értelmezni az üres linkeket. Vagy csendben maradnak ("Link, [...hosszú szünet...]"), vagy a teljes URL-t betűzik ki.</p><p>Egyes szerkesztőkben a linkelt szóközök nehezen törölhetők; előfordulhat, hogy a szóköz körüli szöveget is törölni kell.</p></div>`,
