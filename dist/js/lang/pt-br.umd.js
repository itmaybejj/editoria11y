(function(global, factory) {
  ...
  const tooltip = {
    ...
    HEADING_UNPRONOUNCEABLE: "O texto do cabeçalho contém apenas símbolos ou caracteres impronunciáveis. Se você acha que isso é um erro devido a uma falha de copiar/colar, considere excluí-lo. <hr> <strong {B}>Texto do cabeçalho</strong> <strong {C}>%(TEXT)</strong>",
    ...
    EMBED_MISSING_TITLE: 'O conteúdo incorporado requer um nome acessível que descreva seu conteúdo. Forneça um atributo <code>title</code> ou <code>aria-label</code> exclusivo no elemento <code>&lt;%(ELEMENT)&gt;</code>. Saiba mais sobre <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
