...
var es = {
  ...
  strings: {
    ...
    OUTLINE: 'Esquema',
    READABILITY_DESC:
      'Muestra la puntuación de legibilidad en la pestaña <strong>Esquema</strong> para ayudar a evaluar la dificultad de lectura.',
    TITLE: 'Título',
    ALT: 'ALT',
    IMAGES: 'Imágenes',
    EDIT: 'Editar',
    ...
    DEVELOPER_DESC:
      'Verifica problemas que pueden requerir conocimientos de programación para solucionarse, como atributos HTML, formularios y más.',
    ...
    NOT_VISIBLE:
      'El item que estas intentando ver no es visible; puede estar oculto o dentro de un componente de acordeón o pestaña.',
    MISSING_ROOT:
      'Se comprobó la accesibilidad de la página completa porque el área de destino <code>%(root)</code> no existe.',
    MISSING_READABILITY_ROOT:
      'La puntuación de legibilidad se basa en el área de contenido <code>%(fallback)</code>, porque el área objetivo <code>%(root)</code> no existe.',
    SKIP_TO_PAGE_ISSUES: 'Saltar problemas de la página',
    CONSOLE_ERROR:
      'Lo siento, pero hay un problema con el comprobador de accesibilidad en esta página. Puedes por favor <a href="%(link)">reportarlo a través de este formulario</a> or on <a href="%(link)">GitHub</a>?',
    ...
    DISMISSED: 'Ignorado',
    DISMISS_REMINDER:
      'Tenga en cuenta que las advertencias solo se <strong>ignoran temporalmente</strong>. Eliminar el historial del navegador y las cookies restaurará todas las advertencias previamente ignoradas en todas las páginas.',
    ...
    COLOUR_FILTER_MESSAGE:
      'Comprueba elementos que sean difíciles de percibir o distinguir de otros colores.',
    RED_EYE: 'Ciego rojo.',
    ...
    READABILITY_NOT_ENOUGH:
      'No hay suficiente contenido para calcular la puntuación de legibilidad.',

    // Headings
    HEADING_SKIPPED_LEVEL:
      'Las cabeceras no deben saltarse niveles ni pasar de <strong>Encabezado %(PREV_LEVEL)</strong> a <strong {C}>Encabezado %(LEVEL)</strong>, ya que esto interrumpe el orden y la jerarquía del contenido, lo que dificulta su seguimiento. <hr> Si <strong {C}>%(HEADING)</strong> cae bajo la sección <strong>%(PREV_HEADING)</strong>, considere formatearlo como un <strong>Encabezado %(LEVEL)</strong> en su lugar.',
    HEADING_EMPTY:
      'Encabezado vacío encontrado! Para corregir, elimine esta línea o cambie su formato de <strong {C}>Encabezado %(level)</strong> a <strong>Normal</strong> o <strong>Párrafo</strong>.',
    HEADING_LONG:
      '¡El título es largo! Los encabezados deben usarse para organizar el contenido y transmitir la estructura. Deben ser breves, informativos y únicos. Mantenga los encabezados de menos de %(MAX_LENGTH) caracteres (no más de una oración). <hr> <strong {B}>%(HEADING_LENGTH) Caracteres</strong>',
    HEADING_FIRST:
    ...
    HEADING_MISSING_ONE:
      'Falta el encabezado 1. El encabezado 1 debe ser el comienzo del área de contenido principal y es el encabezado principal que describe el propósito general de la página. Aprender más acerca de la <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">estructura de encabezado.</a>',
    HEADING_EMPTY_WITH_IMAGE:
      'El encabezado no tiene texto, pero contiene una imagen. Si no es un encabezado, cambie su formato de <strong {C}>Título %(level)</strong> a <strong>Normal</strong> o <strong>Párrafo</strong>. De lo contrario, agregue texto alternativo a la imagen si no es decorativa.',
    ...
    LINK_EMPTY_LABELLEDBY:
      'El enlace tiene un valor para <code>aria-labelledby</code> que está vacío o no coincide con el valor del atributo <code>id</code> de otro elemento en la página.',
    LINK_EMPTY_NO_LABEL:
      'El enlace no tiene texto perceptible que sea visible para los lectores de pantalla y otras tecnologías de asistencia. Para solucionarlo: <ul><li>Agregue un texto conciso que describa a dónde lo lleva el enlace.</li><li>Si es un <a href="https://a11y-101.com/development/icons-and-links">icono de enlace o SVG,</a> es probable que le falte una etiqueta descriptiva.</li><li>Si cree que este enlace es un error debido a un error de copiar/pegar, considere eliminarlo.</li></ul>',
    LINK_STOPWORD:
      'El texto del enlace puede no ser lo suficientemente descriptivo fuera de contexto: <strong {C}>%(ERROR)</strong>',
    LINK_STOPWORD_ARIA:
      'Aunque se proporcionó un nombre accesible, considere revisar el texto visible del enlace. Frases como &quot;<strong {C}>%(ERROR)</strong>&quot; no son significativas.',
    LINK_TIP:
      '<hr> <strong>¡Consejo!</strong> Use un texto de enlace claro y único que describa el destino del enlace, típicamente el título de la página o documento.',
    LINK_CLICK_HERE:
      'La frase "haz clic" o "haga clic aquí" pone el foco en la mecánica del mouse, cuando muchas personas no usan un mouse o pueden estar viendo este sitio web en un dispositivo móvil. Considere usar un verbo diferente relacionado con la tarea.',
    DUPLICATE_TITLE:
      'El atributo <code>title</code> en enlaces e imágenes está diseñado para proporcionar información adicional y debe ser <strong>diferente</strong> al texto o texto alternativo. El texto del título aparece al pasar el ratón sobre un elemento, pero no es accesible con teclado o entrada táctil. Considere <a href="https://www.a11yproject.com/posts/title-attributes/">evitar completamente el atributo de título.</a>',
    LINK_SYMBOLS:
      'Evite usar símbolos como llamadas a la acción dentro del texto del enlace a menos que estén ocultos a las tecnologías de asistencia. Los lectores de pantalla pueden leer los símbolos en voz alta, lo que puede ser confuso. Considere eliminarlos: <strong {C}>%(ERROR)</strong>',
    LINK_URL:
      'Las URL más largas y menos inteligibles utilizadas como texto de enlace pueden ser difíciles de escuchar con tecnología de asistencia. En la mayoría de los casos, es mejor usar texto legible por humanos en lugar de la URL. Las URL cortas (como la página de inicio de un sitio) están bien.',
    LINK_DOI:
      'En el caso de páginas web o recursos en línea, la <a href="https://apastyle.apa.org/style-grammar-guidelines/paper-format/accessibility/urls#:~:text=descriptive%20links">Guía de estilo de la APA</a> recomienda utilizar enlaces descriptivos que incluyan la URL o el DOI de la obra alrededor de su título. Las URL más largas y menos inteligibles utilizadas como texto de enlace pueden resultar difíciles de comprender cuando se accede a ellas con tecnología de asistencia.',
    LINK_NEW_TAB:
    ...
    // Images
    ALT_UNPRONOUNCEABLE:
      'El texto alternativo solo contiene símbolos impronunciables y/o espacios. Los lectores de pantalla anunciarán la imagen y luego harán una pausa. Si la imagen es decorativa, asegúrese de que no haya espacios en el texto alternativo. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_ALT_UNPRONOUNCEABLE:
      'El texto alternativo de esta imagen vinculada solo contiene símbolos impronunciables y/o espacios. Los lectores de pantalla anunciarán la imagen y luego harán una pausa. Asegúrese de que el texto alternativo describa el destino del enlace. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    MISSING_ALT_LINK_HAS_TEXT:
      'La imagen se utiliza como vínculo con el texto circundante, aunque el atributo alt debe marcarse como decorativo o nulo.',
    MISSING_ALT_LINK:
      'La imagen se está utilizando como enlace, ¡pero falta el texto alternativo! Asegúrese de que el texto alternativo describa a dónde lo lleva el enlace.',
    MISSING_ALT:
      '¡Falta el texto alternativo! Si la imagen transmite una historia, un estado de ánimo o información importante, asegúrese de describir la imagen.',
    LINK_ALT_FILE_EXT:
      'El texto alternativo no debe incluir extensiones de archivos ni dimensiones de imágenes. Asegúrese de que el texto alternativo describa el destino del enlace, no una descripción literal de la imagen. Eliminar: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_PLACEHOLDER_ALT:
      'Se encontró texto alternativo no descriptivo o de marcador de posición dentro de una imagen vinculada. Asegúrese de que el texto alternativo describa el destino del enlace, no una descripción literal de la imagen. Reemplace el siguiente texto alternativo. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_SUS_ALT:
      'Las tecnologías de asistencia ya indican que se trata de una imagen, por lo que &quot;<strong {C}>%(ERROR)</strong>&quot; puede ser redundante. Asegúrese de que el texto alternativo describa el destino del enlace, no una descripción literal de la imagen. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_FILE_EXT:
      'El texto alternativo no debe incluir extensiones de archivos ni dimensiones de imágenes. Si la imagen transmite una historia, un estado de ánimo o información importante, asegúrese de describir la imagen. Eliminar: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER:
      'Se encontró texto alternativo no descriptivo o de marcador de posición. Reemplace el siguiente texto alternativo con algo más significativo. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    SUS_ALT:
      'Las tecnologías de asistencia ya indican que se trata de una imagen, por lo que &quot;<strong {C}>%(ERROR)</strong>&quot; puede ser redundante. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_NO_ALT_TEXT:
      'La imagen dentro del enlace está marcada como decorativa y no hay texto de enlace. Agregue texto alternativo a la imagen que describa el destino del enlace.',
    LINK_IMAGE_TEXT:
      'La imagen está marcada como decorativa, aunque el enlace utiliza el texto circundante como etiqueta descriptiva.',
    LINK_IMAGE_LONG_ALT:
    ...
    LINK_ALT_MAYBE_BAD:
      'El enlace de imagen tiene texto alternativo que puede no ser útil o no ser descriptivo. Asegúrate de que el texto alternativo describa el destino del enlace. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_MAYBE_BAD:
      'El texto alternativo puede no ser útil o no ser descriptivo. Mejora el siguiente texto alternativo: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

    // Labels
    LABELS_MISSING_IMAGE_INPUT:
      'Al botón de imagen le falta el texto alternativo. Agregue texto alternativo para proporcionar un nombre accesible. Por ejemplo: <em>Buscar</em> o <em>Enviar</em>.',
    LABELS_INPUT_RESET:
    ...
    LABELS_ARIA_LABEL_INPUT:
      'La entrada tiene un nombre accesible, aunque asegúrese de que también haya una etiqueta visible. <hr> <strong {B}>Nombre accesible</strong> <strong {C}>%(TEXT)</strong>',
    LABELS_NO_FOR_ATTRIBUTE:
      'No hay ninguna etiqueta asociada con esta entrada. Agregue un atributo <code>for</code> a la etiqueta que coincida con el <code>id</code> de esta entrada. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    ...
    // Embedded content
    EMBED_VIDEO:
      'Asegúrese de que <strong>todos los videos tengan subtítulos.</strong> Proporcionar subtítulos para todo el contenido de audio y video es un requisito obligatorio de nivel A. Los subtítulos ayudan a las personas sordas o con dificultades auditivas.',
    EMBED_AUDIO:
      'Asegúrese de proporcionar una <strong>transcripción para todos los podcasts</strong>. Proporcionar transcripciones para el contenido de audio es un requisito obligatorio de nivel A. Las transcripciones ayudan a las personas sordas o con dificultades auditivas, pero pueden beneficiar a todos. Considere colocar la transcripción debajo o dentro de un panel de acordeón.',
    EMBED_DATA_VIZ:
    ...
    EMBED_MISSING_TITLE:
      'El contenido incrustado requiere un nombre accesible que describa su contenido. Proporcione un atributo único <code>title</code> o <code>aria-label</code> en el elemento <code>iframe</code>. Más información sobre <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
    EMBED_GENERAL:
      'No se puede comprobar el contenido incrustado. Asegúrese de que las imágenes tengan texto alternativo, los videos tengan subtítulos, el texto tenga suficiente contraste y los componentes interactivos sean <a href="https://webaim.org/techniques/keyboard/">accesibles mediante teclado.</a>',
    EMBED_FOCUSABLE:
    ...
    EMBED_UNFOCUSABLE:
      '<code>&lt;iframe&gt;</code> con elementos no enfocables no debe tener <code>tabindex="-1"</code>. El contenido incrustado no será accesible mediante el teclado.',

    // Quality assurance
    QA_BAD_LINK:
      'Enlace incorrecto encontrado. El enlace parece apuntar a un entorno de desarrollo. <hr> {L} <strong {C}>%(LINK)</strong>',
    QA_STRONG_ITALICS:
    ...
    QA_UPPERCASE:
      'Encontrado todo en mayúsculas. Algunos lectores de pantalla pueden interpretar todo el texto en mayúsculas como un acrónimo y leerán cada letra individualmente. Además, algunas personas encuentran que las mayúsculas son más difíciles de leer y puede dar la apariencia de GRITO.',
    QA_UNDERLINE:
    ...
    QA_JUSTIFY:
      'Evite usar texto justificado, que se alinea tanto a los márgenes izquierdo como derecho. Esto puede ser difícil de leer para algunas personas debido a los espacios desiguales entre las palabras. Use texto alineado a la izquierda para una mejor legibilidad.',
    QA_SMALL_TEXT:
    ...
    // Developer
    DUPLICATE_ID:
      '<strong>Identificación duplicada</strong> encontrada. Se sabe que los errores de ID duplicados causan problemas a las tecnologías de asistencia cuando intentan interactuar con el contenido. Elimine o cambie el siguiente ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    UNCONTAINED_LI:
      'Todos los elementos de lista <code>&lt;li&gt;</code> deben colocarse dentro de elementos <code>&lt;ul&gt;</code> desordenados o <code>&lt;ol&gt;</code> ordenados. Esta estructura ayuda a los lectores de pantalla a anunciar la lista y sus elementos con precisión.',
    ...
    META_SCALABLE:
      'Elimine el parámetro <code>user-scalable="no"</code> en la <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">meta etiqueta del viewport</a> para permitir el zoom.',
    META_MAX:
    ...
    BTN_EMPTY_LABELLEDBY:
      'El botón tiene un valor de <code>aria-labelledby</code> que está vacío o no coincide con el valor de <code>id</code> de otro elemento en la página.',
    BTN: 'botón',
    BTN_TIP:
      'Aprende a crear un <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">botón accesible.</a>',
    BTN_ROLE_IN_NAME:
    ...
    // Contrast
    CONTRAST_NORMAL:
      'El texto de tamaño normal debe tener una relación de contraste de al menos %(RATIO).',
    CONTRAST_LARGE:
      'El texto de tamaño grande debe tener una relación de contraste de al menos %(RATIO).',
    CONTRAST_ERROR:
      'El texto no tiene suficiente contraste con el fondo, lo que dificulta su lectura.',
    CONTRAST_WARNING:
      'El contraste de este texto es desconocido y debe revisarse manualmente. Asegúrese de que el texto y el fondo tengan colores con un fuerte contraste.',
    CONTRAST_ERROR_GRAPHIC:
      'El gráfico no tiene suficiente contraste con el fondo, lo que dificulta su visibilidad.',
    CONTRAST_WARNING_GRAPHIC:
      'El contraste de este gráfico es desconocido y debe revisarse manualmente.',
    CONTRAST_TIP_GRAPHIC:
      'Los gráficos y los elementos de la interfaz de usuario deben tener al menos una relación de contraste de 3:1.',
    CONTRAST_OPACITY: 'Aumente la opacidad para una mejor visibilidad.',
    CONTRAST_APCA:
      'Este contraste no es suficiente para ningún tamaño de texto. ¿Considera usar esta combinación de color y tamaño de texto?',
    ...
    CONTRAST_PLACEHOLDER:
      'El texto del marcador de posición en esta entrada no tiene suficiente contraste con el fondo, lo que dificulta su lectura.',
    CONTRAST_PLACEHOLDER_UNSUPPORTED:
      'El contraste de este texto de marcador de posición es desconocido y debe revisarse manualmente. Asegúrese de que el texto y el fondo tengan colores fuertemente contrastantes.',
    CONTRAST_INPUT:
      'El texto en esta entrada no tiene suficiente contraste con el fondo, lo que dificulta su lectura.',
    CONTRAST: 'Contraste',
    UNKNOWN: 'Desconocido',
    FG: 'Primer plano',
    BG: 'Fondo',
