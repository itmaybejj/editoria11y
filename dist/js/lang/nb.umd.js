(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p><strong class="badge">Slik løser du det</strong> Legg til tekst som beskriver lenkemålet, eller slett den hvis det bare er en skrivefeil eller en lenket mellomromstegn.</p><div class="why"><p>Tips: Skjermlesere kan ikke beskrive tomme lenker. De faller til taushet ("Lenke, [...pause...]") eller leser opp URL-en: "Lenke, H-T-T-P-S skråstrek skråstrek example dot com".</p><p>Lenkede mellomromstegn kan være vanskelige å slette i enkelte redigeringsverktøy; det kan være nødvendig å slette og skrive inn tekst på nytt rundt mellomrommet.</p></div>`,
