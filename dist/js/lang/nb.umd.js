(function(global, factory) {
  ...
  const testNames = {
    ...
    META_LANG_VALID: "Språkkoden for dette elementet er ikke gyldig",
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span>Alt-tekst: <i>%(ALT_TEXT)</i></p><p>Skjermlesere vil lese opp denne URL-en, ofte bokstav for bokstav. Det gir vanligvis ikke samme mening som å se bildet.</p><p><strong class="badge">Slik løser du det</strong> Legg til tom alt (alt="") hvis dette er ren dekorasjon som bør ignoreres av skjermlesere, eller legg til en beskrivende alt-tekst.</p>${why.images}`,
    ALT_MAYBE_BAD: `<p>Alt-tekst: <i>%(alt)</i></p><p><strong class="badge">Slik løser du det</strong> Sett en alt-tekst som kort beskriver hva dette bildet betyr i konteksten.</p>${why.images}`,
    ALT_MAYBE_BAD_WARNING: `<p>Alt-tekst: <i>%(alt)</i></p><p><strong class="badge">Slik løser du det</strong> Sett en alt-tekst som kort beskriver hva dette bildet betyr i konteksten.</p>${why.images}`,
    ALT_PLACEHOLDER: `<p>Alt-tekst: <i>%(alt)</i></p><p><strong class="badge">Slik løser du det</strong> Sett en alt-tekst som kort beskriver hva dette bildet betyr i konteksten.</p>${why.images}`,
    ALT_UNPRONOUNCEABLE: `<p>Alt-tekst: <i>%(alt)</i></p><p>Denne alt-teksten inneholder bare tegn som ikke kan uttales og/eller mellomrom. Skjermlesere vil annonsere bildet og så pause unaturlig, eller lese noe uforståelig.</p><p><strong class="badge">Slik løser du det</strong> Legg til en beskrivende alt-tekst, eller bruk en helt tom alt (alt="") hvis dette bare er et ikon eller mellomrom som skjermlesere skal ignorere.</p>${why.images}`,
    ...
    LINK_ALT_FILE_EXT: `<p><span style="display: none;">%(ALT)</span>Alt-tekst: <i>%(alt)</i></p><p>Denne alt-teksten er sannsynligvis et filnavn i stedet for en meningsfull lenketittel.</p><p><strong class="badge">Slik løser du det</strong> Sett denne bildets alt-tekst til navnet på lenkemålet.</p><div class="why"><p>Formålet med alt-tekst er å beskrive hva et bilde betyr, ikke hva det inneholder. For et lenket bilde er meningen lenkemålet:</p><ul><li>"Side med tekst" beskriver bildet, ikke lenken.</li><li>"IMG_1234.jpg" er bare et filnavn.</li><li>"Påmeldingsskjema for arrangement (.doc)" er et lenkemål.</li></ul></p></div>`,
    LINK_ALT_MAYBE_BAD: `<p>Alt-tekst: <i>%(alt)</i></p><p><strong class="badge">Slik løser du det</strong> Sett alt-teksten til navnet på lenkemålet.</p>${why.imageLinks}`,
    LINK_ALT_MAYBE_BAD_WARNING: `<p>Alt-tekst: <i>%(alt)</i></p><p><strong class="badge">Slik løser du det</strong> Sett alt-teksten til navnet på lenkemålet.</p>${why.imageLinks}`,
    LINK_ALT_UNPRONOUNCEABLE: `<p>Alt‑teksten <i>%(ALT_TEXT)</i> består av tegn som ikke kan uttales og kan ikke beskrive lenken.</p><p>${why.fix}Beskriv lenkens formål eller mål med alt‑teksten.</p>${why.imageLinks}`,
    ...
    LINK_IMAGE_ALT: `<p><strong>Alt-tekst:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Kontroller at alt‑teksten beskriver lenkens mål, ikke bare det visuelle innholdet i bildet:</p>${why.imageLinks}`,
    ...
    LINK_PLACEHOLDER_ALT: `<p>Alt‑teksten er en plassholder: <i>%(alt)</i>.</p><p>${why.fix}Bruk en alt‑tekst som beskriver lenkens mål.</p>${why.imageLinks}`,
    ...
    LINK_SUS_ALT: `<p>Denne alt-teksten inneholder ordet <i>%(alt)</i>, noe som vanligvis betyr at den ikke beskriver lenkemålet.</p><p>Alt-tekst: <i>%(ALT_TEXT)</i></p><p><strong class="badge">Slik løser du det</strong> Sørg for at alt-teksten beskriver lenkens formål eller mål.</p>${why.imageLinks}`,
    ...
    SUS_ALT: `<p>Denne alt-teksten inneholder ordet <i>%(alt)</i>:</p><p><i>%(ALT_TEXT)</i></p><p><strong class="badge">Slik løser du det</strong> Skriv alt-teksten slik at den kort uttrykker hva bildet betyr.</p><div class="why"><p>Tips: Skjermlesere annonserer at de beskriver et bilde før alt-teksten, så uttrykk som "bilde av" og "foto av" er vanligvis overflødige.</p></div>`,
