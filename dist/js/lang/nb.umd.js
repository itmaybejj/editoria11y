(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt-tekst:</strong> <i>%(ALT_TEXT)</i></p><p>Skjermlesere vil forsøke å uttale denne URL-en, ofte bokstav for bokstav. Det gir vanligvis ikke samme mening som å se bildet.</p><p>${why.fix}Beskriv kort hva dette bildet betyr, i denne konteksten.</p>${why.images}`,
