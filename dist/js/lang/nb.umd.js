(function(global, factory) {
  ...
  const tips = {
    ...
    BTN_EMPTY: `<p>${why.fix}Bruk en hvilken som helst metode for å fortelle skjermlesere hva knappen gjør, f.eks. tekst, alt-tekst på et ikon eller en title-attributt.</p>`,
    ...
    DUPLICATE_TITLE: `<p>${why.fix}Slett tekst eller <code>title</code>-attributtet for denne lenken.</p><div class="why"><p>Tips: <code>title</code>-verktøytips vises bare ved mus. De vises ikke på mobil eller med tastatur, så mange brukere vil aldri se dem. De bør aldri inneholde unik eller viktig informasjon.</p></div>`,
    ...
    HIDDEN_FOCUSABLE: `<p>Dette interaktive elementet har <code>aria-hidden="true"</code>, men kan få tastaturfokus.</p><p>${why.fix}Hvis du vil skjule det for skjermlesere, bruk også <code>tabindex="-1"</code>; hvis ikke, fjern <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LABELS_MISSING_LABEL: `<p>${why.fix}Legg til et <code>id</code> på dette inndatafeltet og et samsvarende <code>for</code>-attributt på etiketten.</p>`,
    ...
    LINK_IDENTICAL_NAME: `<p><strong>Lenketekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Omskriv lenker som går til forskjellige steder, slik at teksten gjenspeiler deres unike mål.</p>${why.links}`,
    ...
    LINK_STOPWORD: `<p>Lenketekst: <i>%(ERROR)</i></p><p>${why.fix}Bruk lenketekst som beskriver målet.</p>${why.links}`,
