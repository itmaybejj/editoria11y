(function(global, factory) {
  ...
  const testNames = {
    ...
    META_LANG_VALID: "Språkkoden er ikke gyldig",
  ...
  const tips = {
    ...
    LABELS_NO_FOR_ATTRIBUTE: `Det er ingen etikett tilknyttet dette inndatafeltet. Legg til et <code>for</code>-attributt på etiketten som samsvarer med feltets <code>id</code>. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>`,
