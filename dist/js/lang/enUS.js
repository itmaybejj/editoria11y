const strings = {
  ...
  strings: {
    ...
    LINK_IDENTICAL_NAME: "Multiple links with the same text can be confusing. <strong>Consider making the link more descriptive to help distinguish it from other links.</strong> <strong {B}>Accessible Name</strong> <strong {C}>%(TEXT)</strong>",
    // Images
    ...
    QA_IN_PAGE_LINK: "The link target does not match any element on this page.",
