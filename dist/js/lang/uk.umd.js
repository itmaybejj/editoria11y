(function(global, factory) {
  ...
  const Sa11yStrings = {
    ...
    strings: {
      ...
      LINK_MAYBE_BUTTON: 'Це посилання має недійсний шлях, а його доступна назва містить слово "<strong>%(NAME)</strong>". Це свідчить про те, що це взагалі не посилання, а натомість елемент керування певним сценарієм на сторінці. Щоб виправити це, замініть посилання <a href="https://www.w3.org/WAI/ARIA/apg/patterns/button/">доступною кнопкою</a> або виправте шлях посилання. <hr> <strong>Порада!</strong> Асистивні технології по-різному обробляють кнопки та посилання. Використання правильного HTML-елемента гарантує, що користувачі знатимуть, які комбінації клавіш використовувати та яка дія буде активована.',
  ...
  const testNames = {
    ...
    META_LANG_VALID: "Код мови є недійсним",
