...
var et = {
  ...
  strings: {
    ...
    OUTLINE: 'Ülesehitus',
    READABILITY_DESC:
      'Kuvab loetavuse skoori vahekaardil <strong>Ülesehitus</strong>, et aidata hinnata lugemisraskust.',
    TITLE: 'Pealkiri',
    ALT: 'ALT',
    IMAGES: 'Pildid',
    EDIT: 'Muuda',
    ...
    DEVELOPER_DESC:
      'Kontrollib probleeme, mille lahendamiseks võib vaja minna kodeerimise teadmisi, näiteks HTML atribuudid, vormid ja muu.',
    ...
    NOT_VISIBLE:
      'Objekt, mida üritate vaadata, ei ole nähtav; see võib olla peidetud või olla akordioni või vahekaardikomponendi sees.',
    MISSING_ROOT:
      'Täielik lehekülg kontrolliti ligipääsetavuse osas, sest sihtala <code>%(root)</code> ei ole olemas.',
    ...
    DISMISSED: 'Eiratud',
    DISMISS_REMINDER:
      'Palun pane tähele, et hoiatuseid <strong>ajutiselt</strong> eiratakse. Brauseri ajalugu ja küpsiste kustutamine taastab kõik eelnevalt eiratud hoiatuste kõikidel lehtedel.',
    ...
    COLOUR_FILTER_MESSAGE:
      'Kontrollige, kas on raske tajuda või teistest värvidest eristada elemente.',
    RED_EYE: 'Punane pime.',
    ...
    HEADING_SKIPPED_LEVEL:
      'Pealkirjad ei tohiks vahele jätta tasemeid ega hüpata <strong>Pealkiri %(PREV_LEVEL)</strong> pealt <strong {C}>Pealkiri %(LEVEL)</strong> peale, sest see rikub sisu järjekorra ja hierarhia, muutes selle jälgimise keerulisemaks. <hr> Kui <strong {C}>%(HEADING)</strong> kuulub <strong>%(PREV_HEADING)</strong> sektsiooni, siis kaaluge selle vormindamist kui <strong>Pealkiri %(LEVEL)</strong>.',
    HEADING_EMPTY:
      'Tühi rubriik leitud! Parandamiseks kustutage see rida või muutke selle vorming <strong {C}>pealkiri %(level)</strong> <strong>normaalseks</strong> või <strong>paragrahviks</strong>.',
    HEADING_LONG:
      'Pealkiri on pikk! Pealkirju tuleks kasutada sisu korrastamiseks ja struktuuri edastamiseks. Need peaksid olema lühikesed, informatiivsed ja unikaalsed. Palun hoidke pealkirjad alla %(MAX_LENGTH) tähemärgi (mitte rohkem kui üks lause). <hr> <strong {B}>%(HEADING_LENGTH) Tähemärki</strong>',
    HEADING_FIRST:
      'Lehekülje esimene pealkiri peaks tavaliselt olema pealkiri 1 või 2. Pealkiri 1 peaks olema peamise sisuosa algus ja on peamine pealkiri, mis kirjeldab lehe üldist eesmärki. Lisateave <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">pealkirjade struktuuri kohta.</a>',
    HEADING_MISSING_ONE:
    ...
    LINK_EMPTY_LABELLEDBY:
      'Lingil on väärtus <code>aria-labelledby</code>, mis on tühi või ei ühti lehe teise elemendi atribuudi <code>id</code> väärtusega.',
    LINK_EMPTY_NO_LABEL:
      'Lingil ei ole eristatavat teksti, mis oleks nähtav ekraanilugejatele ja muudele abivahenditele. Parandada: <ul><li>Lisandage lühike tekst, mis kirjeldab, kuhu link viib.</li><li>Kui tegemist on <a href="https://a11y-101.com/development/icons-and-links">ikoonilink või SVG,</a> puudub tõenäoliselt kirjeldav märgistus.</li><li>Kui arvate, et see link on kopeerimis-/liidevigast tingitud viga, kaaluge selle kustutamist.</li><li>Kui arvate, et tegemist on kopeerimis-/liidevigast tingitud veaga, kaaluge selle kustutamist.</li></ul>',
    LINK_STOPWORD:
      'Lingitekst ei pruugi olla piisavalt kirjeldav kontekstist välja: <strong {C}>%(ERROR)</strong>',
    LINK_STOPWORD_ARIA:
      'Kuigi on antud ligipääsetav nimi, kaaluge nähtava lingiteksti ülevaatamist. Sellised fraasid nagu &quot;<strong {C}>%(ERROR)</strong>&quot; ei ole tähendusrikkad.',
    LINK_TIP:
      '<hr> <strong>Näpunäide!</strong> Kasutage selget ja ainulaadset lingiteksti, mis kirjeldab lingi sihtkohta, tavaliselt lehe või dokumendi pealkirja.',
    LINK_CLICK_HERE:
      '"klõpsa" või "klõpsa siia" fraasid panevad rõhu hiiremängule, kuid paljud inimesed ei kasuta hiirt ega pruugi vaadata seda veebisaiti mobiilseadmes. Kaaluge tegevuse ülesandele viitavat teist verbivormi.',
    DUPLICATE_TITLE:
      'Lingid ja pildid, millel on <code>title</code> atribuut, on mõeldud täiendava teabe esitamiseks ja see peaks olema <strong>erinev</strong> tekstist või alternatiivtekstist. Pealkirja tekst kuvatakse, kui liigutate hiirega üle elemendi, kuid seda ei saa kasutada klaviatuurilt ega puutetundlikelt sisenditelt. Kaaluge <a href="https://www.a11yproject.com/posts/title-attributes/">title atribuudist täielikult hoidumist.</a>',
    LINK_SYMBOLS:
      'Vältige sümbolite kasutamist tegevuse sooritamise üleskutsetena lingitekstis, välja arvatud juhul, kui need on abitehnoloogiate eest varjatud. Ekraanilugejad võivad sümboleid valjusti ette lugeda, mis võib olla segadusttekitav. Kaaluge nende eemaldamist: <strong {C}>%(ERROR)</strong>',
    LINK_URL:
      'Pikemad, vähem arusaadavad URL-aadressid, mida kasutatakse linkide tekstina, võivad olla raskesti mõistetavad, kui neid kasutatakse abivahendi abil. Enamasti on parem kasutada URL-i asemel inimesele loetavat teksti. Lühikesed URL-aadressid (näiteks saidi koduleht) on okei.',
    LINK_DOI:
      'Veebilehtede või ainult veebipõhiste ressursside puhul soovitab <a href="https://apastyle.apa.org/style-grammar-guidelines/paper-format/accessibility/urls#:~:text=descriptive%20links">APA stiilijuhend</a> kasutada kirjeldavaid linke, ümbritsedes teose URL-i või DOI-d selle pealkirja ümber. Pikemad, vähem arusaadavad URL-aadressid, mida kasutatakse linkide tekstina, võivad olla raskesti mõistetavad, kui neid kasutatakse abivahendi abil.',
    LINK_NEW_TAB:
    ...
    // Images
    ALT_UNPRONOUNCEABLE:
      'Alternatiivne tekst sisaldab ainult hääldamatuid sümboleid ja/või tühikuid. Ekraanilugejad teatavad pildist ja siis peatavad. Kui pilt on dekoratiivne, veenduge, et alternatiivtekstis poleks tühikuid. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_ALT_UNPRONOUNCEABLE:
      'Selles lingitud pildis olev alternatiivne tekst sisaldab ainult hääldamatuid sümboleid ja/või tühikuid. Ekraanilugejad teatavad pildist ja siis peatavad. Veenduge, et alternatiivtekst kirjeldaks lingi sihtkohta. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    MISSING_ALT_LINK_HAS_TEXT:
      'Pilti kasutatakse lingina koos ümbritseva tekstiga, kuigi alt-atribuut peaks olema märgitud dekoratiivseks või null.',
    MISSING_ALT_LINK:
      'Pilti kasutatakse lingina, kuid puudub alt-tekst! Palun veenduge, et alt-tekst kirjeldab, kuhu link viib.',
    MISSING_ALT:
      'Puuduv alt-tekst! Kui pilt edastab lugu, meeleolu või olulist teavet - kirjeldage kindlasti pilti.',
    LINK_ALT_FILE_EXT:
      'Alternatiivtekst ei tohiks sisaldada faililaiendeid ega pildi mõõtmeid. Veenduge, et alt-tekst kirjeldab lingi sihtkohta, mitte pildi sõna-sõnalist kirjeldust. Eemaldage: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_PLACEHOLDER_ALT:
      'Leitud lingitud pildi sees olev mittekirjeldav või paigutatud alt-tekst. Veenduge, et alt-tekst kirjeldab lingi sihtkohta, mitte pildi sõna-sõnalist kirjeldust. Asendage järgmine alt-tekst. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_SUS_ALT:
      'Abitehnoloogiad näitavad juba, et tegemist on pildiga, seega võib &quot;<strong {C}>%(ERROR)</strong>&quot; olla üleliigne. Veenduge, et alt-tekst kirjeldab lingi sihtkohta, mitte pildi sõna-sõnalist kirjeldust. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_FILE_EXT:
      'Alternatiivtekst ei tohiks sisaldada faililaiendeid ega pildi mõõtmeid. Kui pilt edastab lugu, meeleolu või olulist teavet - kirjeldage kindlasti pilti. Eemaldage: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER:
      'Leitud mittekirjeldav või paigutatud alt-tekst. Asendage järgmine alt-tekst millegi sisukamaga. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    SUS_ALT:
      'Abitehnoloogiad näitavad juba, et tegemist on pildiga, seega &quot;<strong {C}>%(ERROR)</strong>&quot; võib olla üleliigne. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_NO_ALT_TEXT:
      'Linki sees olev pilt on märgitud dekoratiivseks ja lingi tekst puudub. Palun lisage pildile alt-tekst, mis kirjeldab lingi sihtkohta.',
    LINK_IMAGE_TEXT:
      'Pilt on märgitud dekoratiivseks, kuigi link kasutab ümbritsevat teksti kirjeldava märgisena.',
    LINK_IMAGE_LONG_ALT:
      'Lingitud pildi Alt-teksti kirjeldus on <strong>liiga pikk</strong>. Lingitud piltide alt-tekst peaks kirjeldama, kuhu link viib, mitte pildi sõna-sõnaline kirjeldus. <strong>Võta arvesse, et kasuta alt-tekstina selle lehekülje pealkirja, millele see viitab.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Tähemärki</strong> <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT:
      'Pildilink sisaldab alternatiivset teksti. <strong>Kas alternatiivne tekst kirjeldab, kuhu link viib?</strong> Kaaluge alternatiivse tekstina selle lehekülje pealkirja kasutamist, millele link viitab. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_AND_TEXT:
      'Pildilink sisaldab <strong>sellise alt-teksti ja ümbritseva lingi teksti.</strong> Kui see pilt on dekoratiivne ja seda kasutatakse funktsionaalse lingina teisele lehele, kaaluge pildi märkimist dekoratiivseks või nullina - ümbritsevast lingi tekstist peaks piisama. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Ligipääsetav nimi</strong> {L} <strong {C}>%(TEXT)</strong>',
    IMAGE_FIGURE_DECORATIVE:
      'Pilt on märgitud kui <strong>dekoratiivne</strong> ja abitehnoloogiad ignoreerivad seda. <hr> Kuigi on esitatud <strong>caption</strong>, peaks pildil olema enamasti ka alt-tekst. <ul><li>Alt-tekst peaks andma lühikese kirjelduse selle kohta, mis on pildil.</li><li>Tekstis peaks tavaliselt olema kontekst, et seostada pilt ümbritseva sisuga või juhtida tähelepanu konkreetsele teabele.</li></ul>Lisaks: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a>',
    IMAGE_FIGURE_DUPLICATE_ALT:
      'Ärge kasutage täpselt samu sõnu nii alt- kui ka tiiteltekstis. Ekraanilugejad annavad teavet kaks korda teada.<ul><li>Alt-tekst peaks andma lühikese kirjelduse selle kohta, mis on pildil.</li><li>Tekstis peaks tavaliselt olema kontekst, et seostada pilt ümbritseva sisuga või juhtida tähelepanu konkreetsele teabele.</li></ul> Lisateave: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
    IMAGE_DECORATIVE:
      'Pilt on märgitud kui <strong>dekoratiivne</strong> ja abitehnoloogiad ignoreerivad seda. Kui pilt edastab lugu, meeleolu või olulist teavet - lisage kindlasti alt-tekst.',
    ...
    ALT_MAYBE_BAD:
      'Alt-tekst ei pruugi anda kasulikku teavet või ei ole kirjeldav. Paranda järgmine alt-tekst: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

    // Form labels
    LABELS_MISSING_IMAGE_INPUT:
      'Pildi nupul puudub alt-tekst. Palun lisage alt-tekst, et anda ligipääsetav nimi. Näiteks: <em>Search</em> või <em>Submit</em>.',
    LABELS_INPUT_RESET:
      'Reset-nuppe ei tohiks <strong>ei</strong> kasutada, kui see pole spetsiaalselt vajalik, sest neid on lihtne kogemata aktiveerida. <hr> <strong>Nipp!</strong> Lugege, miks <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">Reset ja Cancel nupud tekitavad kasutatavusprobleeme.</a>',
    LABELS_ARIA_LABEL_INPUT:
      'Sisendil on juurdepääsetav nimi, kuigi palun veenduge, et ka silt on nähtav. <hr> <strong {B}>Ligipääsetav nimi</strong> <strong {C}>%(TEXT)</strong>',
    LABELS_NO_FOR_ATTRIBUTE:
      'Selle sisendiga ei ole seotud mingit märgistust. Lisage sildile <code>for</code> atribuut, mis vastab selle sisendi <code>id</code>. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    ...
    // Embedded content
    EMBED_VIDEO:
      'Palun veenduge, et <strong>kõik millisel videol on kinnised subtiitrid.</strong> Kogu heli- ja videosisu puhul on subtiitrite esitamine kohustuslik A-taseme nõue. Üleskirjutused toetavad kurte ja vaegkuuljaid inimesi, kes on kurdid või vaegkuuljad.',
    EMBED_AUDIO:
      'Veenduge, et kõigi podcastide kohta esitatakse <strong>transkriptsioon.</strong> Audiosisu transkriptsiooni esitamine on kohustuslik A-taseme nõue. Transkriptsioonid toetavad kurte ja vaegkuuljaid, kuid neist on kasu kõigile. Kaaluge transkriptsiooni paigutamist allapoole või akordionpaneeli sisse.',
    EMBED_DATA_VIZ:
    ...
    QA_BLOCKQUOTE:
      'Kas see on pealkiri? <strong {C}>%(TEXT)</strong> <hr> Plokkviiteid tuleks kasutada ainult jutumärkide jaoks. Kui see on mõeldud pealkirjaks, muutke see plokktsitaat semantiliseks pealkirjaks (nt pealkiri 2 või pealkiri 3).',
    QA_FAKE_HEADING:
      'Kas see on pealkiri? <strong {C}>%(TEXT)</strong> <hr> Raske või suur tekstirida võib tunduda pealkirjana, kuid keegi, kes kasutab ekraanilugejat, ei saa aru, et see on oluline või ei saa selle sisu juurde hüpata. Paks või suur tekst ei tohiks kunagi asendada semantilisi pealkirju (rubriik 2 kuni rubriik 6).',
    QA_FAKE_LIST:
      'Kas püüate koostada nimekirja? Võimalik nimekiri on leitud: <strong {C}>%(firstPrefix)</strong> <hr> Veenduge, et kasutate semantilisi nimekirju, kasutades selle asemel bullet- või numbrivormingu nuppe. Kui kasutate semantilist loetelu, saavad abivahendid edastada teavet, näiteks elementide koguarvu ja iga elemendi suhtelise positsiooni loetelus. Lisateave <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">semantiliste loetelude kohta.</a>',
    QA_UPPERCASE:
      'Leidsin kõik suurtähed. Mõned ekraanilugejad võivad tõlgendada täistähti akronüümina ja lugeda iga tähte eraldi. Lisaks sellele on mõnedel inimestel raskem lugeda ja see võib jätta mulje, nagu oleks see HÄÄLETUS.',
    QA_UNDERLINE:
      'Allakriipsutatud teksti võib segi ajada linkidega. Kaaluge teistsuguse stiili kasutamist, näiteks <code>&lt;strong&gt;</code><strong>tugev tähtsus</strong><code>&lt;/strong&gt;</code> või <code>&lt;em&gt;</code><em>emphasis</em><code>&lt;/em&gt;</code>.',
    QA_SUBSCRIPT:
      'Alam- ja ülaindeksite vormindamise võimalusi tuleks kasutada ainult teksti asukoha muutmiseks tüpograafiliste konventsioonide või standardite alusel. Seda ei tohiks <strong>ei</strong> kasutada ainult esitlus- või välimuseesmärkidel. Tervete lausete vormindamine tekitab probleeme loetavusega. Asjakohased kasutusjuhud on näiteks eksponentide, ordinaalarvude, näiteks 4<sup>th</sup> asemel 4<sup>, ja keemiliste valemite (nt H<sub>2</sub>O) kuvamine.',
    QA_NESTED_COMPONENTS:
      'Vältige interaktiivsete paigutuskomponentide pesastamist, näiteks akordeonide paigutamist tabide sisse või tabide paigutamist akordeonide sisse. See võib keeruliseks muuta navigeerimise, suurendada kognitiivset ülekoormust ja viia sellele, et inimesed jätavad sisu tähelepanuta.',
    QA_JUSTIFY:
      'Vältige õigustatud teksti kasutamist, mis on joondatud nii vasakule kui ka paremale äärele. See võib olla raskesti loetav mõnele inimesele ebaühtlaste sõnavahede tõttu. Kasutage vasakule joondatud teksti parema loetavuse saavutamiseks.',
    QA_SMALL_TEXT:
    ...
    // Developer
    DUPLICATE_ID:
      'Leiti <strong>korduv ID</strong>. Teadaolevalt põhjustavad dubleeritud ID-vead probleeme tugitehnoloogiatele, kui need üritavad sisuga suhelda. Palun eemaldage või muutke järgmine ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
    UNCONTAINED_LI:
      'Kõik <code>&lt;li&gt;</code> nimekirjaelemendid peavad olema paigutatud <code>&lt;ul&gt;</code> järjestamata või <code>&lt;ol&gt;</code> järjestatud elementide sisse. See struktuur aitab ekraani lugemistarkvaral nimekirja ja selle elemente täpselt kuulutada.',
    ...
    BTN: 'nupp',
    BTN_TIP:
      'Õpi, kuidas teha <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">ligipääsetav nupp.</a>',
    BTN_ROLE_IN_NAME:
    ...
    CONTRAST_WARNING:
      'Selle teksti kontrastsus on teadmata ja see tuleb käsitsi üle vaadata. Veenduge, et tekstil ja taustal oleks tugev värvikontrast.',
    CONTRAST_ERROR_GRAPHIC:
      'Graafikal pole taustaga piisavalt kontrasti, mistõttu võib seda olla raske näha.',
    CONTRAST_WARNING_GRAPHIC:
      'Selle graafika kontrastsus on teadmata ja see tuleb käsitsi üle vaadata.',
    CONTRAST_TIP_GRAPHIC:
      'Graafikal ja kasutajaliidese elementidel peaks olema vähemalt 3:1 kontrastsuse suhe.',
    CONTRAST_OPACITY: 'Parandage nähtavust, suurendades läbipaistmatust.',
    CONTRAST_APCA:
      'See kontrastsus pole ühegi suurusega teksti jaoks piisav. Kas kaalute selle värvi ja teksti suuruse kombinatsiooni kasutamist?',
    ...
    CONTRAST_PLACEHOLDER:
      'Selle sisendi kohatäite tekstil pole taustaga piisavalt kontrasti, mistõttu on seda raskem lugeda.',
    CONTRAST_PLACEHOLDER_UNSUPPORTED:
      'Selle kohatäite teksti kontrastsus on teadmata ja vajab käsitsi ülevaatamist. Veenduge, et tekstil ja taustal oleksid tugevalt kontrastsed värvid.',
    CONTRAST_INPUT:
      'Selle sisendi tekstil pole taustaga piisavalt kontrasti, mistõttu on seda raskem lugeda.',
