(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Texto alternativo:</strong> <i>%(ALT_TEXT)</i></p><p>Os leitores de ecrã irão ler este URL, muitas vezes carácter a carácter. Isto dificilmente transmite o mesmo significado que ver a imagem.</p><p>${why.fix}Descreva de forma concisa o que esta imagem significa neste contexto.</p>${why.images}`,
    ...
    MISSING_ALT: `<p>Sem alt, leitores tendem a anunciar a URL do ficheiro (por vezes, letra a letra).</p><p>${why.fix}Descreva de forma concisa o que esta imagem significa neste contexto.</p>${why.images}`,
