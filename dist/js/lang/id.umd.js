...
(function (global, factory) {
  ...
  var id = {
    ...
    strings: {
      ...
      OUTLINE: 'Kerangka',
      READABILITY_DESC:
        'Menampilkan skor keterbacaan di tab <strong>Kerangka</strong> untuk membantu mengukur kesulitan membaca.',
      TITLE: 'Judul',
      ALT: 'ALT',
      IMAGES: 'Gambar',
      EDIT: 'Edit',
      ...
      DEVELOPER_DESC:
        'Memeriksa masalah yang mungkin memerlukan pengetahuan pemrograman untuk diperbaiki, seperti atribut HTML, formulir, dan lainnya.',
      ...
      NOT_VISIBLE:
        'Item yang ingin Anda lihat tidak terlihat; item tersebut mungkin tersembunyi atau berada di dalam komponen akordeon atau tab.',
      MISSING_ROOT:
        'Halaman penuh diperiksa aksesibilitasnya karena area target <code>%(root)</code> tidak ada.',
      MISSING_READABILITY_ROOT:
        'Skor keterbacaan didasarkan pada area konten <code>%(fallback)</code>, karena area target <code>%(root)</code> tidak ada.',
      SKIP_TO_PAGE_ISSUES: 'Loncat ke Halaman Masalah',
      CONSOLE_ERROR:
        'Maaf, ada masalah dengan pemeriksa aksesibilitas di halaman ini. Bisakah Anda <a href="%(link)">melaporkannya melalui formulir ini</a> atau di <a href="%(link)">GitHub</a>?',
      APPEARANCE: 'Tampilan',
      ...
      DISMISSED: 'Diabaikan',
      DISMISS_REMINDER:
        'Harap diperhatikan bahwa peringatan hanya <strong>sementara</strong> diabaikan. Menghapus riwayat browser dan cookie akan mengembalikan semua peringatan yang sebelumnya diabaikan di semua halaman.',
      ...
      HEADING_EMPTY:
        'Judul kosong ditemukan! Untuk memperbaikinya, hapus baris ini atau ubah formatnya dari <strong {C}>Header %(level)</strong> ke <strong>Normal</strong> atau <strong>Paragraph</strong>.',
      HEADING_LONG:
        'Judulnya panjang! Judul harus digunakan untuk mengatur konten dan menyampaikan struktur. Judul harus singkat, informatif, dan unik. Harap jaga agar judul kurang dari %(MAX_LENGTH) karakter (tidak lebih dari satu kalimat). <hr> <strong {B}>%(HEADING_LENGTH) Karakter</strong>',
      HEADING_FIRST:
      ...
      LINK_EMPTY_LABELLEDBY:
        'Tautan memiliki nilai untuk <code>aria-labelledby</code> yang kosong atau tidak cocok dengan nilai atribut <code>id</code> dari elemen lain di halaman.',
      LINK_EMPTY_NO_LABEL:
      ...
      LINK_STOPWORD:
        'Teks tautan mungkin tidak cukup deskriptif tanpa konteks: <strong {C}>%(ERROR)</strong>',
      LINK_STOPWORD_ARIA:
        'Meskipun nama yang dapat diakses telah diberikan, pertimbangkan untuk merevisi teks tautan yang terlihat. Frase seperti &quot;<strong {C}>%(ERROR)</strong>&quot; tidak bermakna.',
      LINK_TIP:
        '<hr> <strong>Tip!</strong> Gunakan teks tautan yang jelas dan unik yang menjelaskan tujuan tautan, biasanya judul halaman atau dokumen.',
      LINK_CLICK_HERE:
        'Frasa "klik" atau "klik di sini" memberi penekanan pada mekanisme mouse, padahal banyak orang tidak menggunakan mouse atau mungkin sedang melihat situs web ini di perangkat seluler. Pertimbangkan untuk menggunakan kata kerja lain yang terkait dengan tugas tersebut.',
      DUPLICATE_TITLE:
        'Atribut <code>title</code> pada tautan dan gambar dimaksudkan untuk memberikan informasi tambahan dan harus <strong>berbeda</strong> dari teks atau teks alternatif. Teks judul muncul saat mengarahkan mouse ke elemen, tetapi tidak dapat diakses dengan keyboard atau input sentuh. Pertimbangkan untuk <a href="https://www.a11yproject.com/posts/title-attributes/">menghindari atribut title sepenuhnya.</a>',
      LINK_SYMBOLS:
        'Hindari menggunakan simbol sebagai ajakan bertindak dalam teks tautan kecuali jika disembunyikan dari teknologi bantu. Pembaca layar dapat membaca simbol dengan keras, yang bisa membingungkan. Pertimbangkan untuk menghapus: <strong {C}>%(ERROR)</strong>',
      LINK_URL:
        'URL yang lebih panjang dan kurang dapat dipahami yang digunakan sebagai teks tautan mungkin sulit untuk disimak dengan teknologi bantuan. Dalam kebanyakan kasus, lebih baik menggunakan teks yang dapat dibaca manusia daripada URL. URL pendek (seperti beranda situs) tidak masalah.',
      LINK_DOI:
      ...
      // Images
      ALT_UNPRONOUNCEABLE:
        'Teks alt hanya berisi simbol yang tidak dapat diucapkan dan/atau spasi. Pembaca layar akan mengumumkan gambar lalu berhenti. Jika gambar dekoratif, pastikan tidak ada spasi di dalam teks alt. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_ALT_UNPRONOUNCEABLE:
        'Teks alt dalam gambar tertaut ini hanya berisi simbol yang tidak dapat diucapkan dan/atau spasi. Pembaca layar akan mengumumkan gambar lalu berhenti. Pastikan teks alt menjelaskan tujuan tautan. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      MISSING_ALT_LINK_HAS_TEXT:
        'Gambar digunakan sebagai tautan dengan teks di sekitarnya, meskipun atribut alt harus ditandai sebagai dekoratif atau nol.',
      MISSING_ALT_LINK:
        'Gambar digunakan sebagai tautan tetapi tidak memiliki teks alt! Pastikan teks alt menjelaskan ke mana tautan tersebut membawa Anda.',
      MISSING_ALT:
        'Teks alt yang hilang! Jika gambar menyampaikan suatu cerita, suasana hati, atau informasi penting - pastikan untuk mendeskripsikan gambar tersebut.',
      LINK_ALT_FILE_EXT:
        'Teks alternatif tidak boleh menyertakan ekstensi file atau dimensi gambar. Pastikan teks alt menjelaskan tujuan tautan, bukan deskripsi harfiah dari gambar. Hapus: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_PLACEHOLDER_ALT:
        'Teks alt non-deskripsi atau placeholder dalam gambar yang ditautkan ditemukan. Pastikan teks alt mendeskripsikan tujuan tautan, bukan deskripsi harfiah gambar. Ganti teks alt berikut ini. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_SUS_ALT:
        'Teknologi bantuan sudah menunjukkan bahwa ini adalah gambar, jadi &quot;<strong {C}>%(ERROR)</strong>&quot; mungkin berlebihan. Pastikan teks alt menjelaskan tujuan tautan, bukan deskripsi harfiah dari gambar. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_FILE_EXT:
        'Teks alternatif tidak boleh menyertakan ekstensi file atau dimensi gambar. Jika gambar menyampaikan cerita, suasana hati, atau informasi penting - pastikan untuk mendeskripsikan gambar. Hapus: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_PLACEHOLDER:
        'Teks alt non-deskripsi atau placeholder ditemukan. Ganti teks alt berikut dengan sesuatu yang lebih bermakna. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      SUS_ALT:
        'Teknologi bantuan sudah menunjukkan bahwa ini adalah gambar, jadi &quot;<strong {C}>%(ERROR)</strong>&quot; mungkin berlebihan. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_NO_ALT_TEXT:
        'Gambar di dalam tautan ditandai sebagai dekoratif dan tidak ada teks tautan. Tambahkan teks alt ke gambar yang menjelaskan tujuan tautan.',
      LINK_IMAGE_TEXT:
        'Gambar ditandai sebagai dekoratif, meskipun tautannya menggunakan teks di sekelilingnya sebagai label deskriptif.',
      LINK_IMAGE_LONG_ALT:
      ...
      LINK_IMAGE_ALT:
        'Tautan gambar berisi teks alt. <strong>Apakah teks alt menjelaskan ke mana tautan tersebut membawa Anda?</strong> Pertimbangkan untuk menggunakan judul halaman yang ditautkan sebagai teks alt. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT_AND_TEXT:
        'Tautan gambar berisi <strong>teks alt dan teks tautan di sekitarnya.</strong> Jika gambar ini bersifat dekoratif dan digunakan sebagai tautan fungsional ke halaman lain, pertimbangkan untuk menandai gambar tersebut sebagai dekoratif atau nol - teks tautan di sekitarnya sudah cukup. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Nama yang dapat diakses</strong> {L} <strong {C}>%(TEXT)</strong>',
      ...
      ALT_MAYBE_BAD:
        'Teks alt mungkin tidak memberikan informasi berguna atau tidak deskriptif. Perbaiki teks alt berikut: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

      // Form labels
      LABELS_MISSING_IMAGE_INPUT:
        'Tombol gambar tidak memiliki teks alt. Tambahkan teks alt untuk memberikan nama yang dapat diakses. Sebagai contoh: <em>Cari</em> atau <em>Kirim</em>.',
      LABELS_INPUT_RESET:
        'Tombol Reset sebaiknya <strong>tidak</strong> digunakan kecuali jika secara khusus diperlukan karena mudah diaktifkan secara tidak sengaja. <hr> <strong>Tip!</strong> Pelajari mengapa tombol <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">Reset dan Batal menimbulkan masalah dalam hal kegunaan.</a>',
      LABELS_ARIA_LABEL_INPUT:
        'Input memiliki nama yang dapat diakses, meskipun pastikan ada label yang terlihat juga. <hr> <strong {B}>Nama yang dapat diakses</strong> <strong {C}>%(TEXT)</strong>',
      LABELS_NO_FOR_ATTRIBUTE:
        'Tidak ada label yang terkait dengan input ini. Tambahkan atribut <code>untuk</code> ke label yang sesuai dengan <code>id</code> input ini. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      ...
      // Embedded content
      EMBED_VIDEO:
        'Pastikan <strong>semua video memiliki teks tertutup.</strong> Menyediakan teks untuk semua konten audio dan video adalah persyaratan Level A wajib. Teks mendukung orang-orang yang tuli atau sulit mendengar.',
      EMBED_AUDIO:
      ...
      EMBED_UNFOCUSABLE:
        '<code>&lt;iframe&gt;</code> dengan elemen yang tidak dapat difokuskan seharusnya tidak memiliki <code>tabindex="-1"</code>. Konten yang disematkan tidak akan dapat diakses menggunakan keyboard.',
      ...
      QA_PDF:
        'Tidak dapat memeriksa aksesibilitas PDF. PDF dianggap sebagai konten web dan harus dapat diakses juga. PDF sering kali mengandung masalah bagi orang yang menggunakan pembaca layar (tag struktural yang hilang atau label bidang formulir yang hilang) dan orang yang memiliki penglihatan rendah (teks tidak dapat dilihat ketika diperbesar). <ul><li>Jika ini adalah formulir, pertimbangkan untuk menggunakan formulir HTML yang dapat diakses sebagai alternatif.</li><li>Jika ini adalah dokumen, pertimbangkan untuk mengonversinya menjadi halaman web.</li></ul> Jika tidak, periksa <a href="https://helpx.adobe.com/acrobat/using/create-verify-pdf-accessibility.html">PDF untuk aksesibilitas di Acrobat DC.</a>',
      QA_DOCUMENT:
        'Tidak dapat memeriksa aksesibilitas dokumen. Dokumen yang ditautkan dianggap sebagai konten web dan harus dapat diakses juga. Silakan tinjau dokumen ini secara manual. <ul><li>Buat dokumen atau presentasi <a href="https://support.google.com/docs/answer/6199477?hl=id">Google Workspace Anda lebih mudah diakses.</a></li><li>Buat dokumen <a href="https://support.microsoft.com/id/office/create-accessible-office-documents-868ecfcd-4f00-4224-b881-a65537a7c155">Office Anda lebih mudah diakses.</a></li></ul>',
      QA_BLOCKQUOTE:
        'Apakah ini sebuah judul? <strong {C}>%(TEXT)</strong> <hr> Kutipan blok harus digunakan hanya untuk kutipan. Jika ini dimaksudkan sebagai judul, ubahlah tanda kutip blok ini menjadi judul semantik (misalnya Judul 2 atau Judul 3).',
      QA_FAKE_HEADING:
        'Apakah ini sebuah judul? <strong {C}>%(TEXT)</strong> <hr> Sebaris teks yang dicetak tebal atau besar mungkin terlihat seperti judul, namun seseorang yang menggunakan pembaca layar tidak dapat mengetahui bahwa teks tersebut penting atau langsung menuju ke isinya. Teks yang dicetak tebal atau besar tidak boleh menggantikan judul semantik (Judul 2 hingga Judul 6).',
      QA_FAKE_LIST:
      ...
      QA_UPPERCASE:
        'Ditemukan semua huruf besar. Beberapa pembaca layar mungkin menafsirkan teks huruf besar semua sebagai akronim dan akan membaca setiap huruf satu per satu. Selain itu, beberapa orang menganggap huruf besar lebih sulit dibaca dan mungkin memberikan kesan berteriak.',
      QA_UNDERLINE:
        'Teks yang digarisbawahi dapat membingungkan dengan tautan. Pertimbangkan untuk menggunakan gaya yang berbeda seperti <code>&lt;strong&gt;</code><strong>kepentingan yang kuat</strong><code>&lt;/strong&gt;</code> atau <code>&lt;em&gt;</code><em>penekanan</em><code>&lt;/em&gt;</code>.',
      QA_SUBSCRIPT:
        'Opsi pemformatan subskrip dan superskrip hanya boleh digunakan untuk mengubah posisi teks untuk konvensi atau standar tipografi. Opsi ini tidak boleh <strong>tidak</strong> digunakan hanya untuk tujuan presentasi atau penampilan. Memformat seluruh kalimat dapat menimbulkan masalah keterbacaan. Kasus penggunaan yang tepat akan mencakup menampilkan eksponen, angka ordinal seperti 4<sup>th</sup>, bukan keempat, dan rumus kimia (misalnya H<sup>2</sup>O).',
      QA_NESTED_COMPONENTS:
        'Hindari menempatkan komponen tata letak interaktif yang bersarang, seperti menempatkan akordeon di dalam tab atau tab di dalam akordeon. Ini dapat mempersulit navigasi, meningkatkan beban kognitif, dan menyebabkan orang mengabaikan konten.',
      QA_JUSTIFY:
        'Hindari penggunaan teks rata kanan-kiri, yang sejajar dengan margin kiri dan kanan. Ini bisa sulit dibaca oleh beberapa orang karena spasi antar kata yang tidak merata. Gunakan teks rata kiri untuk keterbacaan yang lebih baik.',
      QA_SMALL_TEXT:
      ...
      // Developer
      DUPLICATE_ID:
        'Ditemukan <strong>duplikat ID</strong>. Kesalahan ID duplikat diketahui dapat menyebabkan masalah pada teknologi bantuan saat mencoba berinteraksi dengan konten. Harap hapus atau ubah ID berikut ini. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      UNCONTAINED_LI:
        'Semua item daftar <code>&lt;li&gt;</code> harus diletakkan di dalam elemen <code>&lt;ul&gt;</code> yang tidak terurut atau <code>&lt;ol&gt;</code> yang terurut. Struktur ini membantu pembaca layar mengumumkan daftar dan item-itemnya dengan akurat.',
      TABINDEX_ATTR:
        'Elemen tidak boleh memiliki atribut <code>tabindex</code> yang lebih besar dari 0.',

      // Meta checks
      META_LANG:
        'Bahasa halaman tidak dideklarasikan! Silakan <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklarasikan bahasa pada tag HTML.</a>',
      META_TITLE:
        'Judul halaman tidak ada! Harap berikan <a href="https://developer.mozilla.org/id/docs/Web/HTML/Element/title">judul halaman.</a>',
      META_SCALABLE:
        'Hapus parameter <code>user-scalable="no"</code> dalam <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport_meta_tag">tag meta viewport</a> untuk memungkinkan zoom.',
      META_MAX:
      ...
      BTN: 'tombol',
      BTN_TIP:
        'Pelajari cara membuat <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">tombol aksesibel.</a>',
      BTN_ROLE_IN_NAME:
      ...
      CONTRAST_ERROR:
        'Teks tidak memiliki kontras yang cukup dengan latar belakang, sehingga sulit untuk dibaca.',
      CONTRAST_WARNING:
        'Kontras teks ini tidak diketahui dan harus ditinjau secara manual. Pastikan teks dan latar belakang memiliki perbedaan warna yang kuat.',
      CONTRAST_ERROR_GRAPHIC:
        'Grafik tidak memiliki kontras yang cukup dengan latar belakang, sehingga sulit untuk dilihat.',
      CONTRAST_WARNING_GRAPHIC:
        'Kontras grafik ini tidak diketahui dan harus ditinjau secara manual.',
      CONTRAST_TIP_GRAPHIC:
        'Grafik dan elemen antarmuka pengguna harus memiliki rasio kontras minimal 3:1.',
      CONTRAST_OPACITY: 'Tingkatkan opasitas untuk visibilitas yang lebih baik.',
      CONTRAST_APCA:
        'Kontras ini tidak cukup untuk ukuran teks apa pun. Apakah Anda ingin menggunakan kombinasi warna dan ukuran teks ini?',
      ...
      CONTRAST_PLACEHOLDER:
        'Teks placeholder dalam input ini tidak memiliki kontras yang cukup dengan latar belakang, sehingga sulit dibaca.',
      CONTRAST_PLACEHOLDER_UNSUPPORTED:
        'Kontras dari teks placeholder ini tidak diketahui dan perlu ditinjau secara manual. Pastikan teks dan latar belakang memiliki warna yang sangat kontras.',
      CONTRAST_INPUT:
        'Teks dalam input ini tidak memiliki kontras yang cukup dengan latar belakang, sehingga sulit dibaca.',
      CONTRAST: 'Kontras',
      UNKNOWN: 'Tidak diketahui',
      FG: 'Latar depan',
      BG: 'Latar belakang',
      NO_SUGGESTION:
        'Tidak ada kombinasi aksesibel yang dapat ditemukan dengan hanya mengubah warna teks. Coba ubah warna latar belakang.',
    },
  };
