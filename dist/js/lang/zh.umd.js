(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_MAYBE_BUTTON: `<p>此链接的目标无效，且包含"<strong>%(NAME)</strong>"一词。这表明它可能并非真正的链接，而是控制页面上某些脚本行为。</p><p>${why.fix}请将该链接替换为<a href="https://www.w3.org/WAI/ARIA/apg/patterns/button/">可访问的按钮</a>，或修正链接的目标地址。</p><div class="why"><p>提示：辅助技术对按钮和链接的处理方式不同。使用正确的 HTML 元素可确保用户了解应使用哪些键盘快捷键以及将触发何种操作。</p></div>`,
