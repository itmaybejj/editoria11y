(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p><strong class="badge">Oplossen</strong> Voeg tekst toe die het linkdoel beschrijft, of verwijder de link als het een fout is (zoals een gelinkt spatiekarakter).</p><div class="why"><p>Tip: schermlezers kunnen lege links niet beschrijven. Ze blijven stil ("Link, [...lange pauze...]") of lezen de URL voor.</p><p>Gelinkte spaties zijn soms lastig te verwijderen; het kan nodig zijn om tekst rondom de spatie te verwijderen en opnieuw te typen.</p></div>`,
