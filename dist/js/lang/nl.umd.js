(function(global, factory) {
  ...
  const tips = {
    ...
    QA_IN_PAGE_LINK: `<p><strong>Link:</strong> <i>%(TEXT)</i></p><p><strong>URL:</strong> <code>#%(ID)</code></p><p>Het linkdoel komt niet overeen met een element op deze pagina.</p><div class="why"><p>Voor ontwikkelaars: als dit door JavaScript wordt afgehandeld, verifieer dan toetsenbordbediening voordat u deze controle negeert.</p></div>`,
