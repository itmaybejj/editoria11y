(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Ed11yLangNl = {}));
  ...
  const tooltip = {
    ...
    EMBED_MISSING_TITLE: 'Voor ingesloten inhoud is een toegankelijke naam nodig die de inhoud beschrijft. Geef een uniek <code>title</code> of <code>aria-label</code> attribuut bij het <code>&lt;%(ELEMENT)&gt;</code> element. Meer informatie over <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
  ...
  const testNames = {
    ...
    ALT_PLACEHOLDER: "Deze alt‑tekst is mogelijk een placeholder",
    ALT_UNPRONOUNCEABLE: "Deze alt‑tekst is niet uit te spreken",
    ARIA_INPUT_FIELD_NAME: "Dit aangepaste invoerveld mist een label",
    BTN_EMPTY: "Knop mist een toegankelijk label",
    BTN_UNPRONOUNCEABLE: "Deze knop is niet uitsprekbaar",
    ...
    HEADING_UNPRONOUNCEABLE: "Deze kop is niet uitsprekbaar",
    ...
    IMAGE_FIGURE_DECORATIVE: "Deze afbeelding met bijschrift heeft geen alt‑tekst",
    ...
    LABELS_MISSING_IMAGE_INPUT: "Dit afbeeldingsinvoerveld mist alt‑tekst",
    LABELS_MISSING_LABEL: "Dit invoerveld heeft een leeg label",
    LABELS_NO_FOR_ATTRIBUTE: "Dit invoerveld is niet gekoppeld aan een label",
    LABELS_PLACEHOLDER: "Gebruik bij voorkeur zichtbare labels in plaats van placeholders",
    LABEL_IN_NAME: "Zichtbare label komt niet overeen met de toegankelijke naam",
    LANG_MISMATCH: "Taaltag komt niet overeen met de inhoud",
    LANG_OF_PARTS: "Deze inhoud lijkt in een andere taal te zijn",
    LANG_OF_PARTS_ALT: "Deze alt‑tekst lijkt in een andere taal te zijn",
    ...
    LINK_CLICK_HERE: "Deze link bevat “klik hier”",
    ...
    LINK_IMAGE_ALT: "Beschrijft deze alt‑tekst de link of de afbeelding?",
    ...
    LINK_IMAGE_TEXT: "Heeft deze gekoppelde afbeelding een beschrijving nodig?",
    LINK_LABEL: "Linklabel",
    LINK_MAYBE_BUTTON: "Is deze link eigenlijk een knop?",
    LINK_NEW_TAB: "Opent deze link een nieuw tabblad zonder waarschuwing?",
    LINK_PLACEHOLDER_ALT: "Deze gekoppelde alt‑tekst is mogelijk een placeholder",
    LINK_STOPWORD: "Deze link bevat alleen algemene woorden",
    LINK_STOPWORD_ARIA: "Het doel van deze link is visueel verborgen",
    LINK_SUS_ALT: "Beschrijft deze alt‑tekst de afbeelding of de link?",
    LINK_SYMBOLS: "Zijn de symbolen of emoji’s in deze link betekenisvol?",
    LINK_URL: "Linktekst mag geen URL zijn",
    META_LANG: "Meta‑tag voor paginataal ontbreekt",
    META_LANG_SUGGEST: "Bedoelde u een andere taalcode?",
    META_LANG_VALID: "Ongeldige taalcode",
    ...
    PAGE_LANG_CONFIDENCE: "Paginataal komt mogelijk niet overeen met de inhoud",
    QA_BAD_LINK: "Dit linkdoel is mogelijk ongeldig",
    ...
    TABINDEX_ATTR: "Tabindex‑overrides verstoren de focusvolgorde",
    TABLES_EMPTY_HEADING: "Deze tabelkopcel heeft tekst nodig",
    TABLES_INVALID_HEADERS_REF: "Deze tabel heeft een ongeldig headers‑attribuut",
  ...
  const why = {
    buttons: `<div class="why"><p>Tip: de toegankelijke naam van een knop moet duidelijk maken wat de knop doet wanneer erop geklikt wordt. Als dat verandert, moet de huidige toestand duidelijk zijn:</p><ul><li>Knoppen die het label bijwerken:<br>"Afspelen/Pauzeren", "Details tonen/Details verbergen"</li><li>Knoppen die <a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/button_role#associated_aria_roles_states_and_properties">de toestand bijwerken</a>:<br>"Afspelen/Afspelen, ingedrukt", "Details, samengevouwen/Details, uitgeklapt"</li></ul></div>`,
    ...
    imageLinks: `<div class="why"><p>Tip: de bedoeling van alt‑tekst is om een alternatief te bieden voor wat een afbeelding betekent, niet wat deze bevat. Bij een gelinkte afbeelding is de betekenis het linkdoel:</p><ul><li>"<em>Een vergrootglas</em>" beschrijft een afbeelding, geen link.</li><li>"<em>Vergrootglas zoeken</em>" beschrijft beide en is verwarrend.</li><li>"<em>Zoeken</em>" beschrijft het linkdoel nauwkeurig.</li></ul></div>`,
    ...
    links: `<div class="why"><p>Tip: gebruikers scannen pagina’s op links en gebruiken zoeken binnen de pagina om links op naam te vinden. Effectieve links zijn betekenisvol, uniek en beknopt:</p><ul><li>Ideaal: "Learn about <a href="https://webaim.org/techniques/hypertext/link_text">meaningful links</a>"</li><li>Niet uniek: "Klik <a href="https://webaim.org/techniques/hypertext/link_text">hier</a> om meer te leren over betekenisvolle links."</li><li>Niet beknopt: "<a href="https://webaim.org/techniques/hypertext/link_text">Klik hier om meer te leren over betekenisvolle links</a>"</li></ul></div>`
  };
  const tips = {
    ALT_FILE_EXT: `<p><span hidden>%(alt)</span><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>Schermlezers proberen deze URL uit te spreken, vaak letter voor letter. Dit geeft meestal niet dezelfde betekenis als het beeld zelf.</p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    ALT_MAYBE_BAD: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    ALT_MAYBE_BAD_WARNING: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    ALT_PLACEHOLDER: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    ALT_UNPRONOUNCEABLE: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>Deze alt‑tekst bevat alleen niet‑uitspreekbare symbolen of spaties. Schermlezers kondigen een afbeelding aan en vallen daarna stil of lezen iets onbegrijpelijks op.</p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    ARIA_INPUT_FIELD_NAME: `<p><strong>Element:</strong> <code>%(EL)</code></p><p>${why.fix}Geef een geldig label op; voor aangepaste invoerelementen betekent dat vaak inner‑tekst, of een title‑, aria-label‑ of aria-labelledby‑attribuut.</p>`,
    ...
    BTN_TIP: `${why.buttons}`,
    BTN_ROLE_IN_NAME: `<p><strong>Label voor schermlezers:</strong> <i>%(TEXT)</i></p><p>Schermlezers gebruiken het woord “button” om aan te kondigen dat ze een knop beschrijven, dus dit woord is herhalend.</p><p>${why.fix}Het knoplabel moet overeenkomen met de actie. Als het zichtbare label een pictogram is in plaats van tekst, benoem de knop dan naar de betekenis van het pictogram, bijvoorbeeld “Afspelen”, “Zoeken” of “Menu”.</p>`,
    BTN_UNPRONOUNCEABLE: `<p><strong>Knoptekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Voeg tekst, een titel of een aria-label toe die de bestemming beschrijft.</p><div class="why"><p>Tip: Schermlezers kunnen knoppen die alleen spaties of symbolen bevatten niet beschrijven. Ze worden ofwel stil ("Knop, [...ongemakkelijke pauze waar het knoplabel zou moeten staan...]"), of lezen de naam van het symbool voor.</p></div>`,
    ...
    DUPLICATE_ID: `<p>Op deze pagina worden ID’s gebruikt als labels of linkdoelen en moeten daarom uniek zijn.</p><p>${why.fix}Wijzig deze ID: <code>#%(ID)</code></p><div class="why"><p>In veel CMS’en komt dit uit een veld “name” of “id”. In HTML is het een attribuut: <code>&lt;a id=""></code></p></div>`,
    ...
    EMBED_GENERAL: 'Automatische controles zien de inhoud binnen embeds niet. Zorg dat afbeeldingen alt hebben, video’s ondertiteld zijn, tekst voldoende contrast heeft en links/knoppen <a href="https://webaim.org/techniques/keyboard/">toetsenbordtoegankelijk</a> zijn. Daarna kunt u deze melding sluiten.',
    ...
    EMBED_UNFOCUSABLE: `<p>Dit attribuut laat toetsenbord en hulpmiddelen het element overslaan. Verwijder dit attribuut, tenzij de iframe geen links, knoppen, formulierelementen of scrollbare inhoud bevat.</p>`,
    ...
    HEADING_UNPRONOUNCEABLE: `<p>Lege koppen veroorzaken gaten in de documentstructuur.</p><p>${why.fix}Voeg leesbare tekst toe aan deze kop, of zet deze om in een alinea.</p>${why.headings}`,
    HEADING_EMPTY_WITH_IMAGE: `<p>Lege koppen veroorzaken gaten in de structuur.</p><p>${why.fix}Als dit geen kop is, wijzig de opmaak van <code>Kop %(level)</code> naar <code>Alinea</code>. Is het wel een kop, beschrijf dan de betekenis van de afbeelding in de alt‑tekst.</p>${why.headings}`,
    HEADING_FIRST: `${why.fix}Zorg ervoor dat de paginatitel is gemarkeerd als Kop 1 of Kop 2. ${why.headings}`,
    HEADING_LONG: `<p>${why.fix}Tenzij het om een vaste titel gaat (bv. publicatie), verkort de kop voor betere scanbaarheid:<span hidden>%(drop)%(drop)</span></p><p><i>%(TEXT)</i></p>${why.headings}`,
    ...
    HEADING_SKIPPED_LEVEL: `<p>Deze kop springt van <code>niveau %(prevLevel)</code> naar <code>niveau %(level)</code>. Voor schermlezers klinkt dit alsof er inhoud ontbreekt.</p><p>${why.fix}Pas de niveaus aan zodat de structuur logisch blijft.</p>${why.headings}`,
    HIDDEN_FOCUSABLE: `<p>Dit interactieve element heeft <code>aria-hidden="true"</code>, maar kan nog steeds focussen. Als u het echt wilt verbergen voor schermlezers, voeg dan <code>tabindex="-1"</code> toe; anders verwijdert u <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
    IMAGE_ALT_TOO_LONG: `<p>Deze alt‑tekst is %(altLength) tekens lang: <i class="ed11y-small">%(ALT_TEXT)</i></p><p>${why.fix}Vat samen of verplaats delen van de beschrijving naar een bijschrift.</p><div class="why"><p>Tip: complexe afbeeldingen die meer informatie bevatten dan in één zin past, hebben vaak een <strong>zichtbaar</strong> bijschrift of alternatieve tekst nodig die belangrijke details beschrijft. Het is prima om schermlezergebruikers daarheen te verwijzen:</p><ul><li>"Poster voor de dansavond op vrijdag; details staan in het bijschrift."</li><li>"Grafiek met een daling van 10% dit jaar; details staan in de tabel."</li></ul></div>`,
    ...
    IMAGE_FIGURE_DUPLICATE_ALT: `<p><strong>Dubbele tekst: </strong><i>%(ALT_TEXT)</i></p><p>${why.fix}Beschrijf in de alt‑tekst de visuele betekenis die nog ontbreekt.</p><div class="why"><p>Tip: afbeelding, alt‑tekst en bijschrift vullen elkaar aan:</p><ul><li>Bijschrift biedt context.</li><li>Alt‑tekst beschrijft het beeld voor wie het niet ziet.</li></ul></div>`,
    LABELS_ARIA_LABEL_INPUT: `<p><strong>Onzichtbare veldlabel:</strong> <i>%(TEXT)</i></p><p>Controleer of er een zichtbare label is, of deze zichtbaar blijft bij invoer én overeenkomt met de toegankelijke naam.</p><div class="why"><p>Labels die alleen als <em>title</em> of <em>placeholder</em> verschijnen, verdwijnen bij typen en bemoeilijken controle en consistentie.</p></div>`,
    ...
    LABELS_NO_FOR_ATTRIBUTE: `Dit invoerveld heeft geen gekoppeld label. Voeg een <code>for</code>-attribuut toe aan het label dat overeenkomt met het <code>id</code> van dit invoerveld.<hr><strong>ID:</strong> <code>#%(ID)</code>`,
    LABELS_PLACEHOLDER: `<p>Placeholder‑tekst kan worden aangezien voor reeds ingevoerde inhoud als deze goed contrast heeft, of onleesbaar zijn als dat niet zo is. Daarna verdwijnt de tekst zodra er wordt getypt, waardoor informatie die gebruikers nodig hebben om fouten te controleren kan verdwijnen.</p><p>${why.fix}Zorg dat label, hulp‑ en vormeisen zichtbaar blijven, ook wanneer het veld gevuld is.</p>`,
    LABEL_IN_NAME: `<p><strong>Zichtbare tekst:</strong> <i>%(VISIBLE)</i></p><p><strong>Label voor schermlezers:</strong> <i>%(LABEL)</i></p><p>De zichtbare tekst van dit element lijkt anders te zijn dan de toegankelijke naam. Dit kan schermlezergebruikers verwarren en spraakbesturing verstoren.</p><p>${why.fix}Zorg dat het zichtbare label begint met de tekst van het onzichtbare label en geen betekenisvolle informatie bevat die niet in het onzichtbare label staat.</p>`,
    LINK_ALT_FILE_EXT: `<p>Deze alt‑tekst is waarschijnlijk een bestandsnaam in plaats van een betekenisvolle linktitel:<br><span hidden>%(ALT)</span><i>%(alt)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p><div class="why"><p>Alt‑tekst moet de betekenis van een afbeelding beschrijven. Voor een gelinkte afbeelding is dat de bestemming:</p><ul><li>"Pagina met tekst" beschrijft het beeld, niet de link.</li><li>"IMG_1234.jpg" is slechts een bestandsnaam.</li><li>"Formulier voor evenementregistratie (.doc)" is het linkdoel.</li></ul></div>`,
    LINK_ALT_MAYBE_BAD: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_ALT_MAYBE_BAD_WARNING: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_ALT_UNPRONOUNCEABLE: `<p>De alt‑tekst <i>%(ALT_TEXT)</i> bestaat uit niet‑uitspreekbare tekens/spaties; het linkdoel kan niet worden aangekondigd.</p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_CLICK_HERE: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Verwijder overbodige woorden die afleiden van het doel van de link.</p>${why.links}`,
    LINK_DOI: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Link de artikeltitel en geef de DOI in platte tekst; link niet de DOI zelf.</p><div class="why"><p>Beschrijvende links zijn makkelijker te scannen en helpen schermlezers betekenisvolle linknamen voor te lezen.</p></div>`,
    ...
    LINK_FILE_EXT: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>Deze link verwijst naar een bestand (bijv. PDF/MP3/ZIP/Word) zonder waarschuwing.</p><p>${why.fix}Geef in de linktekst het bestandstype aan (tekst/pictogram): <a href="https://itmaybejj.github.io/linkpurpose/"></a>.</p><p class="why">Vermeld bij grote bestanden ook de grootte, bijvoorbeeld “Jaarverslag (PDF, 3 MB)”.</p>`,
    LINK_IDENTICAL_NAME: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p><strong class="badge">Oplossen</strong> Herschrijf links die naar verschillende locaties gaan zodat hun tekst uniek is.</p>${why.links}`,
    LINK_IMAGE_ALT: `<p><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_IMAGE_ALT_AND_TEXT: `<p><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p><strong>Linktekst inclusief alt‑tekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Bewerk of verwijder de alt‑tekst als deze irrelevante of dubbele informatie toevoegt.</p>${why.imageLinks}`,
    LINK_IMAGE_LONG_ALT: `<p>Deze alt‑tekst is %(altLength) tekens lang: <i class="ed11y-small">%(ALT_TEXT)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p><div class="why"><p>Schermlezergebruikers horen vaak een lijst met links zonder context. De alt‑tekst van een gelinkt beeld wordt de linktitel en moet daarom het linkdoel beschrijven, niet het beeld.</p></div>`,
    LINK_IMAGE_NO_ALT_TEXT: `<p>Als een link een afbeelding bevat, wordt de alt‑tekst van die afbeelding <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">de linknaam</a> voor schermlezers.</p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_IMAGE_TEXT: "Afbeelding is als decoratief gemarkeerd, terwijl de omliggende tekst als linklabel dient.",
    LINK_MAYBE_BUTTON: `<p><strong>Link:</strong> <i>%(TEXT)</i></p><p>Deze link heeft een ongeldig doel en heeft een naam die suggereert dat deze mogelijk als knop of schakelaar werkt in plaats van als link.</p><p>${why.fix}Gebruik in plaats daarvan een <a href="https://www.w3.org/WAI/ARIA/apg/patterns/button/">&lt;button&gt;</a>, of corrigeer de linkbestemming.</p><div class="why"><p>Tip: hulpmiddelen behandelen knoppen en links verschillend. Het juiste HTML‑element zorgt ervoor dat gebruikers weten welke sneltoetsen ze moeten gebruiken en welke actie wordt uitgevoerd.</p></div>`,
    LINK_NEW_TAB: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Laat de link in hetzelfde tabblad openen of <a href="https://itmaybejj.github.io/linkpurpose/">waarschuw vooraf</a> dat een nieuw tabblad wordt geopend.</p><div class="why"><p>Gebruikers kunnen zelf kiezen voor een nieuw tabblad; afdwingen werkt verwarrend (bijv. “terug” werkt anders).</p><p>Uitzondering: in formulieren worden links vaak in een nieuw tabblad geopend om verlies van invoer te voorkomen.</p></div>`,
    LINK_PLACEHOLDER_ALT: `<p><strong>Alt‑tekst:</strong> <i>%(alt)</i>.</p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_STOPWORD: `<p>Linktekst: <i>%(ERROR)</i></p><p><strong class="badge">Oplossen</strong> Gebruik linktekst die het doel beschrijft.</p>${why.links}`,
    LINK_STOPWORD_ARIA: `<p>Er is via ARIA een andere naam opgegeven:</p><p><strong>Zichtbare tekst:</strong> <i>%(VISIBLE)</i></p><p><strong>Verborgen tekst:</strong> <i>%(HIDDEN)</i></p><p>${why.fix}Schrijf betekenisvolle links voor iedereen, niet alleen voor schermlezergebruikers, en zorg dat het <a href="https://www.w3.org/WAI/WCAG22/Understanding/label-in-name.html">zichtbare label overeenkomt met de naam</a> van elk element, zodat gebruikers van spraakbesturing hun browser kunnen vertellen op welke link te klikken.</p>${why.links}`,
    LINK_SUS_ALT: `<p>Tenzij "<i>%(alt)</i>" de linkbestemming beschrijft, beschrijft deze alt‑tekst waarschijnlijk de afbeelding.</p><p><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
    LINK_SYMBOLS: `<p>Symbool gevonden: <i>%(ERROR)</i></p><p>${why.fix}Gebruik geen symbolen als call‑to‑action in linktekst, tenzij ze verborgen zijn voor ondersteunende technologie. Schermlezers lezen de symbolen hardop voor en dat kan verwarrend zijn.</p>`,
    LINK_URL: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Gebruik de titel of het doel van de bestemming i.p.v. een URL als linktekst.</p><div class="why"><p>Gebruikers — zeker schermlezergebruikers — scannen links op naam.</p><p>URL’s als linktekst scannen en zoeken lastig.</p></div>`,
    META_LANG: `<p>${why.fix}Voeg een <a href="https://www.w3.org/International/questions/qa-html-language-declarations">taalattribuut</a> toe op het HTML‑element.</p><div class="why"><p>Schermlezers stemmen uitspraak af op de ingestelde taal; een verkeerde taal maakt voorlezen onduidelijk.</p></div>`,
    META_LANG_VALID: `<p><strong>Element:</strong> <code>&lt;%(ELEMENT) lang="%(CODE)"&gt;</code></p><p>${why.fix}Vervang het lang‑attribuut door een geldige taalcode.</p><div class="why"><p>Tip: pagina's en elementen hebben <a href="https://www.w3.org/International/questions/qa-html-language-declarations">taalattributen</a> zodat schermlezers en vertaaltools de tekst correct lezen.</p></div>`,
    ...
    META_TITLE: `<p>${why.fix}Voeg een <code>&lt;title&gt;</code> toe in de <code>head</code>.</p><div class="why"><p>Een <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/title">korte, unieke titel</a> is cruciaal: zoekresultaten, browsertabbladen en schermlezers gebruiken die.</p><p>Zonder titel ziet/hoort men alleen de ruwe URL.</p></div>`,
    MISSING_ALT: `<p>Zonder alt probeert een schermlezer vaak de bestands‑URL letter voor letter uit te spreken.</p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
    MISSING_ALT_LINK: `<p>Bij een linkbeeld zonder alt probeert de schermlezer de bestands‑URL uit te spreken — extra verwarrend.</p><p>${why.fix}Voorzie een alt‑tekst die het linkdoel beschrijft.</p>${why.imageLinks}`,
    MISSING_ALT_LINK_HAS_TEXT: `<p>Deze afbeelding staat in een link met tekst. Als die tekst het doel volledig beschrijft, gebruik alt=""; anders, voeg alt‑tekst toe die helpt de bestemming of het doel van de link te beschrijven.</p>${why.imageLinks}`,
    QA_BAD_LINK: `<p>De link lijkt naar een ontwikkelomgeving te verwijzen:<br>{L} <code>%(LINK)</code></p><p>${why.fix}Gebruik een relatief pad (/map) of de publieke URL.</p>`,
    QA_BLOCKQUOTE: `<p><strong>Verdacht kort citaat:</strong> <i>%(TEXT)</i></p><p>${why.fix}Als dit een kop is en geen citaat, tag het dan als kop zodat het in de structuur van de pagina verschijnt.</p>${why.headings}`,
    QA_DOCUMENT: `<p><strong>Link:</strong> <i>%(TEXT)</i></p><p>Gekoppelde documenten worden beschouwd als webinhoud en moeten ook toegankelijk zijn. Controleer of het document koppen, tabelkoppen en alt‑teksten heeft voordat u deze waarschuwing negeert.</p><div class="why"><ul><li><a href="https://support.google.com/docs/answer/6199477?hl=en">Zo maakt u Google‑documenten toegankelijker</a></li><li><a href="https://support.microsoft.com/en-us/office/create-accessible-office-documents-868ecfcd-4f00-4224-b881-a65537a7c155">Zo maakt u Office‑documenten toegankelijker</a></li></ul></div>`,
    QA_FAKE_HEADING: `<p><strong>Vetgedrukte tekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Als deze tekst vet is om een onderwerpwissel aan te geven, tag deze dan als kop zodat schermlezergebruikers hem kunnen gebruiken om door de pagina te navigeren.</p><div class="why"><p>Tip: vet en cursief bieden visuele nadruk, maar voegen niet automatisch tekst toe aan de inhoudsopgave van het document voor ondersteunende technologieën.</p></div>`,
    QA_FAKE_LIST: `<p>${why.fix}Als <i>%(TEXT)</i> bij een lijst hoort, gebruik dan lijstopmaak.</p><div class="why"><p>Lijsten geven visuele én semantische structuur:</p><ol><li>Uitgelijnde inspringingen verbeteren de leesbaarheid.</li><li>Schermlezers melden positie (“item 3 van 7”).</li></ol><p>Een zin die met een nummer begint is nog geen echte lijst.</p></div>`,
    QA_IN_PAGE_LINK: `<p><strong>URL:</strong> <i>#%(ID)</i></p><p><strong>Link:</strong> <code>%(TEXT)</code></p><p>Het linkdoel komt niet overeen met een element op deze pagina.</p><div class="why"><p>Voor ontwikkelaars: als dit door JavaScript wordt afgehandeld, verifieer dan toetsenbordbediening voordat u deze controle negeert.</p></div>`,
    ...
    QA_SMALL_TEXT: `<p><strong>Tekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Blijf boven 80% van de standaard lettergrootte. Kleine tekst is moeilijk te lezen, vooral voor slechtzienden.</p>`,
    QA_STRONG_ITALICS: `<p><strong>Tekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Gebruik vet en cursief spaarzaam, bij voorkeur voor kernwoorden.</p><div class="why"><p>Opmerking: gebruik <code>blockquote</code> voor citaten.</p></div>`,
    QA_SUBSCRIPT: `<p><strong>Tekst:</strong> <i>%(TEXT)</i></p><p>Subscript/superscript maakt tekst klein en moeilijk leesbaar. Gebruik het gericht voor 4<sup>e</sup>, H<sub>2</sub>O, voetnootreferenties e.d.</p>`,
    QA_UNDERLINE: `<p>Onderstreepte tekst op het web wordt gebruikt voor links, niet voor nadruk. Gebruikers zullen denken dat ze hierop kunnen klikken: <i><u>%(TEXT)</u></i></p><p>${why.fix}Gebruik <strong>vet</strong> of <em>cursief</em> voor nadruk, en koppen voor structuur.</p><div class="why"><p>Schermlezers melden visuele opmaak niet; koppen geven wél structuur.</p></div>`,
    QA_UPPERCASE: `<p><strong>Tekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Gebruik hoofdletters slechts voor enkele woorden ter benadrukking. GROTE BLOKKEN TEKST IN HOOFDLETTERS ZIJN MOEILIJKER TE LEZEN EN VEEL LEZERS ERVAREN ZE ALS SCHREEUWERIG.</p><div class="why"><p>Opmerking: schermlezers melden puur visuele opmaak zoals hoofdlettertekst niet. Gebruik liever een kopstijl als deze benadrukte tekst een onderwerpswissel of kritische informatie aankondigt.</p></div>`,
    SUS_ALT: `<p>Deze alt‑tekst bevat het woord "<i>%(alt)</i>." Schermlezers kondigen aan dat ze een afbeelding beschrijven, dus zinsdelen als "afbeelding van" of "foto van" zijn meestal overbodig.</p><p><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p><div class="why"><p>Tip: deze zinsdelen zijn het waard om te behouden als de vorm zelf betekenisvol is:<br>"Een foto van een kat, ingelijst en opgehangen aan de muur."</p></div>`,
    TABINDEX_ATTR: `<p>Tabindex‑waarden groter dan 0 verplaatsen focusbare elementen uit hun visuele volgorde, waardoor gebruikers van ondersteunende technologieën ze moeilijk kunnen vinden en bedienen.</p><p>${why.fix}Pas de HTML‑volgorde van elementen aan zodat focusvolgorde en leesvolgorde overeenkomen.</p><div class="why"><p>Tip: de visuele volgorde van woorden op de pagina en de volgorde waarin toetsenborden door elementen tabben zijn meestal gelijk.</p><p>Een positieve tabindex verplaatst een element naar het begin van de tabvolgorde, <strong>maar niet in de visuele of leesvolgorde</strong>.</p></div>`,
    ...
    TABLES_INVALID_HEADERS_REF: `<p>Deze tabel probeert een specifieke datacel te koppelen aan een specifieke kopcel, maar het ID van de kopcel is niet te vinden: <code>%(VALUE)</code>.</p><p>${why.fix}Zorg dat elk <code>headers</code>-attribuut overeenkomt met de ID van een kopcel in dezelfde tabel.</p><div class="why">Tip: <a href="https://www.w3.org/WAI/WCAG22/Techniques/html/H43">handmatige ID‑referenties gebruiken</a> om datacellen aan kopcellen te koppelen is ingewikkeld en foutgevoelig. Splits complexe gegevens waar mogelijk op in kleinere tabellen met eenvoudige koprijen en ‑kolommen.</div>`,
  ...
  const interfaceStrings = {
    ALERT_CLOSE: "Sluiten",
    ALT: "Alt‑tekst: ",
    CONSOLE_ERROR: 'Er is een probleem met de toegankelijkheidscontrole op deze pagina. <a class="g-link">Meld het op GitHub</a>. Foutopsporing:',
