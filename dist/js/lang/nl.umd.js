(function(global, factory) {
  ...
  const tips = {
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>Schermlezers proberen deze URL uit te spreken, vaak letter voor letter. Dit geeft meestal niet dezelfde betekenis als het beeld zelf.</p><p>${why.fix}Beschrijf beknopt wat deze afbeelding in deze context betekent.</p>${why.images}`,
