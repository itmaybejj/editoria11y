(function(global, factory) {
  ...
  const tips = {
    ...
    BTN_EMPTY: `<p>${why.fix}Geef schermlezers aan wat deze knop doet, via tekst, alt-tekst op een icoon of een title-attribuut.</p>`,
    ...
    DUPLICATE_TITLE: `<p>${why.fix}Verwijder de tekst of het <code>title</code>-attribuut van deze link.</p><div class="why"><p>Tip: <code>title</code>-tooltips verschijnen alleen bij muisgebruik. Ze zijn niet zichtbaar op telefoons of met toetsenbordnavigatie. Plaats er geen belangrijke informatie in.</p></div>`,
    ...
    HIDDEN_FOCUSABLE: `<p>Dit interactieve element heeft <code>aria-hidden="true"</code>, maar kan nog steeds focussen.</p><p>${why.fix}Als u het echt wilt verbergen voor schermlezers, voeg dan <code>tabindex="-1"</code> toe; anders verwijdert u <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LABELS_MISSING_LABEL: `<p>${why.fix}Voeg een <code>id</code> toe aan dit invoerveld en voeg een overeenkomend <code>for</code>-attribuut toe aan het label.</p>`,
    ...
    LINK_EMPTY_NO_LABEL: `<p>${why.fix}Voeg tekst toe die het linkdoel beschrijft, of verwijder de link als het een typefout is.</p><div class="why"><p>Tip: schermlezers kunnen lege links niet beschrijven; ze blijven stil of lezen de URL voor.</p><p>Gelinkte spaties kunnen lastig te verwijderen zijn; verwijder soms de woorden aan beide kanten.</p></div>`,
    ...
    LINK_IDENTICAL_NAME: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Herschrijf links die naar verschillende locaties gaan zodat hun tekst uniek is.</p>${why.links}`,
    ...
    LINK_STOPWORD: `<p>Linktekst: <i>%(ERROR)</i></p><p>${why.fix}Gebruik linktekst die het doel beschrijft.</p>${why.links}`,
