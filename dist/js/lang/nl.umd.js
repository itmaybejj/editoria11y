(function(global, factory) {
  ...
  const testNames = {
    ...
    META_LANG_VALID: "De taalcode voor dit element is niet geldig",
  ...
  const tips = {
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span>Alt‑tekst: <i>%(ALT_TEXT)</i></p><p>Schermlezers lezen deze URL voor, vaak letter voor letter. Dit geeft meestal niet dezelfde betekenis als het beeld zelf.</p><p><strong class="badge">Oplossen</strong> Gebruik alt="" als dit decoratief is en door schermlezers genegeerd mag worden, of voeg een beschrijvende alt‑tekst toe.</p>${why.images}`,
    ALT_MAYBE_BAD: `<p>Alt‑tekst: <i>%(alt)</i></p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op een korte beschrijving van wat de afbeelding in deze context betekent.</p>${why.images}`,
    ALT_MAYBE_BAD_WARNING: `<p>Alt‑tekst: <i>%(alt)</i></p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op een korte beschrijving van wat de afbeelding in deze context betekent.</p>${why.images}`,
    ALT_PLACEHOLDER: `<p>Alt‑tekst: <i>%(alt)</i></p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op een korte beschrijving van wat de afbeelding in deze context betekent.</p>${why.images}`,
    ALT_UNPRONOUNCEABLE: `<p>Alt‑tekst: <i>%(alt)</i></p><p>Deze alt‑tekst bevat alleen niet‑uitspreekbare symbolen of spaties. Schermlezers kondigen een afbeelding aan en vallen daarna stil of lezen iets onbegrijpelijks op.</p><p><strong class="badge">Oplossen</strong> Voeg een beschrijvende alt‑tekst toe, of gebruik een volledig lege alt (alt="") als dit slechts een pictogram of spatiehouder is.</p>${why.images}`,
    ...
    IMAGE_ALT_TOO_LONG: `<p>Alt‑tekst van %(altLength) tekens: <i class="ed11y-small">%(ALT_TEXT)</i></p><p><strong class="badge">Oplossen</strong> Vat samen of verplaats delen van de beschrijving naar een bijschrift.</p><div class="why"><p>Tip: complexe afbeeldingen die meer informatie bevatten dan in één zin past, hebben vaak een <strong>zichtbaar</strong> bijschrift of alternatieve tekst nodig die belangrijke details beschrijft. Het is prima om schermlezergebruikers daarheen te verwijzen:</p><ul><li>"Poster voor de dansavond op vrijdag; details staan in het bijschrift."</li><li>"Grafiek met een daling van 10% dit jaar; details staan in de tabel."</li></ul></div>`,
    ...
    LINK_ALT_FILE_EXT: `<p><span style="display: none;">%(ALT)</span>Alt‑tekst: <i>%(alt)</i></p><p>Deze alt‑tekst is waarschijnlijk een bestandsnaam in plaats van een betekenisvolle linktitel.</p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op de naam van het linkdoel.</p><div class="why"><p>Alt‑tekst moet de betekenis van een afbeelding beschrijven. Voor een gelinkte afbeelding is dat de bestemming:</p><ul><li>"Pagina met tekst" beschrijft het beeld, niet de link.</li><li>"IMG_1234.jpg" is slechts een bestandsnaam.</li><li>"Formulier voor evenementregistratie (.doc)" is het linkdoel.</li></ul></p></div>`,
    LINK_ALT_MAYBE_BAD: `<p>Alt‑tekst: <i>%(alt)</i></p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op de naam van het linkdoel.</p>${why.imageLinks}`,
    LINK_ALT_MAYBE_BAD_WARNING: `<p>Alt‑tekst: <i>%(alt)</i></p><p><strong class="badge">Oplossen</strong> Stel de alt‑tekst in op de naam van het linkdoel.</p>${why.imageLinks}`,
    LINK_ALT_UNPRONOUNCEABLE: `<p>De alt‑tekst <i>%(ALT_TEXT)</i> bestaat uit niet‑uitspreekbare tekens/spaties; het linkdoel kan niet worden aangekondigd.</p><p>${why.fix}Beschrijf de linkbestemming of functie in de alt‑tekst.</p>${why.imageLinks}`,
    ...
    LINK_IMAGE_ALT: `<p><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>${why.fix}Controleer of deze alt‑tekst de linkbestemming beschrijft, en niet alleen de visuele inhoud van de afbeelding:</p>${why.imageLinks}`,
    ...
    LINK_PLACEHOLDER_ALT: `<p>Alt‑tekst is een placeholder: <i>%(alt)</i>.</p><p>${why.fix}Stel de alt‑tekst in op de linkbestemming.</p>${why.imageLinks}`,
    ...
    LINK_SUS_ALT: `<p>Deze alt‑tekst bevat het woord <i>%(alt)</i>, wat meestal betekent dat deze niet het linkdoel beschrijft.</p><p>Alt‑tekst: <i>%(ALT_TEXT)</i></p><p><strong class="badge">Oplossen</strong> Zorg dat de alt‑tekst het doel of de functie van de link beschrijft.</p>${why.imageLinks}`,
    ...
    SUS_ALT: `<p>Deze alt‑tekst bevat het woord <i>%(alt)</i>:</p><p><i>%(ALT_TEXT)</i></p><p><strong class="badge">Oplossen</strong> Herschrijf de alt‑tekst zodat deze kort aangeeft wat de afbeelding betekent.</p><div class="why"><p>Tip: schermlezers kondigen aan dat ze een afbeelding beschrijven, dus zinsdelen als "afbeelding van" of "foto van" zijn meestal overbodig</p></div>`,
