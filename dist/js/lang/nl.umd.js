(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_IMAGE_NO_ALT_TEXT: `<p>Als een link een afbeelding bevat, wordt de alt‑tekst van die afbeelding https://webaim.org/techniques/hypertext/link_text#alt_linkde linknaam</a> voor schermlezers.</p><p>${why.fix}Gebruik de titel van de linkbestemming als alt‑tekst voor gelinkte afbeeldingen.</p>${why.imageLinks}`,
