(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_EMPTY: `<p>${why.fix}Προσθέστε κείμενο προορισμού ή διαγράψτε τον αν είναι τυχαίο.</p><div class="why"><p>Οι κενές άγκυρες δεν περιγράφονται.</p></div>`,
    // updated
  ...
  const interfaceStrings = {
    ...
    panelCheckAltText: `<p class="ed11y-small">Ελέγξτε ότι κάθε εικόνα περιγράφει τι σημαίνει στο πλαίσιο και ότι δεν υπάρχουν εικόνες με κείμενο.</p>`,
