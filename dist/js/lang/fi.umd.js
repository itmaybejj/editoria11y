...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Sa11yLangFi = factory());
  ...
  var fi = {
    ...
    strings: {
      ...
      OUTLINE: 'Jäsennys',
      READABILITY_DESC:
        'Näyttää luettavuuspisteet <strong>Jäsennys</strong>-välilehdellä auttaakseen lukemisen vaikeuden arvioinnissa.',
      TITLE: 'Otsikko',
      ALT: 'ALT',
      IMAGES: 'Kuvat',
      EDIT: 'Muokkaa',
      ...
      DEVELOPER_DESC:
        'Tarkistaa ongelmat, joiden korjaaminen saattaa vaatia koodausosaamista, kuten HTML-attribuutit, lomakkeet ja muut.',
      ...
      NOT_VISIBLE:
        'Kohde, jota yrität tarkastella, ei ole näkyvissä; se voi olla piilossa tai harmonikka- tai välilehtikomponentin sisällä.',
      MISSING_ROOT:
        'Koko sivun saavutettavuus tarkistettiin, koska kohdealuetta <code>%(root)</code> ei ole olemassa.',
      ...
      DISMISSED: 'Ohitettu',
      DISMISS_REMINDER:
        'Huomaa, että varoitukset on vain <strong>väliaikaisesti</strong> ohitettu. Selaushistorian ja evästeiden poistaminen palauttaa kaikki aikaisemmin ohitetut varoitukset kaikilla sivuilla.',
      ...
      HEADING_SKIPPED_LEVEL:
        'Otsikoiden ei tulisi ohittaa tasoja tai hypätä <strong>Otsikosta %(PREV_LEVEL)</strong> <strong {C}>Otsikkoon %(LEVEL)</strong>, koska se häiritsee sisällön järjestystä ja hierarkiaa, mikä tekee siitä vaikeammin seurattavaa. <hr> Jos <strong {C}>%(HEADING)</strong> kuuluu <strong>%(PREV_HEADING)</strong> -osioon, harkitse sen muotoilemista <strong>Otsikko %(LEVEL)</strong> sijaan.',
      HEADING_EMPTY:
        'Tyhjä otsikko löytyi! Korjaa ongelma poistamalla tämä rivi tai muuttamalla sen muoto <strong {C}>otsikko %(level)</strong> muotoon <strong>Normaali</strong> tai <strong>Paragraph</strong>.',
      HEADING_LONG:
        'Otsikko on pitkä! Otsikoita tulisi käyttää sisällön järjestämiseen ja rakenteen välittämiseen. Niiden tulisi olla lyhyitä, informatiivisia ja ainutlaatuisia. Pidä otsikot alle %(MAX_LENGTH) merkin pituisina (enintään lause). <hr> <strong {B}>%(HEADING_LENGTH) Merkkiä</strong>',
      HEADING_FIRST:
      ...
      LINK_EMPTY_LABELLEDBY:
        'Linkillä on arvo <code>aria-labelledby</code>, joka on tyhjä tai ei vastaa toisen sivun elementin <code>id</code>-ominaisuuden arvoa.',
      LINK_EMPTY_NO_LABEL:
      ...
      LINK_STOPWORD:
        'Linkkiteksti ei välttämättä ole tarpeeksi kuvaava ilman asiayhteyttä: <strong {C}>%(ERROR)</strong>',
      LINK_STOPWORD_ARIA:
        'Vaikka esteetön nimi on annettu, harkitse näkyvän linkkitekstin tarkistamista. Ilmaukset kuten &quot;<strong {C}>%(ERROR)</strong>&quot; eivät ole merkityksellisiä.',
      LINK_TIP:
        '<hr> <strong>Vinkki!</strong> Käytä selkeitä ja yksilöllisiä linkkitekstejä, jotka kuvaavat linkin kohdetta, kuten sivun tai dokumentin otsikkoa.',
      LINK_CLICK_HERE:
        'Ilmaukset "klikkaa" tai "klikkaa tästä" keskittyvät hiiren käyttöön, vaikka monet eivät käytä hiirtä tai saattavat käyttää verkkosivua mobiililaitteella. Harkitse tehtävään liittyvän toisen verbin käyttöä.',
      DUPLICATE_TITLE:
        'Linkkien ja kuvien <code>title</code>-attribuutti on tarkoitettu antamaan lisätietoja, ja sen tulisi olla <strong>erilainen</strong> kuin teksti tai vaihtoehtoinen teksti. Title-teksti näkyy, kun hiiren osoitin viedään elementin päälle, mutta ei ole käytettävissä näppäimistöllä tai kosketusnäytöllä. Harkitse <a href="https://www.a11yproject.com/posts/title-attributes/">title-attribuutin välttämistä kokonaan.</a>',
      LINK_SYMBOLS:
        'Vältä symbolien käyttöä toimintakehotuksina linkkitekstissä, ellei niitä ole piilotettu avustavilta teknologioilta. Näytönlukijat saattavat lukea symbolit ääneen, mikä voi olla hämmentävää. Harkitse niiden poistamista: <strong {C}>%(ERROR)</strong>',
      LINK_URL:
        'Linkkitekstinä käytetyt pidemmät, vaikeaselkoiset URL-osoitteet saattavat olla vaikeasti ymmärrettäviä, kun niitä käytetään apuvälineillä. Useimmissa tapauksissa on parempi käyttää URL-osoitteen sijasta ihmisen luettavissa olevaa tekstiä. Lyhyet URL-osoitteet (kuten sivuston etusivu) ovat ok.',
      LINK_DOI:
        'Verkkosivujen tai vain verkossa olevien resurssien osalta <a href="https://apastyle.apa.org/style-grammar-guidelines/paper-format/accessibility/urls#:~:text=descriptive%20links">APA:n tyyliopas</a> suosittelee kuvailevien linkkien käyttämistä kietomalla teoksen URL-osoite tai DOI-osoite sen otsikon ympärille. Linkkitekstinä käytetyt pidemmät, vaikeaselkoiset URL-osoitteet saattavat olla vaikeasti ymmärrettäviä, kun niitä käytetään apuvälineillä.',
      LINK_NEW_TAB:
      ...
      // Images
      ALT_UNPRONOUNCEABLE:
        'Alt-teksti sisältää vain ääntämättömiä symboleja ja/tai välilyöntejä. Ruudunlukuohjelmat ilmoittavat kuvan ja sitten pysähtyvät. Jos kuva on koristeellinen, varmista ettei alt-tekstissä ole välilyöntejä. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_ALT_UNPRONOUNCEABLE:
        'Tämän linkitetyn kuvan alt-teksti sisältää vain ääntämättömiä symboleja ja/tai välilyöntejä. Ruudunlukuohjelmat ilmoittavat kuvan ja sitten pysähtyvät. Varmista, että alt-teksti kuvaa linkin kohdetta. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      MISSING_ALT_LINK_HAS_TEXT:
        'Kuvaa käytetään linkkinä ympäröivän tekstin kanssa, vaikka alt-attribuutti pitäisi merkitä koristeelliseksi tai nollaksi.',
      MISSING_ALT_LINK:
        'Kuvaa käytetään linkkinä, mutta siitä puuttuu alt-teksti! Varmista, että alt-teksti kuvaa, minne linkki vie.',
      MISSING_ALT:
        'Puuttuva alt-teksti! Jos kuva välittää tarinan, tunnelman tai tärkeää tietoa - muista kuvata kuva.',
      LINK_ALT_FILE_EXT:
        'Vaihtoehtoinen teksti ei saa sisältää tiedostopäätteitä tai kuvan mittoja. Varmista, että alt-teksti kuvaa linkin määränpäätä, ei kuvan kirjaimellista kuvausta. Poista: <strong {C}>%(ERROR)</strong> <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_PLACEHOLDER_ALT:
        'Linkitetyn kuvan sisältämä ei-kuvaava tai sijoitettu alt-teksti löydetty. Varmista, että alt-teksti kuvaa linkin määränpäätä, ei kuvan kirjaimellista kuvausta. Korvaa seuraava alt-teksti. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>.',
      LINK_SUS_ALT:
        'Avustavat teknologiat osoittavat jo, että kyseessä on kuva, joten &quot;<strong {C}>%(ERROR)</strong>&quot; voi olla tarpeeton. Varmista, että alt-teksti kuvaa linkin määränpäätä, ei kuvan kirjaimellista kuvausta. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_FILE_EXT:
        'Vaihtoehtoinen teksti ei saa sisältää tiedostopäätteitä tai kuvan mittoja. Jos kuva välittää tarinan, tunnelman tai tärkeän tiedon - muista kuvata kuva. Poista: <strong {C}>%(ERROR)</strong> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      ALT_PLACEHOLDER:
        'Ei-kuvaava tai paikannettu alt-teksti löydetty. Korvaa seuraava alt-teksti jollain merkityksellisemmällä. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      SUS_ALT:
        'Avustavat teknologiat osoittavat jo, että kyseessä on kuva, joten &quot;<strong {C}>%(ERROR)</strong>&quot; voi olla tarpeeton. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_NO_ALT_TEXT:
        'Linkissä oleva kuva on merkitty koristeeksi, eikä linkkitekstiä ole. Lisää kuvaan alt-teksti, joka kuvaa linkin kohdetta.',
      LINK_IMAGE_TEXT:
        'Kuva on merkitty koristeelliseksi, vaikka linkki käyttää ympäröivää tekstiä kuvaavana merkintänä.',
      LINK_IMAGE_LONG_ALT:
        'Linkitetyn kuvan Alt-tekstin kuvaus on <strong>liian pitkä</strong>. Linkitettyjen kuvien alt-tekstin tulisi kuvata, minne linkki vie, ei kirjaimellista kuvausta kuvasta. <strong>Harkitse sen sivun otsikon käyttämistä alt-tekstinä, johon linkki johtaa.</strong> <hr> {L} {ALT} <strong {B}>%(altLength) Merkkiä</strong> <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT:
        'Kuvalinkki sisältää alt-tekstin. <strong>Kuvaako alt-teksti, minne linkki vie?</strong> Harkitse linkin sisältämän sivun otsikon käyttämistä alt-tekstinä. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_IMAGE_ALT_AND_TEXT:
        'Kuvalinkki sisältää <strong> sekä alt-tekstin että ympäröivän linkkitekstin.</strong> Jos kuva on koristeellinen ja sitä käytetään toiminnallisena linkkinä toiselle sivulle, harkitse kuvan merkitsemistä koristeelliseksi tai nollaksi - ympäröivän linkkitekstin pitäisi riittää. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Saavutettava nimi</strong> {L} <strong {C}>%(TEXT)</strong>',
      IMAGE_FIGURE_DECORATIVE:
        'Kuva on merkitty <strong>koristeelliseksi</strong> ja avustava teknologia jättää sen huomiotta. <hr> Vaikka <strong>kuvateksti</strong> on annettu, kuvassa pitäisi useimmissa tapauksissa olla myös alt-teksti. <ul><li>Alttitekstin tulisi antaa tiivis kuvaus siitä, mitä kuvassa on.</li><li>Kuvatekstin tulisi yleensä tarjota konteksti, joka liittää kuvan takaisin ympäröivään sisältöön, tai kiinnittää huomiota tiettyyn tietoon.</li></ul> Lisää lisää: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a>',
      IMAGE_FIGURE_DUPLICATE_ALT:
        'Älä käytä täsmälleen samoja sanoja sekä alt- että kuvatekstissä. Ruudunlukuohjelmat ilmoittavat tiedon kahdesti. <ul><li> Alt-tekstin tulisi antaa tiivis kuvaus siitä, mitä kuvassa on.</li><li>Tekstikuvan kuvatekstin tulisi yleensä tarjota konteksti, joka liittää kuvan ympäröivään sisältöön, tai kiinnittää huomiota tiettyyn tietoon.</li></ul> Lue lisää: <a href="https://thoughtbot.com/blog/alt-vs-figcaption#the-figcaption-element">alt versus figcaption.</a> <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      IMAGE_DECORATIVE:
        'Kuva on merkitty <strong>koristeelliseksi</strong> ja avustava teknologia jättää sen huomiotta. Jos kuva välittää tarinaa, tunnelmaa tai tärkeää tietoa - muista lisätä alt-teksti.',
      ...
      ALT_MAYBE_BAD:
        'Alt-teksti ei ehkä anna hyödyllistä tietoa tai on epämääräinen. Paranna seuraavaa alt-tekstiä: <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong>',

      // Form labels
      LABELS_MISSING_IMAGE_INPUT:
        'Kuvapainikkeesta puuttuu alt-teksti. Lisää alt-tekstiä, jotta nimi on helposti saatavilla. Esimerkiksi: <em>Haku</em> tai <em>Lähetä</em>.',
      LABELS_INPUT_RESET:
        'Nollauspainikkeita <strong>ei</strong> tulisi käyttää, ellei niitä erityisesti tarvita, koska ne on helppo aktivoida vahingossa. <hr> <strong>Vinkki!</strong> Lue, miksi <a href="https://www.nngroup.com/articles/reset-and-cancel-buttons/">Reset- ja Cancel-painikkeet aiheuttavat käytettävyysongelmia.</a>',
      LABELS_ARIA_LABEL_INPUT:
        'Syötteellä on helppokäyttöinen nimi, mutta varmista, että myös merkintä on näkyvissä. <hr> <strong {B}>Saavutettava nimi</strong> <strong {C}>%(TEXT)</strong>',
      LABELS_NO_FOR_ATTRIBUTE:
        'Tähän syötteeseen ei liity nimikettä. Lisää <code>for</code>-attribuutti labeliin, joka vastaa tämän syötteen <code>id</code>:tä. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      ...
      // Embedded content
      EMBED_VIDEO:
        'Varmista, että <strong>kaikissa videoissa on kuvatekstit.</strong> Kaiken ääni- ja videosisällön tekstittäminen on pakollinen A-tason vaatimus. Kuvatekstit tukevat kuuroja ja huonokuuloisia.',
      EMBED_AUDIO:
        'Varmista, että kaikista podcasteista toimitetaan <strong>käännös.</strong> Äänisisällön käännösten toimittaminen on pakollinen tason A vaatimus. Jäljennökset tukevat kuuroja ja huonokuuloisia, mutta niistä on hyötyä kaikille. Harkitse transkriptin sijoittamista alapuolelle tai harmonikkapaneeliin.',
      EMBED_DATA_VIZ:
      ...
      QA_UNDERLINE:
        'Alleviivattu teksti voidaan sekoittaa linkkeihin. Harkitse eri tyylin, kuten <code>&lt;strong&gt;</code><strong>strong importance</strong><code>&lt;/strong&gt;</code> tai <code>&lt;em&gt;</code><em>emphasis</em><code>&lt;/em&gt;</code> käyttöä.',
      QA_SUBSCRIPT:
        'Ala- ja yläindeksin muotoiluvaihtoehtoja tulisi käyttää vain tekstin sijainnin muuttamiseen typografisten konventioiden tai standardien vuoksi. Niitä <strong>ei</strong> pitäisi käyttää pelkästään esitystarkoituksiin tai ulkoasuun. Kokonaisten lauseiden muotoilu aiheuttaa luettavuusongelmia. Sopivia käyttötapauksia olisivat esimerkiksi eksponenttien, järjestyslukujen, kuten 4<sup>th</sup> neljännen sijasta, ja kemiallisten kaavojen (esim. H<sub>2</sub>O) näyttäminen.',
      QA_NESTED_COMPONENTS:
        'Vältä interaktiivisten asettelukomponenttien upottamista, kuten akordeonien sijoittamista välilehtiin tai välilehtien sijoittamista akordeoneihin. Tämä voi monimutkaistaa navigointia, lisätä kognitiivista kuormitusta ja johtaa siihen, että ihmiset ohittavat sisällön.',
      QA_JUSTIFY:
        'Vältä tasattua tekstiä, joka tasataan sekä vasemmalle että oikealle reunalle. Tämä voi olla joidenkin ihmisten vaikea lukea, koska sanojen välissä on epätasaisia välejä. Käytä vasemmalle tasattua tekstiä paremman luettavuuden takaamiseksi.',
      QA_SMALL_TEXT:
      ...
      // Developer
      DUPLICATE_ID:
        'Löytyi <strong>kaksoistunniste</strong>. Kaksoistunnusvirheiden tiedetään aiheuttavan ongelmia avustaville teknologioille, kun ne yrittävät toimia vuorovaikutuksessa sisällön kanssa. Poista tai vaihda seuraava ID. <hr> <strong {B}>ID</strong> <strong {C}>#%(id)</strong>',
      UNCONTAINED_LI:
        'Kaikki <code>&lt;li&gt;</code> luetteloelementit on sijoitettava <code>&lt;ul&gt;</code> järjestämättömien tai <code>&lt;ol&gt;</code> järjestettyjen elementtien sisään. Tämä rakenne auttaa ruudunlukuohjelmia ilmoittamaan luettelon ja sen kohteet tarkasti.',
      TABINDEX_ATTR:
        'Elementillä ei tulisi olla <code>tabindex</code>-attribuuttia, joka on suurempi kuin 0.',
      ...
      BTN_EMPTY_LABELLEDBY:
        'Painikkeessa on <code>aria-labelledby</code>-arvo, joka on tyhjä tai ei vastaa toisen elementin <code>id</code>-arvoa sivulla.',
      BTN: 'painike',
      BTN_TIP:
        'Opi, kuinka tehdä <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">saavutettava painike.</a>',
      BTN_ROLE_IN_NAME:
      ...
      CONTRAST_ERROR:
        'Tekstissä ei ole tarpeeksi kontrastia taustaan nähden, joten sitä on vaikea lukea.',
      CONTRAST_WARNING:
        'Tämän tekstin kontrasti on tuntematon ja se tulee tarkistaa manuaalisesti. Varmista, että tekstissä ja taustassa on voimakas värierotus.',
      CONTRAST_ERROR_GRAPHIC:
        'Grafiikassa ei ole tarpeeksi kontrastia taustaan nähden, joten sitä on vaikea nähdä.',
      CONTRAST_WARNING_GRAPHIC:
        'Tämän grafiikan kontrasti on tuntematon ja se tulee tarkistaa manuaalisesti.',
      CONTRAST_TIP_GRAPHIC:
        'Grafiikassa ja käyttöliittymäelementeissä tulee olla vähintään 3:1 kontrastisuhde.',
      CONTRAST_OPACITY: 'Lisää opasiteettia paremman näkyvyyden saavuttamiseksi.',
      CONTRAST_APCA:
        'Tässä ei ole tarpeeksi kontrastia minkään kokoiselle tekstille. Harkitse tämän värin ja tekstikoon yhdistelmän käyttöä?',
      ...
      CONTRAST_PLACEHOLDER:
        'Tämän syötteen paikkamerkintätekstissä ei ole tarpeeksi kontrastia taustaan nähden, joten sitä on vaikea lukea.',
      CONTRAST_PLACEHOLDER_UNSUPPORTED:
        'Tämän paikkamerkkitekstin kontrasti on tuntematon ja se on tarkistettava manuaalisesti. Varmista, että teksti ja tausta ovat voimakkaasti kontrastisia värejä.',
      CONTRAST_INPUT:
        'Tässä syötteessä ei ole tarpeeksi kontrastia taustaan nähden, joten sitä on vaikea lukea.',
      CONTRAST: 'Kontrasti',
      UNKNOWN: 'Tuntematon',
      FG: 'Etualalla',
      BG: 'Tausta',
      NO_SUGGESTION:
        'Ei löydy käyttökelpoista yhdistelmää pelkästään tekstin värin muuttamalla. Kokeile taustavärin vaihtamista.',
    },
  };
