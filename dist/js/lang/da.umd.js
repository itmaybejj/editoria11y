(function(global, factory) {
  ...
  const tips = {
    ...
    LINK_ALT_MAYBE_BAD_WARNING: `<p>Alt‑tekst: "<strong>%(alt)</strong>"</p><p><strong class="badge">Løsning</strong> Sæt denne billedes alt‑tekst til linkdestinationens navn.</p>${why.imageLinks}`,
    LINK_ALT_UNPRONOUNCEABLE: `<p>Alt‑teksten for dette linkede billede består kun af uudtalelige tegn: “<strong>%(ALT_TEXT)</strong>”.</p><p>${why.fix}Sæt alt‑teksten til linkets mål eller formål.</p>${why.imageLinks}`,
