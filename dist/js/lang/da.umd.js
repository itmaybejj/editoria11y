(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Ed11yLangDa = {}));
  ...
  const tooltip = {
    ...
    EMBED_MISSING_TITLE: 'Indlejret indhold kræver et tilgængeligt navn, der beskriver dets indhold. Angiv venligst en unik <code>title</code> eller <code>aria-label</code> attribut på <code>&lt;%(ELEMENT)&gt;</code>-elementet. Få mere at vide om <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
  ...
  const testNames = {
    ...
    BTN_UNPRONOUNCEABLE: "Denne knap kan ikke udtales",
    ...
    HEADING_UNPRONOUNCEABLE: "Denne overskrift kan ikke udtales",
    ...
    IMAGE_FIGURE_DECORATIVE: "Dette billede med billedtekst mangler alt-tekst",
    ...
    LINK_CLICK_HERE: "Dette link indeholder “klik her”",
    ...
    LINK_IMAGE_ALT: "Beskriver denne alt-tekst linket eller billedet?",
    ...
    LINK_IMAGE_TEXT: "Behøver dette billede i et link en beskrivelse?",
    ...
    LINK_SYMBOLS: "Er symbolerne eller emojierne i dette link meningsfulde?",
    ...
    QA_BAD_LINK: "Dette linkmål er måske ugyldigt",
  ...
  const tips = {
    ...
    BTN_EMPTY: `<p>${why.fix}Brug enhver gyldig metode til at forklare for skærmlæsere, hvad denne knap gør, f.eks. tekst, alt-tekst på et ikon eller en title-attribut.</p>`,
    ...
    BTN_UNPRONOUNCEABLE: `<p><strong>Knaptekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Tilføj tekst, en titel eller en aria-label, der beskriver dens destination.</p><div class="why"><p>Tip: Skærmlæsere kan ikke beskrive knapper, der kun indeholder mellemrum eller symboler. De bliver enten tavse (“Knap, [...ubehagelig pause hvor knappens etiket burde være...]”), eller de læser symbolets navn.</p></div>`,
    ...
    DUPLICATE_TITLE: `<p>${why.fix}Slet linkets tekst eller dets <code>title</code>-attribut.</p><div class="why"><p>Tip: <code>title</code>-værktøjstip vises kun ved muse-hover. De kan ikke ses på mobil eller med tastatur, så mange brugere ser dem aldrig. De bør ikke indeholde vigtige oplysninger.</p></div>`,
    ...
    HEADING_UNPRONOUNCEABLE: `<p>Tomme overskrifter skaber huller i sidens struktur.</p><p>${why.fix}Tilføj læsbar tekst til denne overskrift, eller konvertér den til et afsnit.</p>${why.headings}`,
    ...
    HIDDEN_FOCUSABLE: `<p>Dette interaktive element har <code>aria-hidden="true"</code>, men kan stadig fokuseres med tastatur.</p><p>${why.fix}Skal det skjules for skærmlæsere, tilføj også <code>tabindex="-1"</code>; ellers fjern <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
    ...
    LABELS_MISSING_LABEL: `<p>${why.fix}Tilføj et <code>id</code> til dette felt, og tilføj en matchende <code>for</code>-attribut til etiketten.</p>`,
    ...
    LINK_EMPTY_NO_LABEL: `<p>${why.fix}Tilføj beskrivende tekst, eller slet linket, hvis det var en fejl.</p><div class="why"><p>Tip: skærmlæsere kan ikke beskrive tomme links.</p><p>Nogle editorer gør linkede mellemrum svære at fjerne; slet ord på begge sider og skriv dem igen.</p></div>`,
    ...
    LINK_FILE_EXT: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>Linket fører til en fil (PDF, MP3, Zip, Word, …) uden advarsel.</p><p>${why.fix}Angiv filtype i linket via tekst/ikon.</p><p class="why">Angiv evt. filstørrelse: “Årsrapport (PDF, 3 MB)”.</p>`,
    LINK_IDENTICAL_NAME: `<p><strong>Linktekst:</strong> <i>%(TEXT)</i></p><p>${why.fix}Omskriv links, der fører til forskellige steder, så deres tekst entydigt afspejler deres destination.</p>${why.links}`,
    ...
    LINK_IMAGE_NO_ALT_TEXT: `<p>Når et link indeholder et billede, bruges billedets alt-tekst <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">som linkets navn</a></p><p>${why.fix}Brug titlen på linkets destination som alt-tekst for linkede billeder.</p>${why.imageLinks}`,
    ...
    LINK_STOPWORD: `<p>Linktekst: <i>%(ERROR)</i></p><p>${why.fix}Brug linktekst, der beskriver destinationen.</p>${why.links}`,
    ...
    QA_IN_PAGE_LINK: `<p><strong>URL:</strong> <i>#%(ID)</i></p><p><strong>Link:</strong> <code>%(TEXT)</code></p><p>Linkets mål matcher ikke noget element på siden.</p><div class="why"><p>Udviklernote: hvis det er en JS-anker, så test tastaturbetjening før udelukkelse.</p></div>`,
