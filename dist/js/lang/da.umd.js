(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>Skærmlæsere læser denne URL op — ofte tegn for tegn. Det formidler sjældent samme betydning som at se billedet.</p><p>${why.fix}Beskriv kort, hvad billedet betyder i denne sammenhæng.</p>${why.images}`,
    ...
    LINK_ALT_FILE_EXT: `<p><span style="display: none;">%(ALT)</span>Alt‑tekst: <i>%(alt)</i></p><p>Denne alt‑tekst er sandsynligvis et filnavn og ikke en meningsfuld linketiket.</p><p>${why.fix}Brug titlen på linkets destination som alt‑tekst for linkede billeder.</p><div class="why"><p>Formålet med alt‑tekst er at forklare billedets betydning. For et linket billede er dette selve linkdestinationen:</p><ul><li>"Side med tekst" beskriver billedet, ikke linket.</li><li>"IMG_1234.jpg" er kun et filnavn.</li><li>"Tilmeldingsformular til arrangement (.doc)" beskriver linkets mål.</li></ul></p></div>`,
    ...
    MISSING_ALT: `<p>Mangler alt, læser skærmlæsere billed‑URL’en bogstav for bogstav.</p><p>${why.fix}Beskriv kort, hvad billedet betyder i denne sammenhæng.</p>${why.images}`,
