(function(global, factory) {
  ...
  const tips = {
    ...
    ALT_FILE_EXT: `<p><span style="display: none">%(alt)</span><strong>Alt‑tekst:</strong> <i>%(ALT_TEXT)</i></p><p>Skærmlæsere forsøger at udtale denne URL — ofte tegn for tegn. Det formidler sjældent samme betydning som at se billedet.</p><p>${why.fix}Beskriv kort, hvad billedet betyder i denne sammenhæng.</p>${why.images}`,
