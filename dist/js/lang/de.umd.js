(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Ed11yLangDe = {}));
  ...
  const Sa11yStrings = {
    ...
    strings: {
      ...
      TABLES_INVALID_HEADERS_REF: 'Das <code>headers</code>-Attribut enthält einen ungültigen Verweis: <strong {C}>%(VALUE)</strong>. Es muss auf die ID einer gültigen Kopfzeilenzelle innerhalb derselben Tabelle verweisen. <hr> Erfahren Sie mehr über die <a href="https://www.w3.org/WAI/WCAG22/Techniques/html/H43">Verwendung von id- und headers-Attributen zur Verknüpfung von Datenzellen mit Kopfzeilenzellen in Datentabellen.</a>',
      // Contrast
