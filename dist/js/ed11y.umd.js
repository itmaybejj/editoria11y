...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apca-w3'), require('node:constants')) :
  typeof define === 'function' && define.amd ? define(['exports', 'apca-w3', 'node:constants'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Ed11y = {}, global.apcaW3));
})(this, (function (exports, apcaW3) { 'use strict';
...
<pre>${escapeHTML(this.error.stack)}</pre>
  ...
  */
    ...
    while (targetEl && targetEl.nodeType === 1) {
      ...
      if (bgColor[3] !== 0 && bgColor !== 'transparent') {
        ...
        if (bgColor[3] < 1) {
          ...
          const blendedBG = apcaW3.alphaBlend(bgColor, parentColor);
          return blendedBG;
        }
  ...
  function calculateContrast(color, bg) {
    let ratio;
    const blendedColor = apcaW3.alphaBlend(color, bg).slice(0, 4);
    if (Constants.Global.contrastAPCA) {
      const foreground = apcaW3.sRGBtoY(blendedColor);
      const background = apcaW3.sRGBtoY(bg);
      ratio = apcaW3.APCAcontrast(foreground, background);
    } else {
  ...
  */
  function apcaAlgorithm($el, color, background, fontSize, fontWeight, opacity) {
    ...
    const fontLookup = apcaW3.fontLookupAPCA(ratio).slice(1);
