...
const testNames = {
	...
	BTN_UNPRONOUNCEABLE: 'Este botão não pode ser pronunciado',
	...
	HEADING_UNPRONOUNCEABLE: 'Este cabeçalho não pode ser pronunciado',
	...
	IMAGE_FIGURE_DECORATIVE: 'Esta imagem com legenda não possui texto alternativo',
	...
	LINK_CLICK_HERE: 'Este link contém “clique aqui”',
	...
	LINK_IMAGE_ALT: 'Este texto alternativo descreve o link ou a imagem?',
	...
	LINK_IMAGE_TEXT: 'Esta imagem usada como link precisa de uma descrição?',
	...
	LINK_SYMBOLS: 'Os símbolos ou emojis deste link são significativos?',
	...
	QA_BAD_LINK: 'O destino deste link pode ser inválido',
...
export const tips = {
	...
	BTN_UNPRONOUNCEABLE: `<p><strong>Texto do botão:</strong> <i>%(TEXT)</i></p><p>${why.fix}Adicione texto, um título ou um aria-label descrevendo seu destino.</p><div class="why"><p>Dica: leitores de tela não conseguem descrever botões que contêm apenas espaços ou símbolos. Eles ficam silenciosos (“Botão, [...pausa incômoda onde o rótulo do botão deveria estar...]”), ou leem o nome do símbolo.</p></div>`,
	...
	EMBED_GENERAL: 'Ferramentas automáticas não analisam conteúdo dentro de embeds. Garanta alt em imagens, legendas em vídeos, contraste adequado e links/botões <a href="https://webaim.org/techniques/keyboard/">acessíveis por teclado</a>. Depois, ignore o alerta.',
	...
	HEADING_UNPRONOUNCEABLE: `<p>Cabeçalhos vazios criam lacunas na estrutura.</p><p>${why.fix}Adicione texto legível a este cabeçalho, ou converta-o em um parágrafo.</p>${why.headings}`,
	...
	HIDDEN_FOCUSABLE: `<p>Este elemento tem <code>aria-hidden="true"</code> mas recebe foco pelo teclado.</p><p>${why.fix}Para escondê-lo de leitores, adicione <code>tabindex="-1"</code>; caso contrário, remova <code>aria-hidden</code>.</p><p><strong>Elemento:</strong> <code>%(ELEMENT)</code></p>`,
	...
	LINK_FILE_EXT: `<p><strong>Texto do link:</strong> <i>%(TEXT)</i></p><p>O link leva a arquivo (PDF/MP3/ZIP/Word etc.) sem aviso.</p><p>${why.fix}Indique o tipo de arquivo na própria ligação (texto ou ícone): <a href="https://itmaybejj.github.io/linkpurpose/"></a>.</p><p class="why">Para arquivos grandes, informe o tamanho (ex.: “Relatório (PDF, 3 MB)”).</p>`,
	LINK_IDENTICAL_NAME: `<p><strong>Texto do link:</strong> <i>%(TEXT)</i></p><p>${why.fix}Reformule links que levam a destinos diferentes para que o texto reflita o título específico de cada destino.</p>${why.links}`,
	...
	LINK_IMAGE_NO_ALT_TEXT: `<p>Quando um link contém uma imagem, o alt vira <a href="https://webaim.org/techniques/hypertext/link_text#alt_link">o nome do link</a>.</p><p>${why.fix}Use o título do destino do link como texto alternativo para imagens vinculadas.</p>${why.imageLinks}`,
	...
	META_LANG: `<p>${why.fix}Adicione <a href="https://www.w3.org/International/questions/qa-html-language-declarations">atributo de idioma</a> ao elemento <code>html</code>.</p><div class="why"><p>Leitores de tela dependem do idioma para pronunciar corretamente; idioma incorreto atrapalha a compreensão.</p></div>`,
	...
	META_TITLE: `<p>${why.fix}Inclua <code>&lt;title&gt;</code> dentro de <code>head</code>.</p><div class="why"><p>Um <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/title">título curto e único</a> é importante para resultados de busca, abas do navegador e anúncio por leitores.</p><p>Sem título, usuários veem/ouvirão apenas a URL.</p></div>`,
