...
export const tips = {
	...
	MISSING_ALT: `<p>Sem alt, leitores costumam anunciar a URL do arquivo (até letra por letra).</p><p>${why.fix}Descreva de forma concisa o que esta imagem significa, neste contexto.</p>${why.images}`,
