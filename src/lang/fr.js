...
const testNames = {
	...
	IMAGE_FIGURE_DECORATIVE: 'Cette image avec légende n’a pas de texte alternatif',
...
export const tips = {
	...
	BTN_UNPRONOUNCEABLE: `<p><strong>Texte du bouton :</strong> <i>%(TEXT)</i></p><p>${why.fix}Ajoutez du texte, un titre ou un aria-label décrivant sa destination.</p><div class="why"><p>Conseil : les lecteurs d'écran ne peuvent pas décrire les boutons qui ne contiennent que des espaces ou des symboles. Ils restent soit silencieux (« Bouton, [...pause maladroite là où l'étiquette du bouton devrait être...] »), soit lisent le nom du symbole.</p></div>`,
	...
	LINK_IDENTICAL_NAME: `<p><strong>Texte du lien :</strong> <i>%(TEXT)</i></p><p>${why.fix}Réécrivez les liens menant à des destinations différentes en utilisant les titres uniques de chaque destination.</p>${why.links}`,
