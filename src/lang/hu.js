...
export const testNames = {
	...
	DUPLICATE_TITLE: 'Ez a hivatkozás olyan tooltipet tartalmaz, amely megegyezik a link szövegével',
	EMBED_AUDIO: 'Ennek a hanganyagnak van átirata?',
	EMBED_DATA_VIZ: 'Ez az adatvizualizáció hozzáférhető?',
	EMBED_GENERAL: 'A beágyazott ifame‑ek kézi ellenőrzést igényelnek',
	...
	IMAGE_DECORATIVE: 'Ez a kép valóban díszítő jellegű?',
	...
	LABELS_INPUT_RESET: 'Szükséges ez a törlés gomb?',
	...
	QA_JUSTIFY: 'Ne használj sorkizárt igazítást',
	...
	QA_SUBSCRIPT: 'A felső- vagy alsóindexet ne használd pusztán vizuális formázásként',
...
<li>Váltó címkék:<br>„Lejátszás/Szünet”, „Részletek mutatása/Részletek elrejtése”</li>
<li>Állapotváltozás a következő ARIA tulajdonságokban: https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/button_role#associated_aria_roles_states_and_properties</a><br>„Lejátszás/Lejátszás – megnyomva”, „Részletek – összecsukva/Részletek – kinyitva”</li>
</ul>
<p>Fontos: ne változtasd meg egyszerre a címkét <em>és</em> az állapotot. Ha a „Lejátszás” szöveget „Szünet – megnyomva” feliratra cseréled, az azt jelenti, hogy a lejátszó szünetel — nem azt, hogy éppen lejátszik!</p></div>`,

	headings: `<div class="why"><p>Tipp: a címsorok és alcímek hierarchikus szerkezetbe rendezik a tartalmat. A képernyőolvasó‑felhasználók erre a szerkezetre támaszkodnak a megértés és navigáció érdekében:</p><ul>
<li>1. szintű címsor: oldal címe
<ul><li>2. szintű címsor: fő témák
<ul><li>3. szintű címsor: al‑témák</li></ul>
</li></ul>
</li>
</ul></div>`,

	images: `<div class="why"><p>Tipp: amikor alt szöveget írsz, azt írd le, mit jelent a kép a kontextusban — nem csak azt, hogy mi látható rajta. Egy gyerekről készült kép, ahogy labdába rúg, a helyzettől függően jelentheti például:</p><ul>
<li>Esőben is folytatták a játékot.</li>
<li>Az új csapatmezek menő sárkánylogóval készültek.</li>
<li>A bal szélső pozícióból gólt lőtt, amivel megnyerték a meccset!</li>
</ul></div>`,

	links: `<div class="why"><p>Az emberek gyakran a linkek alapján tájékozódnak az oldalon, és név szerint keresik őket. Ezért a jó linkek legyenek: egyértelműek, egyediek és tömörek:</p><ul>
<li>Ideális: „További információk: <a href="https://webaim.org/techniques/hypertext/link_text">értelmes linkek</a>”</li>
<li>Nem egyedi: „Kattints <a href="https://webaim.org/techniques/hypertext/link_text">her</a>, hogy többet megtudj.”</li>
<li>Nem tömör: „<a href="https://webaim.org/techniques/hypertext/link_text">Kattints ide, hogy többet megtudj”</a></li>
</ul></div>`,

	imageLinks: `<div class="why"><p>Az alt szöveg célja nem a kép vizuális tartalmának leírása, hanem a <em>jelentésének</em> közvetítése. Ha a kép egy link része, akkor a jelentése a link célja:</p><ul>
<li>„<em>Nagyító</em>” — csak a képet írja le, nem a linket.</li>
<li>„<em>Kereső ikon</em>” — kétértelmű, nem elég világos.</li>
<li>„<em>Keresés</em>” — a link funkcióját írja le pontosan.</li>
</ul></p></div>`,
};
...
const interfaceStrings = {
	...
	MISSING: '(hiányzik!)',
	NOT_VISIBLE: 'Megjegyzés: ez a tartalom lehet, hogy nem látható. Keresd a kijelölt területen belül.',
	...
	buttonHideHiddenAlerts: `%(count) elrejtett figyelmeztetés elrejtése`,
	...
	dismissHideTitle: 'Csak számodra rejti el ezt a figyelmeztetést',
	...
	dismissalsHeader: 'Nem szeretnéd kijavítani ezt?',
	...
	panelCheckAltText: '<p class="ed11y-small">Ellenőrizd, hogy minden kép a kontextusban értelmezhető‑e, és hogy nincs‑e rajtuk beágyazott szöveg.</p>',
	panelCheckOutline: '<p class="ed11y-small">Ez megjeleníti a címsorstruktúrát. Ellenőrizd, hogy megfelel‑e a vizuális szerkezetnek.</p>',
	...
	unDismissNotePermissions: 'Ezt a figyelmeztetést egy adminisztrátor rejtette el',
