...
export const testNames = {
	...
	LINK_IDENTICAL_NAME: 'Beskriver dette link sin destination entydigt?',
...
export const tips = {
	...
	LABELS_MISSING_LABEL: 'Dette inputfelt mangler en label. Tilføj <code>id</code> til feltet og tilsvarende <code>for</code> til label.',
	...
	LABEL_IN_NAME: `<p>Synlig tekst ser ud til at afvige fra det tilgængelige navn. Det kan forvirre skærmlæser‑brugere og tale‑styring.</p><p>${why.check}Den synlige etiket skal starte med og matche den usynlige.</p><p><strong>Skjult etiket:</strong> “%(TEXT)”</p>`,
	...
	LINK_ALT_MAYBE_BAD: `<p>Alt‑teksten er en placeholder: “<strong>%(alt)</strong>”.</p><p>${why.fix}Sæt alt‑teksten til linkets destination.</p>${why.imageLinks}`,
	...
	LINK_IDENTICAL_NAME: `<p>Flere links med forskellige destinationer bruger samme tekst: “<strong>%(TEXT)</strong>”.</p><p>${why.fix}Gør linkteksterne unikke og målspecifikke.</p>${why.links}`,
	...
	LINK_IMAGE_ALT_AND_TEXT: `<p>Tjek at alt‑teksten hjælper med at beskrive destinationen uden at være redundant:</p><p><strong class="badge">Alt</strong> “<em><strong>%(alt)</strong></em>”</p>${why.imageLinks}`,
	...
	LINK_IMAGE_NO_ALT_TEXT: `<p>Når et link indeholder et billede, bruges billedets alt‑tekst https://webaim.org/techniques/hypertext/link_text#alt_linksom linkets navn</a>.</p><p>${why.fix}Sæt alt‑teksten til linkets mål/formål.</p>${why.imageLinks}`,
	...
	LINK_SUS_ALT: `<p>Alt‑teksten indeholder “%(alt)”, hvilket ofte betyder, at billedet beskrives frem for linkdestinationen.</p><strong class="badge">Alt‑tekst</strong> “%(ALT_TEXT)”<p>Løsning: sørg for at alt‑teksten beskriver linkets mål/formål.<br></p>${why.imageLinks}`,
	...
	QA_DOCUMENT: `<p>Linkede dokumenter er webindhold og skal være tilgængelige. Tjek overskrifter, tabelhoveder og alt‑tekster; luk derefter advarslen.</p><ul class="why"><li>Gør dine <a href="https://support.google.com/docs/answer/6199477?hl=da">Google‑dokumenter</a> tilgængelige.</li><li>Gør dine <a href="https://support.microsoft.com/en-us/office/create-accessible-office-documents-868ecfcd-4f00-4224-b881-a65537a7c155">Office‑dokumenter</a> tilgængelige.</li></ul>`,
	...
	QA_UPPERCASE: `<p>STORE BLOKKE MED VERSALER ER SVÆRERE AT LÆSE OG KAN OPFATTES SOM “RAWBEN”.</p><p>${why.fix}Fremhæv få ord ad gangen, helst med fed frem for versaler.</p><div class="why"><p>Skærmlæsere annoncerer ikke “fed”. Brug overskrift ved nyt emne.</p></div>`,

	SUS_ALT: `<p>Alt‑teksten indeholder “%(alt)” og er formentlig redundant:</p><p><strong class="badge">Alt‑tekst</strong> “%(ALT_TEXT)”</p><p>Løsning: omskriv alt‑teksten kort og betydningsbærende.</p><div class="why"><p>Skærmlæsere annoncerer allerede “billede”, så “billede af …” er ofte unødvendigt.</p></div>`,
