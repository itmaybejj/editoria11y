...
const tips = {
	...
	HIDDEN_FOCUSABLE: `<p>Dieses interaktive Element hat <code>aria-hidden="true"</code>, ist aber weiterhin per Tastatur erreichbar.</p><p>${why.fix}Wenn es wirklich verborgen sein soll, fügen Sie zusätzlich <code>tabindex="-1"</code> hinzu. Andernfalls entfernen Sie <code>aria-hidden</code>.</p><p><strong>Element:</strong> <code>%(ELEMENT)</code></p>`,
