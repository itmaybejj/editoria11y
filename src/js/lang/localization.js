const ed11yLang = {
  ...
  strings: {
    ...
    */
    ...
    // Errors and alerts ==================================
    NOT_VISIBLE:
      'Note: this content may not be visible. Look for it inside the outlined container.',
    SUS_ALT_STOPWORDS: [
      'image',
      'graphic',
      'picture',
  ...
  testNames: {
    ...
    MISSING_ALT_LINK_HAS_TEXT_TEST_NAME:
      'Image in link with text has no alternative text attribute', // Off by default in Editoria11y.
    ...
    HEADING_FIRST_TEST_NAME:
      'The first heading on a page should usually be a Heading 1 or Heading 2',
    ...
    LINK_STOPWORD_ARIA_TEST_NAME:
      'Manual check: link text overridden by ARIA that may not be meaningful',
    ...
    HIDDEN_FOCUSABLE_TEST_NAME:
      'Screen readers told not to speak the name of an interactive element',
    ...
    CONTRAST_PLACEHOLDER_TEST_NAME:
      'Placeholder text does not have enough contrast to be easily legible',
    CONTRAST_PLACEHOLDER_UNSUPPORTED_TEST_NAME: 'Does this placeholder text have enough contrast?',
    CONTRAST_ERROR_GRAPHIC_TEST_NAME:
      'Graphic or icon does not have enough contrast with the background',
  ...
  tests: {
    ...
    EMBED_CUSTOM:
      "<p>This checker cannot test inside embedded content. Check to sure images inside this embed have alt text, videos have captions, and interactive components can be <a href='https://webaim.org/techniques/keyboard/'>operated by a keyboard</a>.</p>",
